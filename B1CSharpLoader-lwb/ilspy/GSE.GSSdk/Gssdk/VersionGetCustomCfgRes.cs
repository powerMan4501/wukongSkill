...
public sealed class VersionGetCustomCfgRes : IMessage<VersionGetCustomCfgRes>, IMessage, IEquatable<VersionGetCustomCfgRes>, IDeepCloneable<VersionGetCustomCfgRes>
{
	private static readonly MessageParser<VersionGetCustomCfgRes> _parser = new MessageParser<VersionGetCustomCfgRes>(() => new VersionGetCustomCfgRes());
	...
	public static MessageParser<VersionGetCustomCfgRes> Parser => _parser;
	...
	public VersionGetCustomCfgRes()
	{
	}

	public VersionGetCustomCfgRes(VersionGetCustomCfgRes other)
		: this()
	{
	...
	public VersionGetCustomCfgRes Clone()
	{
		return new VersionGetCustomCfgRes(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as VersionGetCustomCfgRes);
	}

	public bool Equals(VersionGetCustomCfgRes other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(VersionGetCustomCfgRes other)
	{
		if (other != null)
		{
