...
public sealed class AuthBindReq : IMessage<AuthBindReq>, IMessage, IEquatable<AuthBindReq>, IDeepCloneable<AuthBindReq>
{
	private static readonly MessageParser<AuthBindReq> _parser = new MessageParser<AuthBindReq>(() => new AuthBindReq());
	...
	public static MessageParser<AuthBindReq> Parser => _parser;
	...
	public AuthBindReq(AuthBindReq other)
		: this()
	{
	...
	public AuthBindReq Clone()
	{
		return new AuthBindReq(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as AuthBindReq);
	}

	public bool Equals(AuthBindReq other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(AuthBindReq other)
	{
		if (other == null)
		{
			return;
