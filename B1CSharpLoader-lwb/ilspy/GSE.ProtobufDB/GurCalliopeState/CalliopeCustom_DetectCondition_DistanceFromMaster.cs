...
public sealed class CalliopeCustom_DetectCondition_DistanceFromMaster : IMessage<CalliopeCustom_DetectCondition_DistanceFromMaster>, IMessage, IEquatable<CalliopeCustom_DetectCondition_DistanceFromMaster>, IDeepCloneable<CalliopeCustom_DetectCondition_DistanceFromMaster>
{
	private static readonly MessageParser<CalliopeCustom_DetectCondition_DistanceFromMaster> _parser = new MessageParser<CalliopeCustom_DetectCondition_DistanceFromMaster>(() => new CalliopeCustom_DetectCondition_DistanceFromMaster());
	...
	public static MessageParser<CalliopeCustom_DetectCondition_DistanceFromMaster> Parser => _parser;
	...
	public CalliopeCustom_DetectCondition_DistanceFromMaster()
	{
	}

	public CalliopeCustom_DetectCondition_DistanceFromMaster(CalliopeCustom_DetectCondition_DistanceFromMaster other)
		: this()
	{
	...
	public CalliopeCustom_DetectCondition_DistanceFromMaster Clone()
	{
		return new CalliopeCustom_DetectCondition_DistanceFromMaster(this);
	}
	...
	{
		return Equals(other as CalliopeCustom_DetectCondition_DistanceFromMaster);
	}

	public bool Equals(CalliopeCustom_DetectCondition_DistanceFromMaster other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(CalliopeCustom_DetectCondition_DistanceFromMaster other)
	{
		if (other != null)
		{
