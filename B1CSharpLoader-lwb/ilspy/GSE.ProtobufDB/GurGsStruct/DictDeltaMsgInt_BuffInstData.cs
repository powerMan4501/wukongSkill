...
public sealed class DictDeltaMsgInt_BuffInstData : IMessage<DictDeltaMsgInt_BuffInstData>, IMessage, IEquatable<DictDeltaMsgInt_BuffInstData>, IDeepCloneable<DictDeltaMsgInt_BuffInstData>
{
	...
	private static readonly FieldCodec<ClassDeltaMsgBuffInstData> _repeated_value_codec = FieldCodec.ForMessage(18u, ClassDeltaMsgBuffInstData.Parser);

	private readonly RepeatedField<ClassDeltaMsgBuffInstData> value_ = new RepeatedField<ClassDeltaMsgBuffInstData>();
	...
	public RepeatedField<ClassDeltaMsgBuffInstData> Value => value_;
