...
public sealed class ListDeltaMsgFRepInnerClass : IMessage<ListDeltaMsgFRepInnerClass>, IMessage, IEquatable<ListDeltaMsgFRepInnerClass>, IDeepCloneable<ListDeltaMsgFRepInnerClass>
{
	...
	private static readonly FieldCodec<ClassDeltaMsgFRepInnerClass> _repeated_value_codec = FieldCodec.ForMessage(18u, ClassDeltaMsgFRepInnerClass.Parser);

	private readonly RepeatedField<ClassDeltaMsgFRepInnerClass> value_ = new RepeatedField<ClassDeltaMsgFRepInnerClass>();
	...
	public RepeatedField<ClassDeltaMsgFRepInnerClass> Value => value_;
