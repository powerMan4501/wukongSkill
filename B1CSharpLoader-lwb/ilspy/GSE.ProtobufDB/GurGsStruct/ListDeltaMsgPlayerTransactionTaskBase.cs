...
public sealed class ListDeltaMsgPlayerTransactionTaskBase : IMessage<ListDeltaMsgPlayerTransactionTaskBase>, IMessage, IEquatable<ListDeltaMsgPlayerTransactionTaskBase>, IDeepCloneable<ListDeltaMsgPlayerTransactionTaskBase>
{
	...
	private static readonly FieldCodec<ClassDeltaMsgPlayerTransactionTaskBase> _repeated_value_codec = FieldCodec.ForMessage(18u, ClassDeltaMsgPlayerTransactionTaskBase.Parser);

	private readonly RepeatedField<ClassDeltaMsgPlayerTransactionTaskBase> value_ = new RepeatedField<ClassDeltaMsgPlayerTransactionTaskBase>();
	...
	public RepeatedField<ClassDeltaMsgPlayerTransactionTaskBase> Value => value_;
