...
public sealed class DictDeltaMsgInt_CollectionGroupDataInfo : IMessage<DictDeltaMsgInt_CollectionGroupDataInfo>, IMessage, IEquatable<DictDeltaMsgInt_CollectionGroupDataInfo>, IDeepCloneable<DictDeltaMsgInt_CollectionGroupDataInfo>
{
	...
	private static readonly FieldCodec<ClassDeltaMsgCollectionGroupDataInfo> _repeated_value_codec = FieldCodec.ForMessage(18u, ClassDeltaMsgCollectionGroupDataInfo.Parser);

	private readonly RepeatedField<ClassDeltaMsgCollectionGroupDataInfo> value_ = new RepeatedField<ClassDeltaMsgCollectionGroupDataInfo>();
	...
	public RepeatedField<ClassDeltaMsgCollectionGroupDataInfo> Value => value_;
