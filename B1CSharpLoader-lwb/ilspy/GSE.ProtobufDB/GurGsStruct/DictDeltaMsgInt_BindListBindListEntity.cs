...
public sealed class DictDeltaMsgInt_BindListBindListEntity : IMessage<DictDeltaMsgInt_BindListBindListEntity>, IMessage, IEquatable<DictDeltaMsgInt_BindListBindListEntity>, IDeepCloneable<DictDeltaMsgInt_BindListBindListEntity>
{
	...
	private static readonly FieldCodec<ListDeltaMsgBindListEntity> _repeated_value_codec = FieldCodec.ForMessage(18u, ListDeltaMsgBindListEntity.Parser);

	private readonly RepeatedField<ListDeltaMsgBindListEntity> value_ = new RepeatedField<ListDeltaMsgBindListEntity>();
	...
	public RepeatedField<ListDeltaMsgBindListEntity> Value => value_;
