...
public sealed class FUStAbnormalDispVictimMapDesc : IMessage<FUStAbnormalDispVictimMapDesc>, IMessage, IEquatable<FUStAbnormalDispVictimMapDesc>, IDeepCloneable<FUStAbnormalDispVictimMapDesc>
{
	private static readonly MessageParser<FUStAbnormalDispVictimMapDesc> _parser = new MessageParser<FUStAbnormalDispVictimMapDesc>(() => new FUStAbnormalDispVictimMapDesc());
	...
	public static MessageParser<FUStAbnormalDispVictimMapDesc> Parser => _parser;
	...
	public FUStAbnormalDispVictimMapDesc()
	{
	}

	public FUStAbnormalDispVictimMapDesc(FUStAbnormalDispVictimMapDesc other)
		: this()
	{
		iD_ = other.iD_;
	...
	public FUStAbnormalDispVictimMapDesc Clone()
	{
		return new FUStAbnormalDispVictimMapDesc(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as FUStAbnormalDispVictimMapDesc);
	}

	public bool Equals(FUStAbnormalDispVictimMapDesc other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(FUStAbnormalDispVictimMapDesc other)
	{
		if (other == null)
		{
			return;
