...
public sealed class ServerMailContent : IMessage<ServerMailContent>, IMessage, IEquatable<ServerMailContent>, IDeepCloneable<ServerMailContent>
{
	private static readonly MessageParser<ServerMailContent> _parser = new MessageParser<ServerMailContent>(() => new ServerMailContent());
	...
	public static MessageParser<ServerMailContent> Parser => _parser;
	...
	public ServerMailContent()
	{
	}

	public ServerMailContent(ServerMailContent other)
		: this()
	{
	...
	public ServerMailContent Clone()
	{
		return new ServerMailContent(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as ServerMailContent);
	}

	public bool Equals(ServerMailContent other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(ServerMailContent other)
	{
		if (other != null)
		{
