...
public sealed class BehaviorCustom_BeAttackedNumFromSkillEffect : IMessage<BehaviorCustom_BeAttackedNumFromSkillEffect>, IMessage, IEquatable<BehaviorCustom_BeAttackedNumFromSkillEffect>, IDeepCloneable<BehaviorCustom_BeAttackedNumFromSkillEffect>
{
	private static readonly MessageParser<BehaviorCustom_BeAttackedNumFromSkillEffect> _parser = new MessageParser<BehaviorCustom_BeAttackedNumFromSkillEffect>(() => new BehaviorCustom_BeAttackedNumFromSkillEffect());
	...
	public static MessageParser<BehaviorCustom_BeAttackedNumFromSkillEffect> Parser => _parser;
	...
	public BehaviorCustom_BeAttackedNumFromSkillEffect()
	{
	}

	public BehaviorCustom_BeAttackedNumFromSkillEffect(BehaviorCustom_BeAttackedNumFromSkillEffect other)
		: this()
	{
	...
	public BehaviorCustom_BeAttackedNumFromSkillEffect Clone()
	{
		return new BehaviorCustom_BeAttackedNumFromSkillEffect(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as BehaviorCustom_BeAttackedNumFromSkillEffect);
	}

	public bool Equals(BehaviorCustom_BeAttackedNumFromSkillEffect other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(BehaviorCustom_BeAttackedNumFromSkillEffect other)
	{
		if (other != null)
		{
			if (other.UnitType != 0)
