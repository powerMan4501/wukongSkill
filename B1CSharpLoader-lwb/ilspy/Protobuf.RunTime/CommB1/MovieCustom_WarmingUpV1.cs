...
public sealed class MovieCustom_WarmingUpV1 : IMessage<MovieCustom_WarmingUpV1>, IMessage, IEquatable<MovieCustom_WarmingUpV1>, IDeepCloneable<MovieCustom_WarmingUpV1>
{
	private static readonly MessageParser<MovieCustom_WarmingUpV1> _parser = new MessageParser<MovieCustom_WarmingUpV1>(() => new MovieCustom_WarmingUpV1());
	...
	private int associationConfigId_;

	private int associationSpawnType_;

	public static MessageParser<MovieCustom_WarmingUpV1> Parser => _parser;
	...
	public int AssociationConfigId
	{
		get
		{
			return associationConfigId_;
		}
		set
		{
			associationConfigId_ = value;
		}
	}

	public int AssociationSpawnType
	{
		get
		{
			return associationSpawnType_;
		}
		set
		{
			associationSpawnType_ = value;
		}
	}

	public MovieCustom_WarmingUpV1()
	{
	}

	public MovieCustom_WarmingUpV1(MovieCustom_WarmingUpV1 other)
		: this()
	{
		...
		associationConfigId_ = other.associationConfigId_;
		associationSpawnType_ = other.associationSpawnType_;
		_unknownFields = UnknownFieldSet.Clone(other._unknownFields);
	}

	public MovieCustom_WarmingUpV1 Clone()
	{
		return new MovieCustom_WarmingUpV1(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as MovieCustom_WarmingUpV1);
	}

	public bool Equals(MovieCustom_WarmingUpV1 other)
	{
		if (other == null)
		{
			return false;
		...
		if (AssociationConfigId != other.AssociationConfigId)
		{
			return false;
		}
		if (AssociationSpawnType != other.AssociationSpawnType)
		{
			return false;
		}
	...
	public override int GetHashCode()
	{
		...
		if (AssociationConfigId != 0)
		{
			num ^= AssociationConfigId.GetHashCode();
		}
		if (AssociationSpawnType != 0)
		{
			num ^= AssociationSpawnType.GetHashCode();
		}
	...
	public void WriteTo(CodedOutputStream output)
	{
		...
		if (AssociationConfigId != 0)
		{
			...
			output.WriteInt32(AssociationConfigId);
		}
		if (AssociationSpawnType != 0)
		{
			output.WriteRawTag(88);
			output.WriteInt32(AssociationSpawnType);
		}
		if (_unknownFields != null)
		{
	...
	public int CalculateSize()
	{
		...
		if (AssociationConfigId != 0)
		{
			num += 1 + CodedOutputStream.ComputeInt32Size(AssociationConfigId);
		}
		if (AssociationSpawnType != 0)
		{
			num += 1 + CodedOutputStream.ComputeInt32Size(AssociationSpawnType);
		}
		if (_unknownFields != null)
		{
	...
	public void MergeFrom(MovieCustom_WarmingUpV1 other)
	{
		if (other != null)
		{
			...
			if (other.AssociationConfigId != 0)
			{
				AssociationConfigId = other.AssociationConfigId;
			}
			if (other.AssociationSpawnType != 0)
			{
				AssociationSpawnType = other.AssociationSpawnType;
			}
	...
	public void MergeFrom(CodedInputStream input)
	{
		...
		while ((num = input.ReadTag()) != 0)
		{
			...
			case 72u:
				...
				break;
			case 80u:
				AssociationConfigId = input.ReadInt32();
				break;
			case 88u:
				AssociationSpawnType = input.ReadInt32();
				break;
			}
		}
	}
