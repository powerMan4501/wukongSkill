...
public sealed class CalliopeCustom_CompositeTransitionCondition_Battle : IMessage<CalliopeCustom_CompositeTransitionCondition_Battle>, IMessage, IEquatable<CalliopeCustom_CompositeTransitionCondition_Battle>, IDeepCloneable<CalliopeCustom_CompositeTransitionCondition_Battle>
{
	private static readonly MessageParser<CalliopeCustom_CompositeTransitionCondition_Battle> _parser = new MessageParser<CalliopeCustom_CompositeTransitionCondition_Battle>(() => new CalliopeCustom_CompositeTransitionCondition_Battle());

	private UnknownFieldSet _unknownFields;

	private CalliopeCustom_TransitionCondition_Battle single_;

	private bool isUseCompositeCondition_;

	private static readonly FieldCodec<CalliopeCustom_TransitionCondition_Battle> _repeated_conditions_codec = FieldCodec.ForMessage(26u, CalliopeCustom_TransitionCondition_Battle.Parser);

	private readonly RepeatedField<CalliopeCustom_TransitionCondition_Battle> conditions_ = new RepeatedField<CalliopeCustom_TransitionCondition_Battle>();
	...
	public static MessageParser<CalliopeCustom_CompositeTransitionCondition_Battle> Parser => _parser;

	public CalliopeCustom_TransitionCondition_Battle Single
	{
		get
		{
			return single_;
	...
	public RepeatedField<CalliopeCustom_TransitionCondition_Battle> Conditions => conditions_;
	...
	public CalliopeCustom_CompositeTransitionCondition_Battle()
	{
	}

	public CalliopeCustom_CompositeTransitionCondition_Battle(CalliopeCustom_CompositeTransitionCondition_Battle other)
		: this()
	{
	...
	public CalliopeCustom_CompositeTransitionCondition_Battle Clone()
	{
		return new CalliopeCustom_CompositeTransitionCondition_Battle(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as CalliopeCustom_CompositeTransitionCondition_Battle);
	}

	public bool Equals(CalliopeCustom_CompositeTransitionCondition_Battle other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(CalliopeCustom_CompositeTransitionCondition_Battle other)
	{
		if (other == null)
		{
			return;
		...
		if (other.single_ != null)
		{
			if (single_ == null)
			{
				Single = new CalliopeCustom_TransitionCondition_Battle();
			}
