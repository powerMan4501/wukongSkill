...
public sealed class CalliopeCustom_CompositeTransitionCondition_Group : IMessage<CalliopeCustom_CompositeTransitionCondition_Group>, IMessage, IEquatable<CalliopeCustom_CompositeTransitionCondition_Group>, IDeepCloneable<CalliopeCustom_CompositeTransitionCondition_Group>
{
	private static readonly MessageParser<CalliopeCustom_CompositeTransitionCondition_Group> _parser = new MessageParser<CalliopeCustom_CompositeTransitionCondition_Group>(() => new CalliopeCustom_CompositeTransitionCondition_Group());

	private UnknownFieldSet _unknownFields;

	private CalliopeCustom_TransitionCondition_Group single_;

	private bool isUseCompositeCondition_;

	private static readonly FieldCodec<CalliopeCustom_TransitionCondition_Group> _repeated_conditions_codec = FieldCodec.ForMessage(26u, CalliopeCustom_TransitionCondition_Group.Parser);

	private readonly RepeatedField<CalliopeCustom_TransitionCondition_Group> conditions_ = new RepeatedField<CalliopeCustom_TransitionCondition_Group>();
	...
	public static MessageParser<CalliopeCustom_CompositeTransitionCondition_Group> Parser => _parser;

	public CalliopeCustom_TransitionCondition_Group Single
	{
		get
		{
			return single_;
	...
	public RepeatedField<CalliopeCustom_TransitionCondition_Group> Conditions => conditions_;
	...
	public CalliopeCustom_CompositeTransitionCondition_Group()
	{
	}

	public CalliopeCustom_CompositeTransitionCondition_Group(CalliopeCustom_CompositeTransitionCondition_Group other)
		: this()
	{
	...
	public CalliopeCustom_CompositeTransitionCondition_Group Clone()
	{
		return new CalliopeCustom_CompositeTransitionCondition_Group(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as CalliopeCustom_CompositeTransitionCondition_Group);
	}

	public bool Equals(CalliopeCustom_CompositeTransitionCondition_Group other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(CalliopeCustom_CompositeTransitionCondition_Group other)
	{
		if (other == null)
		{
			return;
		...
		if (other.single_ != null)
		{
			if (single_ == null)
			{
				Single = new CalliopeCustom_TransitionCondition_Group();
			}
