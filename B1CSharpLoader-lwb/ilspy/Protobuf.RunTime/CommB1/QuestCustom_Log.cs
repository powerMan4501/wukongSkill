...
public sealed class QuestCustom_Log : IMessage<QuestCustom_Log>, IMessage, IEquatable<QuestCustom_Log>, IDeepCloneable<QuestCustom_Log>
{
	private static readonly MessageParser<QuestCustom_Log> _parser = new MessageParser<QuestCustom_Log>(() => new QuestCustom_Log());
	...
	public static MessageParser<QuestCustom_Log> Parser => _parser;
	...
	public QuestCustom_Log()
	{
	}

	public QuestCustom_Log(QuestCustom_Log other)
		: this()
	{
	...
	public QuestCustom_Log Clone()
	{
		return new QuestCustom_Log(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as QuestCustom_Log);
	}

	public bool Equals(QuestCustom_Log other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(QuestCustom_Log other)
	{
		if (other != null)
		{
