...
public sealed class CardStoryStageSyncWrapper : IMessage<CardStoryStageSyncWrapper>, IMessage, IEquatable<CardStoryStageSyncWrapper>, IDeepCloneable<CardStoryStageSyncWrapper>
{
	private static readonly MessageParser<CardStoryStageSyncWrapper> _parser = new MessageParser<CardStoryStageSyncWrapper>(() => new CardStoryStageSyncWrapper());
	...
	public static MessageParser<CardStoryStageSyncWrapper> Parser => _parser;
	...
	public CardStoryStageSyncWrapper()
	{
	}

	public CardStoryStageSyncWrapper(CardStoryStageSyncWrapper other)
		: this()
	{
	...
	public CardStoryStageSyncWrapper Clone()
	{
		return new CardStoryStageSyncWrapper(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as CardStoryStageSyncWrapper);
	}

	public bool Equals(CardStoryStageSyncWrapper other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(CardStoryStageSyncWrapper other)
	{
		if (other == null)
		{
			return;
