...
public sealed class OutputConfigSyncWrapper : IMessage<OutputConfigSyncWrapper>, IMessage, IEquatable<OutputConfigSyncWrapper>, IDeepCloneable<OutputConfigSyncWrapper>
{
	private static readonly MessageParser<OutputConfigSyncWrapper> _parser = new MessageParser<OutputConfigSyncWrapper>(() => new OutputConfigSyncWrapper());
	...
	public static MessageParser<OutputConfigSyncWrapper> Parser => _parser;
	...
	public OutputConfigSyncWrapper()
	{
	}

	public OutputConfigSyncWrapper(OutputConfigSyncWrapper other)
		: this()
	{
	...
	public OutputConfigSyncWrapper Clone()
	{
		return new OutputConfigSyncWrapper(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as OutputConfigSyncWrapper);
	}

	public bool Equals(OutputConfigSyncWrapper other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(OutputConfigSyncWrapper other)
	{
		if (other == null)
		{
			return;
