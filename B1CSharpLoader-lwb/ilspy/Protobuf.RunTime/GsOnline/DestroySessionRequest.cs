...
public sealed class DestroySessionRequest : IMessage<DestroySessionRequest>, IMessage, IEquatable<DestroySessionRequest>, IDeepCloneable<DestroySessionRequest>
{
	...
	public static MessageParser<DestroySessionRequest> Parser => _parser;
