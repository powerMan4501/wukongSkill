...
internal static class Native_IConsoleManager
{
	...
	[MonoNativeFunctionWrapper]
	public delegate IntPtr Del_RegisterConsoleCommandDefault(IntPtr instance, ref FScriptArray name, ref FScriptArray help, IntPtr command, EConsoleVariableFlags flags);

	[MonoNativeFunctionWrapper]
	public delegate IntPtr Del_RegisterConsoleCommandWithArgs(IntPtr instance, ref FScriptArray name, ref FScriptArray help, IntPtr command, EConsoleVariableFlags flags);

	[MonoNativeFunctionWrapper]
	public delegate IntPtr Del_RegisterConsoleCommandWithWorld(IntPtr instance, ref FScriptArray name, ref FScriptArray help, IntPtr command, EConsoleVariableFlags flags);

	[MonoNativeFunctionWrapper]
	public delegate IntPtr Del_RegisterConsoleCommandWithWorldAndArgs(IntPtr instance, ref FScriptArray name, ref FScriptArray help, IntPtr command, EConsoleVariableFlags flags);

	[MonoNativeFunctionWrapper]
	public delegate IntPtr Del_RegisterConsoleCommandWithOutputDevice(IntPtr instance, ref FScriptArray name, ref FScriptArray help, IntPtr command, EConsoleVariableFlags flags);
