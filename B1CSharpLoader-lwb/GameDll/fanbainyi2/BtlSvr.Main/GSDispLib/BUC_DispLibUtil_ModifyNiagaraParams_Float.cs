...
[BlueprintType]
[UStruct]
[USharpPath("/Script/b1-Managed.BUC_DispLibUtil_ModifyNiagaraParams_Float")]
public struct BUC_DispLibUtil_ModifyNiagaraParams_Float
{
	[DisplayName("模式")]
	[BlueprintReadWrite]
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BUC_DispLibUtil_ModifyNiagaraParams_Float:Mode")]
	...
	[DisplayName("每帧设置")]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BUC_DispLibUtil_ModifyNiagaraParams_Float:SetEveryFrame")]
	...
	[USharpPath("/Script/b1-Managed.BUC_DispLibUtil_ModifyNiagaraParams_Float:SpecAttType")]
	...
	[UMeta(MD.ToolTip, "【特殊属性类型】为速度时，此参数表示计算速度时的平滑插值速率")]
	[UProperty]
	[EditAnywhere]
	[BlueprintReadWrite]
	[DisplayName("值")]
	[USharpPath("/Script/b1-Managed.BUC_DispLibUtil_ModifyNiagaraParams_Float:Value")]
	public float Value;
	...
	[DisplayName("随机范围Min")]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BUC_DispLibUtil_ModifyNiagaraParams_Float:RangeMin")]
	...
	[DisplayName("随机范围Max")]
	[UMeta(MDProp.EditCondition, "Mode == DispLibDBCAdvProcessModifyNiagaraParamUtilMode::RandomOnSpawn || Mode == DispLibDBCAdvProcessModifyNiagaraParamUtilMode::Random")]
	[USharpPath("/Script/b1-Managed.BUC_DispLibUtil_ModifyNiagaraParams_Float:RangeMax")]
	...
	[USharpPath("/Script/b1-Managed.BUC_DispLibUtil_ModifyNiagaraParams_Float:Loop")]
	public bool Loop;
	...
	[UMeta(MDProp.EditCondition, "Mode == DispLibDBCAdvProcessModifyNiagaraParamUtilMode::TimedUCurve")]
	[DisplayName("周期时长")]
	[USharpPath("/Script/b1-Managed.BUC_DispLibUtil_ModifyNiagaraParams_Float:Period")]
	public float Period;
	...
	[USharpPath("/Script/b1-Managed.BUC_DispLibUtil_ModifyNiagaraParams_Float:Duration")]
	...
	[UProperty]
	[USharpPath("/Script/b1-Managed.BUC_DispLibUtil_ModifyNiagaraParams_Float:EndStageDuration")]
	...
	[USharpPath("/Script/b1-Managed.BUC_DispLibUtil_ModifyNiagaraParams_Float:EndValue")]
	...
	[DisplayName("Y轴缩放")]
	[BlueprintReadWrite]
	[USharpPath("/Script/b1-Managed.BUC_DispLibUtil_ModifyNiagaraParams_Float:Scale")]
	public float Scale;
	...
	[UMeta(MDProp.EditCondition, "Mode == DispLibDBCAdvProcessModifyNiagaraParamUtilMode::TimedUCurve || Mode == DispLibDBCAdvProcessModifyNiagaraParamUtilMode::SpecAttUCurve")]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BUC_DispLibUtil_ModifyNiagaraParams_Float:Curve")]
	public UCurveFloat Curve;

	private static int BUC_DispLibUtil_ModifyNiagaraParams_Float_StructSize;

	private static int BUC_DispLibUtil_ModifyNiagaraParams_Float_IsValid;
	...
	public BUC_DispLibUtil_ModifyNiagaraParams_Float Copy()
	{
		return this;
	}

	public static BUC_DispLibUtil_ModifyNiagaraParams_Float FromNative(IntPtr nativeBuffer)
	{
		return new BUC_DispLibUtil_ModifyNiagaraParams_Float(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, BUC_DispLibUtil_ModifyNiagaraParams_Float value)
	{
		value.ToNative(nativeBuffer);
	}

	public static BUC_DispLibUtil_ModifyNiagaraParams_Float FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new BUC_DispLibUtil_ModifyNiagaraParams_Float(IntPtr.Add(nativeBuffer, arrayIndex * BUC_DispLibUtil_ModifyNiagaraParams_Float_StructSize));
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, BUC_DispLibUtil_ModifyNiagaraParams_Float value)
	{
		value.ToNative(IntPtr.Add(nativeBuffer, arrayIndex * BUC_DispLibUtil_ModifyNiagaraParams_Float_StructSize));
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (BUC_DispLibUtil_ModifyNiagaraParams_Float_IsValid == 0)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/b1-Managed.BUC_DispLibUtil_ModifyNiagaraParams_Float");
			return;
		}
		...
		BlittableTypeMarshaler<float>.ToNative(IntPtr.Add(nativeStruct, RangeMin_Offset), RangeMin);
		BlittableTypeMarshaler<float>.ToNative(IntPtr.Add(nativeStruct, RangeMax_Offset), RangeMax);
	...
	public BUC_DispLibUtil_ModifyNiagaraParams_Float(IntPtr nativeStruct)
	{
		if (BUC_DispLibUtil_ModifyNiagaraParams_Float_IsValid == 0)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/b1-Managed.BUC_DispLibUtil_ModifyNiagaraParams_Float");
		...
		else
		{
			...
			RangeMin = BlittableTypeMarshaler<float>.FromNative(IntPtr.Add(nativeStruct, RangeMin_Offset));
			RangeMax = BlittableTypeMarshaler<float>.FromNative(IntPtr.Add(nativeStruct, RangeMax_Offset));
	...
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/b1-Managed.BUC_DispLibUtil_ModifyNiagaraParams_Float");
		BUC_DispLibUtil_ModifyNiagaraParams_Float_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		RangeMin_IsValid = NativeReflection.ValidatePropertyClass(intPtr, "RangeMin", Classes.FFloatProperty);
		RangeMax_Offset = NativeReflection.GetPropertyOffset(intPtr, "RangeMax");
		RangeMax_IsValid = NativeReflection.ValidatePropertyClass(intPtr, "RangeMax", Classes.FFloatProperty);
		...
		BUC_DispLibUtil_ModifyNiagaraParams_Float_IsValid = ((intPtr != IntPtr.Zero && Mode_IsValid && SetEveryFrame_IsValid && SpecAttType_IsValid && Value_IsValid && RangeMin_IsValid && RangeMax_IsValid && Loop_IsValid && Period_IsValid && Duration_IsValid && EndStageDuration_IsValid && EndValue_IsValid && Scale_IsValid && Curve_IsValid) ? 1 : 0);
		NativeReflection.LogStructIsValid("/Script/b1-Managed.BUC_DispLibUtil_ModifyNiagaraParams_Float", (byte)BUC_DispLibUtil_ModifyNiagaraParams_Float_IsValid != 0);
	}

	static BUC_DispLibUtil_ModifyNiagaraParams_Float()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BUC_DispLibUtil_ModifyNiagaraParams_Float)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BUC_DispLibUtil_ModifyNiagaraParams_Float));
	}
}
