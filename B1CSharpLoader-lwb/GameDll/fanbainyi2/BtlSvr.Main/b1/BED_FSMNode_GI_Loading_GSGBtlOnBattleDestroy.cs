...
[Placeable(true)]
[DisplayName("GSGBtlOnBattleDestroy")]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy")]
public class BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy bED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy = GCHelper.Find<BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy>(obj);
		...
		bED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy bED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy = GCHelper.Find<BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy));
	}
}
