...
public class FSMState_GI_Loading_PauseGame : FSMState_GI_LoadingBase
{
	...
	{
		BGW_EventCollection.Get(Context.GameInst).Evt_SetGamePause(EPauseEvent.LoadingScreen, bPause: true);
