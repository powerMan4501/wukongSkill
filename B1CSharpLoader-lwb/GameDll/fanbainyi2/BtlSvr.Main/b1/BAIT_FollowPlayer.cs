...
[UClass]
[USharpPath("/Script/b1-Managed.BAIT_FollowPlayer")]
internal class BAIT_FollowPlayer : BAIT_Base
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BAIT_FollowPlayer:AcceptableRaidus")]
	public float AcceptableRaidus
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BAIT_FollowPlayer:AcceptableRaidus");
				return 0f;
			}
	...
	[EditAnywhere]
	[BlueprintReadWrite]
	[USharpPath("/Script/b1-Managed.BAIT_FollowPlayer:IncludeSelfRadius")]
	public bool IncludeSelfRadius
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BAIT_FollowPlayer:IncludeSelfRadius");
				return false;
			}
	...
	[EditAnywhere]
	[BlueprintReadWrite]
	[USharpPath("/Script/b1-Managed.BAIT_FollowPlayer:IncludeTargetRadius")]
	public bool IncludeTargetRadius
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BAIT_FollowPlayer:IncludeTargetRadius");
				return false;
			}
	...
	[EditAnywhere]
	[BlueprintReadWrite]
	[USharpPath("/Script/b1-Managed.BAIT_FollowPlayer:MoveAIType")]
	public EBGUMoveAIType MoveAIType
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BAIT_FollowPlayer:MoveAIType");
	...
	[EditAnywhere]
	[BlueprintReadWrite]
	[USharpPath("/Script/b1-Managed.BAIT_FollowPlayer:SpeedRateType")]
	public EAIMoveSpeedType SpeedRateType
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BAIT_FollowPlayer:SpeedRateType");
	...
	{
		ACharacter aCharacter = BGU_UnrealWorldUtil.GetNearestPlayerActor(OwnerActor) as ACharacter;
		if (aCharacter == null)
		{
	...
	{
		IntPtr unrealStruct = NativeReflection.GetClass("/Script/b1-Managed.BAIT_FollowPlayer");
	...
	static BAIT_FollowPlayer()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BAIT_FollowPlayer)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BAIT_FollowPlayer));
	}
}
