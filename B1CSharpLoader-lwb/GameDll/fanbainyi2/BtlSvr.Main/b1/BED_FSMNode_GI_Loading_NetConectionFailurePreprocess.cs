...
[Placeable(true)]
[UClass]
[DisplayName("NetConectionFailurePreprocess")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_NetConectionFailurePreprocess")]
public class BED_FSMNode_GI_Loading_NetConectionFailurePreprocess : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_NetConectionFailurePreprocess:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_NetConectionFailurePreprocess:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_NetConectionFailurePreprocess:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_NetConectionFailurePreprocess:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_NetConectionFailurePreprocess:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_NetConectionFailurePreprocess bED_FSMNode_GI_Loading_NetConectionFailurePreprocess = GCHelper.Find<BED_FSMNode_GI_Loading_NetConectionFailurePreprocess>(obj);
		...
		bED_FSMNode_GI_Loading_NetConectionFailurePreprocess.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_NetConectionFailurePreprocess:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_NetConectionFailurePreprocess bED_FSMNode_GI_Loading_NetConectionFailurePreprocess = GCHelper.Find<BED_FSMNode_GI_Loading_NetConectionFailurePreprocess>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_NetConectionFailurePreprocess.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_NetConectionFailurePreprocess");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_NetConectionFailurePreprocess:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_NetConectionFailurePreprocess:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_NetConectionFailurePreprocess()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_NetConectionFailurePreprocess)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_NetConectionFailurePreprocess));
	}
}
