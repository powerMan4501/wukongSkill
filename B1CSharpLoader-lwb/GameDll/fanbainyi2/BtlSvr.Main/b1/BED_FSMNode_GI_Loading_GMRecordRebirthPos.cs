...
[Placeable(true)]
[UClass]
[DisplayName("GMRecordRebirthPos")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GMRecordRebirthPos")]
public class BED_FSMNode_GI_Loading_GMRecordRebirthPos : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GMRecordRebirthPos:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_GMRecordRebirthPos:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GMRecordRebirthPos:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GMRecordRebirthPos:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_GMRecordRebirthPos:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_GMRecordRebirthPos bED_FSMNode_GI_Loading_GMRecordRebirthPos = GCHelper.Find<BED_FSMNode_GI_Loading_GMRecordRebirthPos>(obj);
		...
		bED_FSMNode_GI_Loading_GMRecordRebirthPos.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_GMRecordRebirthPos:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_GMRecordRebirthPos bED_FSMNode_GI_Loading_GMRecordRebirthPos = GCHelper.Find<BED_FSMNode_GI_Loading_GMRecordRebirthPos>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_GMRecordRebirthPos.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_GMRecordRebirthPos");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_GMRecordRebirthPos:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_GMRecordRebirthPos:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_GMRecordRebirthPos()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_GMRecordRebirthPos)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_GMRecordRebirthPos));
	}
}
