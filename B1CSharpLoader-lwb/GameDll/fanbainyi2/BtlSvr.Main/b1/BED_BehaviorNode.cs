...
[Abstract]
[UClass]
[USharpPath("/Script/b1-Managed.BED_BehaviorNode")]
public class BED_BehaviorNode : BED_CalliopeNodeBae
{
	...
	public virtual EBehaviorNodeSide NodeSide => EBehaviorNodeSide.RightNode;

	[USharpPath("/Script/b1-Managed.BED_BehaviorNode:IsSupportViewType")]
	protected override bool IsSupportViewType_Implementation(ECalliopeViewType InViewType)
	{
		return InViewType == ECalliopeViewType.Behavior;
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_BehaviorNode:IsSupportViewType")]
	private static void IsSupportViewType__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_BehaviorNode bED_BehaviorNode = GCHelper.Find<BED_BehaviorNode>(obj);
		...
		bool value = bED_BehaviorNode.IsSupportViewType_Implementation(inViewType);
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BED_BehaviorNode");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_BehaviorNode:IsSupportViewType", IsSupportViewType_IsValid);
	}

	static BED_BehaviorNode()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_BehaviorNode)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_BehaviorNode));
	}
}
