...
[UClass]
[Placeable(true)]
[DisplayName("LoadChapterViewLevel")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadChapterViewLevel")]
public class BED_FSMNode_GI_Loading_LoadChapterViewLevel : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadChapterViewLevel:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadChapterViewLevel:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadChapterViewLevel:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadChapterViewLevel:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadChapterViewLevel:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_LoadChapterViewLevel bED_FSMNode_GI_Loading_LoadChapterViewLevel = GCHelper.Find<BED_FSMNode_GI_Loading_LoadChapterViewLevel>(obj);
		...
		bED_FSMNode_GI_Loading_LoadChapterViewLevel.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadChapterViewLevel:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_LoadChapterViewLevel bED_FSMNode_GI_Loading_LoadChapterViewLevel = GCHelper.Find<BED_FSMNode_GI_Loading_LoadChapterViewLevel>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_LoadChapterViewLevel.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadChapterViewLevel");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadChapterViewLevel:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadChapterViewLevel:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_LoadChapterViewLevel()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_LoadChapterViewLevel)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_LoadChapterViewLevel));
	}
}
