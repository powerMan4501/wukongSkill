...
[UClass]
[DisplayName("关闭条件检测")]
[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_DisableDetect")]
public class BED_ProcessStateNode_DisableDetect : BED_ProcessStateNode
{
	...
	[Category("State")]
	[VisibleAnywhere]
	[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_DisableDetect:DetectConditionList")]
	public TMapReadWrite<FName, bool> DetectConditionList
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessStateNode_DisableDetect:DetectConditionList");
				return null;
			}
	...
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_DisableDetect:CurrentCondition")]
	public FName CurrentCondition
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessStateNode_DisableDetect:CurrentCondition");
	...
	{
		return "Process.State.DisableDetect";
	}

	public override byte[] GetCustomData()
	{
		return new ProcessStateCustom_DisableDetect
		{
			DetectCondition = CurrentCondition.PlainName
		}.ToByteArray();
	}

	[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_DisableDetect:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_DisableDetect:GetContextOutputsInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_DisableDetect:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_ProcessStateNode_DisableDetect:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_ProcessStateNode_DisableDetect bED_ProcessStateNode_DisableDetect = GCHelper.Find<BED_ProcessStateNode_DisableDetect>(obj);
		...
		bED_ProcessStateNode_DisableDetect.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_ProcessStateNode_DisableDetect:GetContextOutputsInCS")]
	private static void GetContextOutputsInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		List<FName> contextOutputsInCS_Implementation = bED_ProcessStateNode_DisableDetect.GetContextOutputsInCS_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_ProcessStateNode_DisableDetect:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_ProcessStateNode_DisableDetect bED_ProcessStateNode_DisableDetect = GCHelper.Find<BED_ProcessStateNode_DisableDetect>(obj);
		string nodeDescriptionInCS_Implementation = bED_ProcessStateNode_DisableDetect.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_ProcessStateNode_DisableDetect");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ProcessStateNode_DisableDetect:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ProcessStateNode_DisableDetect:GetContextOutputsInCS", GetContextOutputsInCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ProcessStateNode_DisableDetect:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_ProcessStateNode_DisableDetect()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_ProcessStateNode_DisableDetect)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_ProcessStateNode_DisableDetect));
	}
}
