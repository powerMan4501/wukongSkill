...
[DisplayName("BAN Suicide")]
[UClass]
[USharpPath("/Script/b1-Managed.BAN_Suicide")]
internal class BAN_Suicide : BAN_GSBase
{
	...
	[USharpPath("/Script/b1-Managed.BAN_Suicide:bIsNativeBranchingPointCS")]
	protected override bool bIsNativeBranchingPointCS_Implementation()
	{
		return true;
	}

	[USharpPath("/Script/b1-Managed.BAN_Suicide:GSNotifyCS")]
	protected override void GSNotifyCS_Implementation(FUStGSNotifyParam NotifyParam)
	{
		if (!NotifyParam.owner.IsNullOrDestroyed())
		{
			BUS_EventCollectionCS.Get(NotifyParam.owner)?.Evt_UnitDead.Invoke(NotifyParam.owner, EDeadReason.Suicide);
		}
	}

	[UFunctionInvoker("/Script/b1-Managed.BAN_Suicide:GSNotifyCS")]
	private static void GSNotifyCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BAN_Suicide bAN_Suicide = GCHelper.Find<b1.BAN_Suicide>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyCS_NotifyParam_Offset));
		bAN_Suicide.GSNotifyCS_Implementation(notifyParam);
	}

	[UFunctionInvoker("/Script/b1-Managed.BAN_Suicide:bIsNativeBranchingPointCS")]
	private static void bIsNativeBranchingPointCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BAN_Suicide bAN_Suicide = GCHelper.Find<b1.BAN_Suicide>(obj);
		bool value = bAN_Suicide.bIsNativeBranchingPointCS_Implementation();
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BAN_Suicide");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BAN_Suicide:GSNotifyCS", GSNotifyCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BAN_Suicide:bIsNativeBranchingPointCS", bIsNativeBranchingPointCS_IsValid);
	}

	static BAN_Suicide()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BAN_Suicide)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BAN_Suicide));
	}
}
