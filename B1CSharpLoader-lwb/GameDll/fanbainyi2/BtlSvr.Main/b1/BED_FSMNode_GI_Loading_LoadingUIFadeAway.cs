...
[Placeable(true)]
[DisplayName("LoadingUIFadeAway")]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeAway")]
public class BED_FSMNode_GI_Loading_LoadingUIFadeAway : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeAway:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeAway:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeAway:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeAway:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeAway:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_LoadingUIFadeAway bED_FSMNode_GI_Loading_LoadingUIFadeAway = GCHelper.Find<BED_FSMNode_GI_Loading_LoadingUIFadeAway>(obj);
		...
		bED_FSMNode_GI_Loading_LoadingUIFadeAway.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeAway:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_LoadingUIFadeAway bED_FSMNode_GI_Loading_LoadingUIFadeAway = GCHelper.Find<BED_FSMNode_GI_Loading_LoadingUIFadeAway>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_LoadingUIFadeAway.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeAway");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeAway:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeAway:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_LoadingUIFadeAway()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_LoadingUIFadeAway)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_LoadingUIFadeAway));
	}
}
