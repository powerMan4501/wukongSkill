...
[DisplayName("BAN Switch Movement Mode")]
[UClass]
[USharpPath("/Script/b1-Managed.BAN_GSSwitchMovementMode")]
internal class BAN_GSSwitchMovementMode : BAN_GSBase
{
	...
	[USharpPath("/Script/b1-Managed.BAN_GSSwitchMovementMode:MovementMode")]
	public EMovementMode MovementMode
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BAN_GSSwitchMovementMode:MovementMode");
	...
	[USharpPath("/Script/b1-Managed.BAN_GSSwitchMovementMode:bIsNativeBranchingPointCS")]
	protected override bool bIsNativeBranchingPointCS_Implementation()
	{
		return true;
	}

	[USharpPath("/Script/b1-Managed.BAN_GSSwitchMovementMode:GSNotifyCS")]
	protected override void GSNotifyCS_Implementation(FUStGSNotifyParam NotifyParam)
	{
		_ = NotifyParam.owner == null;
	}

	[UFunctionInvoker("/Script/b1-Managed.BAN_GSSwitchMovementMode:GSNotifyCS")]
	private static void GSNotifyCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BAN_GSSwitchMovementMode bAN_GSSwitchMovementMode = GCHelper.Find<b1.BAN_GSSwitchMovementMode>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyCS_NotifyParam_Offset));
		bAN_GSSwitchMovementMode.GSNotifyCS_Implementation(notifyParam);
	}

	[UFunctionInvoker("/Script/b1-Managed.BAN_GSSwitchMovementMode:bIsNativeBranchingPointCS")]
	private static void bIsNativeBranchingPointCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BAN_GSSwitchMovementMode bAN_GSSwitchMovementMode = GCHelper.Find<b1.BAN_GSSwitchMovementMode>(obj);
		bool value = bAN_GSSwitchMovementMode.bIsNativeBranchingPointCS_Implementation();
	...
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BAN_GSSwitchMovementMode");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BAN_GSSwitchMovementMode:GSNotifyCS", GSNotifyCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BAN_GSSwitchMovementMode:bIsNativeBranchingPointCS", bIsNativeBranchingPointCS_IsValid);
	}

	static BAN_GSSwitchMovementMode()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BAN_GSSwitchMovementMode)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BAN_GSSwitchMovementMode));
	}
}
