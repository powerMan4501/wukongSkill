...
public class FSMState_GI_Global_SubG_GI_Loading_820DemoStartUp : FSMState_GI_Global_SubG_GI_Loading_Base
{
	public override void Init(FSMRuntimeInstance_GI_Global RuntimeInstance, FCalliopeNode Node, object InputParams)
	{
		...
		GI_Global_SubG_GI_Loading_820DemoStartUp gI_Global_SubG_GI_Loading_820DemoStartUp = new GI_Global_SubG_GI_Loading_820DemoStartUp();
		gI_Global_SubG_GI_Loading_820DemoStartUp.MergeFrom(Node.NodeData);
		SubGraphResPath = gI_Global_SubG_GI_Loading_820DemoStartUp.SubGraphAsset;
	}
	...
	{
		base.OwningInstance.TriggerSubGraphEvent(EGI_Global_SubG_GI_Loading_820DemoStartUp_Return.Finish);
	}
