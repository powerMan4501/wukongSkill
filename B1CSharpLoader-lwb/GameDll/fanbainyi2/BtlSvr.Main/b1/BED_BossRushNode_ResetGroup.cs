...
[USharpPath("/Script/b1-Managed.BED_BossRushNode_ResetGroup")]
public class BED_BossRushNode_ResetGroup : BED_BossRushNode_TemplateBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_BossRushNode_ResetGroup:GroupName")]
	public FName GroupName
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_BossRushNode_ResetGroup:GroupName");
	...
	[BlueprintReadWrite]
	[Category("Reset Group")]
	[USharpPath("/Script/b1-Managed.BED_BossRushNode_ResetGroup:TransitionConditions")]
	public TArrayReadWrite<FCompositeTransitionCondition_Group> TransitionConditions
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_BossRushNode_ResetGroup:TransitionConditions");
				return null;
			}
	...
	{
		return B1CalliopeDef.BossRushNode.Group;
	}

	[USharpPath("/Script/b1-Managed.BED_BossRushNode_ResetGroup:GetNodeDescriptionInCS")]
	protected override string GetNodeDescriptionInCS_Implementation()
	{
		return GroupName.ToString();
	}

	[USharpPath("/Script/b1-Managed.BED_BossRushNode_ResetGroup:GetContextOutputsInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_BossRushNode_ResetGroup:OnRefreshAssetInCS")]
	protected override void OnRefreshAssetInCS_Implementation()
	{
		...
		{
			bED_BossRushAsset.RegisterGroup(GroupName.PlainName, this);
		}
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_BossRushNode_ResetGroup:OnRefreshAssetInCS")]
	private static void OnRefreshAssetInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_BossRushNode_ResetGroup bED_BossRushNode_ResetGroup = GCHelper.Find<BED_BossRushNode_ResetGroup>(obj);
		bED_BossRushNode_ResetGroup.OnRefreshAssetInCS_Implementation();
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_BossRushNode_ResetGroup:GetContextOutputsInCS")]
	private static void GetContextOutputsInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		List<FName> contextOutputsInCS_Implementation = bED_BossRushNode_ResetGroup.GetContextOutputsInCS_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_BossRushNode_ResetGroup:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_BossRushNode_ResetGroup bED_BossRushNode_ResetGroup = GCHelper.Find<BED_BossRushNode_ResetGroup>(obj);
		string nodeDescriptionInCS_Implementation = bED_BossRushNode_ResetGroup.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_BossRushNode_ResetGroup");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_BossRushNode_ResetGroup:OnRefreshAssetInCS", OnRefreshAssetInCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_BossRushNode_ResetGroup:GetContextOutputsInCS", GetContextOutputsInCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_BossRushNode_ResetGroup:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_BossRushNode_ResetGroup()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_BossRushNode_ResetGroup)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_BossRushNode_ResetGroup));
	}
}
