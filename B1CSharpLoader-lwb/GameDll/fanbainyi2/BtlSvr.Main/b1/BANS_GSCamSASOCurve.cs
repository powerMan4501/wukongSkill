...
[UClass]
[DisplayName("BANS GSCamSASOCurve")]
[USharpPath("/Script/b1-Managed.BANS_GSCamSASOCurve")]
internal class BANS_GSCamSASOCurve : BANS_GSBase
{
	private static readonly FName BG_LOG_CATEGORY;

	private static bool SASOCurve_IsValid;

	private static int SASOCurve_Offset;
	...
	[USharpPath("/Script/b1-Managed.BANS_GSCamSASOCurve:SASOCurve")]
	public UCurveVector SASOCurve
	{
		get
		{
			CheckDestroyed();
			if (!SASOCurve_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BANS_GSCamSASOCurve:SASOCurve");
				return null;
			}
			return UObjectMarshaler<UCurveVector>.FromNative(IntPtr.Add(base.Address, SASOCurve_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				UObjectMarshaler<UCurveVector>.ToNative(IntPtr.Add(base.Address, SASOCurve_Offset), value);
			}
		}
	}
	...
	[BlueprintReadWrite]
	[Category("Anim Notify")]
	[USharpPath("/Script/b1-Managed.BANS_GSCamSASOCurve:BlendInTime")]
	public float BlendInTime
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BANS_GSCamSASOCurve:BlendInTime");
				return 0f;
			}
	...
	[BlueprintReadWrite]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BANS_GSCamSASOCurve:BlendOutTime")]
	public float BlendOutTime
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BANS_GSCamSASOCurve:BlendOutTime");
				return 0f;
			}
	...
	[USharpPath("/Script/b1-Managed.BANS_GSCamSASOCurve:GSNotifyBeginCS")]
	protected override void GSNotifyBeginCS_Implementation(FUStGSNotifyParam NotifyParam, float TotalDuration)
	{
		AActor owner = NotifyParam.owner;
		if (!(owner == null) && !UBGUFunctionLibraryForCS.BGUGetIsInEditorPreview(owner.World))
		{
			BUS_EventCollectionCS.Get(owner).Evt_EnableCameraSASOCurve.Invoke(SASOCurve, BlendInTime);
		}
	}

	[USharpPath("/Script/b1-Managed.BANS_GSCamSASOCurve:GSNotifyTickCS")]
	protected override void GSNotifyTickCS_Implementation(FUStGSNotifyParam NotifyParam, float FrameDeltaTime)
	{
	}

	[USharpPath("/Script/b1-Managed.BANS_GSCamSASOCurve:GSNotifyEndCS")]
	protected override void GSNotifyEndCS_Implementation(FUStGSNotifyParam NotifyParam)
	{
		AActor owner = NotifyParam.owner;
		if (!(owner == null) && !UBGUFunctionLibraryForCS.BGUGetIsInEditorPreview(owner.World))
		{
			BUS_EventCollectionCS.Get(owner).Evt_DisableCameraSASOCurve.Invoke(BlendOutTime);
		}
	}

	static BANS_GSCamSASOCurve()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BANS_GSCamSASOCurve)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BANS_GSCamSASOCurve));
		BG_LOG_CATEGORY = B1GlobalFNames.BANS_GSCamSASOCurve;
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_GSCamSASOCurve:GSNotifyEndCS")]
	private static void GSNotifyEndCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BANS_GSCamSASOCurve bANS_GSCamSASOCurve = GCHelper.Find<b1.BANS_GSCamSASOCurve>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyEndCS_NotifyParam_Offset));
		bANS_GSCamSASOCurve.GSNotifyEndCS_Implementation(notifyParam);
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_GSCamSASOCurve:GSNotifyTickCS")]
	private static void GSNotifyTickCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		bANS_GSCamSASOCurve.GSNotifyTickCS_Implementation(notifyParam, frameDeltaTime);
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_GSCamSASOCurve:GSNotifyBeginCS")]
	private static void GSNotifyBeginCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BANS_GSCamSASOCurve bANS_GSCamSASOCurve = GCHelper.Find<b1.BANS_GSCamSASOCurve>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyBeginCS_NotifyParam_Offset));
		float totalDuration = BlittableTypeMarshaler<float>.FromNative(IntPtr.Add(buffer, GSNotifyBeginCS_TotalDuration_Offset));
		bANS_GSCamSASOCurve.GSNotifyBeginCS_Implementation(notifyParam, totalDuration);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BANS_GSCamSASOCurve");
		SASOCurve_Offset = NativeReflection.GetPropertyOffset(intPtr, "SASOCurve");
		SASOCurve_IsValid = NativeReflection.ValidatePropertyClass(intPtr, "SASOCurve", Classes.FObjectProperty);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_GSCamSASOCurve:GSNotifyEndCS", GSNotifyEndCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_GSCamSASOCurve:GSNotifyTickCS", GSNotifyTickCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_GSCamSASOCurve:GSNotifyBeginCS", GSNotifyBeginCS_IsValid);
	}
}
