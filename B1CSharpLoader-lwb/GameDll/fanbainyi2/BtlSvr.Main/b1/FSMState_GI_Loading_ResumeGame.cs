...
public class FSMState_GI_Loading_ResumeGame : FSMState_GI_LoadingBase
{
	...
	{
		BGW_EventCollection.Get(Context.GameInst).Evt_SetGamePause(EPauseEvent.LoadingScreen, bPause: false);
