...
[UClass]
[Placeable(true)]
[DisplayName("InBattleOnLineLS")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineLS")]
public class BED_FSMNode_GI_Global_InBattleOnLineLS : BED_FSMNode_GI_GlobalBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineLS:AcceptEvents")]
	public TArrayReadWrite<EGI_Global> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineLS:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineLS:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineLS:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineLS:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Global_InBattleOnLineLS bED_FSMNode_GI_Global_InBattleOnLineLS = GCHelper.Find<BED_FSMNode_GI_Global_InBattleOnLineLS>(obj);
		...
		bED_FSMNode_GI_Global_InBattleOnLineLS.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineLS:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Global_InBattleOnLineLS bED_FSMNode_GI_Global_InBattleOnLineLS = GCHelper.Find<BED_FSMNode_GI_Global_InBattleOnLineLS>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Global_InBattleOnLineLS.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineLS");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineLS:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineLS:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Global_InBattleOnLineLS()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Global_InBattleOnLineLS)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Global_InBattleOnLineLS));
	}
}
