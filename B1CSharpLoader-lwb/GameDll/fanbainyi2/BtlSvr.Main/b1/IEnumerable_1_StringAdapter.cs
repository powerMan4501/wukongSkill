...
{
	public class Adapter : IEnumerable<string>, IEnumerable, CrossBindingAdaptorType
	{
		private CrossBindingFunctionInfo<IEnumerator<string>> mGetEnumerator_0 = new CrossBindingFunctionInfo<IEnumerator<string>>("GetEnumerator");
	...
	public override Type BaseCLRType => typeof(IEnumerable<string>);
