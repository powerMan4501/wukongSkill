...
public class FSMState_GI_Global_SubG_GI_Loading_BackToStandAlone : FSMState_GI_Global_SubG_GI_Loading_Base
{
	public override void Init(FSMRuntimeInstance_GI_Global RuntimeInstance, FCalliopeNode Node, object InputParams)
	{
		...
		GI_Global_SubG_GI_Loading_BackToStandAlone gI_Global_SubG_GI_Loading_BackToStandAlone = new GI_Global_SubG_GI_Loading_BackToStandAlone();
		gI_Global_SubG_GI_Loading_BackToStandAlone.MergeFrom(Node.NodeData);
		SubGraphResPath = gI_Global_SubG_GI_Loading_BackToStandAlone.SubGraphAsset;
	}
	...
	{
		base.OwningInstance.TriggerSubGraphEvent(EGI_Global_SubG_GI_Loading_BackToStandAlone_Return.Finish);
	}
