...
[UClass]
[DisplayName("CacheArchiveDataForClient")]
[Placeable(true)]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CacheArchiveDataForClient")]
public class BED_FSMNode_GI_Loading_CacheArchiveDataForClient : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CacheArchiveDataForClient:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_CacheArchiveDataForClient:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CacheArchiveDataForClient:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CacheArchiveDataForClient:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_CacheArchiveDataForClient:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_CacheArchiveDataForClient bED_FSMNode_GI_Loading_CacheArchiveDataForClient = GCHelper.Find<BED_FSMNode_GI_Loading_CacheArchiveDataForClient>(obj);
		...
		bED_FSMNode_GI_Loading_CacheArchiveDataForClient.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_CacheArchiveDataForClient:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_CacheArchiveDataForClient bED_FSMNode_GI_Loading_CacheArchiveDataForClient = GCHelper.Find<BED_FSMNode_GI_Loading_CacheArchiveDataForClient>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_CacheArchiveDataForClient.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_CacheArchiveDataForClient");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_CacheArchiveDataForClient:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_CacheArchiveDataForClient:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_CacheArchiveDataForClient()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_CacheArchiveDataForClient)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_CacheArchiveDataForClient));
	}
}
