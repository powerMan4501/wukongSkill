...
[DisplayName("BANS FBIK StandBar")]
[UClass]
[USharpPath("/Script/b1-Managed.BANS_FBIK_StandBar")]
internal class BANS_FBIK_StandBar : BANS_GSBase
{
	...
	[USharpPath("/Script/b1-Managed.BANS_FBIK_StandBar:GSNotifyBeginCS")]
	protected override void GSNotifyBeginCS_Implementation(FUStGSNotifyParam NotifyParam, float TotalDuration)
	{
		if (!UBGUFunctionLibraryForCS.BGUGetIsInEditorPreview(NotifyParam.owner))
		{
			BUC_ABPEventCollection.Get(NotifyParam.MeshComp.GetAnimInstance())?.Evt_SetValue_Alpha_FBIK_StandBar(1f);
		}
	}

	[USharpPath("/Script/b1-Managed.BANS_FBIK_StandBar:GSNotifyTickCS")]
	protected override void GSNotifyTickCS_Implementation(FUStGSNotifyParam NotifyParam, float FrameDeltaTime)
	{
	}

	[USharpPath("/Script/b1-Managed.BANS_FBIK_StandBar:GSNotifyEndCS")]
	protected override void GSNotifyEndCS_Implementation(FUStGSNotifyParam NotifyParam)
	{
		if (!UBGUFunctionLibraryForCS.BGUGetIsInEditorPreview(NotifyParam.owner))
		{
			BUC_ABPEventCollection.Get(NotifyParam.MeshComp.GetAnimInstance())?.Evt_SetValue_Alpha_FBIK_StandBar(0f);
		}
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_FBIK_StandBar:GSNotifyEndCS")]
	private static void GSNotifyEndCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BANS_FBIK_StandBar bANS_FBIK_StandBar = GCHelper.Find<b1.BANS_FBIK_StandBar>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyEndCS_NotifyParam_Offset));
		bANS_FBIK_StandBar.GSNotifyEndCS_Implementation(notifyParam);
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_FBIK_StandBar:GSNotifyTickCS")]
	private static void GSNotifyTickCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		bANS_FBIK_StandBar.GSNotifyTickCS_Implementation(notifyParam, frameDeltaTime);
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_FBIK_StandBar:GSNotifyBeginCS")]
	private static void GSNotifyBeginCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BANS_FBIK_StandBar bANS_FBIK_StandBar = GCHelper.Find<b1.BANS_FBIK_StandBar>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyBeginCS_NotifyParam_Offset));
		float totalDuration = BlittableTypeMarshaler<float>.FromNative(IntPtr.Add(buffer, GSNotifyBeginCS_TotalDuration_Offset));
		bANS_FBIK_StandBar.GSNotifyBeginCS_Implementation(notifyParam, totalDuration);
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BANS_FBIK_StandBar");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_FBIK_StandBar:GSNotifyEndCS", GSNotifyEndCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_FBIK_StandBar:GSNotifyTickCS", GSNotifyTickCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_FBIK_StandBar:GSNotifyBeginCS", GSNotifyBeginCS_IsValid);
	}

	static BANS_FBIK_StandBar()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BANS_FBIK_StandBar)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BANS_FBIK_StandBar));
	}
}
