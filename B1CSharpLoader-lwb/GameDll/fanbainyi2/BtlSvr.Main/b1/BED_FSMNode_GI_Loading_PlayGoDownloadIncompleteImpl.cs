...
[UClass]
[Placeable(true)]
[DisplayName("PlayGoDownloadIncompleteImpl")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl")]
public class BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl bED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl = GCHelper.Find<BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl>(obj);
		...
		bED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl bED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl = GCHelper.Find<BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl));
	}
}
