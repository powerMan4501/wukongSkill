...
[USharpPath("/Script/b1-Managed.BED_QuestNode_SubGraph")]
public class BED_QuestNode_SubGraph : BED_QuestNode
{
	...
	[EditDefaultsOnly]
	[BlueprintReadWrite]
	[USharpPath("/Script/b1-Managed.BED_QuestNode_SubGraph:Asset")]
	public TSoftObject<BED_QuestAsset> Asset
	{
		get
		{
			CheckDestroyed();
			if (!Asset_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_QuestNode_SubGraph:Asset");
				return default(TSoftObject<BED_QuestAsset>);
			}
			return TSoftObjectMarshaler<BED_QuestAsset>.FromNative(IntPtr.Add(base.Address, Asset_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				TSoftObjectMarshaler<BED_QuestAsset>.ToNative(IntPtr.Add(base.Address, Asset_Offset), value);
			}
		}
	}
	...
	[USharpPath("/Script/b1-Managed.BED_QuestNode_SubGraph:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_QuestNode_SubGraph:GetAssetToEditInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_QuestNode_SubGraph:GetContextInputsInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_QuestNode_SubGraph:GetContextOutputsInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_QuestNode_SubGraph:PrePropertyChanged")]
	...
	[USharpPath("/Script/b1-Managed.BED_QuestNode_SubGraph:PostPropertyChanged")]
	...
	static BED_QuestNode_SubGraph()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_QuestNode_SubGraph)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_QuestNode_SubGraph));
		StartPin = B1GlobalFNames.Start;
		FinishPin = B1GlobalFNames.Finish;
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_QuestNode_SubGraph:GetAssetToEditInCS")]
	private static void GetAssetToEditInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_QuestNode_SubGraph bED_QuestNode_SubGraph = GCHelper.Find<BED_QuestNode_SubGraph>(obj);
		UObject assetToEditInCS_Implementation = bED_QuestNode_SubGraph.GetAssetToEditInCS_Implementation();
		UObjectMarshaler<UObject>.ToNative(IntPtr.Add(buffer, GetAssetToEditInCS_ReturnValue_Offset), assetToEditInCS_Implementation);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_QuestNode_SubGraph:PrePropertyChanged")]
	private static void PrePropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		bED_QuestNode_SubGraph.PrePropertyChanged_Implementation(propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_QuestNode_SubGraph:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		bED_QuestNode_SubGraph.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_QuestNode_SubGraph:GetContextInputsInCS")]
	private static void GetContextInputsInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		List<FName> contextInputsInCS_Implementation = bED_QuestNode_SubGraph.GetContextInputsInCS_Implementation();
		tArrayCopyMarshaler.ToNative(IntPtr.Add(buffer, GetContextInputsInCS_ReturnValue_Offset), contextInputsInCS_Implementation);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_QuestNode_SubGraph:GetContextOutputsInCS")]
	private static void GetContextOutputsInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		List<FName> contextOutputsInCS_Implementation = bED_QuestNode_SubGraph.GetContextOutputsInCS_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_QuestNode_SubGraph:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_QuestNode_SubGraph bED_QuestNode_SubGraph = GCHelper.Find<BED_QuestNode_SubGraph>(obj);
		string nodeDescriptionInCS_Implementation = bED_QuestNode_SubGraph.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_QuestNode_SubGraph");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_QuestNode_SubGraph:GetAssetToEditInCS", GetAssetToEditInCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_QuestNode_SubGraph:PrePropertyChanged", PrePropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_QuestNode_SubGraph:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_QuestNode_SubGraph:GetContextInputsInCS", GetContextInputsInCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_QuestNode_SubGraph:GetContextOutputsInCS", GetContextOutputsInCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_QuestNode_SubGraph:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}
}
