...
[DisplayName("CheckGSSdkServerConfig")]
[Placeable(true)]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkServerConfig")]
public class BED_FSMNode_GI_Loading_CheckGSSdkServerConfig : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkServerConfig:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkServerConfig:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkServerConfig:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkServerConfig:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkServerConfig:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_CheckGSSdkServerConfig bED_FSMNode_GI_Loading_CheckGSSdkServerConfig = GCHelper.Find<BED_FSMNode_GI_Loading_CheckGSSdkServerConfig>(obj);
		...
		bED_FSMNode_GI_Loading_CheckGSSdkServerConfig.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkServerConfig:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_CheckGSSdkServerConfig bED_FSMNode_GI_Loading_CheckGSSdkServerConfig = GCHelper.Find<BED_FSMNode_GI_Loading_CheckGSSdkServerConfig>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_CheckGSSdkServerConfig.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkServerConfig");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkServerConfig:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkServerConfig:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_CheckGSSdkServerConfig()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_CheckGSSdkServerConfig)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_CheckGSSdkServerConfig));
	}
}
