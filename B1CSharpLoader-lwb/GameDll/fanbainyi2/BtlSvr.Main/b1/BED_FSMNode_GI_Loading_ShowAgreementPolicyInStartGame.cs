...
[Placeable(true)]
[DisplayName("ShowAgreementPolicyInStartGame")]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame")]
public class BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame bED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame = GCHelper.Find<BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame>(obj);
		...
		bED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame bED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame = GCHelper.Find<BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame));
	}
}
