...
[UClass]
[Placeable(true)]
[DisplayName("RequestTemplatePerformActionsFromArchive")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive")]
public class BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive bED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive = GCHelper.Find<BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive>(obj);
		...
		bED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive bED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive = GCHelper.Find<BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive));
	}
}
