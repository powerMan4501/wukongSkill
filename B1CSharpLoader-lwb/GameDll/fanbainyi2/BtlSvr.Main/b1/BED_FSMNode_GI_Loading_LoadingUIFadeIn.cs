...
[Placeable(true)]
[UClass]
[DisplayName("LoadingUIFadeIn")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeIn")]
public class BED_FSMNode_GI_Loading_LoadingUIFadeIn : BED_FSMNode_GI_LoadingBase
{
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeIn:WaitTick")]
	private int WaitTick
	{
		get
		{
			...
			if (!WaitTick_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeIn:WaitTick");
				return 0;
			}
	...
	[UProperty]
	[DisplayName("Reason")]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeIn:Reason")]
	private ELoadingUIFadeInReason Reason
	{
		get
		{
			...
			if (!Reason_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeIn:Reason");
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeIn:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeIn:AcceptEvents");
				return null;
			}
	...
	{
		return new GI_Loading_LoadingUIFadeIn
		{
			WaitTick = WaitTick,
			Reason = (int)Reason
		}.ToByteArray();
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeIn:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeIn:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeIn:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_LoadingUIFadeIn bED_FSMNode_GI_Loading_LoadingUIFadeIn = GCHelper.Find<BED_FSMNode_GI_Loading_LoadingUIFadeIn>(obj);
		...
		bED_FSMNode_GI_Loading_LoadingUIFadeIn.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeIn:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_LoadingUIFadeIn bED_FSMNode_GI_Loading_LoadingUIFadeIn = GCHelper.Find<BED_FSMNode_GI_Loading_LoadingUIFadeIn>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_LoadingUIFadeIn.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeIn");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeIn:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIFadeIn:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_LoadingUIFadeIn()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_LoadingUIFadeIn)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_LoadingUIFadeIn));
	}
}
