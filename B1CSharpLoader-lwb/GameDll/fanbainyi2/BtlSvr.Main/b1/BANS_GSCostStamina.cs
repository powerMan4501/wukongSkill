...
[UClass]
[DisplayName("BANS Cost Stamina")]
[USharpPath("/Script/b1-Managed.BANS_GSCostStamina")]
internal class BANS_GSCostStamina : BANS_GSBase
{
	...
	[USharpPath("/Script/b1-Managed.BANS_GSCostStamina:GSNotifyBeginCS")]
	protected override void GSNotifyBeginCS_Implementation(FUStGSNotifyParam NotifyParam, float TotalDuration)
	{
	}

	[USharpPath("/Script/b1-Managed.BANS_GSCostStamina:GSNotifyTickCS")]
	protected override void GSNotifyTickCS_Implementation(FUStGSNotifyParam NotifyParam, float FrameDeltaTime)
	{
	}

	[USharpPath("/Script/b1-Managed.BANS_GSCostStamina:GSNotifyEndCS")]
	protected override void GSNotifyEndCS_Implementation(FUStGSNotifyParam NotifyParam)
	{
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_GSCostStamina:GSNotifyEndCS")]
	private static void GSNotifyEndCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BANS_GSCostStamina bANS_GSCostStamina = GCHelper.Find<b1.BANS_GSCostStamina>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyEndCS_NotifyParam_Offset));
		bANS_GSCostStamina.GSNotifyEndCS_Implementation(notifyParam);
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_GSCostStamina:GSNotifyTickCS")]
	private static void GSNotifyTickCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		bANS_GSCostStamina.GSNotifyTickCS_Implementation(notifyParam, frameDeltaTime);
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_GSCostStamina:GSNotifyBeginCS")]
	private static void GSNotifyBeginCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BANS_GSCostStamina bANS_GSCostStamina = GCHelper.Find<b1.BANS_GSCostStamina>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyBeginCS_NotifyParam_Offset));
		float totalDuration = BlittableTypeMarshaler<float>.FromNative(IntPtr.Add(buffer, GSNotifyBeginCS_TotalDuration_Offset));
		bANS_GSCostStamina.GSNotifyBeginCS_Implementation(notifyParam, totalDuration);
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BANS_GSCostStamina");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_GSCostStamina:GSNotifyEndCS", GSNotifyEndCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_GSCostStamina:GSNotifyTickCS", GSNotifyTickCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_GSCostStamina:GSNotifyBeginCS", GSNotifyBeginCS_IsValid);
	}

	static BANS_GSCostStamina()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BANS_GSCostStamina)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BANS_GSCostStamina));
	}
}
