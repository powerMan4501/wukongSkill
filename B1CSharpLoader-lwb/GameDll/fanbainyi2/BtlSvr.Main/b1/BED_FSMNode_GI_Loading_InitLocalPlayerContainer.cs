...
[DisplayName("InitLocalPlayerContainer")]
[Placeable(true)]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitLocalPlayerContainer")]
public class BED_FSMNode_GI_Loading_InitLocalPlayerContainer : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitLocalPlayerContainer:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitLocalPlayerContainer:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitLocalPlayerContainer:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitLocalPlayerContainer:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitLocalPlayerContainer:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_InitLocalPlayerContainer bED_FSMNode_GI_Loading_InitLocalPlayerContainer = GCHelper.Find<BED_FSMNode_GI_Loading_InitLocalPlayerContainer>(obj);
		...
		bED_FSMNode_GI_Loading_InitLocalPlayerContainer.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitLocalPlayerContainer:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_InitLocalPlayerContainer bED_FSMNode_GI_Loading_InitLocalPlayerContainer = GCHelper.Find<BED_FSMNode_GI_Loading_InitLocalPlayerContainer>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_InitLocalPlayerContainer.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitLocalPlayerContainer");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitLocalPlayerContainer:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitLocalPlayerContainer:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_InitLocalPlayerContainer()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_InitLocalPlayerContainer)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_InitLocalPlayerContainer));
	}
}
