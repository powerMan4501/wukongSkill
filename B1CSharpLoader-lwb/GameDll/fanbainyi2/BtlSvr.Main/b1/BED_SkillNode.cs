...
[Abstract]
[UClass]
[USharpPath("/Script/b1-Managed.BED_SkillNode")]
internal class BED_SkillNode : BED_CalliopeNodeBae
{
	...
	[USharpPath("/Script/b1-Managed.BED_SkillNode:IsSupportViewType")]
	protected override bool IsSupportViewType_Implementation(ECalliopeViewType InViewType)
	{
		return InViewType == ECalliopeViewType.Skill;
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_SkillNode:IsSupportViewType")]
	private static void IsSupportViewType__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BED_SkillNode bED_SkillNode = GCHelper.Find<b1.BED_SkillNode>(obj);
		...
		bool value = bED_SkillNode.IsSupportViewType_Implementation(inViewType);
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BED_SkillNode");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_SkillNode:IsSupportViewType", IsSupportViewType_IsValid);
	}

	static BED_SkillNode()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BED_SkillNode)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BED_SkillNode));
	}
}
