...
[UClass]
[DisplayName("CheckArchiveDataIsValid")]
[Placeable(true)]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckArchiveDataIsValid")]
public class BED_FSMNode_GI_Loading_CheckArchiveDataIsValid : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckArchiveDataIsValid:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckArchiveDataIsValid:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckArchiveDataIsValid:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckArchiveDataIsValid:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckArchiveDataIsValid:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_CheckArchiveDataIsValid bED_FSMNode_GI_Loading_CheckArchiveDataIsValid = GCHelper.Find<BED_FSMNode_GI_Loading_CheckArchiveDataIsValid>(obj);
		...
		bED_FSMNode_GI_Loading_CheckArchiveDataIsValid.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckArchiveDataIsValid:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_CheckArchiveDataIsValid bED_FSMNode_GI_Loading_CheckArchiveDataIsValid = GCHelper.Find<BED_FSMNode_GI_Loading_CheckArchiveDataIsValid>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_CheckArchiveDataIsValid.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckArchiveDataIsValid");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckArchiveDataIsValid:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckArchiveDataIsValid:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_CheckArchiveDataIsValid()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_CheckArchiveDataIsValid)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_CheckArchiveDataIsValid));
	}
}
