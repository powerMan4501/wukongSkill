...
[USharpPath("/Script/b1-Managed.BED_BehaviorNode_ExitState")]
internal class BED_BehaviorNode_ExitState : BED_BehaviorNode
{
	...
	[BlueprintReadWrite]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_BehaviorNode_ExitState:StateTag")]
	public FGameplayTag StateTag
	{
		get
		{
			...
			if (!StateTag_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_BehaviorNode_ExitState:StateTag");
	...
	{
		return B1CalliopeDef.BehaviorNode.ExitState;
	}

	public override byte[] GetCustomData()
	{
		return new BehaviorCustom_ExitState
		{
			StateName = StateTag.TagName.ToString()
		}.ToByteArray();
	}

	[USharpPath("/Script/b1-Managed.BED_BehaviorNode_ExitState:GetNodeDescriptionInCS")]
	protected override string GetNodeDescriptionInCS_Implementation()
	{
		return "退出：" + StateTag.TagName.PlainName;
	}

	[USharpPath("/Script/b1-Managed.BED_BehaviorNode_ExitState:IsSupportViewType")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_BehaviorNode_ExitState:IsSupportViewType")]
	private static void IsSupportViewType__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BED_BehaviorNode_ExitState bED_BehaviorNode_ExitState = GCHelper.Find<b1.BED_BehaviorNode_ExitState>(obj);
		...
		bool value = bED_BehaviorNode_ExitState.IsSupportViewType_Implementation(inViewType);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_BehaviorNode_ExitState:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BED_BehaviorNode_ExitState bED_BehaviorNode_ExitState = GCHelper.Find<b1.BED_BehaviorNode_ExitState>(obj);
		string nodeDescriptionInCS_Implementation = bED_BehaviorNode_ExitState.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_BehaviorNode_ExitState");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_BehaviorNode_ExitState:IsSupportViewType", IsSupportViewType_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_BehaviorNode_ExitState:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_BehaviorNode_ExitState()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BED_BehaviorNode_ExitState)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BED_BehaviorNode_ExitState));
	}
}
