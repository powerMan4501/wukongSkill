...
[UClass]
[Placeable(true)]
[DisplayName("RequestTemplatePostEnterLevelFinish")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish")]
public class BED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish bED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish = GCHelper.Find<BED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish>(obj);
		...
		bED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish bED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish = GCHelper.Find<BED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_RequestTemplatePostEnterLevelFinish));
	}
}
