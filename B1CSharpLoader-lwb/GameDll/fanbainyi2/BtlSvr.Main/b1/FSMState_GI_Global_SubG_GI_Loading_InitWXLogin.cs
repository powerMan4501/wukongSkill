...
public class FSMState_GI_Global_SubG_GI_Loading_InitWXLogin : FSMState_GI_Global_SubG_GI_Loading_Base
{
	public override void Init(FSMRuntimeInstance_GI_Global RuntimeInstance, FCalliopeNode Node, object InputParams)
	{
		...
		GI_Global_SubG_GI_Loading_InitWXLogin gI_Global_SubG_GI_Loading_InitWXLogin = new GI_Global_SubG_GI_Loading_InitWXLogin();
		gI_Global_SubG_GI_Loading_InitWXLogin.MergeFrom(Node.NodeData);
		SubGraphResPath = gI_Global_SubG_GI_Loading_InitWXLogin.SubGraphAsset;
	}
	...
	{
		base.OwningInstance.TriggerSubGraphEvent(EGI_Global_SubG_GI_Loading_InitWXLogin_Return.Finish);
	}
