...
[Placeable(true)]
[UClass]
[DisplayName("RequestTemplatePostSaveArchiveFinish")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish")]
public class BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish bED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish = GCHelper.Find<BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish>(obj);
		...
		bED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish bED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish = GCHelper.Find<BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish));
	}
}
