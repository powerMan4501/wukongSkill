...
[UClass]
[Placeable(true)]
[DisplayName("RequestTemplateOpenLevel")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateOpenLevel")]
public class BED_FSMNode_GI_Loading_RequestTemplateOpenLevel : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateOpenLevel:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateOpenLevel:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateOpenLevel:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateOpenLevel:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateOpenLevel:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_RequestTemplateOpenLevel bED_FSMNode_GI_Loading_RequestTemplateOpenLevel = GCHelper.Find<BED_FSMNode_GI_Loading_RequestTemplateOpenLevel>(obj);
		...
		bED_FSMNode_GI_Loading_RequestTemplateOpenLevel.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateOpenLevel:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_RequestTemplateOpenLevel bED_FSMNode_GI_Loading_RequestTemplateOpenLevel = GCHelper.Find<BED_FSMNode_GI_Loading_RequestTemplateOpenLevel>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_RequestTemplateOpenLevel.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateOpenLevel");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateOpenLevel:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateOpenLevel:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_RequestTemplateOpenLevel()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_RequestTemplateOpenLevel)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_RequestTemplateOpenLevel));
	}
}
