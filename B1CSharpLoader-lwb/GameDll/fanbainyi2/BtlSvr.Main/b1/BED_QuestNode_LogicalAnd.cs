...
[NotBlueprintable]
[DisplayName("AND")]
[USharpPath("/Script/b1-Managed.BED_QuestNode_LogicalAnd")]
public class BED_QuestNode_LogicalAnd : BED_QuestNode
{
	...
	[USharpPath("/Script/b1-Managed.BED_QuestNode_LogicalAnd:CanUserAddInputInCS")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_QuestNode_LogicalAnd:CanUserAddInputInCS")]
	private static void CanUserAddInputInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_QuestNode_LogicalAnd bED_QuestNode_LogicalAnd = GCHelper.Find<BED_QuestNode_LogicalAnd>(obj);
		bool value = bED_QuestNode_LogicalAnd.CanUserAddInputInCS_Implementation();
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BED_QuestNode_LogicalAnd");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_QuestNode_LogicalAnd:CanUserAddInputInCS", CanUserAddInputInCS_IsValid);
	}

	static BED_QuestNode_LogicalAnd()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_QuestNode_LogicalAnd)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_QuestNode_LogicalAnd));
	}
}
