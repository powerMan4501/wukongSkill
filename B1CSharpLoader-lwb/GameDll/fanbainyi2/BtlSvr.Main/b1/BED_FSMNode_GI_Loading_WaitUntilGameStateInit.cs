...
[UClass]
[Placeable(true)]
[DisplayName("WaitUntilGameStateInit")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitUntilGameStateInit")]
public class BED_FSMNode_GI_Loading_WaitUntilGameStateInit : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitUntilGameStateInit:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitUntilGameStateInit:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitUntilGameStateInit:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitUntilGameStateInit:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitUntilGameStateInit:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitUntilGameStateInit bED_FSMNode_GI_Loading_WaitUntilGameStateInit = GCHelper.Find<BED_FSMNode_GI_Loading_WaitUntilGameStateInit>(obj);
		...
		bED_FSMNode_GI_Loading_WaitUntilGameStateInit.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitUntilGameStateInit:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitUntilGameStateInit bED_FSMNode_GI_Loading_WaitUntilGameStateInit = GCHelper.Find<BED_FSMNode_GI_Loading_WaitUntilGameStateInit>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_WaitUntilGameStateInit.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitUntilGameStateInit");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitUntilGameStateInit:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitUntilGameStateInit:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_WaitUntilGameStateInit()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_WaitUntilGameStateInit)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_WaitUntilGameStateInit));
	}
}
