...
[UClass]
[Abstract]
[USharpPath("/Script/b1-Managed.BED_MovieNode")]
public class BED_MovieNode : BED_CalliopeNodeBae
{
	...
	[USharpPath("/Script/b1-Managed.BED_MovieNode:IsSupportViewType")]
	protected override bool IsSupportViewType_Implementation(ECalliopeViewType InViewType)
	{
		return InViewType == ECalliopeViewType.Movie;
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_MovieNode:IsSupportViewType")]
	private static void IsSupportViewType__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_MovieNode bED_MovieNode = GCHelper.Find<BED_MovieNode>(obj);
		...
		bool value = bED_MovieNode.IsSupportViewType_Implementation(inViewType);
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BED_MovieNode");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_MovieNode:IsSupportViewType", IsSupportViewType_IsValid);
	}

	static BED_MovieNode()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_MovieNode)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_MovieNode));
	}
}
