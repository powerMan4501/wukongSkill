...
[UClass]
[Placeable(true)]
[DisplayName("WaitLocalPlayerFillLoginOption")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption")]
public class BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption bED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption = GCHelper.Find<BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption>(obj);
		...
		bED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption bED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption = GCHelper.Find<BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption));
	}
}
