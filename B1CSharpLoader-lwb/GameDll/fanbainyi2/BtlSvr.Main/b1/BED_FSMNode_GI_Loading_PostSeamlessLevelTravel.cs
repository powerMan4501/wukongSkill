...
[Placeable(true)]
[UClass]
[DisplayName("PostSeamlessLevelTravel")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PostSeamlessLevelTravel")]
public class BED_FSMNode_GI_Loading_PostSeamlessLevelTravel : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PostSeamlessLevelTravel:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_PostSeamlessLevelTravel:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PostSeamlessLevelTravel:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PostSeamlessLevelTravel:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_PostSeamlessLevelTravel:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_PostSeamlessLevelTravel bED_FSMNode_GI_Loading_PostSeamlessLevelTravel = GCHelper.Find<BED_FSMNode_GI_Loading_PostSeamlessLevelTravel>(obj);
		...
		bED_FSMNode_GI_Loading_PostSeamlessLevelTravel.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_PostSeamlessLevelTravel:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_PostSeamlessLevelTravel bED_FSMNode_GI_Loading_PostSeamlessLevelTravel = GCHelper.Find<BED_FSMNode_GI_Loading_PostSeamlessLevelTravel>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_PostSeamlessLevelTravel.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_PostSeamlessLevelTravel");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_PostSeamlessLevelTravel:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_PostSeamlessLevelTravel:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_PostSeamlessLevelTravel()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_PostSeamlessLevelTravel)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_PostSeamlessLevelTravel));
	}
}
