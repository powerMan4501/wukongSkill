...
[UClass]
[DisplayName("SpawnPlayerPawnWithOutECSBeginPlay")]
[Placeable(true)]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay")]
public class BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay bED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay = GCHelper.Find<BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay>(obj);
		...
		bED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay bED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay = GCHelper.Find<BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay));
	}
}
