...
[Abstract]
[Blueprintable]
[USharpPath("/Script/b1-Managed.BED_QuestNode")]
public class BED_QuestNode : BED_CalliopeNodeBae
{
	...
	[USharpPath("/Script/b1-Managed.BED_QuestNode:IsSupportViewType")]
	protected override bool IsSupportViewType_Implementation(ECalliopeViewType InViewType)
	{
		return InViewType == ECalliopeViewType.Quest;
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_QuestNode:IsSupportViewType")]
	private static void IsSupportViewType__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_QuestNode bED_QuestNode = GCHelper.Find<BED_QuestNode>(obj);
		...
		bool value = bED_QuestNode.IsSupportViewType_Implementation(inViewType);
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BED_QuestNode");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_QuestNode:IsSupportViewType", IsSupportViewType_IsValid);
	}

	static BED_QuestNode()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_QuestNode)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_QuestNode));
	}
}
