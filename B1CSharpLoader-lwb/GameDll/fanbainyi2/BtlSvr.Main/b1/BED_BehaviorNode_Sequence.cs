...
[UClass]
[USharpPath("/Script/b1-Managed.BED_BehaviorNode_Sequence")]
internal class BED_BehaviorNode_Sequence : BED_BehaviorNode
{
	...
	{
		return B1CalliopeDef.BehaviorNode.Sequence;
	}

	[USharpPath("/Script/b1-Managed.BED_BehaviorNode_Sequence:CanUserAddOutputInCS")]
	protected override bool CanUserAddOutputInCS_Implementation()
	{
		return true;
	}

	[USharpPath("/Script/b1-Managed.BED_BehaviorNode_Sequence:IsSupportViewType")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_BehaviorNode_Sequence:IsSupportViewType")]
	private static void IsSupportViewType__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BED_BehaviorNode_Sequence bED_BehaviorNode_Sequence = GCHelper.Find<b1.BED_BehaviorNode_Sequence>(obj);
		...
		bool value = bED_BehaviorNode_Sequence.IsSupportViewType_Implementation(inViewType);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_BehaviorNode_Sequence:CanUserAddOutputInCS")]
	private static void CanUserAddOutputInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BED_BehaviorNode_Sequence bED_BehaviorNode_Sequence = GCHelper.Find<b1.BED_BehaviorNode_Sequence>(obj);
		bool value = bED_BehaviorNode_Sequence.CanUserAddOutputInCS_Implementation();
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BED_BehaviorNode_Sequence");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_BehaviorNode_Sequence:IsSupportViewType", IsSupportViewType_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_BehaviorNode_Sequence:CanUserAddOutputInCS", CanUserAddOutputInCS_IsValid);
	}

	static BED_BehaviorNode_Sequence()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BED_BehaviorNode_Sequence)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BED_BehaviorNode_Sequence));
	}
}
