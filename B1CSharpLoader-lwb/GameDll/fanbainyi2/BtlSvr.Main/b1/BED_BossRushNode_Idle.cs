...
[DisplayName("空闲（Idle）")]
[UClass]
[USharpPath("/Script/b1-Managed.BED_BossRushNode_Idle")]
public class BED_BossRushNode_Idle : BED_BossRushNode_TemplateBase
{
	...
	[USharpPath("/Script/b1-Managed.BED_BossRushNode_Idle:TransitionConditions")]
	public TArrayReadWrite<FCompositeTransitionCondition_Idle> TransitionConditions
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_BossRushNode_Idle:TransitionConditions");
				return null;
			}
	...
	[Tooltip("进入时直接执行")]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_BossRushNode_Idle:ProcessActions")]
	public TArrayReadWrite<FIdleProcessAction> ProcessActions
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_BossRushNode_Idle:ProcessActions");
				return null;
			}
	...
	[Category("Pin")]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_BossRushNode_Idle:bUseResetPin")]
	public bool bUseResetPin
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_BossRushNode_Idle:bUseResetPin");
				return false;
			}
	...
	{
		return B1CalliopeDef.BossRushNode.Idle;
	}

	[USharpPath("/Script/b1-Managed.BED_BossRushNode_Idle:GetContextOutputsInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_BossRushNode_Idle:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_BossRushNode_Idle:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_BossRushNode_Idle bED_BossRushNode_Idle = GCHelper.Find<BED_BossRushNode_Idle>(obj);
		...
		bED_BossRushNode_Idle.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_BossRushNode_Idle:GetContextOutputsInCS")]
	private static void GetContextOutputsInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		List<FName> contextOutputsInCS_Implementation = bED_BossRushNode_Idle.GetContextOutputsInCS_Implementation();
	...
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_BossRushNode_Idle");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_BossRushNode_Idle:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_BossRushNode_Idle:GetContextOutputsInCS", GetContextOutputsInCS_IsValid);
	}

	static BED_BossRushNode_Idle()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_BossRushNode_Idle)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_BossRushNode_Idle));
	}
}
