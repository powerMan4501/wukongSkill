...
[UClass]
[Placeable(true)]
[DisplayName("StartNewGamePlus")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_StartNewGamePlus")]
public class BED_FSMNode_GI_Loading_StartNewGamePlus : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_StartNewGamePlus:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_StartNewGamePlus:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_StartNewGamePlus:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_StartNewGamePlus:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_StartNewGamePlus:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_StartNewGamePlus bED_FSMNode_GI_Loading_StartNewGamePlus = GCHelper.Find<BED_FSMNode_GI_Loading_StartNewGamePlus>(obj);
		...
		bED_FSMNode_GI_Loading_StartNewGamePlus.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_StartNewGamePlus:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_StartNewGamePlus bED_FSMNode_GI_Loading_StartNewGamePlus = GCHelper.Find<BED_FSMNode_GI_Loading_StartNewGamePlus>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_StartNewGamePlus.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_StartNewGamePlus");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_StartNewGamePlus:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_StartNewGamePlus:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_StartNewGamePlus()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_StartNewGamePlus)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_StartNewGamePlus));
	}
}
