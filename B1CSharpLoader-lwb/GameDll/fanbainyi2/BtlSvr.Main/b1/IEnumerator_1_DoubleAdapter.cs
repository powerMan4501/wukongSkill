...
public class IEnumerator_1_DoubleAdapter : CrossBindingAdaptor
{
	public class Adapter : IEnumerator<double>, IDisposable, IEnumerator, CrossBindingAdaptorType
	{
		private CrossBindingFunctionInfo<double> mget_Current_0 = new CrossBindingFunctionInfo<double>("get_Current");
		...
		public double Current => mget_Current_0.Invoke(instance);
	...
	public override Type BaseCLRType => typeof(IEnumerator<double>);
