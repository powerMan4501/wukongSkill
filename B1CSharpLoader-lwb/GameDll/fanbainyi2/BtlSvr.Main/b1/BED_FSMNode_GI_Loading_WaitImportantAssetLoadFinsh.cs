...
[UClass]
[Placeable(true)]
[DisplayName("WaitImportantAssetLoadFinsh")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh")]
public class BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh bED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh = GCHelper.Find<BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh>(obj);
		...
		bED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh bED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh = GCHelper.Find<BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh));
	}
}
