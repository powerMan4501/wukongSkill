...
[UClass]
[DisplayName("TriggerBackToStandAlone")]
[Placeable(true)]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerBackToStandAlone")]
public class BED_FSMNode_GI_Loading_TriggerBackToStandAlone : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerBackToStandAlone:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerBackToStandAlone:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerBackToStandAlone:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerBackToStandAlone:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerBackToStandAlone:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_TriggerBackToStandAlone bED_FSMNode_GI_Loading_TriggerBackToStandAlone = GCHelper.Find<BED_FSMNode_GI_Loading_TriggerBackToStandAlone>(obj);
		...
		bED_FSMNode_GI_Loading_TriggerBackToStandAlone.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerBackToStandAlone:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_TriggerBackToStandAlone bED_FSMNode_GI_Loading_TriggerBackToStandAlone = GCHelper.Find<BED_FSMNode_GI_Loading_TriggerBackToStandAlone>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_TriggerBackToStandAlone.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerBackToStandAlone");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerBackToStandAlone:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerBackToStandAlone:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_TriggerBackToStandAlone()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_TriggerBackToStandAlone)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_TriggerBackToStandAlone));
	}
}
