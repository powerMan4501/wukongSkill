...
[Placeable(true)]
[UClass]
[DisplayName("InitNewArchiveData")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitNewArchiveData")]
public class BED_FSMNode_GI_Loading_InitNewArchiveData : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitNewArchiveData:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitNewArchiveData:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitNewArchiveData:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitNewArchiveData:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitNewArchiveData:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_InitNewArchiveData bED_FSMNode_GI_Loading_InitNewArchiveData = GCHelper.Find<BED_FSMNode_GI_Loading_InitNewArchiveData>(obj);
		...
		bED_FSMNode_GI_Loading_InitNewArchiveData.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitNewArchiveData:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_InitNewArchiveData bED_FSMNode_GI_Loading_InitNewArchiveData = GCHelper.Find<BED_FSMNode_GI_Loading_InitNewArchiveData>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_InitNewArchiveData.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitNewArchiveData");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitNewArchiveData:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitNewArchiveData:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_InitNewArchiveData()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_InitNewArchiveData)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_InitNewArchiveData));
	}
}
