...
[UClass]
[Placeable(true)]
[DisplayName("ShowArchiveMarkInStartGame")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame")]
public class BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame bED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame = GCHelper.Find<BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame>(obj);
		...
		bED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame bED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame = GCHelper.Find<BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame));
	}
}
