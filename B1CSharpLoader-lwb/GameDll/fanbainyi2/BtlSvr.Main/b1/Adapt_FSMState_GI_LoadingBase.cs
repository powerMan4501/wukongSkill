...
public class Adapt_FSMState_GI_LoadingBase : CrossBindingAdaptor
{
	public class Adaptor : FSMState_GI_LoadingBase, CrossBindingAdaptorType
	{
		...
		private CrossBindingMethodInfo<FSMRuntimeInstance_GI_Loading, FCalliopeNode, object> sVMInit = new CrossBindingMethodInfo<FSMRuntimeInstance_GI_Loading, FCalliopeNode, object>("Init");
	...
	public override Type BaseCLRType => typeof(FSMState_GI_LoadingBase);
