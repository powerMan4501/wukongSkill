...
[UClass]
[Placeable(true)]
[DisplayName("UnlockScopeReplayScrubComplete")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete")]
public class BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete bED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete = GCHelper.Find<BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete>(obj);
		...
		bED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete bED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete = GCHelper.Find<BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete));
	}
}
