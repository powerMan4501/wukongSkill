...
[UClass]
[Abstract]
[USharpPath("/Script/b1-Managed.BED_ComboNode")]
public class BED_ComboNode : BED_CalliopeNodeBae
{
	...
	[USharpPath("/Script/b1-Managed.BED_ComboNode:IsSupportViewType")]
	protected override bool IsSupportViewType_Implementation(ECalliopeViewType InViewType)
	{
		return InViewType == ECalliopeViewType.Combo;
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_ComboNode:IsSupportViewType")]
	private static void IsSupportViewType__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_ComboNode bED_ComboNode = GCHelper.Find<BED_ComboNode>(obj);
		...
		bool value = bED_ComboNode.IsSupportViewType_Implementation(inViewType);
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BED_ComboNode");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ComboNode:IsSupportViewType", IsSupportViewType_IsValid);
	}

	static BED_ComboNode()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_ComboNode)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_ComboNode));
	}
}
