...
[Placeable(true)]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitTick")]
public class BED_FSMNode_GI_Loading_WaitTick : BED_FSMNode_GI_LoadingBase
{
	private static bool WaitTotalTick_IsValid;

	private static int WaitTotalTick_Offset;
	...
	[EditAnywhere]
	[DisplayName("WaitTotalTick")]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitTick:WaitTotalTick")]
	private int WaitTotalTick
	{
		get
		{
			CheckDestroyed();
			if (!WaitTotalTick_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitTick:WaitTotalTick");
				return 0;
			}
			return BlittableTypeMarshaler<int>.FromNative(IntPtr.Add(base.Address, WaitTotalTick_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				BlittableTypeMarshaler<int>.ToNative(IntPtr.Add(base.Address, WaitTotalTick_Offset), value);
			}
		}
	}
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitTick:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitTick:AcceptEvents");
				return null;
			}
	...
	{
		return new GI_Loading_WaitTick
		{
			WaitTotalTick = WaitTotalTick
		}.ToByteArray();
	}

	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitTick:GetNodeDescriptionInCS")]
	protected override string GetNodeDescriptionInCS_Implementation()
	{
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.Append($"WaitTotalTick:{WaitTotalTick}");
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitTick:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitTick:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitTick bED_FSMNode_GI_Loading_WaitTick = GCHelper.Find<BED_FSMNode_GI_Loading_WaitTick>(obj);
		...
		bED_FSMNode_GI_Loading_WaitTick.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitTick:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitTick bED_FSMNode_GI_Loading_WaitTick = GCHelper.Find<BED_FSMNode_GI_Loading_WaitTick>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_WaitTick.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitTick");
		WaitTotalTick_Offset = NativeReflection.GetPropertyOffset(intPtr, "WaitTotalTick");
		WaitTotalTick_IsValid = NativeReflection.ValidatePropertyClass(intPtr, "WaitTotalTick", Classes.FIntProperty);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitTick:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitTick:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_WaitTick()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_WaitTick)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_WaitTick));
	}
}
