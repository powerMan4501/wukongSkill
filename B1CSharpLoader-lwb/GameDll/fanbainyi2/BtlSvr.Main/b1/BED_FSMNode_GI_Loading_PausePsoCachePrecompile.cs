...
[UClass]
[Placeable(true)]
[DisplayName("PausePsoCachePrecompile")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PausePsoCachePrecompile")]
public class BED_FSMNode_GI_Loading_PausePsoCachePrecompile : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PausePsoCachePrecompile:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_PausePsoCachePrecompile:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PausePsoCachePrecompile:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PausePsoCachePrecompile:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_PausePsoCachePrecompile:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_PausePsoCachePrecompile bED_FSMNode_GI_Loading_PausePsoCachePrecompile = GCHelper.Find<BED_FSMNode_GI_Loading_PausePsoCachePrecompile>(obj);
		...
		bED_FSMNode_GI_Loading_PausePsoCachePrecompile.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_PausePsoCachePrecompile:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_PausePsoCachePrecompile bED_FSMNode_GI_Loading_PausePsoCachePrecompile = GCHelper.Find<BED_FSMNode_GI_Loading_PausePsoCachePrecompile>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_PausePsoCachePrecompile.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_PausePsoCachePrecompile");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_PausePsoCachePrecompile:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_PausePsoCachePrecompile:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_PausePsoCachePrecompile()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_PausePsoCachePrecompile)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_PausePsoCachePrecompile));
	}
}
