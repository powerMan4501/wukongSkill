...
[DisplayName("动画通知")]
[UClass]
[USharpPath("/Script/b1-Managed.BED_BehaviorNode_AMNotify")]
public class BED_BehaviorNode_AMNotify : BED_BehaviorNode_ListenerTrigger
{
	...
	[DisplayName("监听单位")]
	[BlueprintReadWrite]
	[USharpPath("/Script/b1-Managed.BED_BehaviorNode_AMNotify:UnitType")]
	public EDetectedUnitType UnitType
	{
		get
		{
			...
			if (!UnitType_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_BehaviorNode_AMNotify:UnitType");
	...
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_BehaviorNode_AMNotify:SmartUnit")]
	public FGsSmartParam SmartUnit
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_BehaviorNode_AMNotify:SmartUnit");
	...
	[BlueprintReadWrite]
	[DisplayName("通知信息")]
	[USharpPath("/Script/b1-Managed.BED_BehaviorNode_AMNotify:NotifyTag")]
	public string NotifyTag
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_BehaviorNode_AMNotify:NotifyTag");
				return null;
			}
	...
	{
		return B1CalliopeDef.BehaviorNode.AMNotify;
	}

	public override byte[] GetCustomData()
	{
		return new BehaviorCustom_AMNotify
		{
	...
	[USharpPath("/Script/b1-Managed.BED_BehaviorNode_AMNotify:GetNodeDescriptionInCS")]
	protected override string GetNodeDescriptionInCS_Implementation()
	{
		...
		stringBuilder.AppendLine("通知信息: " + NotifyTag);
		return stringBuilder.ToString();
	}

	[USharpPath("/Script/b1-Managed.BED_BehaviorNode_AMNotify:IsSupportViewType")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_BehaviorNode_AMNotify:IsSupportViewType")]
	private static void IsSupportViewType__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_BehaviorNode_AMNotify bED_BehaviorNode_AMNotify = GCHelper.Find<BED_BehaviorNode_AMNotify>(obj);
		...
		bool value = bED_BehaviorNode_AMNotify.IsSupportViewType_Implementation(inViewType);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_BehaviorNode_AMNotify:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_BehaviorNode_AMNotify bED_BehaviorNode_AMNotify = GCHelper.Find<BED_BehaviorNode_AMNotify>(obj);
		string nodeDescriptionInCS_Implementation = bED_BehaviorNode_AMNotify.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_BehaviorNode_AMNotify");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_BehaviorNode_AMNotify:IsSupportViewType", IsSupportViewType_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_BehaviorNode_AMNotify:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_BehaviorNode_AMNotify()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_BehaviorNode_AMNotify)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_BehaviorNode_AMNotify));
	}
}
