...
public class BUFFAttrBaseModifyAttr : BUFixFunctionTemplate
{
	public BUFFAttrBaseModifyAttr()
	{
		Type = EFixFunctionType.AttrBaseModifyAttr;
	}
	...
	private void Apply(AActor Caster, AActor Target, int Param1, int Param2, int Param3, int Param4, int Param5, float Param6, out float OutAbs, out float OutMul)
	{
		...
		OutAbs = (valueFromAttrID / valueFromAttrID2 - (float)Param4 / 10000f) * 100f * Param6;
