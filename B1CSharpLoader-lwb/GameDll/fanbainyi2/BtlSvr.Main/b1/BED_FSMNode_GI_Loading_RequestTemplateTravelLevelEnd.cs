...
[Placeable(true)]
[UClass]
[DisplayName("RequestTemplateTravelLevelEnd")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd")]
public class BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd bED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd = GCHelper.Find<BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd>(obj);
		...
		bED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd bED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd = GCHelper.Find<BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd));
	}
}
