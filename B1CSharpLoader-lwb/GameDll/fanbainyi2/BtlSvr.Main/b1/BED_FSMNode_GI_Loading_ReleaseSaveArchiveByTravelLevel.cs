...
[UClass]
[Placeable(true)]
[DisplayName("ReleaseSaveArchiveByTravelLevel")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel")]
public class BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel bED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel = GCHelper.Find<BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel>(obj);
		...
		bED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel bED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel = GCHelper.Find<BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel));
	}
}
