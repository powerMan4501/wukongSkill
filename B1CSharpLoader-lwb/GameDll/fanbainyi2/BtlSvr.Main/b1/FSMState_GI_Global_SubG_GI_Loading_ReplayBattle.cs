...
public class FSMState_GI_Global_SubG_GI_Loading_ReplayBattle : FSMState_GI_Global_SubG_GI_Loading_Base
{
	public override void Init(FSMRuntimeInstance_GI_Global RuntimeInstance, FCalliopeNode Node, object InputParams)
	{
		...
		GI_Global_SubG_GI_Loading_ReplayBattle gI_Global_SubG_GI_Loading_ReplayBattle = new GI_Global_SubG_GI_Loading_ReplayBattle();
		gI_Global_SubG_GI_Loading_ReplayBattle.MergeFrom(Node.NodeData);
		SubGraphResPath = gI_Global_SubG_GI_Loading_ReplayBattle.SubGraphAsset;
	}
	...
	{
		base.OwningInstance.TriggerSubGraphEvent(EGI_Global_SubG_GI_Loading_ReplayBattle_Return.Finish);
	}
