...
[UClass]
[Placeable(true)]
[DisplayName("CreateNewRoleData")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CreateNewRoleData")]
public class BED_FSMNode_GI_Loading_CreateNewRoleData : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CreateNewRoleData:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_CreateNewRoleData:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CreateNewRoleData:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CreateNewRoleData:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_CreateNewRoleData:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_CreateNewRoleData bED_FSMNode_GI_Loading_CreateNewRoleData = GCHelper.Find<BED_FSMNode_GI_Loading_CreateNewRoleData>(obj);
		...
		bED_FSMNode_GI_Loading_CreateNewRoleData.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_CreateNewRoleData:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_CreateNewRoleData bED_FSMNode_GI_Loading_CreateNewRoleData = GCHelper.Find<BED_FSMNode_GI_Loading_CreateNewRoleData>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_CreateNewRoleData.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_CreateNewRoleData");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_CreateNewRoleData:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_CreateNewRoleData:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_CreateNewRoleData()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_CreateNewRoleData)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_CreateNewRoleData));
	}
}
