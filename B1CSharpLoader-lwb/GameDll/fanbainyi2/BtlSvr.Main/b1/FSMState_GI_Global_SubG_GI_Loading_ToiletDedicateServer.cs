...
public class FSMState_GI_Global_SubG_GI_Loading_ToiletDedicateServer : FSMState_GI_Global_SubG_GI_Loading_Base
{
	public override void Init(FSMRuntimeInstance_GI_Global RuntimeInstance, FCalliopeNode Node, object InputParams)
	{
		...
		GI_Global_SubG_GI_Loading_ToiletDedicateServer gI_Global_SubG_GI_Loading_ToiletDedicateServer = new GI_Global_SubG_GI_Loading_ToiletDedicateServer();
		gI_Global_SubG_GI_Loading_ToiletDedicateServer.MergeFrom(Node.NodeData);
		SubGraphResPath = gI_Global_SubG_GI_Loading_ToiletDedicateServer.SubGraphAsset;
	}
	...
	{
		base.OwningInstance.TriggerSubGraphEvent(EGI_Global_SubG_GI_Loading_ToiletDedicateServer_Return.Finish);
	}
