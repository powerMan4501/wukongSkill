...
[UClass]
[Placeable(true)]
[DisplayName("GSGBtlOnBattleStart")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleStart")]
public class BED_FSMNode_GI_Loading_GSGBtlOnBattleStart : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleStart:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleStart:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleStart:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleStart:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleStart:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_GSGBtlOnBattleStart bED_FSMNode_GI_Loading_GSGBtlOnBattleStart = GCHelper.Find<BED_FSMNode_GI_Loading_GSGBtlOnBattleStart>(obj);
		...
		bED_FSMNode_GI_Loading_GSGBtlOnBattleStart.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleStart:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_GSGBtlOnBattleStart bED_FSMNode_GI_Loading_GSGBtlOnBattleStart = GCHelper.Find<BED_FSMNode_GI_Loading_GSGBtlOnBattleStart>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_GSGBtlOnBattleStart.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleStart");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleStart:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGBtlOnBattleStart:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_GSGBtlOnBattleStart()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_GSGBtlOnBattleStart)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_GSGBtlOnBattleStart));
	}
}
