...
[DisplayName("OpenLevelByIdInContext")]
[Placeable(true)]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelByIdInContext")]
public class BED_FSMNode_GI_Loading_OpenLevelByIdInContext : BED_FSMNode_GI_LoadingBase
{
	private static bool ContextOptions_IsValid;

	private static int ContextOptions_Offset;
	...
	[DisplayName("ContextOptions")]
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelByIdInContext:ContextOptions")]
	private string ContextOptions
	{
		get
		{
			CheckDestroyed();
			if (!ContextOptions_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelByIdInContext:ContextOptions");
				return null;
			}
			return FStringMarshaler.FromNative(IntPtr.Add(base.Address, ContextOptions_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				FStringMarshaler.ToNative(IntPtr.Add(base.Address, ContextOptions_Offset), value);
			}
		}
	}
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelByIdInContext:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelByIdInContext:AcceptEvents");
				return null;
			}
	...
	{
		return new GI_Loading_OpenLevelByIdInContext
		{
			ContextOptions = ContextOptions
		}.ToByteArray();
	}

	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelByIdInContext:GetNodeDescriptionInCS")]
	protected override string GetNodeDescriptionInCS_Implementation()
	{
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.Append("ContextOptions:" + ContextOptions);
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelByIdInContext:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelByIdInContext:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_OpenLevelByIdInContext bED_FSMNode_GI_Loading_OpenLevelByIdInContext = GCHelper.Find<BED_FSMNode_GI_Loading_OpenLevelByIdInContext>(obj);
		...
		bED_FSMNode_GI_Loading_OpenLevelByIdInContext.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelByIdInContext:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_OpenLevelByIdInContext bED_FSMNode_GI_Loading_OpenLevelByIdInContext = GCHelper.Find<BED_FSMNode_GI_Loading_OpenLevelByIdInContext>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_OpenLevelByIdInContext.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelByIdInContext");
		ContextOptions_Offset = NativeReflection.GetPropertyOffset(intPtr, "ContextOptions");
		ContextOptions_IsValid = NativeReflection.ValidatePropertyClass(intPtr, "ContextOptions", Classes.FStrProperty);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelByIdInContext:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelByIdInContext:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_OpenLevelByIdInContext()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_OpenLevelByIdInContext)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_OpenLevelByIdInContext));
	}
}
