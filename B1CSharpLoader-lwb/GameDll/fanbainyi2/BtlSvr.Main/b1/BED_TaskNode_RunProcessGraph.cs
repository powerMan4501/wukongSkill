...
[Placeable(false)]
[USharpPath("/Script/b1-Managed.BED_TaskNode_RunProcessGraph")]
public class BED_TaskNode_RunProcessGraph : BED_TaskNode
{
	...
	[BlueprintReadWrite]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_TaskNode_RunProcessGraph:Asset")]
	public TSoftObject<BED_ProcessAsset> Asset
	{
		get
		{
			...
			if (!Asset_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_TaskNode_RunProcessGraph:Asset");
	...
	[USharpPath("/Script/b1-Managed.BED_TaskNode_RunProcessGraph:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_TaskNode_RunProcessGraph:GetAssetToEditInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_TaskNode_RunProcessGraph:PrePropertyChanged")]
	...
	[USharpPath("/Script/b1-Managed.BED_TaskNode_RunProcessGraph:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_TaskNode_RunProcessGraph:GetAssetToEditInCS")]
	private static void GetAssetToEditInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_TaskNode_RunProcessGraph bED_TaskNode_RunProcessGraph = GCHelper.Find<BED_TaskNode_RunProcessGraph>(obj);
		UObject assetToEditInCS_Implementation = bED_TaskNode_RunProcessGraph.GetAssetToEditInCS_Implementation();
		UObjectMarshaler<UObject>.ToNative(IntPtr.Add(buffer, GetAssetToEditInCS_ReturnValue_Offset), assetToEditInCS_Implementation);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_TaskNode_RunProcessGraph:PrePropertyChanged")]
	private static void PrePropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		bED_TaskNode_RunProcessGraph.PrePropertyChanged_Implementation(propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_TaskNode_RunProcessGraph:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		bED_TaskNode_RunProcessGraph.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_TaskNode_RunProcessGraph:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_TaskNode_RunProcessGraph bED_TaskNode_RunProcessGraph = GCHelper.Find<BED_TaskNode_RunProcessGraph>(obj);
		string nodeDescriptionInCS_Implementation = bED_TaskNode_RunProcessGraph.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_TaskNode_RunProcessGraph");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_TaskNode_RunProcessGraph:GetAssetToEditInCS", GetAssetToEditInCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_TaskNode_RunProcessGraph:PrePropertyChanged", PrePropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_TaskNode_RunProcessGraph:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_TaskNode_RunProcessGraph:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_TaskNode_RunProcessGraph()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_TaskNode_RunProcessGraph)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_TaskNode_RunProcessGraph));
	}
}
