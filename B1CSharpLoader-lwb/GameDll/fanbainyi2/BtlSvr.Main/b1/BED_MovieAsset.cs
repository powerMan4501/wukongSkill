...
[UClass]
[USharpPath("/Script/b1-Managed.BED_MovieAsset")]
public class BED_MovieAsset : BED_CalliopeAssetBase
{
	...
	[USharpPath("/Script/b1-Managed.BED_MovieAsset:GetViewType")]
	protected override ECalliopeViewType GetViewType_Implementation()
	{
		return ECalliopeViewType.Movie;
	}

	[USharpPath("/Script/b1-Managed.BED_MovieAsset:GetRerouteNodeClass")]
	protected override TSubclassOf<UObject> GetRerouteNodeClass_Implementation()
	{
		return TSubclassOf<UObject>.Null;
	}

	[USharpPath("/Script/b1-Managed.BED_MovieAsset:GetStartNodeClass")]
	protected override TSubclassOf<UObject> GetStartNodeClass_Implementation()
	{
		return UClass.GetClass<b1.BED_MovieNode_Start>();
	}

	[USharpPath("/Script/b1-Managed.BED_MovieAsset:GetExtraDefaultInputNodes")]
	protected override int GetExtraDefaultInputNodes_Implementation(out List<TSubclassOf<UObject>> OutClasses)
	{
		...
		{
			UClass.GetClass<b1.BED_MovieNode_BeforePlay>(),
			UClass.GetClass<b1.BED_MovieNode_AfterPlay>(),
			UClass.GetClass<b1.BED_MovieNode_OnSkipping>()
		};
		return OutClasses.Count;
	}

	[USharpPath("/Script/b1-Managed.BED_MovieAsset:GetExtraDefaultOutputNodes")]
	protected override int GetExtraDefaultOutputNodes_Implementation(out List<TSubclassOf<UObject>> OutClasses)
	{
		OutClasses = new List<TSubclassOf<UObject>>
		{
			UClass.GetClass<b1.BED_MovieNode_PlayEnd>(),
			UClass.GetClass<b1.BED_MovieNode_Finish>()
		};
		return OutClasses.Count;
	}

	[USharpPath("/Script/b1-Managed.BED_MovieAsset:GetRerouteNodeClassInBranchGraph")]
	protected override TSubclassOf<UObject> GetRerouteNodeClassInBranchGraph_Implementation()
	{
		return TSubclassOf<UObject>.Null;
	}

	[USharpPath("/Script/b1-Managed.BED_MovieAsset:GetStartNodeClassInBranchGraph")]
	protected override TSubclassOf<UObject> GetStartNodeClassInBranchGraph_Implementation()
	{
		return TSubclassOf<UObject>.Null;
	}

	[USharpPath("/Script/b1-Managed.BED_MovieAsset:GetExtraDefaultInputNodesInBranchGraph")]
	...
	[USharpPath("/Script/b1-Managed.BED_MovieAsset:GetExtraDefaultOutputNodesInBranchGraph")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_MovieAsset:GetViewType")]
	private static void GetViewType__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_MovieAsset bED_MovieAsset = GCHelper.Find<BED_MovieAsset>(obj);
		ECalliopeViewType viewType_Implementation = bED_MovieAsset.GetViewType_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_MovieAsset:GetStartNodeClass")]
	private static void GetStartNodeClass__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_MovieAsset bED_MovieAsset = GCHelper.Find<BED_MovieAsset>(obj);
		TSubclassOf<UObject> startNodeClass_Implementation = bED_MovieAsset.GetStartNodeClass_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_MovieAsset:GetRerouteNodeClass")]
	private static void GetRerouteNodeClass__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_MovieAsset bED_MovieAsset = GCHelper.Find<BED_MovieAsset>(obj);
		TSubclassOf<UObject> rerouteNodeClass_Implementation = bED_MovieAsset.GetRerouteNodeClass_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_MovieAsset:GetExtraDefaultInputNodes")]
	private static void GetExtraDefaultInputNodes__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultInputNodes_Implementation = bED_MovieAsset.GetExtraDefaultInputNodes_Implementation(out OutClasses);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_MovieAsset:GetExtraDefaultOutputNodes")]
	private static void GetExtraDefaultOutputNodes__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultOutputNodes_Implementation = bED_MovieAsset.GetExtraDefaultOutputNodes_Implementation(out OutClasses);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_MovieAsset:GetStartNodeClassInBranchGraph")]
	private static void GetStartNodeClassInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_MovieAsset bED_MovieAsset = GCHelper.Find<BED_MovieAsset>(obj);
		TSubclassOf<UObject> startNodeClassInBranchGraph_Implementation = bED_MovieAsset.GetStartNodeClassInBranchGraph_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_MovieAsset:GetRerouteNodeClassInBranchGraph")]
	private static void GetRerouteNodeClassInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_MovieAsset bED_MovieAsset = GCHelper.Find<BED_MovieAsset>(obj);
		TSubclassOf<UObject> rerouteNodeClassInBranchGraph_Implementation = bED_MovieAsset.GetRerouteNodeClassInBranchGraph_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_MovieAsset:GetExtraDefaultInputNodesInBranchGraph")]
	private static void GetExtraDefaultInputNodesInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultInputNodesInBranchGraph_Implementation = bED_MovieAsset.GetExtraDefaultInputNodesInBranchGraph_Implementation(out OutClasses);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_MovieAsset:GetExtraDefaultOutputNodesInBranchGraph")]
	private static void GetExtraDefaultOutputNodesInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultOutputNodesInBranchGraph_Implementation = bED_MovieAsset.GetExtraDefaultOutputNodesInBranchGraph_Implementation(out OutClasses);
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BED_MovieAsset");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_MovieAsset:GetViewType", GetViewType_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_MovieAsset:GetStartNodeClass", GetStartNodeClass_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_MovieAsset:GetRerouteNodeClass", GetRerouteNodeClass_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_MovieAsset:GetExtraDefaultInputNodes", GetExtraDefaultInputNodes_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_MovieAsset:GetExtraDefaultOutputNodes", GetExtraDefaultOutputNodes_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_MovieAsset:GetStartNodeClassInBranchGraph", GetStartNodeClassInBranchGraph_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_MovieAsset:GetRerouteNodeClassInBranchGraph", GetRerouteNodeClassInBranchGraph_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_MovieAsset:GetExtraDefaultInputNodesInBranchGraph", GetExtraDefaultInputNodesInBranchGraph_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_MovieAsset:GetExtraDefaultOutputNodesInBranchGraph", GetExtraDefaultOutputNodesInBranchGraph_IsValid);
	}

	static BED_MovieAsset()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_MovieAsset)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_MovieAsset));
	}
}
