...
[DisplayName("WaitPsoCachePrecompileFinish")]
[Placeable(true)]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish")]
public class BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish bED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish = GCHelper.Find<BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish>(obj);
		...
		bED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish bED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish = GCHelper.Find<BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish));
	}
}
