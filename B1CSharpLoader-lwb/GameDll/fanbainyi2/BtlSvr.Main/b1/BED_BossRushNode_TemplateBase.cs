...
[Abstract]
[UClass]
[USharpPath("/Script/b1-Managed.BED_BossRushNode_TemplateBase")]
public class BED_BossRushNode_TemplateBase : BED_BossRushNode
{
	...
	{
		return B1CalliopeDef.BossRushNode.Template;
	}
	...
	[USharpPath("/Script/b1-Managed.BED_BossRushNode_TemplateBase:GetContextOutputsInCS")]
	protected override List<FName> GetContextOutputsInCS_Implementation()
	{
		return new List<FName>();
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_BossRushNode_TemplateBase:GetContextOutputsInCS")]
	private static void GetContextOutputsInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_BossRushNode_TemplateBase bED_BossRushNode_TemplateBase = GCHelper.Find<BED_BossRushNode_TemplateBase>(obj);
		...
		List<FName> contextOutputsInCS_Implementation = bED_BossRushNode_TemplateBase.GetContextOutputsInCS_Implementation();
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BED_BossRushNode_TemplateBase");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_BossRushNode_TemplateBase:GetContextOutputsInCS", GetContextOutputsInCS_IsValid);
	}

	static BED_BossRushNode_TemplateBase()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_BossRushNode_TemplateBase)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_BossRushNode_TemplateBase));
	}
}
