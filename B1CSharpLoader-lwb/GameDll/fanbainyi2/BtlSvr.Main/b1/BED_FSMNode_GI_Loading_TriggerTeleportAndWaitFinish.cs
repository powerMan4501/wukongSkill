...
[Placeable(true)]
[UClass]
[DisplayName("TriggerTeleportAndWaitFinish")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish")]
public class BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish bED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish = GCHelper.Find<BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish>(obj);
		...
		bED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish bED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish = GCHelper.Find<BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish));
	}
}
