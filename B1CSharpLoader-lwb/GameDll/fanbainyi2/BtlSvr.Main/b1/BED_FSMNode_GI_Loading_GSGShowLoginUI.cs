...
[Placeable(true)]
[UClass]
[DisplayName("GSGShowLoginUI")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGShowLoginUI")]
public class BED_FSMNode_GI_Loading_GSGShowLoginUI : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGShowLoginUI:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGShowLoginUI:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGShowLoginUI:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGShowLoginUI:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGShowLoginUI:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_GSGShowLoginUI bED_FSMNode_GI_Loading_GSGShowLoginUI = GCHelper.Find<BED_FSMNode_GI_Loading_GSGShowLoginUI>(obj);
		...
		bED_FSMNode_GI_Loading_GSGShowLoginUI.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGShowLoginUI:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_GSGShowLoginUI bED_FSMNode_GI_Loading_GSGShowLoginUI = GCHelper.Find<BED_FSMNode_GI_Loading_GSGShowLoginUI>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_GSGShowLoginUI.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGShowLoginUI");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGShowLoginUI:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGShowLoginUI:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_GSGShowLoginUI()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_GSGShowLoginUI)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_GSGShowLoginUI));
	}
}
