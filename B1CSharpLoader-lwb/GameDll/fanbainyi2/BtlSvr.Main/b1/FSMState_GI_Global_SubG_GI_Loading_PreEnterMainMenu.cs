...
public class FSMState_GI_Global_SubG_GI_Loading_PreEnterMainMenu : FSMState_GI_Global_SubG_GI_Loading_Base
{
	public override void Init(FSMRuntimeInstance_GI_Global RuntimeInstance, FCalliopeNode Node, object InputParams)
	{
		...
		GI_Global_SubG_GI_Loading_PreEnterMainMenu gI_Global_SubG_GI_Loading_PreEnterMainMenu = new GI_Global_SubG_GI_Loading_PreEnterMainMenu();
		gI_Global_SubG_GI_Loading_PreEnterMainMenu.MergeFrom(Node.NodeData);
		SubGraphResPath = gI_Global_SubG_GI_Loading_PreEnterMainMenu.SubGraphAsset;
	}
	...
	{
		base.OwningInstance.TriggerSubGraphEvent(EGI_Global_SubG_GI_Loading_PreEnterMainMenu_Return.Finish);
	}
