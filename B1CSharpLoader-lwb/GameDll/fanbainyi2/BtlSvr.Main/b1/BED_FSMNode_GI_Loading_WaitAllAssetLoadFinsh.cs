...
[Placeable(true)]
[UClass]
[DisplayName("WaitAllAssetLoadFinsh")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh")]
public class BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh bED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh = GCHelper.Find<BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh>(obj);
		...
		bED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh bED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh = GCHelper.Find<BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh));
	}
}
