...
public class FSMState_GI_Loading_RequestTemplatePostEnterLevelFinish : FSMState_GI_LoadingBase
{
	...
	{
		Context.TravelLevelTemplate.OnPostEnterLevelFinish(delegate
		{
