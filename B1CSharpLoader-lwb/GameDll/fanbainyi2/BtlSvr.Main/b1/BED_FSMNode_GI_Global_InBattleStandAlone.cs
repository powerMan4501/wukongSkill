...
[UClass]
[Placeable(true)]
[DisplayName("InBattleStandAlone")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleStandAlone")]
public class BED_FSMNode_GI_Global_InBattleStandAlone : BED_FSMNode_GI_GlobalBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleStandAlone:AcceptEvents")]
	public TArrayReadWrite<EGI_Global> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleStandAlone:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleStandAlone:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleStandAlone:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleStandAlone:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Global_InBattleStandAlone bED_FSMNode_GI_Global_InBattleStandAlone = GCHelper.Find<BED_FSMNode_GI_Global_InBattleStandAlone>(obj);
		...
		bED_FSMNode_GI_Global_InBattleStandAlone.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleStandAlone:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Global_InBattleStandAlone bED_FSMNode_GI_Global_InBattleStandAlone = GCHelper.Find<BED_FSMNode_GI_Global_InBattleStandAlone>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Global_InBattleStandAlone.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleStandAlone");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleStandAlone:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleStandAlone:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Global_InBattleStandAlone()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Global_InBattleStandAlone)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Global_InBattleStandAlone));
	}
}
