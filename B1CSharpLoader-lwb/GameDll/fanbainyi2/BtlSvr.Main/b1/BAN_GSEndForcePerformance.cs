...
[UClass]
[DisplayName("BAN EndForcePerformance")]
[USharpPath("/Script/b1-Managed.BAN_GSEndForcePerformance")]
internal class BAN_GSEndForcePerformance : BAN_GSBase
{
	...
	[USharpPath("/Script/b1-Managed.BAN_GSEndForcePerformance:bIsNativeBranchingPointCS")]
	protected override bool bIsNativeBranchingPointCS_Implementation()
	{
		return true;
	}

	[USharpPath("/Script/b1-Managed.BAN_GSEndForcePerformance:GSNotifyCS")]
	protected override void GSNotifyCS_Implementation(FUStGSNotifyParam NotifyParam)
	{
		...
		if (!(owner == null) && !(BGU_UnrealWorldUtil.GetActorStreamingLevelWorld(owner) == null))
		{
			...
			{
				bUS_GSEventCollection.Evt_AdvanceRemoveForcePerformanceState.Invoke();
			}
		}
	}

	[UFunctionInvoker("/Script/b1-Managed.BAN_GSEndForcePerformance:GSNotifyCS")]
	private static void GSNotifyCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BAN_GSEndForcePerformance bAN_GSEndForcePerformance = GCHelper.Find<b1.BAN_GSEndForcePerformance>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyCS_NotifyParam_Offset));
		bAN_GSEndForcePerformance.GSNotifyCS_Implementation(notifyParam);
	}

	[UFunctionInvoker("/Script/b1-Managed.BAN_GSEndForcePerformance:bIsNativeBranchingPointCS")]
	private static void bIsNativeBranchingPointCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BAN_GSEndForcePerformance bAN_GSEndForcePerformance = GCHelper.Find<b1.BAN_GSEndForcePerformance>(obj);
		bool value = bAN_GSEndForcePerformance.bIsNativeBranchingPointCS_Implementation();
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BAN_GSEndForcePerformance");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BAN_GSEndForcePerformance:GSNotifyCS", GSNotifyCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BAN_GSEndForcePerformance:bIsNativeBranchingPointCS", bIsNativeBranchingPointCS_IsValid);
	}

	static BAN_GSEndForcePerformance()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BAN_GSEndForcePerformance)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BAN_GSEndForcePerformance));
	}
}
