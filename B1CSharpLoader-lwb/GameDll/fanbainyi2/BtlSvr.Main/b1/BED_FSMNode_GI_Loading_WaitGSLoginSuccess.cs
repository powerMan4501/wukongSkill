...
[UClass]
[Placeable(true)]
[DisplayName("WaitGSLoginSuccess")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitGSLoginSuccess")]
public class BED_FSMNode_GI_Loading_WaitGSLoginSuccess : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitGSLoginSuccess:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitGSLoginSuccess:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitGSLoginSuccess:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitGSLoginSuccess:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitGSLoginSuccess:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitGSLoginSuccess bED_FSMNode_GI_Loading_WaitGSLoginSuccess = GCHelper.Find<BED_FSMNode_GI_Loading_WaitGSLoginSuccess>(obj);
		...
		bED_FSMNode_GI_Loading_WaitGSLoginSuccess.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitGSLoginSuccess:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitGSLoginSuccess bED_FSMNode_GI_Loading_WaitGSLoginSuccess = GCHelper.Find<BED_FSMNode_GI_Loading_WaitGSLoginSuccess>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_WaitGSLoginSuccess.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitGSLoginSuccess");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitGSLoginSuccess:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitGSLoginSuccess:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_WaitGSLoginSuccess()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_WaitGSLoginSuccess)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_WaitGSLoginSuccess));
	}
}
