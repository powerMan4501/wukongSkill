...
[UClass]
[USharpPath("/Script/b1-Managed.BGUBulletBaseManaged")]
public class BGUBulletBaseManaged : BGUBulletBaseCS
{
	...
	[USharpPath("/Script/b1-Managed.BGUBulletBaseManaged:Datas")]
	private TArrayReadWrite<UObject> Datas
	{
		get
		{
			...
			if (!Datas_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BGUBulletBaseManaged:Datas");
				return null;
			}
	...
	{
		IntPtr unrealStruct = NativeReflection.GetClass("/Script/b1-Managed.BGUBulletBaseManaged");
	...
	static BGUBulletBaseManaged()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BGUBulletBaseManaged)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BGUBulletBaseManaged));
	}
}
