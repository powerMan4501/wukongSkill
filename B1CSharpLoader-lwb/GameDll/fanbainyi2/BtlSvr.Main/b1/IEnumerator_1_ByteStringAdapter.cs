...
public class IEnumerator_1_ByteStringAdapter : CrossBindingAdaptor
{
	public class Adapter : IEnumerator<ByteString>, IDisposable, IEnumerator, CrossBindingAdaptorType
	{
		private CrossBindingFunctionInfo<ByteString> mget_Current_0 = new CrossBindingFunctionInfo<ByteString>("get_Current");
		...
		public ByteString Current => mget_Current_0.Invoke(instance);
	...
	public override Type BaseCLRType => typeof(IEnumerator<ByteString>);
