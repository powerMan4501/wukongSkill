...
[BlueprintType]
[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Story")]
public class BED_ProcessMachineNode_Story : BED_ProcessMachineNode_TemplateBase
{
	...
	[DisplayName("对位类型")]
	[Category("BlendIn")]
	[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Story:MatchPositionType")]
	public ESequenceBlendInMatchPositionType MatchPositionType
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessMachineNode_Story:MatchPositionType");
	...
	[BlueprintReadWrite]
	[Category("BlendIn")]
	[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Story:Overlap")]
	public FGsSmartParam Overlap
	{
		get
		{
			...
			if (!Overlap_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessMachineNode_Story:Overlap");
	...
	[UProperty]
	[Category("Play")]
	[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Story:bWaitPlayFinish")]
	public bool bWaitPlayFinish
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessMachineNode_Story:bWaitPlayFinish");
				return false;
			}
	...
	[BlueprintReadWrite]
	[Category("Play")]
	[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Story:Sequence")]
	public FGsSmartParam Sequence
	{
		get
		{
			...
			if (!Sequence_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessMachineNode_Story:Sequence");
				return default(FGsSmartParam);
			}
	...
	[UProperty]
	[BlueprintReadWrite]
	[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Story:SequenceID")]
	public int SequenceID
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessMachineNode_Story:SequenceID");
				return 0;
			}
	...
	[Category("Play")]
	[DisplayName("结束后获得物品")]
	[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Story:bGainItemWhenFinish")]
	public bool bGainItemWhenFinish
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessMachineNode_Story:bGainItemWhenFinish");
				return false;
			}
	...
	[DisplayName("获得的物品")]
	[VisibleAnywhere]
	[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Story:GainItems")]
	public TArrayReadWrite<FGainItemConfig> GainItems
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessMachineNode_Story:GainItems");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Story:bChapterEndStory")]
	public bool bChapterEndStory
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessMachineNode_Story:bChapterEndStory");
				return false;
			}
	...
	[UProperty]
	[DisplayName("结束的章节ID")]
	[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Story:ChapterID")]
	public int ChapterID
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessMachineNode_Story:ChapterID");
				return 0;
			}
	...
	[Category("Play")]
	[DisplayName("是否姿态回归")]
	[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Story:bTriggerTransBack")]
	public bool bTriggerTransBack
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessMachineNode_Story:bTriggerTransBack");
				return false;
			}
	...
	[Category("Play")]
	[BlueprintReadWrite]
	[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Story:bTriggerMonsterGoHome")]
	public bool bTriggerMonsterGoHome
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessMachineNode_Story:bTriggerMonsterGoHome");
				return false;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Story:bDisablePlayerControl")]
	public bool bDisablePlayerControl
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessMachineNode_Story:bDisablePlayerControl");
				return false;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Story:bDisableMovementInput")]
	public bool bDisableMovementInput
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessMachineNode_Story:bDisableMovementInput");
				return false;
			}
	...
	[BlueprintReadWrite]
	[Category("Camera")]
	[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Story:bDisableLookAtInput")]
	public bool bDisableLookAtInput
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessMachineNode_Story:bDisableLookAtInput");
				return false;
			}
	...
	[Category("Camera")]
	[UMeta(MDProp.EditCondition, "bDisablePlayerControl")]
	[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Story:bHidePlayer")]
	public bool bHidePlayer
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessMachineNode_Story:bHidePlayer");
				return false;
			}
	...
	[BlueprintReadWrite]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Story:bHideHud")]
	public bool bHideHud
	{
		get
		{
			...
			if (!bHideHud_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessMachineNode_Story:bHideHud");
				return false;
			}
	...
	{
		return B1CalliopeDef.ProcessMachineNode.Story;
	}

	[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Story:GetNodeDescriptionInCS")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_ProcessMachineNode_Story:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_ProcessMachineNode_Story bED_ProcessMachineNode_Story = GCHelper.Find<BED_ProcessMachineNode_Story>(obj);
		string nodeDescriptionInCS_Implementation = bED_ProcessMachineNode_Story.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_ProcessMachineNode_Story");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ProcessMachineNode_Story:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_ProcessMachineNode_Story()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_ProcessMachineNode_Story)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_ProcessMachineNode_Story));
	}
}
