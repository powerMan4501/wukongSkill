...
[UClass]
[DisplayName("BAN GSFinishMedicineTalkAnim")]
[USharpPath("/Script/b1-Managed.BAN_GSFinishMedicineTalkAnim")]
internal class BAN_GSFinishMedicineTalkAnim : BAN_GSBase
{
	...
	[USharpPath("/Script/b1-Managed.BAN_GSFinishMedicineTalkAnim:bIsNativeBranchingPointCS")]
	protected override bool bIsNativeBranchingPointCS_Implementation()
	{
		return true;
	}

	[USharpPath("/Script/b1-Managed.BAN_GSFinishMedicineTalkAnim:GSNotifyCS")]
	protected override void GSNotifyCS_Implementation(FUStGSNotifyParam NotifyParam)
	{
		...
		{
			APawn aPawn = UGSE_EngineFuncLib.GetFirstLocalPlayerController(actorStreamingLevelWorld)?.GetControlledPawn();
			if (!aPawn.IsNullOrDestroyed())
			{
				BUS_EventCollectionCS.Get(aPawn)?.Evt_FinishMedicineTalkAnim?.Invoke();
			}
		}
	}

	[UFunctionInvoker("/Script/b1-Managed.BAN_GSFinishMedicineTalkAnim:GSNotifyCS")]
	private static void GSNotifyCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BAN_GSFinishMedicineTalkAnim bAN_GSFinishMedicineTalkAnim = GCHelper.Find<b1.BAN_GSFinishMedicineTalkAnim>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyCS_NotifyParam_Offset));
		bAN_GSFinishMedicineTalkAnim.GSNotifyCS_Implementation(notifyParam);
	}

	[UFunctionInvoker("/Script/b1-Managed.BAN_GSFinishMedicineTalkAnim:bIsNativeBranchingPointCS")]
	private static void bIsNativeBranchingPointCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BAN_GSFinishMedicineTalkAnim bAN_GSFinishMedicineTalkAnim = GCHelper.Find<b1.BAN_GSFinishMedicineTalkAnim>(obj);
		bool value = bAN_GSFinishMedicineTalkAnim.bIsNativeBranchingPointCS_Implementation();
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BAN_GSFinishMedicineTalkAnim");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BAN_GSFinishMedicineTalkAnim:GSNotifyCS", GSNotifyCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BAN_GSFinishMedicineTalkAnim:bIsNativeBranchingPointCS", bIsNativeBranchingPointCS_IsValid);
	}

	static BAN_GSFinishMedicineTalkAnim()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BAN_GSFinishMedicineTalkAnim)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BAN_GSFinishMedicineTalkAnim));
	}
}
