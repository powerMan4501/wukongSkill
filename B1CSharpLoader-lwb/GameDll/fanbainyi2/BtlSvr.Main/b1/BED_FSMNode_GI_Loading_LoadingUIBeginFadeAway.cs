...
[Placeable(true)]
[UClass]
[DisplayName("LoadingUIBeginFadeAway")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway")]
public class BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway bED_FSMNode_GI_Loading_LoadingUIBeginFadeAway = GCHelper.Find<BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway>(obj);
		...
		bED_FSMNode_GI_Loading_LoadingUIBeginFadeAway.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway bED_FSMNode_GI_Loading_LoadingUIBeginFadeAway = GCHelper.Find<BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_LoadingUIBeginFadeAway.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway));
	}
}
