...
[Placeable(true)]
[UClass]
[DisplayName("WaitReplayPlayerSpawn")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn")]
public class BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn bED_FSMNode_GI_Loading_WaitReplayPlayerSpawn = GCHelper.Find<BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn>(obj);
		...
		bED_FSMNode_GI_Loading_WaitReplayPlayerSpawn.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn bED_FSMNode_GI_Loading_WaitReplayPlayerSpawn = GCHelper.Find<BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_WaitReplayPlayerSpawn.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn));
	}
}
