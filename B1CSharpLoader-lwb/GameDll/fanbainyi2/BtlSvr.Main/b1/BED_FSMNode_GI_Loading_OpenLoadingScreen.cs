...
[DisplayName("OpenLoadingScreen")]
[UClass]
[Placeable(true)]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLoadingScreen")]
public class BED_FSMNode_GI_Loading_OpenLoadingScreen : BED_FSMNode_GI_LoadingBase
{
	private static bool WaitTick_IsValid;

	private static int WaitTick_Offset;
	...
	[DisplayName("WaitTick")]
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLoadingScreen:WaitTick")]
	private int WaitTick
	{
		get
		{
			...
			if (!WaitTick_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLoadingScreen:WaitTick");
				return 0;
			}
			return BlittableTypeMarshaler<int>.FromNative(IntPtr.Add(base.Address, WaitTick_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				BlittableTypeMarshaler<int>.ToNative(IntPtr.Add(base.Address, WaitTick_Offset), value);
			}
		}
	}
	...
	[EditAnywhere]
	[DisplayName("Reason")]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLoadingScreen:Reason")]
	private ELoadingUIFadeInReason Reason
	{
		get
		{
			CheckDestroyed();
			if (!Reason_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLoadingScreen:Reason");
				return ELoadingUIFadeInReason.None;
			}
			return EnumMarshaler<ELoadingUIFadeInReason>.FromNative(IntPtr.Add(base.Address, Reason_Offset), 0, Reason_PropertyAddress.Address);
		}
		set
		{
			CheckDestroyed();
			...
			{
				EnumMarshaler<ELoadingUIFadeInReason>.ToNative(IntPtr.Add(base.Address, Reason_Offset), 0, Reason_PropertyAddress.Address, value);
			}
		}
	}
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLoadingScreen:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLoadingScreen:AcceptEvents");
				return null;
			}
	...
	{
		return new GI_Loading_OpenLoadingScreen
		{
			WaitTick = WaitTick,
			Reason = (int)Reason
		}.ToByteArray();
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLoadingScreen:GetNodeDescriptionInCS")]
	protected override string GetNodeDescriptionInCS_Implementation()
	{
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.Append($"WaitTick:{WaitTick}");
		stringBuilder.AppendLine();
		stringBuilder.Append("Reason:" + UEnum.GetEnum<ELoadingUIFadeInReason>().GetDisplayNameTextStringByIndex((int)Reason));
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLoadingScreen:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLoadingScreen:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_OpenLoadingScreen bED_FSMNode_GI_Loading_OpenLoadingScreen = GCHelper.Find<BED_FSMNode_GI_Loading_OpenLoadingScreen>(obj);
		...
		bED_FSMNode_GI_Loading_OpenLoadingScreen.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLoadingScreen:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_OpenLoadingScreen bED_FSMNode_GI_Loading_OpenLoadingScreen = GCHelper.Find<BED_FSMNode_GI_Loading_OpenLoadingScreen>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_OpenLoadingScreen.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLoadingScreen");
		WaitTick_Offset = NativeReflection.GetPropertyOffset(intPtr, "WaitTick");
		WaitTick_IsValid = NativeReflection.ValidatePropertyClass(intPtr, "WaitTick", Classes.FIntProperty);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLoadingScreen:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLoadingScreen:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_OpenLoadingScreen()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_OpenLoadingScreen)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_OpenLoadingScreen));
	}
}
