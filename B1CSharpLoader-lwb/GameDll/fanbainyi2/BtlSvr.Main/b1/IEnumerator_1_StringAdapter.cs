...
public class IEnumerator_1_StringAdapter : CrossBindingAdaptor
{
	public class Adapter : IEnumerator<string>, IDisposable, IEnumerator, CrossBindingAdaptorType
	{
		private CrossBindingFunctionInfo<string> mget_Current_0 = new CrossBindingFunctionInfo<string>("get_Current");
		...
		public string Current => mget_Current_0.Invoke(instance);
	...
	public override Type BaseCLRType => typeof(IEnumerator<string>);
