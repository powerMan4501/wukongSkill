...
[USharpPath("/Script/b1-Managed.BED_BossRushNode_Battle")]
public class BED_BossRushNode_Battle : BED_BossRushNode_TemplateBase
{
	...
	[Category("开始结束")]
	[BlueprintReadWrite]
	[USharpPath("/Script/b1-Managed.BED_BossRushNode_Battle:StartCondition")]
	public FBattleStartCondition StartCondition
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_BossRushNode_Battle:StartCondition");
	...
	[USharpPath("/Script/b1-Managed.BED_BossRushNode_Battle:BattleStartActiveList")]
	public FUnitsAndSpawners BattleStartActiveList
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_BossRushNode_Battle:BattleStartActiveList");
	...
	[UProperty]
	[BlueprintReadWrite]
	[USharpPath("/Script/b1-Managed.BED_BossRushNode_Battle:TransitionConditions")]
	public TArrayReadWrite<FCompositeTransitionCondition_Battle> TransitionConditions
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_BossRushNode_Battle:TransitionConditions");
				return null;
			}
	...
	{
		return B1CalliopeDef.BossRushNode.Battle;
	}

	[USharpPath("/Script/b1-Managed.BED_BossRushNode_Battle:GetContextOutputsInCS")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_BossRushNode_Battle:GetContextOutputsInCS")]
	private static void GetContextOutputsInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_BossRushNode_Battle bED_BossRushNode_Battle = GCHelper.Find<BED_BossRushNode_Battle>(obj);
		...
		List<FName> contextOutputsInCS_Implementation = bED_BossRushNode_Battle.GetContextOutputsInCS_Implementation();
	...
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_BossRushNode_Battle");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_BossRushNode_Battle:GetContextOutputsInCS", GetContextOutputsInCS_IsValid);
	}

	static BED_BossRushNode_Battle()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_BossRushNode_Battle)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_BossRushNode_Battle));
	}
}
