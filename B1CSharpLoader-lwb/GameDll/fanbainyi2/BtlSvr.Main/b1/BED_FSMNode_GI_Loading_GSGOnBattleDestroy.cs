...
[Placeable(true)]
[UClass]
[DisplayName("GSGOnBattleDestroy")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGOnBattleDestroy")]
public class BED_FSMNode_GI_Loading_GSGOnBattleDestroy : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGOnBattleDestroy:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGOnBattleDestroy:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGOnBattleDestroy:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGOnBattleDestroy:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGOnBattleDestroy:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_GSGOnBattleDestroy bED_FSMNode_GI_Loading_GSGOnBattleDestroy = GCHelper.Find<BED_FSMNode_GI_Loading_GSGOnBattleDestroy>(obj);
		...
		bED_FSMNode_GI_Loading_GSGOnBattleDestroy.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGOnBattleDestroy:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_GSGOnBattleDestroy bED_FSMNode_GI_Loading_GSGOnBattleDestroy = GCHelper.Find<BED_FSMNode_GI_Loading_GSGOnBattleDestroy>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_GSGOnBattleDestroy.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGOnBattleDestroy");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGOnBattleDestroy:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_GSGOnBattleDestroy:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_GSGOnBattleDestroy()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_GSGOnBattleDestroy)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_GSGOnBattleDestroy));
	}
}
