...
[Placeable(false)]
[DisplayName("退出状态")]
[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_ExitAction")]
public class BED_ProcessStateNode_ExitAction : BED_ProcessStateNode
{
	...
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_ExitAction:bOverride")]
	public bool bOverride
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessStateNode_ExitAction:bOverride");
				return false;
			}
	...
	{
		return "Process.State.ExitAction";
	}

	public override byte[] GetCustomData()
	{
		return new ProcessStateCustom_ExitAction
		{
	...
	{
		IntPtr unrealStruct = NativeReflection.GetClass("/Script/b1-Managed.BED_ProcessStateNode_ExitAction");
	...
	static BED_ProcessStateNode_ExitAction()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_ProcessStateNode_ExitAction)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_ProcessStateNode_ExitAction));
	}
}
