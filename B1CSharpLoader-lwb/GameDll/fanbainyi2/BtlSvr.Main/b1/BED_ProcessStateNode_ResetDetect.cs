...
[UClass]
[DisplayName("重置条件检测")]
[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_ResetDetect")]
public class BED_ProcessStateNode_ResetDetect : BED_ProcessStateNode
{
	...
	[DisplayName("条件列表")]
	[Category("State")]
	[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_ResetDetect:DetectConditionList")]
	public TMapReadWrite<FName, bool> DetectConditionList
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessStateNode_ResetDetect:DetectConditionList");
				return null;
			}
	...
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_ResetDetect:CurrentCondition")]
	public FName CurrentCondition
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessStateNode_ResetDetect:CurrentCondition");
	...
	{
		return "Process.State.ResetDetect";
	}

	public override byte[] GetCustomData()
	{
		return new ProcessStateCustom_ResetDetect
		{
			DetectCondition = CurrentCondition.PlainName
		}.ToByteArray();
	}

	[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_ResetDetect:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_ResetDetect:GetContextOutputsInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_ResetDetect:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_ProcessStateNode_ResetDetect:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_ProcessStateNode_ResetDetect bED_ProcessStateNode_ResetDetect = GCHelper.Find<BED_ProcessStateNode_ResetDetect>(obj);
		...
		bED_ProcessStateNode_ResetDetect.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_ProcessStateNode_ResetDetect:GetContextOutputsInCS")]
	private static void GetContextOutputsInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		List<FName> contextOutputsInCS_Implementation = bED_ProcessStateNode_ResetDetect.GetContextOutputsInCS_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_ProcessStateNode_ResetDetect:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_ProcessStateNode_ResetDetect bED_ProcessStateNode_ResetDetect = GCHelper.Find<BED_ProcessStateNode_ResetDetect>(obj);
		string nodeDescriptionInCS_Implementation = bED_ProcessStateNode_ResetDetect.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_ProcessStateNode_ResetDetect");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ProcessStateNode_ResetDetect:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ProcessStateNode_ResetDetect:GetContextOutputsInCS", GetContextOutputsInCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ProcessStateNode_ResetDetect:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_ProcessStateNode_ResetDetect()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_ProcessStateNode_ResetDetect)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_ProcessStateNode_ResetDetect));
	}
}
