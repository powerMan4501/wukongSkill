...
[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_ExecutionSequence")]
public class BED_ProcessStateNode_ExecutionSequence : BED_ProcessStateNode
{
	...
	[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_ExecutionSequence:CanUserAddOutputInCS")]
	...
	{
		return "Process.State.ExecutionSequence";
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_ProcessStateNode_ExecutionSequence:CanUserAddOutputInCS")]
	private static void CanUserAddOutputInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_ProcessStateNode_ExecutionSequence bED_ProcessStateNode_ExecutionSequence = GCHelper.Find<BED_ProcessStateNode_ExecutionSequence>(obj);
		bool value = bED_ProcessStateNode_ExecutionSequence.CanUserAddOutputInCS_Implementation();
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BED_ProcessStateNode_ExecutionSequence");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ProcessStateNode_ExecutionSequence:CanUserAddOutputInCS", CanUserAddOutputInCS_IsValid);
	}

	static BED_ProcessStateNode_ExecutionSequence()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_ProcessStateNode_ExecutionSequence)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_ProcessStateNode_ExecutionSequence));
	}
}
