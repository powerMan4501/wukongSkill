...
public class IEnumerator_1_Int64Adapter : CrossBindingAdaptor
{
	public class Adapter : IEnumerator<long>, IDisposable, IEnumerator, CrossBindingAdaptorType
	{
		private CrossBindingFunctionInfo<long> mget_Current_0 = new CrossBindingFunctionInfo<long>("get_Current");
		...
		public long Current => mget_Current_0.Invoke(instance);
	...
	public override Type BaseCLRType => typeof(IEnumerator<long>);
