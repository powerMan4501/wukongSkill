...
public class IEnumerator_1_BooleanAdapter : CrossBindingAdaptor
{
	public class Adapter : IEnumerator<bool>, IDisposable, IEnumerator, CrossBindingAdaptorType
	{
		private CrossBindingFunctionInfo<bool> mget_Current_0 = new CrossBindingFunctionInfo<bool>("get_Current");
		...
		public bool Current => mget_Current_0.Invoke(instance);
	...
	public override Type BaseCLRType => typeof(IEnumerator<bool>);
