...
[UClass]
[BlueprintType]
[USharpPath("/Script/b1-Managed.BED_FSMAsset")]
public class BED_FSMAsset : BED_CalliopeAssetBase
{
	...
	[USharpPath("/Script/b1-Managed.BED_FSMAsset:GetViewType")]
	protected override ECalliopeViewType GetViewType_Implementation()
	{
		return ECalliopeViewType.FSM;
	}

	[USharpPath("/Script/b1-Managed.BED_FSMAsset:GetRerouteNodeClass")]
	protected override TSubclassOf<UObject> GetRerouteNodeClass_Implementation()
	{
		return UClass.GetClass<BED_FSMNode_Reroute>();
	}

	[USharpPath("/Script/b1-Managed.BED_FSMAsset:GetStartNodeClass")]
	protected override TSubclassOf<UObject> GetStartNodeClass_Implementation()
	{
		return UClass.GetClass<BED_FSMNode_Start>();
	}

	[USharpPath("/Script/b1-Managed.BED_FSMAsset:GetExtraDefaultInputNodes")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMAsset:GetExtraDefaultOutputNodes")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMAsset:GetRerouteNodeClassInBranchGraph")]
	protected override TSubclassOf<UObject> GetRerouteNodeClassInBranchGraph_Implementation()
	{
		return TSubclassOf<UObject>.Null;
	}

	[USharpPath("/Script/b1-Managed.BED_FSMAsset:GetStartNodeClassInBranchGraph")]
	protected override TSubclassOf<UObject> GetStartNodeClassInBranchGraph_Implementation()
	{
		return TSubclassOf<UObject>.Null;
	}

	[USharpPath("/Script/b1-Managed.BED_FSMAsset:GetExtraDefaultInputNodesInBranchGraph")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMAsset:GetExtraDefaultOutputNodesInBranchGraph")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMAsset:GetViewType")]
	private static void GetViewType__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMAsset bED_FSMAsset = GCHelper.Find<BED_FSMAsset>(obj);
		ECalliopeViewType viewType_Implementation = bED_FSMAsset.GetViewType_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMAsset:GetStartNodeClass")]
	private static void GetStartNodeClass__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMAsset bED_FSMAsset = GCHelper.Find<BED_FSMAsset>(obj);
		TSubclassOf<UObject> startNodeClass_Implementation = bED_FSMAsset.GetStartNodeClass_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMAsset:GetRerouteNodeClass")]
	private static void GetRerouteNodeClass__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMAsset bED_FSMAsset = GCHelper.Find<BED_FSMAsset>(obj);
		TSubclassOf<UObject> rerouteNodeClass_Implementation = bED_FSMAsset.GetRerouteNodeClass_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMAsset:GetExtraDefaultInputNodes")]
	private static void GetExtraDefaultInputNodes__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultInputNodes_Implementation = bED_FSMAsset.GetExtraDefaultInputNodes_Implementation(out OutClasses);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMAsset:GetExtraDefaultOutputNodes")]
	private static void GetExtraDefaultOutputNodes__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultOutputNodes_Implementation = bED_FSMAsset.GetExtraDefaultOutputNodes_Implementation(out OutClasses);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMAsset:GetStartNodeClassInBranchGraph")]
	private static void GetStartNodeClassInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMAsset bED_FSMAsset = GCHelper.Find<BED_FSMAsset>(obj);
		TSubclassOf<UObject> startNodeClassInBranchGraph_Implementation = bED_FSMAsset.GetStartNodeClassInBranchGraph_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMAsset:GetRerouteNodeClassInBranchGraph")]
	private static void GetRerouteNodeClassInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMAsset bED_FSMAsset = GCHelper.Find<BED_FSMAsset>(obj);
		TSubclassOf<UObject> rerouteNodeClassInBranchGraph_Implementation = bED_FSMAsset.GetRerouteNodeClassInBranchGraph_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMAsset:GetExtraDefaultInputNodesInBranchGraph")]
	private static void GetExtraDefaultInputNodesInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultInputNodesInBranchGraph_Implementation = bED_FSMAsset.GetExtraDefaultInputNodesInBranchGraph_Implementation(out OutClasses);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMAsset:GetExtraDefaultOutputNodesInBranchGraph")]
	private static void GetExtraDefaultOutputNodesInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultOutputNodesInBranchGraph_Implementation = bED_FSMAsset.GetExtraDefaultOutputNodesInBranchGraph_Implementation(out OutClasses);
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMAsset");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMAsset:GetViewType", GetViewType_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMAsset:GetStartNodeClass", GetStartNodeClass_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMAsset:GetRerouteNodeClass", GetRerouteNodeClass_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMAsset:GetExtraDefaultInputNodes", GetExtraDefaultInputNodes_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMAsset:GetExtraDefaultOutputNodes", GetExtraDefaultOutputNodes_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMAsset:GetStartNodeClassInBranchGraph", GetStartNodeClassInBranchGraph_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMAsset:GetRerouteNodeClassInBranchGraph", GetRerouteNodeClassInBranchGraph_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMAsset:GetExtraDefaultInputNodesInBranchGraph", GetExtraDefaultInputNodesInBranchGraph_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMAsset:GetExtraDefaultOutputNodesInBranchGraph", GetExtraDefaultOutputNodesInBranchGraph_IsValid);
	}

	static BED_FSMAsset()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMAsset)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMAsset));
	}
}
