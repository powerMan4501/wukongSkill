...
[UClass]
[Placeable(true)]
[DisplayName("TeleportTemplateEnd")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateEnd")]
public class BED_FSMNode_GI_Loading_TeleportTemplateEnd : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateEnd:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateEnd:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateEnd:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateEnd:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateEnd:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_TeleportTemplateEnd bED_FSMNode_GI_Loading_TeleportTemplateEnd = GCHelper.Find<BED_FSMNode_GI_Loading_TeleportTemplateEnd>(obj);
		...
		bED_FSMNode_GI_Loading_TeleportTemplateEnd.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateEnd:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_TeleportTemplateEnd bED_FSMNode_GI_Loading_TeleportTemplateEnd = GCHelper.Find<BED_FSMNode_GI_Loading_TeleportTemplateEnd>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_TeleportTemplateEnd.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateEnd");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateEnd:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateEnd:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_TeleportTemplateEnd()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_TeleportTemplateEnd)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_TeleportTemplateEnd));
	}
}
