...
[UClass]
[DisplayName("BAN GSFinishSeedSubmitAnim")]
[USharpPath("/Script/b1-Managed.BAN_GSFinishSeedSubmitAnim")]
internal class BAN_GSFinishSeedSubmitAnim : BAN_GSBase
{
	...
	[USharpPath("/Script/b1-Managed.BAN_GSFinishSeedSubmitAnim:bIsNativeBranchingPointCS")]
	protected override bool bIsNativeBranchingPointCS_Implementation()
	{
		return true;
	}

	[USharpPath("/Script/b1-Managed.BAN_GSFinishSeedSubmitAnim:GSNotifyCS")]
	protected override void GSNotifyCS_Implementation(FUStGSNotifyParam NotifyParam)
	{
		...
		if (!(actorStreamingLevelWorld == null) && !UBGUFunctionLibraryForCS.BGUGetIsInEditorPreview(actorStreamingLevelWorld))
		{
			...
			{
				BUS_EventCollectionCS.Get(aPawn)?.Evt_FinishSeedSubmitAnim?.Invoke();
			}
		}
	}

	[UFunctionInvoker("/Script/b1-Managed.BAN_GSFinishSeedSubmitAnim:GSNotifyCS")]
	private static void GSNotifyCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BAN_GSFinishSeedSubmitAnim bAN_GSFinishSeedSubmitAnim = GCHelper.Find<b1.BAN_GSFinishSeedSubmitAnim>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyCS_NotifyParam_Offset));
		bAN_GSFinishSeedSubmitAnim.GSNotifyCS_Implementation(notifyParam);
	}

	[UFunctionInvoker("/Script/b1-Managed.BAN_GSFinishSeedSubmitAnim:bIsNativeBranchingPointCS")]
	private static void bIsNativeBranchingPointCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BAN_GSFinishSeedSubmitAnim bAN_GSFinishSeedSubmitAnim = GCHelper.Find<b1.BAN_GSFinishSeedSubmitAnim>(obj);
		bool value = bAN_GSFinishSeedSubmitAnim.bIsNativeBranchingPointCS_Implementation();
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BAN_GSFinishSeedSubmitAnim");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BAN_GSFinishSeedSubmitAnim:GSNotifyCS", GSNotifyCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BAN_GSFinishSeedSubmitAnim:bIsNativeBranchingPointCS", bIsNativeBranchingPointCS_IsValid);
	}

	static BAN_GSFinishSeedSubmitAnim()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BAN_GSFinishSeedSubmitAnim)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BAN_GSFinishSeedSubmitAnim));
	}
}
