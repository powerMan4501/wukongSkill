...
[DisplayName("PlayerDataInitPreEnterLevel")]
[Placeable(true)]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel")]
public class BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel bED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel = GCHelper.Find<BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel>(obj);
		...
		bED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel bED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel = GCHelper.Find<BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel));
	}
}
