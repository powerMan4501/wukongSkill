...
[UClass]
[DisplayName("BAN Interact Trigger Finish")]
[USharpPath("/Script/b1-Managed.BAN_InteractTriggerFinish")]
internal class BAN_InteractTriggerFinish : BAN_GSBase
{
	...
	[USharpPath("/Script/b1-Managed.BAN_InteractTriggerFinish:bIsNativeBranchingPointCS")]
	protected override bool bIsNativeBranchingPointCS_Implementation()
	{
		return true;
	}

	[USharpPath("/Script/b1-Managed.BAN_InteractTriggerFinish:GSNotifyCS")]
	protected override void GSNotifyCS_Implementation(FUStGSNotifyParam NotifyParam)
	{
		...
		if (owner != null)
		{
			...
			{
				bUS_GSEventCollection.Evt_TriggerFinishInteractActionForce.Invoke();
			}
		}
	}

	[UFunctionInvoker("/Script/b1-Managed.BAN_InteractTriggerFinish:GSNotifyCS")]
	private static void GSNotifyCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BAN_InteractTriggerFinish bAN_InteractTriggerFinish = GCHelper.Find<b1.BAN_InteractTriggerFinish>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyCS_NotifyParam_Offset));
		bAN_InteractTriggerFinish.GSNotifyCS_Implementation(notifyParam);
	}

	[UFunctionInvoker("/Script/b1-Managed.BAN_InteractTriggerFinish:bIsNativeBranchingPointCS")]
	private static void bIsNativeBranchingPointCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BAN_InteractTriggerFinish bAN_InteractTriggerFinish = GCHelper.Find<b1.BAN_InteractTriggerFinish>(obj);
		bool value = bAN_InteractTriggerFinish.bIsNativeBranchingPointCS_Implementation();
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BAN_InteractTriggerFinish");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BAN_InteractTriggerFinish:GSNotifyCS", GSNotifyCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BAN_InteractTriggerFinish:bIsNativeBranchingPointCS", bIsNativeBranchingPointCS_IsValid);
	}

	static BAN_InteractTriggerFinish()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BAN_InteractTriggerFinish)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BAN_InteractTriggerFinish));
	}
}
