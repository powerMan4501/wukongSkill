...
[UClass]
[Placeable(true)]
[DisplayName("AdjustPSOCachePrecompileBatch")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch")]
public class BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch bED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch = GCHelper.Find<BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch>(obj);
		...
		bED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch bED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch = GCHelper.Find<BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch));
	}
}
