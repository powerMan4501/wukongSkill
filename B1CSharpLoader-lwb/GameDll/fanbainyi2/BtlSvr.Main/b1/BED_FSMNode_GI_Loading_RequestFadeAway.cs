...
[Placeable(true)]
[DisplayName("RequestFadeAway")]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestFadeAway")]
public class BED_FSMNode_GI_Loading_RequestFadeAway : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[DisplayName("WaitSecond")]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestFadeAway:WaitSecond")]
	private float WaitSecond
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestFadeAway:WaitSecond");
				return 0f;
			}
			return BlittableTypeMarshaler<float>.FromNative(IntPtr.Add(base.Address, WaitSecond_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				BlittableTypeMarshaler<float>.ToNative(IntPtr.Add(base.Address, WaitSecond_Offset), value);
			}
		}
	}
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestFadeAway:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestFadeAway:AcceptEvents");
				return null;
			}
	...
	{
		return new GI_Loading_RequestFadeAway
		{
			WaitSecond = WaitSecond
		}.ToByteArray();
	}

	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestFadeAway:GetNodeDescriptionInCS")]
	protected override string GetNodeDescriptionInCS_Implementation()
	{
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.Append($"WaitSecond:{WaitSecond}");
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestFadeAway:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestFadeAway:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_RequestFadeAway bED_FSMNode_GI_Loading_RequestFadeAway = GCHelper.Find<BED_FSMNode_GI_Loading_RequestFadeAway>(obj);
		...
		bED_FSMNode_GI_Loading_RequestFadeAway.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestFadeAway:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_RequestFadeAway bED_FSMNode_GI_Loading_RequestFadeAway = GCHelper.Find<BED_FSMNode_GI_Loading_RequestFadeAway>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_RequestFadeAway.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestFadeAway");
		WaitSecond_Offset = NativeReflection.GetPropertyOffset(intPtr, "WaitSecond");
		WaitSecond_IsValid = NativeReflection.ValidatePropertyClass(intPtr, "WaitSecond", Classes.FFloatProperty);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestFadeAway:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestFadeAway:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_RequestFadeAway()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_RequestFadeAway)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_RequestFadeAway));
	}
}
