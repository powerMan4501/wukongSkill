...
[DisplayName("ShowMessageBoxAndWaitConfirm")]
[Placeable(true)]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm")]
public class BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm bED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm = GCHelper.Find<BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm>(obj);
		...
		bED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm bED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm = GCHelper.Find<BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm));
	}
}
