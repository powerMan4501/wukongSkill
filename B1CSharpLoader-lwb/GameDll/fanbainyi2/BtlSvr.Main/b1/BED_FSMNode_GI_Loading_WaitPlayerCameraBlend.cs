...
[UClass]
[Placeable(true)]
[DisplayName("WaitPlayerCameraBlend")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPlayerCameraBlend")]
public class BED_FSMNode_GI_Loading_WaitPlayerCameraBlend : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPlayerCameraBlend:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPlayerCameraBlend:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPlayerCameraBlend:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPlayerCameraBlend:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPlayerCameraBlend:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitPlayerCameraBlend bED_FSMNode_GI_Loading_WaitPlayerCameraBlend = GCHelper.Find<BED_FSMNode_GI_Loading_WaitPlayerCameraBlend>(obj);
		...
		bED_FSMNode_GI_Loading_WaitPlayerCameraBlend.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPlayerCameraBlend:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitPlayerCameraBlend bED_FSMNode_GI_Loading_WaitPlayerCameraBlend = GCHelper.Find<BED_FSMNode_GI_Loading_WaitPlayerCameraBlend>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_WaitPlayerCameraBlend.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPlayerCameraBlend");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPlayerCameraBlend:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitPlayerCameraBlend:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_WaitPlayerCameraBlend()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_WaitPlayerCameraBlend)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_WaitPlayerCameraBlend));
	}
}
