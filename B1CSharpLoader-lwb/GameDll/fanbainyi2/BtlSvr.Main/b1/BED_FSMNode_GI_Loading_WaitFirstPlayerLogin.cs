...
[Placeable(true)]
[UClass]
[DisplayName("WaitFirstPlayerLogin")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitFirstPlayerLogin")]
public class BED_FSMNode_GI_Loading_WaitFirstPlayerLogin : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitFirstPlayerLogin:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitFirstPlayerLogin:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitFirstPlayerLogin:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitFirstPlayerLogin:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitFirstPlayerLogin:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitFirstPlayerLogin bED_FSMNode_GI_Loading_WaitFirstPlayerLogin = GCHelper.Find<BED_FSMNode_GI_Loading_WaitFirstPlayerLogin>(obj);
		...
		bED_FSMNode_GI_Loading_WaitFirstPlayerLogin.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitFirstPlayerLogin:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitFirstPlayerLogin bED_FSMNode_GI_Loading_WaitFirstPlayerLogin = GCHelper.Find<BED_FSMNode_GI_Loading_WaitFirstPlayerLogin>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_WaitFirstPlayerLogin.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitFirstPlayerLogin");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitFirstPlayerLogin:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitFirstPlayerLogin:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_WaitFirstPlayerLogin()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_WaitFirstPlayerLogin)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_WaitFirstPlayerLogin));
	}
}
