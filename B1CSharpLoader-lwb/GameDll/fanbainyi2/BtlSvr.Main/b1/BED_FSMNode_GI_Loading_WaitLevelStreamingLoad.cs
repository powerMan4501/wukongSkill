...
[Placeable(true)]
[DisplayName("WaitLevelStreamingLoad")]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLevelStreamingLoad")]
public class BED_FSMNode_GI_Loading_WaitLevelStreamingLoad : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLevelStreamingLoad:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLevelStreamingLoad:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLevelStreamingLoad:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLevelStreamingLoad:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLevelStreamingLoad:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitLevelStreamingLoad bED_FSMNode_GI_Loading_WaitLevelStreamingLoad = GCHelper.Find<BED_FSMNode_GI_Loading_WaitLevelStreamingLoad>(obj);
		...
		bED_FSMNode_GI_Loading_WaitLevelStreamingLoad.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLevelStreamingLoad:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitLevelStreamingLoad bED_FSMNode_GI_Loading_WaitLevelStreamingLoad = GCHelper.Find<BED_FSMNode_GI_Loading_WaitLevelStreamingLoad>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_WaitLevelStreamingLoad.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLevelStreamingLoad");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLevelStreamingLoad:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLevelStreamingLoad:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_WaitLevelStreamingLoad()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_WaitLevelStreamingLoad)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_WaitLevelStreamingLoad));
	}
}
