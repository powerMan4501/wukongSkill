...
[Placeable(true)]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish")]
public class BED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish : BED_FSMNode_SubGraph
{
	...
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish:ArchiveSaveSource")]
	private EArchiveSaveSource ArchiveSaveSource
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish:ArchiveSaveSource");
	...
	{
		return new GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish
		{
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish:OnCreateGraphNodeInCS")]
	...
	private void FreshOutputPins()
	{
		...
		foreach (EGI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish_Return value in Enum.GetValues(typeof(EGI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish_Return)))
		{
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish:OnCreateGraphNodeInCS")]
	private static void OnCreateGraphNodeInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish bED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish = GCHelper.Find<BED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish>(obj);
		bED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish.OnCreateGraphNodeInCS_Implementation();
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish bED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish = GCHelper.Find<BED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish:OnCreateGraphNodeInCS", OnCreateGraphNodeInCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Global_SubG_GI_Loading_SaveArchiveAndWaitFinish));
	}
}
