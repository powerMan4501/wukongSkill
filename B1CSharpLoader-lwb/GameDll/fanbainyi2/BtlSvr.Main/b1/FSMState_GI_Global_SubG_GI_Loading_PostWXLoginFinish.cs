...
public class FSMState_GI_Global_SubG_GI_Loading_PostWXLoginFinish : FSMState_GI_Global_SubG_GI_Loading_Base
{
	public override void Init(FSMRuntimeInstance_GI_Global RuntimeInstance, FCalliopeNode Node, object InputParams)
	{
		...
		GI_Global_SubG_GI_Loading_PostWXLoginFinish gI_Global_SubG_GI_Loading_PostWXLoginFinish = new GI_Global_SubG_GI_Loading_PostWXLoginFinish();
		gI_Global_SubG_GI_Loading_PostWXLoginFinish.MergeFrom(Node.NodeData);
		SubGraphResPath = gI_Global_SubG_GI_Loading_PostWXLoginFinish.SubGraphAsset;
	}
	...
	{
		base.OwningInstance.TriggerSubGraphEvent(EGI_Global_SubG_GI_Loading_PostWXLoginFinish_Return.Finish);
	}
