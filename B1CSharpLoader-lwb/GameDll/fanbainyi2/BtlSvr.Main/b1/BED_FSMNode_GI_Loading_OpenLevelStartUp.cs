...
[UClass]
[Placeable(true)]
[DisplayName("OpenLevelStartUp")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelStartUp")]
public class BED_FSMNode_GI_Loading_OpenLevelStartUp : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelStartUp:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelStartUp:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelStartUp:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelStartUp:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelStartUp:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_OpenLevelStartUp bED_FSMNode_GI_Loading_OpenLevelStartUp = GCHelper.Find<BED_FSMNode_GI_Loading_OpenLevelStartUp>(obj);
		...
		bED_FSMNode_GI_Loading_OpenLevelStartUp.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelStartUp:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_OpenLevelStartUp bED_FSMNode_GI_Loading_OpenLevelStartUp = GCHelper.Find<BED_FSMNode_GI_Loading_OpenLevelStartUp>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_OpenLevelStartUp.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelStartUp");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelStartUp:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelStartUp:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_OpenLevelStartUp()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_OpenLevelStartUp)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_OpenLevelStartUp));
	}
}
