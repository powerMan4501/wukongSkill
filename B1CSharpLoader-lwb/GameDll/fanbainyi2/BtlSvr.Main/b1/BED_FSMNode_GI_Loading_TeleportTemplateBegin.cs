...
[Placeable(true)]
[UClass]
[DisplayName("TeleportTemplateBegin")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateBegin")]
public class BED_FSMNode_GI_Loading_TeleportTemplateBegin : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateBegin:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateBegin:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateBegin:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateBegin:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateBegin:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_TeleportTemplateBegin bED_FSMNode_GI_Loading_TeleportTemplateBegin = GCHelper.Find<BED_FSMNode_GI_Loading_TeleportTemplateBegin>(obj);
		...
		bED_FSMNode_GI_Loading_TeleportTemplateBegin.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateBegin:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_TeleportTemplateBegin bED_FSMNode_GI_Loading_TeleportTemplateBegin = GCHelper.Find<BED_FSMNode_GI_Loading_TeleportTemplateBegin>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_TeleportTemplateBegin.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateBegin");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateBegin:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_TeleportTemplateBegin:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_TeleportTemplateBegin()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_TeleportTemplateBegin)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_TeleportTemplateBegin));
	}
}
