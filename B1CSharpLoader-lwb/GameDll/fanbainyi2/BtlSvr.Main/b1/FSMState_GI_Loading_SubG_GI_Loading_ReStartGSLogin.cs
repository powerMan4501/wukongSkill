...
public class FSMState_GI_Loading_SubG_GI_Loading_ReStartGSLogin : FSMState_GI_Loading_SubG_GI_Loading_Base
{
	public override void Init(FSMRuntimeInstance_GI_Loading RuntimeInstance, FCalliopeNode Node, object InputParams)
	{
		...
		GI_Loading_SubG_GI_Loading_ReStartGSLogin gI_Loading_SubG_GI_Loading_ReStartGSLogin = new GI_Loading_SubG_GI_Loading_ReStartGSLogin();
		gI_Loading_SubG_GI_Loading_ReStartGSLogin.MergeFrom(Node.NodeData);
		SubGraphResPath = gI_Loading_SubG_GI_Loading_ReStartGSLogin.SubGraphAsset;
	}
	...
	{
		base.OwningInstance.TriggerSubGraphEvent(EGI_Loading_SubG_GI_Loading_ReStartGSLogin_Return.Finish);
	}
