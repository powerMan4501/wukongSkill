...
[DisplayName("BAN Remove SceneItem Data")]
[UClass]
[USharpPath("/Script/b1-Managed.BAN_GSRemoveSceneItemData")]
internal class BAN_GSRemoveSceneItemData : BAN_GSBase
{
	...
	[USharpPath("/Script/b1-Managed.BAN_GSRemoveSceneItemData:bIsNativeBranchingPointCS")]
	protected override bool bIsNativeBranchingPointCS_Implementation()
	{
		return true;
	}

	[USharpPath("/Script/b1-Managed.BAN_GSRemoveSceneItemData:GSNotifyCS")]
	protected override void GSNotifyCS_Implementation(FUStGSNotifyParam NotifyParam)
	{
		AActor owner = NotifyParam.owner;
		if (owner != null)
		{
			BUS_EventCollectionCS.Get(owner)?.Evt_RemoveCatchedSceneItemAndReset.Invoke();
		}
	}

	[UFunctionInvoker("/Script/b1-Managed.BAN_GSRemoveSceneItemData:GSNotifyCS")]
	private static void GSNotifyCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BAN_GSRemoveSceneItemData bAN_GSRemoveSceneItemData = GCHelper.Find<b1.BAN_GSRemoveSceneItemData>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyCS_NotifyParam_Offset));
		bAN_GSRemoveSceneItemData.GSNotifyCS_Implementation(notifyParam);
	}

	[UFunctionInvoker("/Script/b1-Managed.BAN_GSRemoveSceneItemData:bIsNativeBranchingPointCS")]
	private static void bIsNativeBranchingPointCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BAN_GSRemoveSceneItemData bAN_GSRemoveSceneItemData = GCHelper.Find<b1.BAN_GSRemoveSceneItemData>(obj);
		bool value = bAN_GSRemoveSceneItemData.bIsNativeBranchingPointCS_Implementation();
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BAN_GSRemoveSceneItemData");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BAN_GSRemoveSceneItemData:GSNotifyCS", GSNotifyCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BAN_GSRemoveSceneItemData:bIsNativeBranchingPointCS", bIsNativeBranchingPointCS_IsValid);
	}

	static BAN_GSRemoveSceneItemData()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BAN_GSRemoveSceneItemData)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BAN_GSRemoveSceneItemData));
	}
}
