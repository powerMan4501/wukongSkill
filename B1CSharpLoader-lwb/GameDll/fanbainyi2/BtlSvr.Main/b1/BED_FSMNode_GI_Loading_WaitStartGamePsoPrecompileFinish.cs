...
[Placeable(true)]
[DisplayName("WaitStartGamePsoPrecompileFinish")]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish")]
public class BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish bED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish = GCHelper.Find<BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish>(obj);
		...
		bED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish bED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish = GCHelper.Find<BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish));
	}
}
