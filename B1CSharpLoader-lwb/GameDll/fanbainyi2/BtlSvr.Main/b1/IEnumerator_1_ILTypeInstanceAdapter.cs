...
{
	public class Adapter : IEnumerator<ILTypeInstance>, IDisposable, IEnumerator, CrossBindingAdaptorType
	{
		private CrossBindingFunctionInfo<ILTypeInstance> mget_Current_0 = new CrossBindingFunctionInfo<ILTypeInstance>("get_Current");
		...
		public ILTypeInstance Current => mget_Current_0.Invoke(instance);
	...
	public override Type BaseCLRType => typeof(IEnumerator<ILTypeInstance>);
