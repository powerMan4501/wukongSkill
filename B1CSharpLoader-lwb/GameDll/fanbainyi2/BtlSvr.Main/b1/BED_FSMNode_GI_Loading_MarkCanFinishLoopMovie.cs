...
[UClass]
[Placeable(true)]
[DisplayName("MarkCanFinishLoopMovie")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkCanFinishLoopMovie")]
public class BED_FSMNode_GI_Loading_MarkCanFinishLoopMovie : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkCanFinishLoopMovie:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkCanFinishLoopMovie:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkCanFinishLoopMovie:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkCanFinishLoopMovie:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkCanFinishLoopMovie:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_MarkCanFinishLoopMovie bED_FSMNode_GI_Loading_MarkCanFinishLoopMovie = GCHelper.Find<BED_FSMNode_GI_Loading_MarkCanFinishLoopMovie>(obj);
		...
		bED_FSMNode_GI_Loading_MarkCanFinishLoopMovie.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkCanFinishLoopMovie:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_MarkCanFinishLoopMovie bED_FSMNode_GI_Loading_MarkCanFinishLoopMovie = GCHelper.Find<BED_FSMNode_GI_Loading_MarkCanFinishLoopMovie>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_MarkCanFinishLoopMovie.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkCanFinishLoopMovie");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkCanFinishLoopMovie:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkCanFinishLoopMovie:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_MarkCanFinishLoopMovie()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_MarkCanFinishLoopMovie)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_MarkCanFinishLoopMovie));
	}
}
