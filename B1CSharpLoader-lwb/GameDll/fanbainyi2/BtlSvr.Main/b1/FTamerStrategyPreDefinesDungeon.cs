...
public class FTamerStrategyPreDefinesDungeon : ITamerStrategyPreDefines
{
	...
	public float DistanceForPatrolActorBeginPlayMeter => 150f;

	public float DistanceForUnloadPatrolUnitMeter => 180f;

	public float ZOffsetSpawnLimitMeter => 30f;

	public float ZOffsetUnloadLimitMeter => 50f;
