...
public class FSMState_GI_Loading_SubG_GI_Loading_SaveArchiveAndWaitFinish : FSMState_GI_Loading_SubG_GI_Loading_Base
{
	...
	public override void Init(FSMRuntimeInstance_GI_Loading RuntimeInstance, FCalliopeNode Node, object InputParams)
	{
		...
		GI_Loading_SubG_GI_Loading_SaveArchiveAndWaitFinish gI_Loading_SubG_GI_Loading_SaveArchiveAndWaitFinish = new GI_Loading_SubG_GI_Loading_SaveArchiveAndWaitFinish();
		gI_Loading_SubG_GI_Loading_SaveArchiveAndWaitFinish.MergeFrom(Node.NodeData);
		SubGraphResPath = gI_Loading_SubG_GI_Loading_SaveArchiveAndWaitFinish.SubGraphAsset;
		ArchiveSaveSource = (EArchiveSaveSource)gI_Loading_SubG_GI_Loading_SaveArchiveAndWaitFinish.ArchiveSaveSource;
	}
	...
	{
		base.OwningInstance.TriggerSubGraphEvent(EGI_Loading_SubG_GI_Loading_SaveArchiveAndWaitFinish_Return.Finish);
	}
