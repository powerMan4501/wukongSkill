...
[UClass]
[Placeable(true)]
[DisplayName("PlayerTeleportToTemplatetargetPos")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos")]
public class BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos bED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos = GCHelper.Find<BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos>(obj);
		...
		bED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos bED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos = GCHelper.Find<BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos));
	}
}
