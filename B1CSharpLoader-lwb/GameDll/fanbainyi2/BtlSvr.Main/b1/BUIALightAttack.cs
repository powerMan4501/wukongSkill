...
internal class BUIALightAttack : BUInputActionTemplate
{
	public BUIALightAttack()
	{
		InputActionType = EInputActionType.LightAttack;
	}
	...
	protected override bool OnTriggerInputAction(int InputActionID, ETriggerEvent TriggerEvent, ref FInputActionValue Value, GSPredictionKey PredictionKey)
	{
		...
		case ETriggerEvent.Started:
			...
			BUS_EventCollectionCS.Get(owner)?.Evt_InputCastSkill.Invoke(EInputActionType.LightAttack, IsRelease: false);
			break;
		case ETriggerEvent.Completed:
			BUS_EventCollectionCS.Get(owner)?.Evt_InputCastSkill.Invoke(EInputActionType.LightAttack, IsRelease: true);
			break;
		}
		return true;
	}
