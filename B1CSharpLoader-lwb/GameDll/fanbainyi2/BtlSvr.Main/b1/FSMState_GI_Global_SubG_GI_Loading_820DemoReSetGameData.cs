...
public class FSMState_GI_Global_SubG_GI_Loading_820DemoReSetGameData : FSMState_GI_Global_SubG_GI_Loading_Base
{
	public override void Init(FSMRuntimeInstance_GI_Global RuntimeInstance, FCalliopeNode Node, object InputParams)
	{
		...
		GI_Global_SubG_GI_Loading_820DemoReSetGameData gI_Global_SubG_GI_Loading_820DemoReSetGameData = new GI_Global_SubG_GI_Loading_820DemoReSetGameData();
		gI_Global_SubG_GI_Loading_820DemoReSetGameData.MergeFrom(Node.NodeData);
		SubGraphResPath = gI_Global_SubG_GI_Loading_820DemoReSetGameData.SubGraphAsset;
	}
	...
	{
		base.OwningInstance.TriggerSubGraphEvent(EGI_Global_SubG_GI_Loading_820DemoReSetGameData_Return.Finish);
	}
