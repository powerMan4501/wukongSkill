...
[DisplayName("BANS Casting State")]
[UClass]
[USharpPath("/Script/b1-Managed.BANS_GSCastingState")]
internal class BANS_GSCastingState : BANS_GSBase
{
	...
	{
		base.AnimNSType = EGsEnAnimNS.Casting;
	}

	[USharpPath("/Script/b1-Managed.BANS_GSCastingState:GSNotifyBeginCS")]
	protected override void GSNotifyBeginCS_Implementation(FUStGSNotifyParam NotifyParam, float TotalDuration)
	{
		CastingDuration = TotalDuration;
		CastingTimer = 0f;
		BGUCharacterCS bGUCharacterCS = NotifyParam.owner as BGUCharacterCS;
		if (bGUCharacterCS != null)
		{
			BUS_EventCollectionCS.Get(bGUCharacterCS).Evt_ToggleCastingProgressVisibility.Invoke(P1: true);
			BUS_EventCollectionCS.Get(bGUCharacterCS).Evt_UpdateCastingProgress.Invoke(0f);
		}
	}

	[USharpPath("/Script/b1-Managed.BANS_GSCastingState:GSNotifyTickCS")]
	protected override void GSNotifyTickCS_Implementation(FUStGSNotifyParam NotifyParam, float FrameDeltaTime)
	{
		CastingTimer += FrameDeltaTime;
		...
		if (bGUCharacterCS != null)
		{
			BUS_EventCollectionCS.Get(bGUCharacterCS).Evt_UpdateCastingProgress.Invoke(CastingTimer / CastingDuration);
		}
	}

	[USharpPath("/Script/b1-Managed.BANS_GSCastingState:GSNotifyEndCS")]
	protected override void GSNotifyEndCS_Implementation(FUStGSNotifyParam NotifyParam)
	{
		BGUCharacterCS bGUCharacterCS = NotifyParam.owner as BGUCharacterCS;
		if (bGUCharacterCS != null)
		{
			BUS_EventCollectionCS.Get(bGUCharacterCS).Evt_ToggleCastingProgressVisibility.Invoke(P1: false);
			BUS_EventCollectionCS.Get(bGUCharacterCS).Evt_UpdateCastingProgress.Invoke(0f);
			CastingTimer = 0f;
		}
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_GSCastingState:GSNotifyEndCS")]
	private static void GSNotifyEndCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BANS_GSCastingState bANS_GSCastingState = GCHelper.Find<b1.BANS_GSCastingState>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyEndCS_NotifyParam_Offset));
		bANS_GSCastingState.GSNotifyEndCS_Implementation(notifyParam);
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_GSCastingState:GSNotifyTickCS")]
	private static void GSNotifyTickCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		bANS_GSCastingState.GSNotifyTickCS_Implementation(notifyParam, frameDeltaTime);
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_GSCastingState:GSNotifyBeginCS")]
	private static void GSNotifyBeginCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BANS_GSCastingState bANS_GSCastingState = GCHelper.Find<b1.BANS_GSCastingState>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyBeginCS_NotifyParam_Offset));
		float totalDuration = BlittableTypeMarshaler<float>.FromNative(IntPtr.Add(buffer, GSNotifyBeginCS_TotalDuration_Offset));
		bANS_GSCastingState.GSNotifyBeginCS_Implementation(notifyParam, totalDuration);
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BANS_GSCastingState");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_GSCastingState:GSNotifyEndCS", GSNotifyEndCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_GSCastingState:GSNotifyTickCS", GSNotifyTickCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_GSCastingState:GSNotifyBeginCS", GSNotifyBeginCS_IsValid);
	}

	static BANS_GSCastingState()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BANS_GSCastingState)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BANS_GSCastingState));
	}
}
