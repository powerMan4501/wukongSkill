...
public class FSMState_GI_Global_SubG_GI_Loading_PartyRoomClient : FSMState_GI_Global_SubG_GI_Loading_Base
{
	public override void Init(FSMRuntimeInstance_GI_Global RuntimeInstance, FCalliopeNode Node, object InputParams)
	{
		...
		GI_Global_SubG_GI_Loading_PartyRoomClient gI_Global_SubG_GI_Loading_PartyRoomClient = new GI_Global_SubG_GI_Loading_PartyRoomClient();
		gI_Global_SubG_GI_Loading_PartyRoomClient.MergeFrom(Node.NodeData);
		SubGraphResPath = gI_Global_SubG_GI_Loading_PartyRoomClient.SubGraphAsset;
	}
	...
	{
		base.OwningInstance.TriggerSubGraphEvent(EGI_Global_SubG_GI_Loading_PartyRoomClient_Return.Finish);
	}
