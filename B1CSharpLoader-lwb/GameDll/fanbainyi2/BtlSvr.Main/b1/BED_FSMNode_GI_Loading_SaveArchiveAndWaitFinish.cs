...
[DisplayName("SaveArchiveAndWaitFinish")]
[Placeable(true)]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish")]
public class BED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish bED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish = GCHelper.Find<BED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish>(obj);
		...
		bED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish bED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish = GCHelper.Find<BED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_SaveArchiveAndWaitFinish));
	}
}
