...
[UClass]
[Placeable(true)]
[DisplayName("CheckGSSdkUserConfig")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkUserConfig")]
public class BED_FSMNode_GI_Loading_CheckGSSdkUserConfig : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkUserConfig:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkUserConfig:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkUserConfig:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkUserConfig:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkUserConfig:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_CheckGSSdkUserConfig bED_FSMNode_GI_Loading_CheckGSSdkUserConfig = GCHelper.Find<BED_FSMNode_GI_Loading_CheckGSSdkUserConfig>(obj);
		...
		bED_FSMNode_GI_Loading_CheckGSSdkUserConfig.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkUserConfig:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_CheckGSSdkUserConfig bED_FSMNode_GI_Loading_CheckGSSdkUserConfig = GCHelper.Find<BED_FSMNode_GI_Loading_CheckGSSdkUserConfig>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_CheckGSSdkUserConfig.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkUserConfig");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkUserConfig:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_CheckGSSdkUserConfig:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_CheckGSSdkUserConfig()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_CheckGSSdkUserConfig)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_CheckGSSdkUserConfig));
	}
}
