...
[UClass]
[Placeable(true)]
[DisplayName("WaittingSelectLevel820Demo")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_WaittingSelectLevel820Demo")]
public class BED_FSMNode_GI_Global_WaittingSelectLevel820Demo : BED_FSMNode_GI_GlobalBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_WaittingSelectLevel820Demo:AcceptEvents")]
	public TArrayReadWrite<EGI_Global> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Global_WaittingSelectLevel820Demo:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_WaittingSelectLevel820Demo:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_WaittingSelectLevel820Demo:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Global_WaittingSelectLevel820Demo:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Global_WaittingSelectLevel820Demo bED_FSMNode_GI_Global_WaittingSelectLevel820Demo = GCHelper.Find<BED_FSMNode_GI_Global_WaittingSelectLevel820Demo>(obj);
		...
		bED_FSMNode_GI_Global_WaittingSelectLevel820Demo.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Global_WaittingSelectLevel820Demo:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Global_WaittingSelectLevel820Demo bED_FSMNode_GI_Global_WaittingSelectLevel820Demo = GCHelper.Find<BED_FSMNode_GI_Global_WaittingSelectLevel820Demo>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Global_WaittingSelectLevel820Demo.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Global_WaittingSelectLevel820Demo");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Global_WaittingSelectLevel820Demo:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Global_WaittingSelectLevel820Demo:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Global_WaittingSelectLevel820Demo()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Global_WaittingSelectLevel820Demo)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Global_WaittingSelectLevel820Demo));
	}
}
