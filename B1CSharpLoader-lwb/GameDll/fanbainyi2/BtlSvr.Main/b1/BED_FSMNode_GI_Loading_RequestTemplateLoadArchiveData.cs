...
[Placeable(true)]
[UClass]
[DisplayName("RequestTemplateLoadArchiveData")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData")]
public class BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData bED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData = GCHelper.Find<BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData>(obj);
		...
		bED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData bED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData = GCHelper.Find<BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData));
	}
}
