...
public class FSMState_GI_Global_SubG_GI_Loading_StartNewGamePlus : FSMState_GI_Global_SubG_GI_Loading_Base
{
	public override void Init(FSMRuntimeInstance_GI_Global RuntimeInstance, FCalliopeNode Node, object InputParams)
	{
		...
		GI_Global_SubG_GI_Loading_StartNewGamePlus gI_Global_SubG_GI_Loading_StartNewGamePlus = new GI_Global_SubG_GI_Loading_StartNewGamePlus();
		gI_Global_SubG_GI_Loading_StartNewGamePlus.MergeFrom(Node.NodeData);
		SubGraphResPath = gI_Global_SubG_GI_Loading_StartNewGamePlus.SubGraphAsset;
	}
	...
	{
		base.OwningInstance.TriggerSubGraphEvent(EGI_Global_SubG_GI_Loading_StartNewGamePlus_Return.Finish);
	}
