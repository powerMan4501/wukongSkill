...
public class FSMState_GI_Loading_SubG_GI_Loading_ClientEnvInit : FSMState_GI_Loading_SubG_GI_Loading_Base
{
	public override void Init(FSMRuntimeInstance_GI_Loading RuntimeInstance, FCalliopeNode Node, object InputParams)
	{
		...
		GI_Loading_SubG_GI_Loading_ClientEnvInit gI_Loading_SubG_GI_Loading_ClientEnvInit = new GI_Loading_SubG_GI_Loading_ClientEnvInit();
		gI_Loading_SubG_GI_Loading_ClientEnvInit.MergeFrom(Node.NodeData);
		SubGraphResPath = gI_Loading_SubG_GI_Loading_ClientEnvInit.SubGraphAsset;
	}
	...
	{
		base.OwningInstance.TriggerSubGraphEvent(EGI_Loading_SubG_GI_Loading_ClientEnvInit_Return.Finish);
	}
