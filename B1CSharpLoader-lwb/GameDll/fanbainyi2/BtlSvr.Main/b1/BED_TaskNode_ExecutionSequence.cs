...
[UClass]
[USharpPath("/Script/b1-Managed.BED_TaskNode_ExecutionSequence")]
public class BED_TaskNode_ExecutionSequence : BED_TaskNode
{
	...
	[USharpPath("/Script/b1-Managed.BED_TaskNode_ExecutionSequence:CanUserAddOutputInCS")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_TaskNode_ExecutionSequence:CanUserAddOutputInCS")]
	private static void CanUserAddOutputInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_TaskNode_ExecutionSequence bED_TaskNode_ExecutionSequence = GCHelper.Find<BED_TaskNode_ExecutionSequence>(obj);
		bool value = bED_TaskNode_ExecutionSequence.CanUserAddOutputInCS_Implementation();
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BED_TaskNode_ExecutionSequence");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_TaskNode_ExecutionSequence:CanUserAddOutputInCS", CanUserAddOutputInCS_IsValid);
	}

	static BED_TaskNode_ExecutionSequence()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_TaskNode_ExecutionSequence)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_TaskNode_ExecutionSequence));
	}
}
