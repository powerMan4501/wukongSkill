...
[DisplayName("蛐蛐战胜利表演结束")]
[UClass]
[USharpPath("/Script/b1-Managed.BSNS_CricketWinFinish")]
internal class BSNS_CricketWinFinish : UMovieSceneCalliopeNotifyStateSection
{
	...
	[USharpPath("/Script/b1-Managed.BSNS_CricketWinFinish:OnNotifyBegin")]
	...
	{
		BGW_CricketBattleMgr.Get(InPlayer.GetPlaybackContext()).BattleFinishShow();
	}

	[USharpPath("/Script/b1-Managed.BSNS_CricketWinFinish:OnNotifyEnd")]
	protected override void OnNotifyEnd_Implementation(UCalliopeLevelSequencePlayer InPlayer, int InStatus, bool bInBackwards)
	{
	}

	[UFunctionInvoker("/Script/b1-Managed.BSNS_CricketWinFinish:OnNotifyEnd")]
	private static void OnNotifyEnd__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BSNS_CricketWinFinish bSNS_CricketWinFinish = GCHelper.Find<b1.BSNS_CricketWinFinish>(obj);
		...
		bSNS_CricketWinFinish.OnNotifyEnd_Implementation(inPlayer, inStatus, bInBackwards);
	}

	[UFunctionInvoker("/Script/b1-Managed.BSNS_CricketWinFinish:OnNotifyBegin")]
	private static void OnNotifyBegin__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		bSNS_CricketWinFinish.OnNotifyBegin_Implementation(inPlayer, inStatus, bInBackwards);
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BSNS_CricketWinFinish");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BSNS_CricketWinFinish:OnNotifyEnd", OnNotifyEnd_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BSNS_CricketWinFinish:OnNotifyBegin", OnNotifyBegin_IsValid);
	}

	static BSNS_CricketWinFinish()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BSNS_CricketWinFinish)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BSNS_CricketWinFinish));
	}
}
