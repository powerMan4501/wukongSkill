...
public class FSMState_GI_Global_SubG_GI_Loading_ToiletClient : FSMState_GI_Global_SubG_GI_Loading_Base
{
	public override void Init(FSMRuntimeInstance_GI_Global RuntimeInstance, FCalliopeNode Node, object InputParams)
	{
		...
		GI_Global_SubG_GI_Loading_ToiletClient gI_Global_SubG_GI_Loading_ToiletClient = new GI_Global_SubG_GI_Loading_ToiletClient();
		gI_Global_SubG_GI_Loading_ToiletClient.MergeFrom(Node.NodeData);
		SubGraphResPath = gI_Global_SubG_GI_Loading_ToiletClient.SubGraphAsset;
	}
	...
	{
		base.OwningInstance.TriggerSubGraphEvent(EGI_Global_SubG_GI_Loading_ToiletClient_Return.Finish);
	}
