...
[Placeable(true)]
[DisplayName("InitClientPlayerContainer")]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitClientPlayerContainer")]
public class BED_FSMNode_GI_Loading_InitClientPlayerContainer : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitClientPlayerContainer:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitClientPlayerContainer:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitClientPlayerContainer:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitClientPlayerContainer:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitClientPlayerContainer:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_InitClientPlayerContainer bED_FSMNode_GI_Loading_InitClientPlayerContainer = GCHelper.Find<BED_FSMNode_GI_Loading_InitClientPlayerContainer>(obj);
		...
		bED_FSMNode_GI_Loading_InitClientPlayerContainer.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitClientPlayerContainer:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_InitClientPlayerContainer bED_FSMNode_GI_Loading_InitClientPlayerContainer = GCHelper.Find<BED_FSMNode_GI_Loading_InitClientPlayerContainer>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_InitClientPlayerContainer.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitClientPlayerContainer");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitClientPlayerContainer:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitClientPlayerContainer:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_InitClientPlayerContainer()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_InitClientPlayerContainer)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_InitClientPlayerContainer));
	}
}
