...
public class FSMState_GI_Loading_SubG_GI_Loading_GSLogin : FSMState_GI_Loading_SubG_GI_Loading_Base
{
	public override void Init(FSMRuntimeInstance_GI_Loading RuntimeInstance, FCalliopeNode Node, object InputParams)
	{
		...
		GI_Loading_SubG_GI_Loading_GSLogin gI_Loading_SubG_GI_Loading_GSLogin = new GI_Loading_SubG_GI_Loading_GSLogin();
		gI_Loading_SubG_GI_Loading_GSLogin.MergeFrom(Node.NodeData);
		SubGraphResPath = gI_Loading_SubG_GI_Loading_GSLogin.SubGraphAsset;
	}
	...
	{
		base.OwningInstance.TriggerSubGraphEvent(EGI_Loading_SubG_GI_Loading_GSLogin_Return.Finish);
		BGW_EventCollection.Get(Context.GameInst).Evt_GSLoginFinish();
	}
