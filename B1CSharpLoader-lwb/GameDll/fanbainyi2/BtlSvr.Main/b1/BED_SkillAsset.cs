...
[UClass]
[BlueprintType]
[USharpPath("/Script/b1-Managed.BED_SkillAsset")]
internal class BED_SkillAsset : BED_CalliopeAssetBase
{
	...
	[USharpPath("/Script/b1-Managed.BED_SkillAsset:GetViewType")]
	protected override ECalliopeViewType GetViewType_Implementation()
	{
		return ECalliopeViewType.Skill;
	}

	[USharpPath("/Script/b1-Managed.BED_SkillAsset:GetRerouteNodeClass")]
	protected override TSubclassOf<UObject> GetRerouteNodeClass_Implementation()
	{
		return TSubclassOf<UObject>.Null;
	}

	[USharpPath("/Script/b1-Managed.BED_SkillAsset:GetStartNodeClass")]
	protected override TSubclassOf<UObject> GetStartNodeClass_Implementation()
	{
		return UClass.GetClass<b1.BED_SkillNode_Start>();
	}

	[USharpPath("/Script/b1-Managed.BED_SkillAsset:GetExtraDefaultInputNodes")]
	...
	[USharpPath("/Script/b1-Managed.BED_SkillAsset:GetExtraDefaultOutputNodes")]
	...
	[USharpPath("/Script/b1-Managed.BED_SkillAsset:GetRerouteNodeClassInBranchGraph")]
	protected override TSubclassOf<UObject> GetRerouteNodeClassInBranchGraph_Implementation()
	{
		return TSubclassOf<UObject>.Null;
	}

	[USharpPath("/Script/b1-Managed.BED_SkillAsset:GetStartNodeClassInBranchGraph")]
	protected override TSubclassOf<UObject> GetStartNodeClassInBranchGraph_Implementation()
	{
		return TSubclassOf<UObject>.Null;
	}

	[USharpPath("/Script/b1-Managed.BED_SkillAsset:GetExtraDefaultInputNodesInBranchGraph")]
	...
	[USharpPath("/Script/b1-Managed.BED_SkillAsset:GetExtraDefaultOutputNodesInBranchGraph")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_SkillAsset:GetViewType")]
	private static void GetViewType__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BED_SkillAsset bED_SkillAsset = GCHelper.Find<b1.BED_SkillAsset>(obj);
		ECalliopeViewType viewType_Implementation = bED_SkillAsset.GetViewType_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_SkillAsset:GetStartNodeClass")]
	private static void GetStartNodeClass__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BED_SkillAsset bED_SkillAsset = GCHelper.Find<b1.BED_SkillAsset>(obj);
		TSubclassOf<UObject> startNodeClass_Implementation = bED_SkillAsset.GetStartNodeClass_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_SkillAsset:GetRerouteNodeClass")]
	private static void GetRerouteNodeClass__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BED_SkillAsset bED_SkillAsset = GCHelper.Find<b1.BED_SkillAsset>(obj);
		TSubclassOf<UObject> rerouteNodeClass_Implementation = bED_SkillAsset.GetRerouteNodeClass_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_SkillAsset:GetExtraDefaultInputNodes")]
	private static void GetExtraDefaultInputNodes__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultInputNodes_Implementation = bED_SkillAsset.GetExtraDefaultInputNodes_Implementation(out OutClasses);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_SkillAsset:GetExtraDefaultOutputNodes")]
	private static void GetExtraDefaultOutputNodes__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultOutputNodes_Implementation = bED_SkillAsset.GetExtraDefaultOutputNodes_Implementation(out OutClasses);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_SkillAsset:GetStartNodeClassInBranchGraph")]
	private static void GetStartNodeClassInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BED_SkillAsset bED_SkillAsset = GCHelper.Find<b1.BED_SkillAsset>(obj);
		TSubclassOf<UObject> startNodeClassInBranchGraph_Implementation = bED_SkillAsset.GetStartNodeClassInBranchGraph_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_SkillAsset:GetRerouteNodeClassInBranchGraph")]
	private static void GetRerouteNodeClassInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BED_SkillAsset bED_SkillAsset = GCHelper.Find<b1.BED_SkillAsset>(obj);
		TSubclassOf<UObject> rerouteNodeClassInBranchGraph_Implementation = bED_SkillAsset.GetRerouteNodeClassInBranchGraph_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_SkillAsset:GetExtraDefaultInputNodesInBranchGraph")]
	private static void GetExtraDefaultInputNodesInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultInputNodesInBranchGraph_Implementation = bED_SkillAsset.GetExtraDefaultInputNodesInBranchGraph_Implementation(out OutClasses);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_SkillAsset:GetExtraDefaultOutputNodesInBranchGraph")]
	private static void GetExtraDefaultOutputNodesInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultOutputNodesInBranchGraph_Implementation = bED_SkillAsset.GetExtraDefaultOutputNodesInBranchGraph_Implementation(out OutClasses);
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BED_SkillAsset");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_SkillAsset:GetViewType", GetViewType_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_SkillAsset:GetStartNodeClass", GetStartNodeClass_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_SkillAsset:GetRerouteNodeClass", GetRerouteNodeClass_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_SkillAsset:GetExtraDefaultInputNodes", GetExtraDefaultInputNodes_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_SkillAsset:GetExtraDefaultOutputNodes", GetExtraDefaultOutputNodes_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_SkillAsset:GetStartNodeClassInBranchGraph", GetStartNodeClassInBranchGraph_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_SkillAsset:GetRerouteNodeClassInBranchGraph", GetRerouteNodeClassInBranchGraph_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_SkillAsset:GetExtraDefaultInputNodesInBranchGraph", GetExtraDefaultInputNodesInBranchGraph_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_SkillAsset:GetExtraDefaultOutputNodesInBranchGraph", GetExtraDefaultOutputNodesInBranchGraph_IsValid);
	}

	static BED_SkillAsset()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BED_SkillAsset)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BED_SkillAsset));
	}
}
