...
[DisplayName("蛛丝缠绕受击")]
[UClass]
[USharpPath("/Script/b1-Managed.BANS_OnSpiderSkillEntangleStiffEnded")]
internal class BANS_OnSpiderSkillEntangleStiffEnded : BANS_GSBase
{
	...
	[USharpPath("/Script/b1-Managed.BANS_OnSpiderSkillEntangleStiffEnded:GSNotifyBeginCS")]
	protected override void GSNotifyBeginCS_Implementation(FUStGSNotifyParam NotifyParam, float TotalDuration)
	{
	}

	[USharpPath("/Script/b1-Managed.BANS_OnSpiderSkillEntangleStiffEnded:GSNotifyTickCS")]
	protected override void GSNotifyTickCS_Implementation(FUStGSNotifyParam NotifyParam, float FrameDeltaTime)
	{
	}

	[USharpPath("/Script/b1-Managed.BANS_OnSpiderSkillEntangleStiffEnded:GSNotifyEndCS")]
	protected override void GSNotifyEndCS_Implementation(FUStGSNotifyParam NotifyParam)
	{
		if (!UBGUFunctionLibraryForCS.BGUGetIsInEditorPreview(NotifyParam.owner))
		{
			BUS_EventCollectionCS.Get(NotifyParam.owner)?.Evt_OnSpiderSkillEntangleStiffEnded.Invoke();
		}
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_OnSpiderSkillEntangleStiffEnded:GSNotifyEndCS")]
	private static void GSNotifyEndCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BANS_OnSpiderSkillEntangleStiffEnded bANS_OnSpiderSkillEntangleStiffEnded = GCHelper.Find<b1.BANS_OnSpiderSkillEntangleStiffEnded>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyEndCS_NotifyParam_Offset));
		bANS_OnSpiderSkillEntangleStiffEnded.GSNotifyEndCS_Implementation(notifyParam);
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_OnSpiderSkillEntangleStiffEnded:GSNotifyTickCS")]
	private static void GSNotifyTickCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		bANS_OnSpiderSkillEntangleStiffEnded.GSNotifyTickCS_Implementation(notifyParam, frameDeltaTime);
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_OnSpiderSkillEntangleStiffEnded:GSNotifyBeginCS")]
	private static void GSNotifyBeginCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BANS_OnSpiderSkillEntangleStiffEnded bANS_OnSpiderSkillEntangleStiffEnded = GCHelper.Find<b1.BANS_OnSpiderSkillEntangleStiffEnded>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyBeginCS_NotifyParam_Offset));
		float totalDuration = BlittableTypeMarshaler<float>.FromNative(IntPtr.Add(buffer, GSNotifyBeginCS_TotalDuration_Offset));
		bANS_OnSpiderSkillEntangleStiffEnded.GSNotifyBeginCS_Implementation(notifyParam, totalDuration);
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BANS_OnSpiderSkillEntangleStiffEnded");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_OnSpiderSkillEntangleStiffEnded:GSNotifyEndCS", GSNotifyEndCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_OnSpiderSkillEntangleStiffEnded:GSNotifyTickCS", GSNotifyTickCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_OnSpiderSkillEntangleStiffEnded:GSNotifyBeginCS", GSNotifyBeginCS_IsValid);
	}

	static BANS_OnSpiderSkillEntangleStiffEnded()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BANS_OnSpiderSkillEntangleStiffEnded)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BANS_OnSpiderSkillEntangleStiffEnded));
	}
}
