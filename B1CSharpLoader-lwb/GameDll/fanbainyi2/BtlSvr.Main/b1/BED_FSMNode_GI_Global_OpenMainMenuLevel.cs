...
[UClass]
[Placeable(true)]
[DisplayName("OpenMainMenuLevel")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_OpenMainMenuLevel")]
public class BED_FSMNode_GI_Global_OpenMainMenuLevel : BED_FSMNode_GI_GlobalBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_OpenMainMenuLevel:AcceptEvents")]
	public TArrayReadWrite<EGI_Global> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Global_OpenMainMenuLevel:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_OpenMainMenuLevel:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_OpenMainMenuLevel:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Global_OpenMainMenuLevel:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Global_OpenMainMenuLevel bED_FSMNode_GI_Global_OpenMainMenuLevel = GCHelper.Find<BED_FSMNode_GI_Global_OpenMainMenuLevel>(obj);
		...
		bED_FSMNode_GI_Global_OpenMainMenuLevel.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Global_OpenMainMenuLevel:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Global_OpenMainMenuLevel bED_FSMNode_GI_Global_OpenMainMenuLevel = GCHelper.Find<BED_FSMNode_GI_Global_OpenMainMenuLevel>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Global_OpenMainMenuLevel.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Global_OpenMainMenuLevel");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Global_OpenMainMenuLevel:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Global_OpenMainMenuLevel:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Global_OpenMainMenuLevel()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Global_OpenMainMenuLevel)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Global_OpenMainMenuLevel));
	}
}
