...
public class FSMState_GI_Global_SubG_GI_Loading_BackToMainMenu : FSMState_GI_Global_SubG_GI_Loading_Base
{
	public override void Init(FSMRuntimeInstance_GI_Global RuntimeInstance, FCalliopeNode Node, object InputParams)
	{
		...
		GI_Global_SubG_GI_Loading_BackToMainMenu gI_Global_SubG_GI_Loading_BackToMainMenu = new GI_Global_SubG_GI_Loading_BackToMainMenu();
		gI_Global_SubG_GI_Loading_BackToMainMenu.MergeFrom(Node.NodeData);
		SubGraphResPath = gI_Global_SubG_GI_Loading_BackToMainMenu.SubGraphAsset;
	}
	...
	{
		base.OwningInstance.TriggerSubGraphEvent(EGI_Global_SubG_GI_Loading_BackToMainMenu_Return.Finish);
	}
