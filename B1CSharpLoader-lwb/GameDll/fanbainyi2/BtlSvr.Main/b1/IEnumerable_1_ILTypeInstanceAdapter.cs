...
{
	public class Adapter : IEnumerable<ILTypeInstance>, IEnumerable, CrossBindingAdaptorType
	{
		private CrossBindingFunctionInfo<IEnumerator<ILTypeInstance>> mGetEnumerator_0 = new CrossBindingFunctionInfo<IEnumerator<ILTypeInstance>>("GetEnumerator");
		...
		public IEnumerator<ILTypeInstance> GetEnumerator()
		{
	...
	public override Type BaseCLRType => typeof(IEnumerable<ILTypeInstance>);
