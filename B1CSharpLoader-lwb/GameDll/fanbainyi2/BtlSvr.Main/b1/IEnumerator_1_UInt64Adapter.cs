...
public class IEnumerator_1_UInt64Adapter : CrossBindingAdaptor
{
	public class Adapter : IEnumerator<ulong>, IDisposable, IEnumerator, CrossBindingAdaptorType
	{
		private CrossBindingFunctionInfo<ulong> mget_Current_0 = new CrossBindingFunctionInfo<ulong>("get_Current");
		...
		public ulong Current => mget_Current_0.Invoke(instance);
	...
	public override Type BaseCLRType => typeof(IEnumerator<ulong>);
