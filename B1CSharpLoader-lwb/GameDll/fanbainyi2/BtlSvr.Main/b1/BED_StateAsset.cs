...
[UClass]
[USharpPath("/Script/b1-Managed.BED_StateAsset")]
public class BED_StateAsset : BED_CalliopeAssetBase
{
	private static bool PhaseBehaviorAsset_IsValid;

	private static int PhaseBehaviorAsset_Offset;
	...
	[EditAnywhere]
	[UProperty]
	[DisplayName("Boss转阶段行为")]
	[USharpPath("/Script/b1-Managed.BED_StateAsset:PhaseBehaviorAsset")]
	public BED_BehaviorAsset PhaseBehaviorAsset
	{
		get
		{
			CheckDestroyed();
			if (!PhaseBehaviorAsset_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_StateAsset:PhaseBehaviorAsset");
				return null;
			}
			return UObjectMarshaler<BED_BehaviorAsset>.FromNative(IntPtr.Add(base.Address, PhaseBehaviorAsset_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				UObjectMarshaler<BED_BehaviorAsset>.ToNative(IntPtr.Add(base.Address, PhaseBehaviorAsset_Offset), value);
			}
		}
	}

	[USharpPath("/Script/b1-Managed.BED_StateAsset:GetViewType")]
	protected override ECalliopeViewType GetViewType_Implementation()
	{
		return ECalliopeViewType.State;
	}

	[USharpPath("/Script/b1-Managed.BED_StateAsset:GetRerouteNodeClass")]
	protected override TSubclassOf<UObject> GetRerouteNodeClass_Implementation()
	{
		return UClass.GetClass<BED_StateNode_Reroute>();
	}

	[USharpPath("/Script/b1-Managed.BED_StateAsset:GetStartNodeClass")]
	protected override TSubclassOf<UObject> GetStartNodeClass_Implementation()
	{
		return UClass.GetClass<BED_StateNode_Initial>();
	}

	[USharpPath("/Script/b1-Managed.BED_StateAsset:GetExtraDefaultInputNodes")]
	...
	[USharpPath("/Script/b1-Managed.BED_StateAsset:GetExtraDefaultOutputNodes")]
	...
	[USharpPath("/Script/b1-Managed.BED_StateAsset:GetRerouteNodeClassInBranchGraph")]
	protected override TSubclassOf<UObject> GetRerouteNodeClassInBranchGraph_Implementation()
	{
		return TSubclassOf<UObject>.Null;
	}

	[USharpPath("/Script/b1-Managed.BED_StateAsset:GetStartNodeClassInBranchGraph")]
	protected override TSubclassOf<UObject> GetStartNodeClassInBranchGraph_Implementation()
	{
		return TSubclassOf<UObject>.Null;
	}

	[USharpPath("/Script/b1-Managed.BED_StateAsset:GetExtraDefaultInputNodesInBranchGraph")]
	...
	[USharpPath("/Script/b1-Managed.BED_StateAsset:GetExtraDefaultOutputNodesInBranchGraph")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_StateAsset:GetViewType")]
	private static void GetViewType__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_StateAsset bED_StateAsset = GCHelper.Find<BED_StateAsset>(obj);
		ECalliopeViewType viewType_Implementation = bED_StateAsset.GetViewType_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_StateAsset:GetStartNodeClass")]
	private static void GetStartNodeClass__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_StateAsset bED_StateAsset = GCHelper.Find<BED_StateAsset>(obj);
		TSubclassOf<UObject> startNodeClass_Implementation = bED_StateAsset.GetStartNodeClass_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_StateAsset:GetRerouteNodeClass")]
	private static void GetRerouteNodeClass__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_StateAsset bED_StateAsset = GCHelper.Find<BED_StateAsset>(obj);
		TSubclassOf<UObject> rerouteNodeClass_Implementation = bED_StateAsset.GetRerouteNodeClass_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_StateAsset:GetExtraDefaultInputNodes")]
	private static void GetExtraDefaultInputNodes__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultInputNodes_Implementation = bED_StateAsset.GetExtraDefaultInputNodes_Implementation(out OutClasses);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_StateAsset:GetExtraDefaultOutputNodes")]
	private static void GetExtraDefaultOutputNodes__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultOutputNodes_Implementation = bED_StateAsset.GetExtraDefaultOutputNodes_Implementation(out OutClasses);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_StateAsset:GetStartNodeClassInBranchGraph")]
	private static void GetStartNodeClassInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_StateAsset bED_StateAsset = GCHelper.Find<BED_StateAsset>(obj);
		TSubclassOf<UObject> startNodeClassInBranchGraph_Implementation = bED_StateAsset.GetStartNodeClassInBranchGraph_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_StateAsset:GetRerouteNodeClassInBranchGraph")]
	private static void GetRerouteNodeClassInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_StateAsset bED_StateAsset = GCHelper.Find<BED_StateAsset>(obj);
		TSubclassOf<UObject> rerouteNodeClassInBranchGraph_Implementation = bED_StateAsset.GetRerouteNodeClassInBranchGraph_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_StateAsset:GetExtraDefaultInputNodesInBranchGraph")]
	private static void GetExtraDefaultInputNodesInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultInputNodesInBranchGraph_Implementation = bED_StateAsset.GetExtraDefaultInputNodesInBranchGraph_Implementation(out OutClasses);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_StateAsset:GetExtraDefaultOutputNodesInBranchGraph")]
	private static void GetExtraDefaultOutputNodesInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultOutputNodesInBranchGraph_Implementation = bED_StateAsset.GetExtraDefaultOutputNodesInBranchGraph_Implementation(out OutClasses);
	...
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_StateAsset");
		PhaseBehaviorAsset_Offset = NativeReflection.GetPropertyOffset(intPtr, "PhaseBehaviorAsset");
		PhaseBehaviorAsset_IsValid = NativeReflection.ValidatePropertyClass(intPtr, "PhaseBehaviorAsset", Classes.FObjectProperty);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_StateAsset:GetViewType", GetViewType_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_StateAsset:GetStartNodeClass", GetStartNodeClass_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_StateAsset:GetRerouteNodeClass", GetRerouteNodeClass_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_StateAsset:GetExtraDefaultInputNodes", GetExtraDefaultInputNodes_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_StateAsset:GetExtraDefaultOutputNodes", GetExtraDefaultOutputNodes_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_StateAsset:GetStartNodeClassInBranchGraph", GetStartNodeClassInBranchGraph_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_StateAsset:GetRerouteNodeClassInBranchGraph", GetRerouteNodeClassInBranchGraph_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_StateAsset:GetExtraDefaultInputNodesInBranchGraph", GetExtraDefaultInputNodesInBranchGraph_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_StateAsset:GetExtraDefaultOutputNodesInBranchGraph", GetExtraDefaultOutputNodesInBranchGraph_IsValid);
	}

	static BED_StateAsset()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_StateAsset)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_StateAsset));
	}
}
