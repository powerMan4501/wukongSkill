...
[UClass]
[DisplayName("ResumePsoCachePrecompile")]
[Placeable(true)]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ResumePsoCachePrecompile")]
public class BED_FSMNode_GI_Loading_ResumePsoCachePrecompile : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ResumePsoCachePrecompile:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_ResumePsoCachePrecompile:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ResumePsoCachePrecompile:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ResumePsoCachePrecompile:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_ResumePsoCachePrecompile:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_ResumePsoCachePrecompile bED_FSMNode_GI_Loading_ResumePsoCachePrecompile = GCHelper.Find<BED_FSMNode_GI_Loading_ResumePsoCachePrecompile>(obj);
		...
		bED_FSMNode_GI_Loading_ResumePsoCachePrecompile.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_ResumePsoCachePrecompile:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_ResumePsoCachePrecompile bED_FSMNode_GI_Loading_ResumePsoCachePrecompile = GCHelper.Find<BED_FSMNode_GI_Loading_ResumePsoCachePrecompile>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_ResumePsoCachePrecompile.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_ResumePsoCachePrecompile");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_ResumePsoCachePrecompile:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_ResumePsoCachePrecompile:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_ResumePsoCachePrecompile()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_ResumePsoCachePrecompile)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_ResumePsoCachePrecompile));
	}
}
