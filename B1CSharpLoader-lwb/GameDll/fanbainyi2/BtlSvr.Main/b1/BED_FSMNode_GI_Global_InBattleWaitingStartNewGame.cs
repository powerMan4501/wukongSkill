...
[UClass]
[Placeable(true)]
[DisplayName("InBattleWaitingStartNewGame")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleWaitingStartNewGame")]
public class BED_FSMNode_GI_Global_InBattleWaitingStartNewGame : BED_FSMNode_GI_GlobalBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleWaitingStartNewGame:AcceptEvents")]
	public TArrayReadWrite<EGI_Global> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleWaitingStartNewGame:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleWaitingStartNewGame:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleWaitingStartNewGame:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleWaitingStartNewGame:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Global_InBattleWaitingStartNewGame bED_FSMNode_GI_Global_InBattleWaitingStartNewGame = GCHelper.Find<BED_FSMNode_GI_Global_InBattleWaitingStartNewGame>(obj);
		...
		bED_FSMNode_GI_Global_InBattleWaitingStartNewGame.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleWaitingStartNewGame:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Global_InBattleWaitingStartNewGame bED_FSMNode_GI_Global_InBattleWaitingStartNewGame = GCHelper.Find<BED_FSMNode_GI_Global_InBattleWaitingStartNewGame>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Global_InBattleWaitingStartNewGame.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleWaitingStartNewGame");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleWaitingStartNewGame:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleWaitingStartNewGame:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Global_InBattleWaitingStartNewGame()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Global_InBattleWaitingStartNewGame)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Global_InBattleWaitingStartNewGame));
	}
}
