...
[UClass]
[Placeable(true)]
[DisplayName("SpawnCharacterForClient")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnCharacterForClient")]
public class BED_FSMNode_GI_Loading_SpawnCharacterForClient : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnCharacterForClient:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnCharacterForClient:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnCharacterForClient:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnCharacterForClient:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnCharacterForClient:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_SpawnCharacterForClient bED_FSMNode_GI_Loading_SpawnCharacterForClient = GCHelper.Find<BED_FSMNode_GI_Loading_SpawnCharacterForClient>(obj);
		...
		bED_FSMNode_GI_Loading_SpawnCharacterForClient.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnCharacterForClient:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_SpawnCharacterForClient bED_FSMNode_GI_Loading_SpawnCharacterForClient = GCHelper.Find<BED_FSMNode_GI_Loading_SpawnCharacterForClient>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_SpawnCharacterForClient.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnCharacterForClient");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnCharacterForClient:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_SpawnCharacterForClient:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_SpawnCharacterForClient()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_SpawnCharacterForClient)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_SpawnCharacterForClient));
	}
}
