...
[UClass]
[DisplayName("Timer")]
[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_Timer")]
public class BED_ProcessStateNode_Timer : BED_ProcessStateNode
{
	...
	[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_Timer:CompletionTime")]
	protected float CompletionTime
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessStateNode_Timer:CompletionTime");
				return 0f;
			}
	...
	[UMeta(MDProp.ClampMin, 0f)]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_Timer:StepTime")]
	protected float StepTime
	{
		get
		{
			...
			if (!StepTime_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_ProcessStateNode_Timer:StepTime");
				return 0f;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_Timer:GetNodeDescriptionInCS")]
	...
	{
		return new ProcessStateCustom_Timer
		{
	...
	{
		return "Process.State.Timer";
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_ProcessStateNode_Timer:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_ProcessStateNode_Timer bED_ProcessStateNode_Timer = GCHelper.Find<BED_ProcessStateNode_Timer>(obj);
		string nodeDescriptionInCS_Implementation = bED_ProcessStateNode_Timer.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_ProcessStateNode_Timer");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ProcessStateNode_Timer:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_ProcessStateNode_Timer()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_ProcessStateNode_Timer)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_ProcessStateNode_Timer));
	}
}
