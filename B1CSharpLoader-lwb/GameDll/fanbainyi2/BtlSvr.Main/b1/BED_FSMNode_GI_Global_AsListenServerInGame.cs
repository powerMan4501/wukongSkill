...
[UClass]
[Placeable(true)]
[DisplayName("AsListenServerInGame")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_AsListenServerInGame")]
public class BED_FSMNode_GI_Global_AsListenServerInGame : BED_FSMNode_GI_GlobalBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_AsListenServerInGame:AcceptEvents")]
	public TArrayReadWrite<EGI_Global> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Global_AsListenServerInGame:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_AsListenServerInGame:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_AsListenServerInGame:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Global_AsListenServerInGame:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Global_AsListenServerInGame bED_FSMNode_GI_Global_AsListenServerInGame = GCHelper.Find<BED_FSMNode_GI_Global_AsListenServerInGame>(obj);
		...
		bED_FSMNode_GI_Global_AsListenServerInGame.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Global_AsListenServerInGame:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Global_AsListenServerInGame bED_FSMNode_GI_Global_AsListenServerInGame = GCHelper.Find<BED_FSMNode_GI_Global_AsListenServerInGame>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Global_AsListenServerInGame.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Global_AsListenServerInGame");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Global_AsListenServerInGame:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Global_AsListenServerInGame:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Global_AsListenServerInGame()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Global_AsListenServerInGame)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Global_AsListenServerInGame));
	}
}
