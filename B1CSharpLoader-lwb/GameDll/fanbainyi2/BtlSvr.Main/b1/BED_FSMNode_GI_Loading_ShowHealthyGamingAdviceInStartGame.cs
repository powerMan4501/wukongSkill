...
[UClass]
[Placeable(true)]
[DisplayName("ShowHealthyGamingAdviceInStartGame")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame")]
public class BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame bED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame = GCHelper.Find<BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame>(obj);
		...
		bED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame bED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame = GCHelper.Find<BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame));
	}
}
