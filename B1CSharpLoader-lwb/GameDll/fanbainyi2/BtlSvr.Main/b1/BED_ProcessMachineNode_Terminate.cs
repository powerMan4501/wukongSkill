...
[DisplayName("Terminate State")]
[UClass]
[NotBlueprintable]
[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Terminate")]
public class BED_ProcessMachineNode_Terminate : BED_ProcessMachineNode
{
	...
	{
		return B1CalliopeDef.ProcessMachineNode.Terminate;
	}

	[USharpPath("/Script/b1-Managed.BED_ProcessMachineNode_Terminate:IsSupportViewType")]
	protected override bool IsSupportViewType_Implementation(ECalliopeViewType InViewType)
	{
		return false;
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_ProcessMachineNode_Terminate:IsSupportViewType")]
	private static void IsSupportViewType__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_ProcessMachineNode_Terminate bED_ProcessMachineNode_Terminate = GCHelper.Find<BED_ProcessMachineNode_Terminate>(obj);
		...
		bool value = bED_ProcessMachineNode_Terminate.IsSupportViewType_Implementation(inViewType);
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BED_ProcessMachineNode_Terminate");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ProcessMachineNode_Terminate:IsSupportViewType", IsSupportViewType_IsValid);
	}

	static BED_ProcessMachineNode_Terminate()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_ProcessMachineNode_Terminate)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_ProcessMachineNode_Terminate));
	}
}
