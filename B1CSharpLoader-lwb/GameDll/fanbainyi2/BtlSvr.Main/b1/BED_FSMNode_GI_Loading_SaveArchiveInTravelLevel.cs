...
[Placeable(true)]
[UClass]
[DisplayName("SaveArchiveInTravelLevel")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel")]
public class BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel bED_FSMNode_GI_Loading_SaveArchiveInTravelLevel = GCHelper.Find<BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel>(obj);
		...
		bED_FSMNode_GI_Loading_SaveArchiveInTravelLevel.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel bED_FSMNode_GI_Loading_SaveArchiveInTravelLevel = GCHelper.Find<BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_SaveArchiveInTravelLevel.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel));
	}
}
