...
[UClass]
[Placeable(true)]
[DisplayName("LockSaveArchiveByTravelLevel")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel")]
public class BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel bED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel = GCHelper.Find<BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel>(obj);
		...
		bED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel bED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel = GCHelper.Find<BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel));
	}
}
