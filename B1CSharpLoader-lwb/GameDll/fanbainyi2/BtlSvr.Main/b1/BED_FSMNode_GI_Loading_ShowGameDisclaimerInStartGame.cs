...
[UClass]
[Placeable(true)]
[DisplayName("ShowGameDisclaimerInStartGame")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame")]
public class BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame bED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame = GCHelper.Find<BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame>(obj);
		...
		bED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame bED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame = GCHelper.Find<BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame));
	}
}
