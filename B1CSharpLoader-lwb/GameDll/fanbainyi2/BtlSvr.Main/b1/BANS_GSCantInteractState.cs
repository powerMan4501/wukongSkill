...
[DisplayName("BANS Cant Interact")]
[UClass]
[USharpPath("/Script/b1-Managed.BANS_GSCantInteractState")]
internal class BANS_GSCantInteractState : BANS_GSBase
{
	...
	[USharpPath("/Script/b1-Managed.BANS_GSCantInteractState:GSNotifyBeginCS")]
	protected override void GSNotifyBeginCS_Implementation(FUStGSNotifyParam NotifyParam, float TotalDuration)
	{
		if (!UBGUFunctionLibraryForCS.BGUGetIsInEditorPreview(NotifyParam.owner))
		{
			BUS_EventCollectionCS.Get(NotifyParam.owner)?.Evt_UnitSetSimpleState.Invoke(EBGUSimpleState.CantInteract);
		}
	}

	[USharpPath("/Script/b1-Managed.BANS_GSCantInteractState:GSNotifyTickCS")]
	protected override void GSNotifyTickCS_Implementation(FUStGSNotifyParam NotifyParam, float FrameDeltaTime)
	{
	}

	[USharpPath("/Script/b1-Managed.BANS_GSCantInteractState:GSNotifyEndCS")]
	protected override void GSNotifyEndCS_Implementation(FUStGSNotifyParam NotifyParam)
	{
		if (!UBGUFunctionLibraryForCS.BGUGetIsInEditorPreview(NotifyParam.owner))
		{
			BUS_EventCollectionCS.Get(NotifyParam.owner)?.Evt_UnitSetSimpleState.Invoke(EBGUSimpleState.CantInteract, IsRemove: true);
		}
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_GSCantInteractState:GSNotifyEndCS")]
	private static void GSNotifyEndCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BANS_GSCantInteractState bANS_GSCantInteractState = GCHelper.Find<b1.BANS_GSCantInteractState>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyEndCS_NotifyParam_Offset));
		bANS_GSCantInteractState.GSNotifyEndCS_Implementation(notifyParam);
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_GSCantInteractState:GSNotifyTickCS")]
	private static void GSNotifyTickCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		bANS_GSCantInteractState.GSNotifyTickCS_Implementation(notifyParam, frameDeltaTime);
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_GSCantInteractState:GSNotifyBeginCS")]
	private static void GSNotifyBeginCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BANS_GSCantInteractState bANS_GSCantInteractState = GCHelper.Find<b1.BANS_GSCantInteractState>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyBeginCS_NotifyParam_Offset));
		float totalDuration = BlittableTypeMarshaler<float>.FromNative(IntPtr.Add(buffer, GSNotifyBeginCS_TotalDuration_Offset));
		bANS_GSCantInteractState.GSNotifyBeginCS_Implementation(notifyParam, totalDuration);
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BANS_GSCantInteractState");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_GSCantInteractState:GSNotifyEndCS", GSNotifyEndCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_GSCantInteractState:GSNotifyTickCS", GSNotifyTickCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_GSCantInteractState:GSNotifyBeginCS", GSNotifyBeginCS_IsValid);
	}

	static BANS_GSCantInteractState()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BANS_GSCantInteractState)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BANS_GSCantInteractState));
	}
}
