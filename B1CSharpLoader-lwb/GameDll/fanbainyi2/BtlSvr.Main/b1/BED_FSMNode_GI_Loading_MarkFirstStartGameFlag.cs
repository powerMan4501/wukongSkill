...
[DisplayName("MarkFirstStartGameFlag")]
[UClass]
[Placeable(true)]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkFirstStartGameFlag")]
public class BED_FSMNode_GI_Loading_MarkFirstStartGameFlag : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkFirstStartGameFlag:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkFirstStartGameFlag:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkFirstStartGameFlag:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkFirstStartGameFlag:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkFirstStartGameFlag:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_MarkFirstStartGameFlag bED_FSMNode_GI_Loading_MarkFirstStartGameFlag = GCHelper.Find<BED_FSMNode_GI_Loading_MarkFirstStartGameFlag>(obj);
		...
		bED_FSMNode_GI_Loading_MarkFirstStartGameFlag.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkFirstStartGameFlag:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_MarkFirstStartGameFlag bED_FSMNode_GI_Loading_MarkFirstStartGameFlag = GCHelper.Find<BED_FSMNode_GI_Loading_MarkFirstStartGameFlag>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_MarkFirstStartGameFlag.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkFirstStartGameFlag");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkFirstStartGameFlag:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_MarkFirstStartGameFlag:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_MarkFirstStartGameFlag()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_MarkFirstStartGameFlag)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_MarkFirstStartGameFlag));
	}
}
