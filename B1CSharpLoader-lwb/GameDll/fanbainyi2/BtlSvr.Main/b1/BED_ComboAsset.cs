...
[UClass]
[USharpPath("/Script/b1-Managed.BED_ComboAsset")]
public class BED_ComboAsset : BED_CalliopeAssetBase
{
	...
	public static List<FName> CommandList { get; set; }

	public static List<FName> OptionalCommandList { get; set; }

	[USharpPath("/Script/b1-Managed.BED_ComboAsset:GetViewType")]
	protected override ECalliopeViewType GetViewType_Implementation()
	{
		return ECalliopeViewType.Combo;
	}

	[USharpPath("/Script/b1-Managed.BED_ComboAsset:GetRerouteNodeClass")]
	protected override TSubclassOf<UObject> GetRerouteNodeClass_Implementation()
	{
		return UClass.GetClass<BED_ComboNode_Reroute>();
	}

	[USharpPath("/Script/b1-Managed.BED_ComboAsset:GetStartNodeClass")]
	protected override TSubclassOf<UObject> GetStartNodeClass_Implementation()
	{
		return UClass.GetClass<BED_ComboNode_Start>();
	}

	[USharpPath("/Script/b1-Managed.BED_ComboAsset:GetExtraDefaultInputNodes")]
	...
	[USharpPath("/Script/b1-Managed.BED_ComboAsset:GetExtraDefaultOutputNodes")]
	...
	[USharpPath("/Script/b1-Managed.BED_ComboAsset:GetRerouteNodeClassInBranchGraph")]
	protected override TSubclassOf<UObject> GetRerouteNodeClassInBranchGraph_Implementation()
	{
		return TSubclassOf<UObject>.Null;
	}

	[USharpPath("/Script/b1-Managed.BED_ComboAsset:GetStartNodeClassInBranchGraph")]
	protected override TSubclassOf<UObject> GetStartNodeClassInBranchGraph_Implementation()
	{
		return TSubclassOf<UObject>.Null;
	}

	[USharpPath("/Script/b1-Managed.BED_ComboAsset:GetExtraDefaultInputNodesInBranchGraph")]
	...
	[USharpPath("/Script/b1-Managed.BED_ComboAsset:GetExtraDefaultOutputNodesInBranchGraph")]
	...
	static BED_ComboAsset()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_ComboAsset)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_ComboAsset));
		CommandList = new List<FName>
		{
			B1ComboEventDef.COMBO_EVENT_ATTACK_LIGHT,
			B1ComboEventDef.COMBO_EVENT_ATTACK_HEAVY,
			B1ComboEventDef.COMBO_EVENT_SPECIAL_CHARGE_START,
			B1ComboEventDef.COMBO_EVENT_ATTACK_LIGHT_FALLING,
			B1ComboEventDef.COMBO_EVENT_ATTACK_HEAVY_FALLING
		};
		OptionalCommandList = new List<FName>
		{
			B1ComboEventDef.COMBO_EVENT_ATTACK_LIGHT_RELEASE,
			B1ComboEventDef.COMBO_EVENT_ATTACK_HEAVY_RELEASE,
			B1ComboEventDef.COMBO_EVENT_SPECIAL_CHARGE_RELEASE,
			B1ComboEventDef.COMBO_EVENT_CHARGE_END,
			B1ComboEventDef.COMBO_EVENT_CHARGE_TIMEOUT,
			B1ComboEventDef.COMBO_EVENT_CHARGE_STAMINAOVER,
			B1ComboEventDef.COMBO_EVENT_MOVE_FORWARD,
			B1ComboEventDef.COMBO_EVENT_MOVE_FORWARD_RELEASE,
			B1ComboEventDef.COMBO_EVENT_PE_LEVELGROWUP
		};
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_ComboAsset:GetViewType")]
	private static void GetViewType__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_ComboAsset bED_ComboAsset = GCHelper.Find<BED_ComboAsset>(obj);
		ECalliopeViewType viewType_Implementation = bED_ComboAsset.GetViewType_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_ComboAsset:GetStartNodeClass")]
	private static void GetStartNodeClass__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_ComboAsset bED_ComboAsset = GCHelper.Find<BED_ComboAsset>(obj);
		TSubclassOf<UObject> startNodeClass_Implementation = bED_ComboAsset.GetStartNodeClass_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_ComboAsset:GetRerouteNodeClass")]
	private static void GetRerouteNodeClass__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_ComboAsset bED_ComboAsset = GCHelper.Find<BED_ComboAsset>(obj);
		TSubclassOf<UObject> rerouteNodeClass_Implementation = bED_ComboAsset.GetRerouteNodeClass_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_ComboAsset:GetExtraDefaultInputNodes")]
	private static void GetExtraDefaultInputNodes__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultInputNodes_Implementation = bED_ComboAsset.GetExtraDefaultInputNodes_Implementation(out OutClasses);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_ComboAsset:GetExtraDefaultOutputNodes")]
	private static void GetExtraDefaultOutputNodes__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultOutputNodes_Implementation = bED_ComboAsset.GetExtraDefaultOutputNodes_Implementation(out OutClasses);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_ComboAsset:GetStartNodeClassInBranchGraph")]
	private static void GetStartNodeClassInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_ComboAsset bED_ComboAsset = GCHelper.Find<BED_ComboAsset>(obj);
		TSubclassOf<UObject> startNodeClassInBranchGraph_Implementation = bED_ComboAsset.GetStartNodeClassInBranchGraph_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_ComboAsset:GetRerouteNodeClassInBranchGraph")]
	private static void GetRerouteNodeClassInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_ComboAsset bED_ComboAsset = GCHelper.Find<BED_ComboAsset>(obj);
		TSubclassOf<UObject> rerouteNodeClassInBranchGraph_Implementation = bED_ComboAsset.GetRerouteNodeClassInBranchGraph_Implementation();
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_ComboAsset:GetExtraDefaultInputNodesInBranchGraph")]
	private static void GetExtraDefaultInputNodesInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultInputNodesInBranchGraph_Implementation = bED_ComboAsset.GetExtraDefaultInputNodesInBranchGraph_Implementation(out OutClasses);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_ComboAsset:GetExtraDefaultOutputNodesInBranchGraph")]
	private static void GetExtraDefaultOutputNodesInBranchGraph__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		int extraDefaultOutputNodesInBranchGraph_Implementation = bED_ComboAsset.GetExtraDefaultOutputNodesInBranchGraph_Implementation(out OutClasses);
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BED_ComboAsset");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ComboAsset:GetViewType", GetViewType_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ComboAsset:GetStartNodeClass", GetStartNodeClass_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ComboAsset:GetRerouteNodeClass", GetRerouteNodeClass_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ComboAsset:GetExtraDefaultInputNodes", GetExtraDefaultInputNodes_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ComboAsset:GetExtraDefaultOutputNodes", GetExtraDefaultOutputNodes_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ComboAsset:GetStartNodeClassInBranchGraph", GetStartNodeClassInBranchGraph_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ComboAsset:GetRerouteNodeClassInBranchGraph", GetRerouteNodeClassInBranchGraph_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ComboAsset:GetExtraDefaultInputNodesInBranchGraph", GetExtraDefaultInputNodesInBranchGraph_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ComboAsset:GetExtraDefaultOutputNodesInBranchGraph", GetExtraDefaultOutputNodesInBranchGraph_IsValid);
	}
}
