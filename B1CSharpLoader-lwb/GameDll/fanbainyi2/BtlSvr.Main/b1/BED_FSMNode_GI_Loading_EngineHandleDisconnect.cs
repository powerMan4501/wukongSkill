...
[Placeable(true)]
[DisplayName("EngineHandleDisconnect")]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_EngineHandleDisconnect")]
public class BED_FSMNode_GI_Loading_EngineHandleDisconnect : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_EngineHandleDisconnect:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_EngineHandleDisconnect:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_EngineHandleDisconnect:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_EngineHandleDisconnect:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_EngineHandleDisconnect:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_EngineHandleDisconnect bED_FSMNode_GI_Loading_EngineHandleDisconnect = GCHelper.Find<BED_FSMNode_GI_Loading_EngineHandleDisconnect>(obj);
		...
		bED_FSMNode_GI_Loading_EngineHandleDisconnect.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_EngineHandleDisconnect:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_EngineHandleDisconnect bED_FSMNode_GI_Loading_EngineHandleDisconnect = GCHelper.Find<BED_FSMNode_GI_Loading_EngineHandleDisconnect>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_EngineHandleDisconnect.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_EngineHandleDisconnect");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_EngineHandleDisconnect:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_EngineHandleDisconnect:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_EngineHandleDisconnect()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_EngineHandleDisconnect)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_EngineHandleDisconnect));
	}
}
