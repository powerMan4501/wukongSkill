...
[DisplayName("BAN_GSItemTeleportTriggerPrepare")]
[UClass]
[USharpPath("/Script/b1-Managed.BAN_GSItemTeleportTriggerPrepare")]
internal class BAN_GSItemTeleportTriggerPrepare : BAN_GSBase
{
	...
	[USharpPath("/Script/b1-Managed.BAN_GSItemTeleportTriggerPrepare:bIsNativeBranchingPointCS")]
	protected override bool bIsNativeBranchingPointCS_Implementation()
	{
		return true;
	}

	[USharpPath("/Script/b1-Managed.BAN_GSItemTeleportTriggerPrepare:GSNotifyCS")]
	protected override void GSNotifyCS_Implementation(FUStGSNotifyParam NotifyParam)
	{
		BUS_GSEventCollection bUS_GSEventCollection = BUS_EventCollectionCS.Get(NotifyParam.owner);
		if (bUS_GSEventCollection != null)
		{
			bUS_GSEventCollection.Evt_GSItemTeleportTriggerPrepare.Invoke();
		}
	}

	[UFunctionInvoker("/Script/b1-Managed.BAN_GSItemTeleportTriggerPrepare:GSNotifyCS")]
	private static void GSNotifyCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BAN_GSItemTeleportTriggerPrepare bAN_GSItemTeleportTriggerPrepare = GCHelper.Find<b1.BAN_GSItemTeleportTriggerPrepare>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyCS_NotifyParam_Offset));
		bAN_GSItemTeleportTriggerPrepare.GSNotifyCS_Implementation(notifyParam);
	}

	[UFunctionInvoker("/Script/b1-Managed.BAN_GSItemTeleportTriggerPrepare:bIsNativeBranchingPointCS")]
	private static void bIsNativeBranchingPointCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BAN_GSItemTeleportTriggerPrepare bAN_GSItemTeleportTriggerPrepare = GCHelper.Find<b1.BAN_GSItemTeleportTriggerPrepare>(obj);
		bool value = bAN_GSItemTeleportTriggerPrepare.bIsNativeBranchingPointCS_Implementation();
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BAN_GSItemTeleportTriggerPrepare");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BAN_GSItemTeleportTriggerPrepare:GSNotifyCS", GSNotifyCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BAN_GSItemTeleportTriggerPrepare:bIsNativeBranchingPointCS", bIsNativeBranchingPointCS_IsValid);
	}

	static BAN_GSItemTeleportTriggerPrepare()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BAN_GSItemTeleportTriggerPrepare)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BAN_GSItemTeleportTriggerPrepare));
	}
}
