...
public class IEnumerator_1_UInt32Adapter : CrossBindingAdaptor
{
	public class Adapter : IEnumerator<uint>, IDisposable, IEnumerator, CrossBindingAdaptorType
	{
		private CrossBindingFunctionInfo<uint> mget_Current_0 = new CrossBindingFunctionInfo<uint>("get_Current");
		...
		public uint Current => mget_Current_0.Invoke(instance);
	...
	public override Type BaseCLRType => typeof(IEnumerator<uint>);
