...
[UClass]
[Placeable(true)]
[DisplayName("InBattleOnLineClient")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineClient")]
public class BED_FSMNode_GI_Global_InBattleOnLineClient : BED_FSMNode_GI_GlobalBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineClient:AcceptEvents")]
	public TArrayReadWrite<EGI_Global> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineClient:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineClient:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineClient:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineClient:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Global_InBattleOnLineClient bED_FSMNode_GI_Global_InBattleOnLineClient = GCHelper.Find<BED_FSMNode_GI_Global_InBattleOnLineClient>(obj);
		...
		bED_FSMNode_GI_Global_InBattleOnLineClient.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineClient:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Global_InBattleOnLineClient bED_FSMNode_GI_Global_InBattleOnLineClient = GCHelper.Find<BED_FSMNode_GI_Global_InBattleOnLineClient>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Global_InBattleOnLineClient.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineClient");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineClient:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Global_InBattleOnLineClient:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Global_InBattleOnLineClient()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Global_InBattleOnLineClient)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Global_InBattleOnLineClient));
	}
}
