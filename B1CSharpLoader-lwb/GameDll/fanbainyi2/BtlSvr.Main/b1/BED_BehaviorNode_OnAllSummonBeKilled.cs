...
[UClass]
[DisplayName("当所有召唤物被杀时")]
[USharpPath("/Script/b1-Managed.BED_BehaviorNode_OnAllSummonBeKilled")]
public class BED_BehaviorNode_OnAllSummonBeKilled : BED_BehaviorNode_ListenerTrigger
{
	...
	private static bool SummonIDList_IsValid;

	private static int SummonIDList_Offset;

	private static FFieldAddress SummonIDList_PropertyAddress;

	private TArrayReadWriteMarshaler<int> SummonIDList_Marshaler;
	...
	[UProperty]
	[BlueprintReadWrite]
	[USharpPath("/Script/b1-Managed.BED_BehaviorNode_OnAllSummonBeKilled:UnitType")]
	public EDetectedUnitType UnitType
	{
		get
		{
			...
			if (!UnitType_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_BehaviorNode_OnAllSummonBeKilled:UnitType");
	...
	[USharpPath("/Script/b1-Managed.BED_BehaviorNode_OnAllSummonBeKilled:SmartUnit")]
	public FGsSmartParam SmartUnit
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_BehaviorNode_OnAllSummonBeKilled:SmartUnit");
	...
	[EditAnywhere]
	[BlueprintReadWrite]
	[DisplayName("SummonIDList")]
	[Tooltip("SummonID, 不是SummonResID, 必须要填SummonID, 不填无效")]
	[USharpPath("/Script/b1-Managed.BED_BehaviorNode_OnAllSummonBeKilled:SummonIDList")]
	public TArrayReadWrite<int> SummonIDList
	{
		get
		{
			CheckDestroyed();
			if (!SummonIDList_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_BehaviorNode_OnAllSummonBeKilled:SummonIDList");
				return null;
			}
			if (SummonIDList_Marshaler == null)
			{
				SummonIDList_Marshaler = new TArrayReadWriteMarshaler<int>(1, SummonIDList_PropertyAddress, CachedMarshalingDelegates<int, BlittableTypeMarshaler<int>>.FromNative, CachedMarshalingDelegates<int, BlittableTypeMarshaler<int>>.ToNative);
			}
			return SummonIDList_Marshaler.FromNative(IntPtr.Add(base.Address, SummonIDList_Offset));
		}
	}

	public override string GetNodeName()
	{
		return B1CalliopeDef.BehaviorNode.OnAllSummonBeKilled;
	}

	public override byte[] GetCustomData()
	{
		BehaviorCustom_OnAllSummonBeKilled behaviorCustom_OnAllSummonBeKilled = new BehaviorCustom_OnAllSummonBeKilled();
		behaviorCustom_OnAllSummonBeKilled.UnitType = (int)UnitType;
		behaviorCustom_OnAllSummonBeKilled.SmartUnitGuid = ConvertGUID_UnitCollection(SmartUnit.ConfigGuid);
		if (SummonIDList.Count > 0)
		{
			int[] array = new int[SummonIDList.Count];
			for (int i = 0; i < SummonIDList.Count; i++)
			{
				array[i] = SummonIDList[i];
			}
			behaviorCustom_OnAllSummonBeKilled.SummonIds.Clear();
			behaviorCustom_OnAllSummonBeKilled.SummonIds.AddRange(array);
		}
		return behaviorCustom_OnAllSummonBeKilled.ToByteArray();
	}

	[USharpPath("/Script/b1-Managed.BED_BehaviorNode_OnAllSummonBeKilled:GetNodeDescriptionInCS")]
	protected override string GetNodeDescriptionInCS_Implementation()
	{
		...
		foreach (int summonID in SummonIDList)
		{
			stringBuilder.AppendLine($"SummonID: {summonID}");
		}
		return stringBuilder.ToString();
	}

	[USharpPath("/Script/b1-Managed.BED_BehaviorNode_OnAllSummonBeKilled:IsSupportViewType")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_BehaviorNode_OnAllSummonBeKilled:IsSupportViewType")]
	private static void IsSupportViewType__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_BehaviorNode_OnAllSummonBeKilled bED_BehaviorNode_OnAllSummonBeKilled = GCHelper.Find<BED_BehaviorNode_OnAllSummonBeKilled>(obj);
		...
		bool value = bED_BehaviorNode_OnAllSummonBeKilled.IsSupportViewType_Implementation(inViewType);
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_BehaviorNode_OnAllSummonBeKilled:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_BehaviorNode_OnAllSummonBeKilled bED_BehaviorNode_OnAllSummonBeKilled = GCHelper.Find<BED_BehaviorNode_OnAllSummonBeKilled>(obj);
		string nodeDescriptionInCS_Implementation = bED_BehaviorNode_OnAllSummonBeKilled.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_BehaviorNode_OnAllSummonBeKilled");
		...
		NativeReflection.GetPropertyRef(ref SummonIDList_PropertyAddress, intPtr, "SummonIDList");
		SummonIDList_Offset = NativeReflection.GetPropertyOffset(intPtr, "SummonIDList");
		SummonIDList_IsValid = NativeReflection.ValidatePropertyClass(intPtr, "SummonIDList", Classes.FArrayProperty);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_BehaviorNode_OnAllSummonBeKilled:IsSupportViewType", IsSupportViewType_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_BehaviorNode_OnAllSummonBeKilled:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_BehaviorNode_OnAllSummonBeKilled()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_BehaviorNode_OnAllSummonBeKilled)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_BehaviorNode_OnAllSummonBeKilled));
	}
}
