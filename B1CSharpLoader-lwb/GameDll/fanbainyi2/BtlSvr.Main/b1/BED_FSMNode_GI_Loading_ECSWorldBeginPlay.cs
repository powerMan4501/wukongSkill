...
[UClass]
[Placeable(true)]
[DisplayName("ECSWorldBeginPlay")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ECSWorldBeginPlay")]
public class BED_FSMNode_GI_Loading_ECSWorldBeginPlay : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ECSWorldBeginPlay:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_ECSWorldBeginPlay:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ECSWorldBeginPlay:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ECSWorldBeginPlay:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_ECSWorldBeginPlay:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_ECSWorldBeginPlay bED_FSMNode_GI_Loading_ECSWorldBeginPlay = GCHelper.Find<BED_FSMNode_GI_Loading_ECSWorldBeginPlay>(obj);
		...
		bED_FSMNode_GI_Loading_ECSWorldBeginPlay.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_ECSWorldBeginPlay:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_ECSWorldBeginPlay bED_FSMNode_GI_Loading_ECSWorldBeginPlay = GCHelper.Find<BED_FSMNode_GI_Loading_ECSWorldBeginPlay>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_ECSWorldBeginPlay.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_ECSWorldBeginPlay");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_ECSWorldBeginPlay:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_ECSWorldBeginPlay:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_ECSWorldBeginPlay()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_ECSWorldBeginPlay)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_ECSWorldBeginPlay));
	}
}
