...
public class BUFFAttrBaseAbsModifyAttr : BUFixFunctionTemplate
{
	public BUFFAttrBaseAbsModifyAttr()
	{
		Type = EFixFunctionType.AttrBaseAbsModifyAttr;
	}
	...
	private void Apply(AActor Caster, AActor Target, int Param1, int Param2, int Param3, int Param4, int Param5, float Param6, out float OutAbs, out float OutMul)
	{
		...
		OutAbs = (valueFromAttrID - (float)Param4) * Param6;
