...
[UClass]
[Placeable(true)]
[DisplayName("WaitLocalPlayerStartPlay")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay")]
public class BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay bED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay = GCHelper.Find<BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay>(obj);
		...
		bED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay bED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay = GCHelper.Find<BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay));
	}
}
