...
[NotBlueprintable]
[UClass]
[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_LogicalOr")]
public class BED_ProcessStateNode_LogicalOr : BED_ProcessStateNode
{
	...
	[USharpPath("/Script/b1-Managed.BED_ProcessStateNode_LogicalOr:CanUserAddInputInCS")]
	...
	{
		return "Process.State.LogicalOr";
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_ProcessStateNode_LogicalOr:CanUserAddInputInCS")]
	private static void CanUserAddInputInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_ProcessStateNode_LogicalOr bED_ProcessStateNode_LogicalOr = GCHelper.Find<BED_ProcessStateNode_LogicalOr>(obj);
		bool value = bED_ProcessStateNode_LogicalOr.CanUserAddInputInCS_Implementation();
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BED_ProcessStateNode_LogicalOr");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_ProcessStateNode_LogicalOr:CanUserAddInputInCS", CanUserAddInputInCS_IsValid);
	}

	static BED_ProcessStateNode_LogicalOr()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_ProcessStateNode_LogicalOr)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_ProcessStateNode_LogicalOr));
	}
}
