...
public class FGuardCondition_UnitActive : FGuardConditionBase
{
	private string UnitGuid { get; set; }

	private IBIC_GlobalActorData GlobalActorData { get; set; }

	public override EGuardConditionType ConditionType => EGuardConditionType.UnitActive;
	...
	{
		UnitGuid = InPsmNodeInstance.ParentInstance.ConvertParamID2StringParam(GuideCondition.UnitGuid);
		return true;
	}
