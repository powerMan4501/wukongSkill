...
[Abstract]
[UClass]
[USharpPath("/Script/b1-Managed.BED_StateNode")]
public class BED_StateNode : BED_CalliopeNodeBae
{
	...
	[USharpPath("/Script/b1-Managed.BED_StateNode:IsSupportViewType")]
	protected override bool IsSupportViewType_Implementation(ECalliopeViewType InViewType)
	{
		return InViewType == ECalliopeViewType.State;
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_StateNode:IsSupportViewType")]
	private static void IsSupportViewType__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_StateNode bED_StateNode = GCHelper.Find<BED_StateNode>(obj);
		...
		bool value = bED_StateNode.IsSupportViewType_Implementation(inViewType);
	...
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BED_StateNode");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_StateNode:IsSupportViewType", IsSupportViewType_IsValid);
	}

	static BED_StateNode()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_StateNode)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_StateNode));
	}
}
