...
[UClass]
[DisplayName("BANS Jump Window")]
[USharpPath("/Script/b1-Managed.BANS_JumpWindow")]
internal class BANS_JumpWindow : BANS_GSBase
{
	...
	[USharpPath("/Script/b1-Managed.BANS_JumpWindow:GSNotifyBeginCS")]
	protected override void GSNotifyBeginCS_Implementation(FUStGSNotifyParam NotifyParam, float TotalDuration)
	{
		if (!UBGUFunctionLibraryForCS.BGUGetIsInEditorPreview(NotifyParam.owner))
		{
			...
			{
				BUS_EventCollectionCS.Get(bGUCharacterCS).Evt_UnitStateTrigger.Invoke(EBUStateTrigger.EnterJumpWindow, 0f);
			}
		}
	}

	[USharpPath("/Script/b1-Managed.BANS_JumpWindow:GSNotifyTickCS")]
	protected override void GSNotifyTickCS_Implementation(FUStGSNotifyParam NotifyParam, float FrameDeltaTime)
	{
	}

	[USharpPath("/Script/b1-Managed.BANS_JumpWindow:GSNotifyEndCS")]
	protected override void GSNotifyEndCS_Implementation(FUStGSNotifyParam NotifyParam)
	{
		if (!UBGUFunctionLibraryForCS.BGUGetIsInEditorPreview(NotifyParam.owner))
		{
			...
			if (bGUCharacterCS != null)
			{
				BUS_EventCollectionCS.Get(bGUCharacterCS).Evt_UnitStateTrigger.Invoke(EBUStateTrigger.ExitJumpWindow, 0f);
			}
		}
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_JumpWindow:GSNotifyEndCS")]
	private static void GSNotifyEndCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BANS_JumpWindow bANS_JumpWindow = GCHelper.Find<b1.BANS_JumpWindow>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyEndCS_NotifyParam_Offset));
		bANS_JumpWindow.GSNotifyEndCS_Implementation(notifyParam);
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_JumpWindow:GSNotifyTickCS")]
	private static void GSNotifyTickCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		...
		bANS_JumpWindow.GSNotifyTickCS_Implementation(notifyParam, frameDeltaTime);
	}

	[UFunctionInvoker("/Script/b1-Managed.BANS_JumpWindow:GSNotifyBeginCS")]
	private static void GSNotifyBeginCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		b1.BANS_JumpWindow bANS_JumpWindow = GCHelper.Find<b1.BANS_JumpWindow>(obj);
		FUStGSNotifyParam notifyParam = FUStGSNotifyParam.FromNative(IntPtr.Add(buffer, GSNotifyBeginCS_NotifyParam_Offset));
		float totalDuration = BlittableTypeMarshaler<float>.FromNative(IntPtr.Add(buffer, GSNotifyBeginCS_TotalDuration_Offset));
		bANS_JumpWindow.GSNotifyBeginCS_Implementation(notifyParam, totalDuration);
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1-Managed.BANS_JumpWindow");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_JumpWindow:GSNotifyEndCS", GSNotifyEndCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_JumpWindow:GSNotifyTickCS", GSNotifyTickCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BANS_JumpWindow:GSNotifyBeginCS", GSNotifyBeginCS_IsValid);
	}

	static BANS_JumpWindow()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.BANS_JumpWindow)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.BANS_JumpWindow));
	}
}
