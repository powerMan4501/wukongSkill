...
[DisplayName("InitCollectionSpawnActorState")]
[Placeable(true)]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitCollectionSpawnActorState")]
public class BED_FSMNode_GI_Loading_InitCollectionSpawnActorState : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitCollectionSpawnActorState:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitCollectionSpawnActorState:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitCollectionSpawnActorState:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitCollectionSpawnActorState:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitCollectionSpawnActorState:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_InitCollectionSpawnActorState bED_FSMNode_GI_Loading_InitCollectionSpawnActorState = GCHelper.Find<BED_FSMNode_GI_Loading_InitCollectionSpawnActorState>(obj);
		...
		bED_FSMNode_GI_Loading_InitCollectionSpawnActorState.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitCollectionSpawnActorState:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_InitCollectionSpawnActorState bED_FSMNode_GI_Loading_InitCollectionSpawnActorState = GCHelper.Find<BED_FSMNode_GI_Loading_InitCollectionSpawnActorState>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_InitCollectionSpawnActorState.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitCollectionSpawnActorState");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitCollectionSpawnActorState:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_InitCollectionSpawnActorState:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_InitCollectionSpawnActorState()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_InitCollectionSpawnActorState)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_InitCollectionSpawnActorState));
	}
}
