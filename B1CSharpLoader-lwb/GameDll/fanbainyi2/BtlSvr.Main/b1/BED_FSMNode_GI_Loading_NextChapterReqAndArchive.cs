...
[DisplayName("NextChapterReqAndArchive")]
[Placeable(true)]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_NextChapterReqAndArchive")]
public class BED_FSMNode_GI_Loading_NextChapterReqAndArchive : BED_FSMNode_GI_LoadingBase
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_NextChapterReqAndArchive:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_NextChapterReqAndArchive:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_NextChapterReqAndArchive:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_NextChapterReqAndArchive:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_NextChapterReqAndArchive:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_NextChapterReqAndArchive bED_FSMNode_GI_Loading_NextChapterReqAndArchive = GCHelper.Find<BED_FSMNode_GI_Loading_NextChapterReqAndArchive>(obj);
		...
		bED_FSMNode_GI_Loading_NextChapterReqAndArchive.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_NextChapterReqAndArchive:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_NextChapterReqAndArchive bED_FSMNode_GI_Loading_NextChapterReqAndArchive = GCHelper.Find<BED_FSMNode_GI_Loading_NextChapterReqAndArchive>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_NextChapterReqAndArchive.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_NextChapterReqAndArchive");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_NextChapterReqAndArchive:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_NextChapterReqAndArchive:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_NextChapterReqAndArchive()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_NextChapterReqAndArchive)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_NextChapterReqAndArchive));
	}
}
