...
[Placeable(true)]
[UClass]
[DisplayName("ChangeGameDefaultMap")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ChangeGameDefaultMap")]
public class BED_FSMNode_GI_Loading_ChangeGameDefaultMap : BED_FSMNode_GI_LoadingBase
{
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ChangeGameDefaultMap:LevelName")]
	private string LevelName
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_ChangeGameDefaultMap:LevelName");
				return null;
			}
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ChangeGameDefaultMap:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_ChangeGameDefaultMap:AcceptEvents");
				return null;
			}
	...
	{
		return new GI_Loading_ChangeGameDefaultMap
		{
			LevelName = LevelName
		}.ToByteArray();
	}

	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ChangeGameDefaultMap:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_ChangeGameDefaultMap:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_ChangeGameDefaultMap:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_ChangeGameDefaultMap bED_FSMNode_GI_Loading_ChangeGameDefaultMap = GCHelper.Find<BED_FSMNode_GI_Loading_ChangeGameDefaultMap>(obj);
		...
		bED_FSMNode_GI_Loading_ChangeGameDefaultMap.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_ChangeGameDefaultMap:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_ChangeGameDefaultMap bED_FSMNode_GI_Loading_ChangeGameDefaultMap = GCHelper.Find<BED_FSMNode_GI_Loading_ChangeGameDefaultMap>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_ChangeGameDefaultMap.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_ChangeGameDefaultMap");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_ChangeGameDefaultMap:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_ChangeGameDefaultMap:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_ChangeGameDefaultMap()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_ChangeGameDefaultMap)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_ChangeGameDefaultMap));
	}
}
