...
public class IEnumerator_1_Int32Adapter : CrossBindingAdaptor
{
	public class Adapter : IEnumerator<int>, IDisposable, IEnumerator, CrossBindingAdaptorType
	{
		private CrossBindingFunctionInfo<int> mget_Current_0 = new CrossBindingFunctionInfo<int>("get_Current");
		...
		public int Current => mget_Current_0.Invoke(instance);
	...
	public override Type BaseCLRType => typeof(IEnumerator<int>);
