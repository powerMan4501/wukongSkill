...
[Placeable(true)]
[DisplayName("PrepareFadeAway")]
[UClass]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PrepareFadeAway")]
public class BED_FSMNode_GI_Loading_PrepareFadeAway : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PrepareFadeAway:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_PrepareFadeAway:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PrepareFadeAway:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_PrepareFadeAway:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_PrepareFadeAway:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_PrepareFadeAway bED_FSMNode_GI_Loading_PrepareFadeAway = GCHelper.Find<BED_FSMNode_GI_Loading_PrepareFadeAway>(obj);
		...
		bED_FSMNode_GI_Loading_PrepareFadeAway.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_PrepareFadeAway:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_PrepareFadeAway bED_FSMNode_GI_Loading_PrepareFadeAway = GCHelper.Find<BED_FSMNode_GI_Loading_PrepareFadeAway>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_PrepareFadeAway.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_PrepareFadeAway");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_PrepareFadeAway:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_PrepareFadeAway:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_PrepareFadeAway()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_PrepareFadeAway)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_PrepareFadeAway));
	}
}
