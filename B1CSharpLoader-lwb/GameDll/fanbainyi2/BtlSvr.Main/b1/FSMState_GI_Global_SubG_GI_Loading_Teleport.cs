...
public class FSMState_GI_Global_SubG_GI_Loading_Teleport : FSMState_GI_Global_SubG_GI_Loading_Base
{
	public override void Init(FSMRuntimeInstance_GI_Global RuntimeInstance, FCalliopeNode Node, object InputParams)
	{
		...
		GI_Global_SubG_GI_Loading_Teleport gI_Global_SubG_GI_Loading_Teleport = new GI_Global_SubG_GI_Loading_Teleport();
		gI_Global_SubG_GI_Loading_Teleport.MergeFrom(Node.NodeData);
		SubGraphResPath = gI_Global_SubG_GI_Loading_Teleport.SubGraphAsset;
	}
	...
	{
		base.OwningInstance.TriggerSubGraphEvent(EGI_Global_SubG_GI_Loading_Teleport_Return.Finish);
	}
