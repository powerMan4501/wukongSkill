...
[UClass]
[DisplayName("OpenLevelDefaultBattle")]
[Placeable(true)]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelDefaultBattle")]
public class BED_FSMNode_GI_Loading_OpenLevelDefaultBattle : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelDefaultBattle:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelDefaultBattle:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelDefaultBattle:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelDefaultBattle:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelDefaultBattle:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_OpenLevelDefaultBattle bED_FSMNode_GI_Loading_OpenLevelDefaultBattle = GCHelper.Find<BED_FSMNode_GI_Loading_OpenLevelDefaultBattle>(obj);
		...
		bED_FSMNode_GI_Loading_OpenLevelDefaultBattle.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelDefaultBattle:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_OpenLevelDefaultBattle bED_FSMNode_GI_Loading_OpenLevelDefaultBattle = GCHelper.Find<BED_FSMNode_GI_Loading_OpenLevelDefaultBattle>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_OpenLevelDefaultBattle.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelDefaultBattle");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelDefaultBattle:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_OpenLevelDefaultBattle:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_OpenLevelDefaultBattle()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_OpenLevelDefaultBattle)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_OpenLevelDefaultBattle));
	}
}
