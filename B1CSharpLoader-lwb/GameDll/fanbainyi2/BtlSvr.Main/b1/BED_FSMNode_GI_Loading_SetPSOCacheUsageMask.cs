...
[UClass]
[Placeable(true)]
[DisplayName("SetPSOCacheUsageMask")]
[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SetPSOCacheUsageMask")]
public class BED_FSMNode_GI_Loading_SetPSOCacheUsageMask : BED_FSMNode_GI_LoadingBase
{
	...
	[UProperty]
	[EditAnywhere]
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SetPSOCacheUsageMask:AcceptEvents")]
	public TArrayReadWrite<EGI_Loading> AcceptEvents
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BED_FSMNode_GI_Loading_SetPSOCacheUsageMask:AcceptEvents");
				return null;
			}
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SetPSOCacheUsageMask:GetNodeDescriptionInCS")]
	...
	[USharpPath("/Script/b1-Managed.BED_FSMNode_GI_Loading_SetPSOCacheUsageMask:PostPropertyChanged")]
	...
	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_SetPSOCacheUsageMask:PostPropertyChanged")]
	private static void PostPropertyChanged__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_SetPSOCacheUsageMask bED_FSMNode_GI_Loading_SetPSOCacheUsageMask = GCHelper.Find<BED_FSMNode_GI_Loading_SetPSOCacheUsageMask>(obj);
		...
		bED_FSMNode_GI_Loading_SetPSOCacheUsageMask.PostPropertyChanged_Implementation(memberName, propertyName);
	}

	[UFunctionInvoker("/Script/b1-Managed.BED_FSMNode_GI_Loading_SetPSOCacheUsageMask:GetNodeDescriptionInCS")]
	private static void GetNodeDescriptionInCS__Invoker(IntPtr buffer, IntPtr obj)
	{
		BED_FSMNode_GI_Loading_SetPSOCacheUsageMask bED_FSMNode_GI_Loading_SetPSOCacheUsageMask = GCHelper.Find<BED_FSMNode_GI_Loading_SetPSOCacheUsageMask>(obj);
		string nodeDescriptionInCS_Implementation = bED_FSMNode_GI_Loading_SetPSOCacheUsageMask.GetNodeDescriptionInCS_Implementation();
		FStringMarshaler.ToNative(IntPtr.Add(buffer, GetNodeDescriptionInCS_ReturnValue_Offset), nodeDescriptionInCS_Implementation);
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.BED_FSMNode_GI_Loading_SetPSOCacheUsageMask");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_SetPSOCacheUsageMask:PostPropertyChanged", PostPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1-Managed.BED_FSMNode_GI_Loading_SetPSOCacheUsageMask:GetNodeDescriptionInCS", GetNodeDescriptionInCS_IsValid);
	}

	static BED_FSMNode_GI_Loading_SetPSOCacheUsageMask()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(BED_FSMNode_GI_Loading_SetPSOCacheUsageMask)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(BED_FSMNode_GI_Loading_SetPSOCacheUsageMask));
	}
}
