...
public class ReadOnlyBossRushRefightRecord
{
	private BossRushRefightRecord mData;
	...
	public ReadOnlyBossRushRefightRecord(BossRushRefightRecord data)
	{
		mData = data;
	}

	public ReadOnlyBossRushRefightRecord Clone()
	{
		return new ReadOnlyBossRushRefightRecord(mData.Clone());
	}

	public BossRushRefightRecord ForceGetRef()
	{
		return mData;
	}

	public BossRushRefightRecord CloneData()
	{
		return mData.Clone();
	}
	...
	{
		builder.Append("<ReadOnlyBossRushRefightRecord>{\n");
