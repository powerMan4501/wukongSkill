...
[Blueprintable]
[BlueprintType]
[USharpPath("/Script/b1-Managed.AutoTest_BYS_Tanglang")]
internal class AutoTest_BYS_Tanglang : b1.AutoQA.AutoTest_Template
{
	...
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.AutoTest_BYS_Tanglang");
	}

	static AutoTest_BYS_Tanglang()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.AutoQA.AutoTest_BYS_Tanglang)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.AutoQA.AutoTest_BYS_Tanglang));
	}
}
