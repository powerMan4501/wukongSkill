...
public class TestState_820EnterMap : AutoTestNodeLib.TestState_Node
{
	...
	public TestState_820EnterMap(UObject WorldContext, int MapID)
	{
	...
	public override AutoTestNodeLib.NodeState OnTick(out string Description, ref Stack<AutoTestNodeLib.TestState_Node> StateStack, float DeltaTime)
	{
		switch (CurrentState)
		{
		case InnerState.Click_BtnLevels:
		{
			UClass uClass = null;
			uClass = BGW_PreloadAssetMgr.Get(WorldContext).TryGetCachedResourceObj<UClass>("WidgetBlueprint'/Game/00Main/UI/BluePrintsV3/820/BI_BtnLevels.BI_BtnLevels_C'", ELoadResourceType.SyncLoadAndCache);
			...
			if (!(uClass == null))
			{
				...
				AutoTestHelperLib.ClickButton(FoundWidgets[MapID - 1]);
