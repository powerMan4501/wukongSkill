...
[Blueprintable]
[UClass]
[USharpPath("/Script/b1-Managed.AutoTest_HFM_HuStone")]
internal class AutoTest_HFM_HuStone : b1.AutoQA.AutoTest_Template
{
	...
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.AutoTest_HFM_HuStone");
	}

	static AutoTest_HFM_HuStone()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.AutoQA.AutoTest_HFM_HuStone)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.AutoQA.AutoTest_HFM_HuStone));
	}
}
