...
[Blueprintable]
[BlueprintType]
[USharpPath("/Script/b1-Managed.AutoTest_PSD_ZiZhuEr")]
internal class AutoTest_PSD_ZiZhuEr : b1.AutoQA.AutoTest_Template
{
	...
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.AutoTest_PSD_ZiZhuEr");
	}

	static AutoTest_PSD_ZiZhuEr()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.AutoQA.AutoTest_PSD_ZiZhuEr)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.AutoQA.AutoTest_PSD_ZiZhuEr));
	}
}
