...
[BlueprintType]
[Blueprintable]
[USharpPath("/Script/b1-Managed.AutoTest_PSD_YouYan")]
internal class AutoTest_PSD_YouYan : b1.AutoQA.AutoTest_Template
{
	...
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.AutoTest_PSD_YouYan");
	}

	static AutoTest_PSD_YouYan()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.AutoQA.AutoTest_PSD_YouYan)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.AutoQA.AutoTest_PSD_YouYan));
	}
}
