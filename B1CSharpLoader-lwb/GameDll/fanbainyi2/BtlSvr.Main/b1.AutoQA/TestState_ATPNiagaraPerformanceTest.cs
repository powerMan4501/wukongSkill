...
public class TestState_ATPNiagaraPerformanceTest : AutoTestNodeLib.TestState_Node
{
	...
	public TestState_ATPNiagaraPerformanceTest(UObject WorldContext, AutoTestHelperLib.BGWDataAsset_TamerListConfig TamerList, bool QuitEditorPerUnit, TArrayReadWrite<int> SkillIDBlackList)
	{
	...
	public override AutoTestNodeLib.NodeState OnTick(out string Description, ref Stack<AutoTestNodeLib.TestState_Node> StateStack, float DeltaTime)
	{
		...
		case InnerState.AddTest:
		{
			...
			list3.Add(new TestState_UnitCastAllSkill(WorldContext, text, isPlayer: false, 0, SkillIDBlackList.ToList()));
			list3.Add(new TestState_TextRecord(WorldContext, CompleteFilePath, text));
			if (QuitEditorPerUnit)
			{
				list3.Add(new AutoTestNodeLib.TestState_ConsoleCommand(WorldContext, "b.QAGenError"));
