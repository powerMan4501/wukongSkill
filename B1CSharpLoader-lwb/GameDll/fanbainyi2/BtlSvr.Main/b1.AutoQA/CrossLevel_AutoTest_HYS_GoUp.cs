...
internal class CrossLevel_AutoTest_HYS_GoUp : b1.AutoQA.CrossLevel_AutoTest_Template
{
	public override string TestLabel => "HYS_6_2_土地阴阳鱼";

	public override float TimeLimit => 1800f;
