...
[UClass]
[BlueprintType]
[USharpPath("/Script/b1-Managed.AutoTest_HFM_ShiXianFeng")]
internal class AutoTest_HFM_ShiXianFeng : b1.AutoQA.AutoTest_Template
{
	...
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1-Managed.AutoTest_HFM_ShiXianFeng");
	}

	static AutoTest_HFM_ShiXianFeng()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.AutoQA.AutoTest_HFM_ShiXianFeng)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.AutoQA.AutoTest_HFM_ShiXianFeng));
	}
}
