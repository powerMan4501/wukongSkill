...
[UClass]
[USharpPath("/Script/b1-Managed.BUI_GMInformationPanel")]
internal class BUI_GMInformationPanel : BUI_Widget
{
	...
	[EditAnywhere]
	[UProperty]
	[USharpPath("/Script/b1-Managed.BUI_GMInformationPanel:InfoTemp")]
	public TSubclassOf<UUserWidget> InfoTemp
	{
		get
		{
			...
			if (!InfoTemp_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1-Managed.BUI_GMInformationPanel:InfoTemp");
	...
	{
		IntPtr unrealStruct = NativeReflection.GetClass("/Script/b1-Managed.BUI_GMInformationPanel");
	...
	static BUI_GMInformationPanel()
	{
		if (UnrealTypes.CanLazyLoadManagedType(typeof(b1.UI.BUI_GMInformationPanel)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(b1.UI.BUI_GMInformationPanel));
	}
}
