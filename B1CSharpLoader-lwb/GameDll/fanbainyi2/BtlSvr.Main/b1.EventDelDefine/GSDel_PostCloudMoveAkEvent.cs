...
public class GSDel_PostCloudMoveAkEvent : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_PostCloudMoveAkEvent operator +(GSDel_PostCloudMoveAkEvent GSEvent, Del_PostCloudMoveAkEvent Del)
	{
	...
	{
		_MultiCastDel?.Invoke(bIsStop, AkEvent);
	}
}
