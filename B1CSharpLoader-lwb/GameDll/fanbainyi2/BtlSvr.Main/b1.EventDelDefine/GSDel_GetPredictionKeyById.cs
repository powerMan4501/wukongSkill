...
public class GSDel_GetPredictionKeyById : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_GetPredictionKeyById operator +(GSDel_GetPredictionKeyById GSEvent, Del_GetPredictionKeyById Del)
	{
