...
public class GSDel_SetTargetInfoWithCameraLocking : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetTargetInfoWithCameraLocking operator +(GSDel_SetTargetInfoWithCameraLocking GSEvent, Del_SetTargetInfoWithCameraLocking Del)
	{
