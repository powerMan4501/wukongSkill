...
public class GSDel_BlockNavigation : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_BlockNavigation operator +(GSDel_BlockNavigation GSEvent, Del_BlockNavigation Del)
	{
	...
	{
		_MultiCastDel?.Invoke(bBlock, Reason);
	}
}
