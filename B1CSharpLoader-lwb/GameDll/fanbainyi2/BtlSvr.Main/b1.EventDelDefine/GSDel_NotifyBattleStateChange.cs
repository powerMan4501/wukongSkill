...
public class GSDel_NotifyBattleStateChange : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_NotifyBattleStateChange operator +(GSDel_NotifyBattleStateChange GSEvent, Del_NotifyBattleStateChange Del)
	{
	...
	{
		_MultiCastDel?.Invoke(bIsIntoBattle);
	}
}
