...
public class GSDel_GetAxisInputAction : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_GetAxisInputAction operator +(GSDel_GetAxisInputAction GSEvent, Del_GetAxisInputAction Del)
	{
