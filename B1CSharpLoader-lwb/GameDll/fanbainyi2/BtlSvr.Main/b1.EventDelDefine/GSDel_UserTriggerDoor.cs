...
public class GSDel_UserTriggerDoor : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_UserTriggerDoor operator +(GSDel_UserTriggerDoor GSEvent, Del_UserTriggerDoor Del)
	{
