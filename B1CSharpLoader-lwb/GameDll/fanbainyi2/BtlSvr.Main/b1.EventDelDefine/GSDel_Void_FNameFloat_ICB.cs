...
public class GSDel_Void_FNameFloat_ICB : IFreshAbleGSEvent
{
	private Del_Void_FNameFloat _InvokeCallBack;

	private Action<Del_Void_FNameFloat> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_FNameFloat_ICB(Del_Void_FNameFloat InvokeCallBack, Action<Del_Void_FNameFloat> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_FNameFloat_ICB operator +(GSDel_Void_FNameFloat_ICB GSEvent, Del_Void_FNameFloat Del)
	{
