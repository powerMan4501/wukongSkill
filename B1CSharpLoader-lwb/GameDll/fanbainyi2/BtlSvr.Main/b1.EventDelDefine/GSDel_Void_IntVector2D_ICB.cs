...
public class GSDel_Void_IntVector2D_ICB : IFreshAbleGSEvent
{
	private Del_Void_IntVector2D _InvokeCallBack;

	private Action<Del_Void_IntVector2D> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_IntVector2D_ICB(Del_Void_IntVector2D InvokeCallBack, Action<Del_Void_IntVector2D> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_IntVector2D_ICB operator +(GSDel_Void_IntVector2D_ICB GSEvent, Del_Void_IntVector2D Del)
	{
