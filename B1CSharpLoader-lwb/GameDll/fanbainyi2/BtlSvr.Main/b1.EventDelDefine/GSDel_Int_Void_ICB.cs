...
public class GSDel_Int_Void_ICB : IFreshAbleGSEvent
{
	private Del_Int_Void _InvokeCallBack;

	private Action<Del_Int_Void> _MultiCastDelChgCallBack;
	...
	public GSDel_Int_Void_ICB(Del_Int_Void InvokeCallBack, Action<Del_Int_Void> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Int_Void_ICB operator +(GSDel_Int_Void_ICB GSEvent, Del_Int_Void Del)
	{
