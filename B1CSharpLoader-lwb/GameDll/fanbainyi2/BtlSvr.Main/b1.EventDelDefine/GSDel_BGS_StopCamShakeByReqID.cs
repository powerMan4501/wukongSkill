...
public class GSDel_BGS_StopCamShakeByReqID : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_BGS_StopCamShakeByReqID operator +(GSDel_BGS_StopCamShakeByReqID GSEvent, Del_BGS_StopCamShakeByReqID Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ReqID, bImmediately);
	}
}
