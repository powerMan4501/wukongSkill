...
public class GSDel_SweepCheckInPreciseDodgeRange : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SweepCheckInPreciseDodgeRange operator +(GSDel_SweepCheckInPreciseDodgeRange GSEvent, Del_SweepCheckInPreciseDodgeRange Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Attacker, MontageID, GroupID, NotifyID, MontageTime);
	}
}
