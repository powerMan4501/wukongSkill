...
public class GSDel_MontageSection : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_MontageSection operator +(GSDel_MontageSection GSEvent, Del_MontageSection Del)
	{
	...
	{
		_MultiCastDel?.Invoke(SectionName);
	}
}
