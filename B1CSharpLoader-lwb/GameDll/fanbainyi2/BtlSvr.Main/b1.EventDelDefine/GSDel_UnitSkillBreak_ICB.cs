...
public class GSDel_UnitSkillBreak_ICB : IFreshAbleGSEvent
{
	private Del_UnitSkillBreak _InvokeCallBack;

	private Action<Del_UnitSkillBreak> _MultiCastDelChgCallBack;
	...
	public GSDel_UnitSkillBreak_ICB(Del_UnitSkillBreak InvokeCallBack, Action<Del_UnitSkillBreak> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_UnitSkillBreak_ICB operator +(GSDel_UnitSkillBreak_ICB GSEvent, Del_UnitSkillBreak Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(SkillID, Reason);
	}
}
