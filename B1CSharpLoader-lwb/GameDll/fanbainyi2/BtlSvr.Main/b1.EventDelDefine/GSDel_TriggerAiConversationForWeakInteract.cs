...
public class GSDel_TriggerAiConversationForWeakInteract : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerAiConversationForWeakInteract operator +(GSDel_TriggerAiConversationForWeakInteract GSEvent, Del_TriggerAiConversationForWeakInteract Del)
	{
	...
	{
		_MultiCastDel?.Invoke(WeakAiInteractGUID, ConversationIDList);
	}
}
