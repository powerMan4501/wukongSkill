...
public class GSDel_BGS_AddCameraShakeWithControl_ICB : IFreshAbleGSEvent
{
	private Del_BGS_AddCameraShakeWithControl _InvokeCallBack;

	private Action<Del_BGS_AddCameraShakeWithControl> _MultiCastDelChgCallBack;
	...
	public GSDel_BGS_AddCameraShakeWithControl_ICB(Del_BGS_AddCameraShakeWithControl InvokeCallBack, Action<Del_BGS_AddCameraShakeWithControl> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_BGS_AddCameraShakeWithControl_ICB operator +(GSDel_BGS_AddCameraShakeWithControl_ICB GSEvent, Del_BGS_AddCameraShakeWithControl Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(CamShakeInst, CamShakeScaleByDistCurve, EpicenterLoc, Override_Duration, EpicenterIsAttach, SocketName, EpicenterOwner, ReqID);
	}
}
