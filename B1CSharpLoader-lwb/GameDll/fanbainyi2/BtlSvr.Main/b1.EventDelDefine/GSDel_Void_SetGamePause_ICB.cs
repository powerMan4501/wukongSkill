...
public class GSDel_Void_SetGamePause_ICB : IFreshAbleGSEvent
{
	private Del_Void_SetGamePause _InvokeCallBack;

	private Action<Del_Void_SetGamePause> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_SetGamePause_ICB(Del_Void_SetGamePause InvokeCallBack, Action<Del_Void_SetGamePause> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_SetGamePause_ICB operator +(GSDel_Void_SetGamePause_ICB GSEvent, Del_Void_SetGamePause Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(PauseGameType, bPause);
	}
}
