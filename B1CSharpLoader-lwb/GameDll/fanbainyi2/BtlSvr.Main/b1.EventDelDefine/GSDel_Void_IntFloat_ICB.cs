...
public class GSDel_Void_IntFloat_ICB : IFreshAbleGSEvent
{
	private Del_Void_IntFloat _InvokeCallBack;

	private Action<Del_Void_IntFloat> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_IntFloat_ICB(Del_Void_IntFloat InvokeCallBack, Action<Del_Void_IntFloat> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_IntFloat_ICB operator +(GSDel_Void_IntFloat_ICB GSEvent, Del_Void_IntFloat Del)
	{
