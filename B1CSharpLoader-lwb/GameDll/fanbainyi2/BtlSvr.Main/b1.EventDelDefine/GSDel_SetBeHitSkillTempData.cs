...
public class GSDel_SetBeHitSkillTempData : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetBeHitSkillTempData operator +(GSDel_SetBeHitSkillTempData GSEvent, Del_SetBeHitSkillTempData Del)
	{
