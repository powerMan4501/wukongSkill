...
public class GSDel_Evt_NotifyUnitTrans_BeforePosses_ICB : IFreshAbleGSEvent
{
	private Del_Evt_NotifyUnitTrans_BeforePosses _InvokeCallBack;

	private Action<Del_Evt_NotifyUnitTrans_BeforePosses> _MultiCastDelChgCallBack;
	...
	public GSDel_Evt_NotifyUnitTrans_BeforePosses_ICB(Del_Evt_NotifyUnitTrans_BeforePosses InvokeCallBack, Action<Del_Evt_NotifyUnitTrans_BeforePosses> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Evt_NotifyUnitTrans_BeforePosses_ICB operator +(GSDel_Evt_NotifyUnitTrans_BeforePosses_ICB GSEvent, Del_Evt_NotifyUnitTrans_BeforePosses Del)
	{
