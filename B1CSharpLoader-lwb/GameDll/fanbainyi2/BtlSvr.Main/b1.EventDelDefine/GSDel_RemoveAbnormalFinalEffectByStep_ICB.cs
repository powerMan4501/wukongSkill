...
public class GSDel_RemoveAbnormalFinalEffectByStep_ICB : IFreshAbleGSEvent
{
	private Del_RemoveAbnormalFinalEffectByStep _InvokeCallBack;

	private Action<Del_RemoveAbnormalFinalEffectByStep> _MultiCastDelChgCallBack;
	...
	public GSDel_RemoveAbnormalFinalEffectByStep_ICB(Del_RemoveAbnormalFinalEffectByStep InvokeCallBack, Action<Del_RemoveAbnormalFinalEffectByStep> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_RemoveAbnormalFinalEffectByStep_ICB operator +(GSDel_RemoveAbnormalFinalEffectByStep_ICB GSEvent, Del_RemoveAbnormalFinalEffectByStep Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(AbnormalType, StepValue);
	}
}
