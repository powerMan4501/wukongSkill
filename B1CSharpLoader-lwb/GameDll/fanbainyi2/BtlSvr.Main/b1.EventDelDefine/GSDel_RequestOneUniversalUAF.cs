...
public class GSDel_RequestOneUniversalUAF : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_RequestOneUniversalUAF operator +(GSDel_RequestOneUniversalUAF GSEvent, Del_RequestOneUniversalUAF Del)
	{
	...
	{
		_MultiCastDel?.Invoke(UniversalDataIndex, Priority);
	}
}
