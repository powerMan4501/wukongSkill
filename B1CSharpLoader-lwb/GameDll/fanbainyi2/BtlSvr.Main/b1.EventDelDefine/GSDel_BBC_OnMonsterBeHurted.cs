...
public class GSDel_BBC_OnMonsterBeHurted : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_BBC_OnMonsterBeHurted operator +(GSDel_BBC_OnMonsterBeHurted GSEvent, Del_BBC_OnMonsterBeHurted Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Dmg, bIsCrit, bIsElemDotDmg);
	}
}
