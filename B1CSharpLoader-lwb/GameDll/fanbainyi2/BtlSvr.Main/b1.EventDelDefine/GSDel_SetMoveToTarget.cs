...
public class GSDel_SetMoveToTarget : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetMoveToTarget operator +(GSDel_SetMoveToTarget GSEvent, Del_SetMoveToTarget Del)
	{
	...
	{
		_MultiCastDel?.Invoke(MoveToTarget, PointLocation, SourceType, SceneCompName, SocketName);
	}
}
