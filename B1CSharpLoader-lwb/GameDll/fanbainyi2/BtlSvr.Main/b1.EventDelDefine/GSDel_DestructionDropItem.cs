...
public class GSDel_DestructionDropItem : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_DestructionDropItem operator +(GSDel_DestructionDropItem GSEvent, Del_DestructionDropItem Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Destruction, DropGroupId, DropDistanceLimit);
	}
}
