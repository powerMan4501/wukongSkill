...
public class GSDel_Void_ReqSpawnAnimals : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Void_ReqSpawnAnimals operator +(GSDel_Void_ReqSpawnAnimals GSEvent, Del_Void_ReqSpawnAnimals Del)
	{
