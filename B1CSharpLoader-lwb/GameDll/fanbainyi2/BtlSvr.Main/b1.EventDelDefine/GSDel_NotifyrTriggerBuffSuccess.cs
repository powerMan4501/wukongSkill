...
public class GSDel_NotifyrTriggerBuffSuccess : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_NotifyrTriggerBuffSuccess operator +(GSDel_NotifyrTriggerBuffSuccess GSEvent, Del_NotifyrTriggerBuffSuccess Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ref EffectInstReq);
	}
}
