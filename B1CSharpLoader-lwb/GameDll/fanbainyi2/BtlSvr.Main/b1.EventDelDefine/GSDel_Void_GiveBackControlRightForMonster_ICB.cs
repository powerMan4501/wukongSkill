...
public class GSDel_Void_GiveBackControlRightForMonster_ICB : IFreshAbleGSEvent
{
	private Del_Void_GiveBackControlRightForMonster _InvokeCallBack;

	private Action<Del_Void_GiveBackControlRightForMonster> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_GiveBackControlRightForMonster_ICB(Del_Void_GiveBackControlRightForMonster InvokeCallBack, Action<Del_Void_GiveBackControlRightForMonster> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_GiveBackControlRightForMonster_ICB operator +(GSDel_Void_GiveBackControlRightForMonster_ICB GSEvent, Del_Void_GiveBackControlRightForMonster Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(Instance, MonsterGuid);
	}
}
