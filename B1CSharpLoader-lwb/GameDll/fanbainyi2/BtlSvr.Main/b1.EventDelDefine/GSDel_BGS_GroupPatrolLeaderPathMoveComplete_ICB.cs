...
public class GSDel_BGS_GroupPatrolLeaderPathMoveComplete_ICB : IFreshAbleGSEvent
{
	private Del_BGS_GroupPatrolLeaderPathMoveComplete _InvokeCallBack;

	private Action<Del_BGS_GroupPatrolLeaderPathMoveComplete> _MultiCastDelChgCallBack;
	...
	public GSDel_BGS_GroupPatrolLeaderPathMoveComplete_ICB(Del_BGS_GroupPatrolLeaderPathMoveComplete InvokeCallBack, Action<Del_BGS_GroupPatrolLeaderPathMoveComplete> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_BGS_GroupPatrolLeaderPathMoveComplete_ICB operator +(GSDel_BGS_GroupPatrolLeaderPathMoveComplete_ICB GSEvent, Del_BGS_GroupPatrolLeaderPathMoveComplete Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(GroupLeaderGuid);
	}
}
