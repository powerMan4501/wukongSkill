...
public class GSDel_Void_Int_IPK_Del : IFreshAbleGSEvent
{
	public delegate void Del_Predict(int P1, GSPredictionKey PredictionKey);
	...
	public static GSDel_Void_Int_IPK_Del operator +(GSDel_Void_Int_IPK_Del GSEvent, Del_Predict Del)
	{
	...
	public void Invoke(int P1, GSPredictionKey PredictionKey = null)
	{
