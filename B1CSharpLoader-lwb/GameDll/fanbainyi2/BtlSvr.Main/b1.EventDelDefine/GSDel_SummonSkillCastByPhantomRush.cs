...
public class GSDel_SummonSkillCastByPhantomRush : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SummonSkillCastByPhantomRush operator +(GSDel_SummonSkillCastByPhantomRush GSEvent, Del_SummonSkillCastByPhantomRush Del)
	{
	...
	{
		_MultiCastDel?.Invoke(SummonID, CBI);
	}
}
