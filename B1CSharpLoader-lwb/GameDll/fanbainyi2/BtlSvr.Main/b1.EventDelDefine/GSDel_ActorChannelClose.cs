...
public class GSDel_ActorChannelClose : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ActorChannelClose operator +(GSDel_ActorChannelClose GSEvent, Del_ActorChannelClose Del)
	{
