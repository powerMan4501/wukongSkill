...
public class GSDel_AbnormalRemoved : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_AbnormalRemoved operator +(GSDel_AbnormalRemoved GSEvent, Del_AbnormalRemoved Del)
	{
