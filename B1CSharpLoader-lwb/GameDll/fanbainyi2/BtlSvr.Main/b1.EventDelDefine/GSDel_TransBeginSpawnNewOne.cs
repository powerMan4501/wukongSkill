...
public class GSDel_TransBeginSpawnNewOne : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TransBeginSpawnNewOne operator +(GSDel_TransBeginSpawnNewOne GSEvent, Del_TransBeginSpawnNewOne Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ToReplaceUnitResID, ToReplaceUnitBornSkillID, EnableBlendViewTarget, TransBeginType);
	}
}
