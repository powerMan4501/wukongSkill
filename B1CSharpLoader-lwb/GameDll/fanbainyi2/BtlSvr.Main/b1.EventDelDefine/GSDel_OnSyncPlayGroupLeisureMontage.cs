...
public class GSDel_OnSyncPlayGroupLeisureMontage : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_OnSyncPlayGroupLeisureMontage operator +(GSDel_OnSyncPlayGroupLeisureMontage GSEvent, Del_OnSyncPlayGroupLeisureMontage Del)
	{
	...
	public float Invoke(AActor Actor, UAnimMontage Montage)
	{
		...
		return _MultiCastDel(Actor, Montage);
	}
}
