...
public class GSDel_OnChangeABP : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_OnChangeABP operator +(GSDel_OnChangeABP GSEvent, Del_OnChangeABP Del)
	{
	...
	{
		_MultiCastDel?.Invoke(NewABPClass);
	}
}
