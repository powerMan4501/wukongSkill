...
public class GSDel_Void_Actor_IPK_Del : IFreshAbleGSEvent
{
	public delegate void Del_Predict(AActor Actor, GSPredictionKey PredictionKey);
	...
	public static GSDel_Void_Actor_IPK_Del operator +(GSDel_Void_Actor_IPK_Del GSEvent, Del_Predict Del)
	{
	...
	public void Invoke(AActor Actor, GSPredictionKey PredictionKey = null)
	{
		_MultiCastDel?.Invoke(Actor, PredictionKey);
	}
}
