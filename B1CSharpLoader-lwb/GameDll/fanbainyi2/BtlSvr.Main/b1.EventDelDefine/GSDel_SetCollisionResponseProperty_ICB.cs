...
public class GSDel_SetCollisionResponseProperty_ICB : IFreshAbleGSEvent
{
	private Del_SetCollisionResponseProperty _InvokeCallBack;

	private Action<Del_SetCollisionResponseProperty> _MultiCastDelChgCallBack;
	...
	public GSDel_SetCollisionResponseProperty_ICB(Del_SetCollisionResponseProperty InvokeCallBack, Action<Del_SetCollisionResponseProperty> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_SetCollisionResponseProperty_ICB operator +(GSDel_SetCollisionResponseProperty_ICB GSEvent, Del_SetCollisionResponseProperty Del)
	{
