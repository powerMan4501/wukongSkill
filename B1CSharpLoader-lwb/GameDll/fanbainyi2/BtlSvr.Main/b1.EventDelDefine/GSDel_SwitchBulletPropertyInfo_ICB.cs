...
public class GSDel_SwitchBulletPropertyInfo_ICB : IFreshAbleGSEvent
{
	private Del_SwitchBulletPropertyInfo _InvokeCallBack;

	private Action<Del_SwitchBulletPropertyInfo> _MultiCastDelChgCallBack;
	...
	public GSDel_SwitchBulletPropertyInfo_ICB(Del_SwitchBulletPropertyInfo InvokeCallBack, Action<Del_SwitchBulletPropertyInfo> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_SwitchBulletPropertyInfo_ICB operator +(GSDel_SwitchBulletPropertyInfo_ICB GSEvent, Del_SwitchBulletPropertyInfo Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(BulletSwitchID);
	}
}
