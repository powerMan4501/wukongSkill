...
public class GSDel_InteractOverrideBegin : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_InteractOverrideBegin operator +(GSDel_InteractOverrideBegin GSEvent, Del_InteractOverrideBegin Del)
	{
	...
	{
		_MultiCastDel?.Invoke(NotifyID, OverrideInfoArr);
	}
}
