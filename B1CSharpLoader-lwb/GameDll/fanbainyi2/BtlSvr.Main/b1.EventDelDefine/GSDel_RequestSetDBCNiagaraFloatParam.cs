...
public class GSDel_RequestSetDBCNiagaraFloatParam : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_RequestSetDBCNiagaraFloatParam operator +(GSDel_RequestSetDBCNiagaraFloatParam GSEvent, Del_RequestSetDBCNiagaraFloatParam Del)
	{
