...
public class GSDel_DecreaseAbnormalAccValue : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_DecreaseAbnormalAccValue operator +(GSDel_DecreaseAbnormalAccValue GSEvent, Del_DecreaseAbnormalAccValue Del)
	{
	...
	{
		_MultiCastDel?.Invoke(AbnormalType, DecreaseValue);
	}
}
