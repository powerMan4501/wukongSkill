...
public class GSDel_SetPlayerCameraCamID : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetPlayerCameraCamID operator +(GSDel_SetPlayerCameraCamID GSEvent, Del_SetPlayerCameraCamID Del)
	{
	...
	{
		_MultiCastDel?.Invoke(CamID, bIsGeneral);
	}
}
