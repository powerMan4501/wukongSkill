...
public class GSDel_TriggerSkillEffectBySkill : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerSkillEffectBySkill operator +(GSDel_TriggerSkillEffectBySkill GSEvent, Del_TriggerSkillEffectBySkill Del)
	{
