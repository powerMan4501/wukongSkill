...
public class GSDel_OnSwitchSelfAssistState_ICB : IFreshAbleGSEvent
{
	private Del_OnSwitchSelfAssistState _InvokeCallBack;

	private Action<Del_OnSwitchSelfAssistState> _MultiCastDelChgCallBack;
	...
	public GSDel_OnSwitchSelfAssistState_ICB(Del_OnSwitchSelfAssistState InvokeCallBack, Action<Del_OnSwitchSelfAssistState> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_OnSwitchSelfAssistState_ICB operator +(GSDel_OnSwitchSelfAssistState_ICB GSEvent, Del_OnSwitchSelfAssistState Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(PartnerAssistState);
	}
}
