...
public class GSDel_ClientInternalReqSpawnDynamicTamer : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ClientInternalReqSpawnDynamicTamer operator +(GSDel_ClientInternalReqSpawnDynamicTamer GSEvent, Del_ClientInternalReqSpawnDynamicTamer Del)
	{
	...
	public string Invoke(TSubclassOf<BUTamerActor> TamerClass, FTransform SpawnWorldTransform, FUnitSpawnInfo UnitSpawnInfo, AActor SpawnTrggerActor)
	{
		...
		return _MultiCastDel(TamerClass, SpawnWorldTransform, UnitSpawnInfo, SpawnTrggerActor);
	}
}
