...
public class GSDel_AttackFeedback : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_AttackFeedback operator +(GSDel_AttackFeedback GSEvent, Del_AttackFeedback Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Victim, AttackSkillID, EffectID, NotifyID, IsAtkRebounding);
	}
}
