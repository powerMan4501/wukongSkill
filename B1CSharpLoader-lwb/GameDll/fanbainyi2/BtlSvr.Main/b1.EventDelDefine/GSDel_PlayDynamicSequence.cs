...
public class GSDel_PlayDynamicSequence : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_PlayDynamicSequence operator +(GSDel_PlayDynamicSequence GSEvent, Del_PlayDynamicSequence Del)
	{
	...
	{
		_MultiCastDel?.Invoke(TargetActor, BoundingBoxTag);
	}
}
