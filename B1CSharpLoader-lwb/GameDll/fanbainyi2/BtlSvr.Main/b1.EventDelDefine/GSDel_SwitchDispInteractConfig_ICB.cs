...
public class GSDel_SwitchDispInteractConfig_ICB : IFreshAbleGSEvent
{
	private Del_SwitchDispInteractConfig _InvokeCallBack;

	private Action<Del_SwitchDispInteractConfig> _MultiCastDelChgCallBack;
	...
	public GSDel_SwitchDispInteractConfig_ICB(Del_SwitchDispInteractConfig InvokeCallBack, Action<Del_SwitchDispInteractConfig> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_SwitchDispInteractConfig_ICB operator +(GSDel_SwitchDispInteractConfig_ICB GSEvent, Del_SwitchDispInteractConfig Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(DispInteractBoneList_New);
	}
}
