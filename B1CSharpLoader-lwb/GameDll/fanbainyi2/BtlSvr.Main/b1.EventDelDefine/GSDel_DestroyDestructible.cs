...
public class GSDel_DestroyDestructible : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_DestroyDestructible operator +(GSDel_DestroyDestructible GSEvent, Del_DestroyDestructible Del)
	{
	...
	{
		_MultiCastDel?.Invoke(HitLocation, ImpulseDir, ImpulseStrength);
	}
}
