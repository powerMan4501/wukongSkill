...
public class GSDel_StartSkillCD : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_StartSkillCD operator +(GSDel_StartSkillCD GSEvent, Del_StartSkillCD Del)
	{
