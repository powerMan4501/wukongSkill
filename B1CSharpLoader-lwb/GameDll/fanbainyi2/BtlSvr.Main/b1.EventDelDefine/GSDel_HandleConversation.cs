...
public class GSDel_HandleConversation : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_HandleConversation operator +(GSDel_HandleConversation GSEvent, Del_HandleConversation Del)
	{
