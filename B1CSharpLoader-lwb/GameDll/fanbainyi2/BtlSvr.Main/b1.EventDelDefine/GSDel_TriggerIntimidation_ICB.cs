...
public class GSDel_TriggerIntimidation_ICB : IFreshAbleGSEvent
{
	private Del_TriggerIntimidation _InvokeCallBack;

	private Action<Del_TriggerIntimidation> _MultiCastDelChgCallBack;
	...
	public GSDel_TriggerIntimidation_ICB(Del_TriggerIntimidation InvokeCallBack, Action<Del_TriggerIntimidation> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_TriggerIntimidation_ICB operator +(GSDel_TriggerIntimidation_ICB GSEvent, Del_TriggerIntimidation Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(StiffLevel, bTriggerByDead);
	}
}
