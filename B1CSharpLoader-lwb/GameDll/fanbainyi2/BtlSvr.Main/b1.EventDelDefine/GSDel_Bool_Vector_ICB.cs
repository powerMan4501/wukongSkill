...
public class GSDel_Bool_Vector_ICB : IFreshAbleGSEvent
{
	private Del_Bool_Vector _InvokeCallBack;

	private Action<Del_Bool_Vector> _MultiCastDelChgCallBack;
	...
	public GSDel_Bool_Vector_ICB(Del_Bool_Vector InvokeCallBack, Action<Del_Bool_Vector> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Bool_Vector_ICB operator +(GSDel_Bool_Vector_ICB GSEvent, Del_Bool_Vector Del)
	{
