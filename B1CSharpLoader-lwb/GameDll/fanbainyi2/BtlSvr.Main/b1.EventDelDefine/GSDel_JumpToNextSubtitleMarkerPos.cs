...
public class GSDel_JumpToNextSubtitleMarkerPos : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_JumpToNextSubtitleMarkerPos operator +(GSDel_JumpToNextSubtitleMarkerPos GSEvent, Del_JumpToNextSubtitleMarkerPos Del)
	{
	...
	{
		_MultiCastDel?.Invoke(InEventName, AkComp, PlayingID);
	}
}
