...
public class GSDel_BulletSimpleCreator : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_BulletSimpleCreator operator +(GSDel_BulletSimpleCreator GSEvent, Del_BulletSimpleCreator Del)
	{
	...
	{
		_MultiCastDel?.Invoke(CreateType, CreatorInfo);
	}
}
