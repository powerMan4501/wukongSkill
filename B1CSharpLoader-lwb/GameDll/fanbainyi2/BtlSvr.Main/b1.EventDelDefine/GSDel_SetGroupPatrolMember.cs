...
public class GSDel_SetGroupPatrolMember : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetGroupPatrolMember operator +(GSDel_SetGroupPatrolMember GSEvent, Del_SetGroupPatrolMember Del)
	{
	...
	{
		_MultiCastDel?.Invoke(GroupLeaderGuid, GroupRelativeLocation, TargetSplinePoint);
	}
}
