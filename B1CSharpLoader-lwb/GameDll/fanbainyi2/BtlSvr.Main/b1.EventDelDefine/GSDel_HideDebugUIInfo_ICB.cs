...
public class GSDel_HideDebugUIInfo_ICB : IFreshAbleGSEvent
{
	private Del_HideDebugUIInfo _InvokeCallBack;

	private Action<Del_HideDebugUIInfo> _MultiCastDelChgCallBack;
	...
	public GSDel_HideDebugUIInfo_ICB(Del_HideDebugUIInfo InvokeCallBack, Action<Del_HideDebugUIInfo> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_HideDebugUIInfo_ICB operator +(GSDel_HideDebugUIInfo_ICB GSEvent, Del_HideDebugUIInfo Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(Name, Column);
	}
}
