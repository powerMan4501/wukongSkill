...
public class GSDel_TriggerHitInPart : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerHitInPart operator +(GSDel_TriggerHitInPart GSEvent, Del_TriggerHitInPart Del)
	{
	...
	{
		_MultiCastDel?.Invoke(PartID, HitHP, HitWeight);
	}
}
