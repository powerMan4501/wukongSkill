...
public class GSDel_CreateTireMark_ICB : IFreshAbleGSEvent
{
	private Del_CreateTireMark _InvokeCallBack;

	private Action<Del_CreateTireMark> _MultiCastDelChgCallBack;
	...
	public GSDel_CreateTireMark_ICB(Del_CreateTireMark InvokeCallBack, Action<Del_CreateTireMark> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_CreateTireMark_ICB operator +(GSDel_CreateTireMark_ICB GSEvent, Del_CreateTireMark Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(NotifyInstID, DecalInst, DecalSize, SocketName, DecalLifeSpan, DelayFadeOutTime, DecalFadeTime);
	}
}
