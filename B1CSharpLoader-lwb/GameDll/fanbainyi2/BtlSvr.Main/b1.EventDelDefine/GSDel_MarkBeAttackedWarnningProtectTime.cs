...
public class GSDel_MarkBeAttackedWarnningProtectTime : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_MarkBeAttackedWarnningProtectTime operator +(GSDel_MarkBeAttackedWarnningProtectTime GSEvent, Del_MarkBeAttackedWarnningProtectTime Del)
	{
	...
	{
		_MultiCastDel?.Invoke(SkillTaskUniqID, ResetTime, GroupResetTime, GroupID, FromInstanceID);
	}
}
