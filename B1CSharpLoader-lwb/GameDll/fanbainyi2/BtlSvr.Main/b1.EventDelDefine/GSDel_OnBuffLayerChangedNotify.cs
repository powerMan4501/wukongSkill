...
public class GSDel_OnBuffLayerChangedNotify : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_OnBuffLayerChangedNotify operator +(GSDel_OnBuffLayerChangedNotify GSEvent, Del_OnBuffLayerChangedNotify Del)
	{
	...
	{
		_MultiCastDel?.Invoke(BuffID, Layer_OldValue, Layer_NewValue);
	}
}
