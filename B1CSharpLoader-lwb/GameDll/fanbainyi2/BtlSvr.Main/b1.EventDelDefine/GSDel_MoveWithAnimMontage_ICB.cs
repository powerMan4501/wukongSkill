...
public class GSDel_MoveWithAnimMontage_ICB : IFreshAbleGSEvent
{
	private Del_MoveWithAnimMontage _InvokeCallBack;

	private Action<Del_MoveWithAnimMontage> _MultiCastDelChgCallBack;
	...
	public GSDel_MoveWithAnimMontage_ICB(Del_MoveWithAnimMontage InvokeCallBack, Action<Del_MoveWithAnimMontage> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_MoveWithAnimMontage_ICB operator +(GSDel_MoveWithAnimMontage_ICB GSEvent, Del_MoveWithAnimMontage Del)
	{
