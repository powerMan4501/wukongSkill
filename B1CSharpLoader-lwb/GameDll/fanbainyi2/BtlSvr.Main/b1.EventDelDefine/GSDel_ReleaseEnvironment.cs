...
public class GSDel_ReleaseEnvironment : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ReleaseEnvironment operator +(GSDel_ReleaseEnvironment GSEvent, Del_ReleaseEnvironment Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Actor, bNeedRollBack);
	}
}
