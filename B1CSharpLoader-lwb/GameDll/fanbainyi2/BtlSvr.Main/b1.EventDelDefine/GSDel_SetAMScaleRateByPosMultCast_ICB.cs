...
public class GSDel_SetAMScaleRateByPosMultCast_ICB : IFreshAbleGSEvent
{
	private Del_SetAMScaleRateByPosMultCast _InvokeCallBack;

	private Action<Del_SetAMScaleRateByPosMultCast> _MultiCastDelChgCallBack;
	...
	public GSDel_SetAMScaleRateByPosMultCast_ICB(Del_SetAMScaleRateByPosMultCast InvokeCallBack, Action<Del_SetAMScaleRateByPosMultCast> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_SetAMScaleRateByPosMultCast_ICB operator +(GSDel_SetAMScaleRateByPosMultCast_ICB GSEvent, Del_SetAMScaleRateByPosMultCast Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(AMScaleType, AMScaleAxis, LandingTraceLength, PureScaleValue, CachedDataID, AttackRangeLimit, DebugMode, TotalDuration, NotifyBeginTime, NotifyEndTime, AMScaleMinRate, AMScaleMaxRate, AMScaleMoveOffset, AMScaleMoveOffsetZ);
	}
}
