...
public class GSDel_AIWallAndCellMoveTo : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_AIWallAndCellMoveTo operator +(GSDel_AIWallAndCellMoveTo GSEvent, Del_AIWallAndCellMoveTo Del)
	{
	...
	{
		_MultiCastDel?.Invoke(TargetLocation, SpeedRateType, TurnSpeed, AcceptableRadius, IncludeSelfRadius);
	}
}
