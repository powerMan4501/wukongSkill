...
public class GSDel_InitAbnormalAttrs : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_InitAbnormalAttrs operator +(GSDel_InitAbnormalAttrs GSEvent, Del_InitAbnormalAttrs Del)
	{
	...
	{
		_MultiCastDel?.Invoke(AbnormalAttrConfig);
	}
}
