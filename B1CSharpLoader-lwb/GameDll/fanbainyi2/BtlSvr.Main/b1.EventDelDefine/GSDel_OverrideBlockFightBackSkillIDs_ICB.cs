...
public class GSDel_OverrideBlockFightBackSkillIDs_ICB : IFreshAbleGSEvent
{
	private Del_OverrideBlockFightBackSkillIDs _InvokeCallBack;

	private Action<Del_OverrideBlockFightBackSkillIDs> _MultiCastDelChgCallBack;
	...
	public GSDel_OverrideBlockFightBackSkillIDs_ICB(Del_OverrideBlockFightBackSkillIDs InvokeCallBack, Action<Del_OverrideBlockFightBackSkillIDs> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_OverrideBlockFightBackSkillIDs_ICB operator +(GSDel_OverrideBlockFightBackSkillIDs_ICB GSEvent, Del_OverrideBlockFightBackSkillIDs Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(NewBlockFightBackSkillIDs);
	}
}
