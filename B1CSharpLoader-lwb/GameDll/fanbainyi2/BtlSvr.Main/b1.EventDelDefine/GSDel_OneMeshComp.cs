...
public class GSDel_OneMeshComp : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_OneMeshComp operator +(GSDel_OneMeshComp GSEvent, Del_OneMeshComp Del)
	{
