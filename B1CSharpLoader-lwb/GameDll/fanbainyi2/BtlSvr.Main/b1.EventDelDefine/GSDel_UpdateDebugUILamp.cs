...
public class GSDel_UpdateDebugUILamp : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_UpdateDebugUILamp operator +(GSDel_UpdateDebugUILamp GSEvent, Del_UpdateDebugUILamp Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Name, Color, Column, ResetTime);
	}
}
