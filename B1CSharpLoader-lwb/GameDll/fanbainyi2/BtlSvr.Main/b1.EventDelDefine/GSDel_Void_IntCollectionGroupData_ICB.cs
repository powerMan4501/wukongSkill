...
public class GSDel_Void_IntCollectionGroupData_ICB : IFreshAbleGSEvent
{
	private Del_Void_IntCollectionGroupData _InvokeCallBack;

	private Action<Del_Void_IntCollectionGroupData> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_IntCollectionGroupData_ICB(Del_Void_IntCollectionGroupData InvokeCallBack, Action<Del_Void_IntCollectionGroupData> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_IntCollectionGroupData_ICB operator +(GSDel_Void_IntCollectionGroupData_ICB GSEvent, Del_Void_IntCollectionGroupData Del)
	{
