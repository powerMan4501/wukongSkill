...
public class GSDel_DragFarCamera : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_DragFarCamera operator +(GSDel_DragFarCamera GSEvent, Del_DragFarCamera Del)
	{
	...
	{
		_MultiCastDel?.Invoke(IsDragFarest, NewMinArmLength, NewMaxArmLength, NewMinSocketZ, NewMaxSocketZ);
	}
}
