...
public class GSDel_RecoveryEnvironment_ICB : IFreshAbleGSEvent
{
	private Del_RecoveryEnvironment _InvokeCallBack;

	private Action<Del_RecoveryEnvironment> _MultiCastDelChgCallBack;
	...
	public GSDel_RecoveryEnvironment_ICB(Del_RecoveryEnvironment InvokeCallBack, Action<Del_RecoveryEnvironment> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_RecoveryEnvironment_ICB operator +(GSDel_RecoveryEnvironment_ICB GSEvent, Del_RecoveryEnvironment Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(EnvType);
	}
}
