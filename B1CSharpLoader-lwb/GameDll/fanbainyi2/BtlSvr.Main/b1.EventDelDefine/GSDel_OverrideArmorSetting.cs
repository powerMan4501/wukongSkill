...
public class GSDel_OverrideArmorSetting : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_OverrideArmorSetting operator +(GSDel_OverrideArmorSetting GSEvent, Del_OverrideArmorSetting Del)
	{
	...
	{
		_MultiCastDel?.Invoke(NewSetting);
	}
}
