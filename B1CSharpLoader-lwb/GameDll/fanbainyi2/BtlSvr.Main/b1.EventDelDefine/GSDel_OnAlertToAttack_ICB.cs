...
public class GSDel_OnAlertToAttack_ICB : IFreshAbleGSEvent
{
	private Del_OnAlertToAttack _InvokeCallBack;

	private Action<Del_OnAlertToAttack> _MultiCastDelChgCallBack;
	...
	public GSDel_OnAlertToAttack_ICB(Del_OnAlertToAttack InvokeCallBack, Action<Del_OnAlertToAttack> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_OnAlertToAttack_ICB operator +(GSDel_OnAlertToAttack_ICB GSEvent, Del_OnAlertToAttack Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(AlertEndBuffID);
	}
}
