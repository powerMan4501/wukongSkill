...
public class GSDel_OnPossessed : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_OnPossessed operator +(GSDel_OnPossessed GSEvent, Del_OnPossessed Del)
	{
	...
	{
		_MultiCastDel?.Invoke(NewController);
	}
}
