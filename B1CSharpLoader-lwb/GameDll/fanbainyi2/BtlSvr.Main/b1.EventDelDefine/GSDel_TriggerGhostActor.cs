...
public class GSDel_TriggerGhostActor : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerGhostActor operator +(GSDel_TriggerGhostActor GSEvent, Del_TriggerGhostActor Del)
	{
	...
	{
		_MultiCastDel?.Invoke(PoseableChr, GhostConfigDataAsset, EffectInstReq, MontageToMapTo);
	}
}
