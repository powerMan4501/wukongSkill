...
public class GSDel_NotifyAiBreakInteractAction : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_NotifyAiBreakInteractAction operator +(GSDel_NotifyAiBreakInteractAction GSEvent, Del_NotifyAiBreakInteractAction Del)
	{
