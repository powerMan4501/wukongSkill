...
public class GSDel_OnProjectileBeHitted : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_OnProjectileBeHitted operator +(GSDel_OnProjectileBeHitted GSEvent, Del_OnProjectileBeHitted Del)
	{
	...
	{
		_MultiCastDel?.Invoke(AttackerActor, HitVEffectID);
	}
}
