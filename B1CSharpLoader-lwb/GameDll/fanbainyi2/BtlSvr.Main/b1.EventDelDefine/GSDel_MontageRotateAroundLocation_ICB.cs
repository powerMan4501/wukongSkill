...
public class GSDel_MontageRotateAroundLocation_ICB : IFreshAbleGSEvent
{
	private Del_MontageRotateAroundLocation _InvokeCallBack;

	private Action<Del_MontageRotateAroundLocation> _MultiCastDelChgCallBack;
	...
	public GSDel_MontageRotateAroundLocation_ICB(Del_MontageRotateAroundLocation InvokeCallBack, Action<Del_MontageRotateAroundLocation> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_MontageRotateAroundLocation_ICB operator +(GSDel_MontageRotateAroundLocation_ICB GSEvent, Del_MontageRotateAroundLocation Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(TargetPos, TurnSpeed, RotateDeflectionAngle, MaxRotateAngle, RotateDirection, bStillRotateWhenAboveMaxRotateAngle, DeadzoneAngle, EnableDebug);
	}
}
