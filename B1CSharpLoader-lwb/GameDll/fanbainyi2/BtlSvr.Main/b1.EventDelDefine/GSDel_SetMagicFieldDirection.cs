...
public class GSDel_SetMagicFieldDirection : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetMagicFieldDirection operator +(GSDel_SetMagicFieldDirection GSEvent, Del_SetMagicFieldDirection Del)
	{
	...
	{
		_MultiCastDel?.Invoke(MagicFieldActor, Usage, in Direction);
	}
}
