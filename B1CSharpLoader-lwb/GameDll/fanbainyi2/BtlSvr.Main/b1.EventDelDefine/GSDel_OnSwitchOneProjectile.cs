...
public class GSDel_OnSwitchOneProjectile : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_OnSwitchOneProjectile operator +(GSDel_OnSwitchOneProjectile GSEvent, Del_OnSwitchOneProjectile Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ProjectileBaseActor, ProjectileSwitchID, SwitchIdx, InnerActor);
	}
}
