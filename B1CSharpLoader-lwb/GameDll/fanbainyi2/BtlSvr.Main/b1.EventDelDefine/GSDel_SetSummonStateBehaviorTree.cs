...
public class GSDel_SetSummonStateBehaviorTree : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetSummonStateBehaviorTree operator +(GSDel_SetSummonStateBehaviorTree GSEvent, Del_SetSummonStateBehaviorTree Del)
	{
