...
public class GSDel_SetRotatorProperty_ICB : IFreshAbleGSEvent
{
	private Del_SetRotatorProperty _InvokeCallBack;

	private Action<Del_SetRotatorProperty> _MultiCastDelChgCallBack;
	...
	public GSDel_SetRotatorProperty_ICB(Del_SetRotatorProperty InvokeCallBack, Action<Del_SetRotatorProperty> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_SetRotatorProperty_ICB operator +(GSDel_SetRotatorProperty_ICB GSEvent, Del_SetRotatorProperty Del)
	{
