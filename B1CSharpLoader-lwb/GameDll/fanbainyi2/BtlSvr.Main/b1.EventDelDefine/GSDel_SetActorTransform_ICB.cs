...
public class GSDel_SetActorTransform_ICB : IFreshAbleGSEvent
{
	private Del_SetActorTransform _InvokeCallBack;

	private Action<Del_SetActorTransform> _MultiCastDelChgCallBack;
	...
	public GSDel_SetActorTransform_ICB(Del_SetActorTransform InvokeCallBack, Action<Del_SetActorTransform> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_SetActorTransform_ICB operator +(GSDel_SetActorTransform_ICB GSEvent, Del_SetActorTransform Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(NewTransform, bSweep, bTeleport);
	}
}
