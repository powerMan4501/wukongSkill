...
public class GSDel_SetMovementInput_ICB : IFreshAbleGSEvent
{
	private Del_SetMovementInput _InvokeCallBack;

	private Action<Del_SetMovementInput> _MultiCastDelChgCallBack;
	...
	public GSDel_SetMovementInput_ICB(Del_SetMovementInput InvokeCallBack, Action<Del_SetMovementInput> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_SetMovementInput_ICB operator +(GSDel_SetMovementInput_ICB GSEvent, Del_SetMovementInput Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(Direction, Value, FromSvr);
	}
}
