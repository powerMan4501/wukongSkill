...
public class GSDel_UnitDeadDropItem_ICB : IFreshAbleGSEvent
{
	private Del_UnitDeadDropItem _InvokeCallBack;

	private Action<Del_UnitDeadDropItem> _MultiCastDelChgCallBack;
	...
	public GSDel_UnitDeadDropItem_ICB(Del_UnitDeadDropItem InvokeCallBack, Action<Del_UnitDeadDropItem> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_UnitDeadDropItem_ICB operator +(GSDel_UnitDeadDropItem_ICB GSEvent, Del_UnitDeadDropItem Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(Victim, Attacker, DeadReason);
	}
}
