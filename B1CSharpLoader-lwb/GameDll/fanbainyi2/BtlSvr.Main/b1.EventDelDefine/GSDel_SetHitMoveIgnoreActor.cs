...
public class GSDel_SetHitMoveIgnoreActor : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetHitMoveIgnoreActor operator +(GSDel_SetHitMoveIgnoreActor GSEvent, Del_SetHitMoveIgnoreActor Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Actor, NeedIgnore);
	}
}
