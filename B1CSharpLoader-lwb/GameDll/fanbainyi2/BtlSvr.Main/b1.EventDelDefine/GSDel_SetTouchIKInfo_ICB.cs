...
public class GSDel_SetTouchIKInfo_ICB : IFreshAbleGSEvent
{
	private Del_SetTouchIKInfo _InvokeCallBack;

	private Action<Del_SetTouchIKInfo> _MultiCastDelChgCallBack;
	...
	public GSDel_SetTouchIKInfo_ICB(Del_SetTouchIKInfo InvokeCallBack, Action<Del_SetTouchIKInfo> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_SetTouchIKInfo_ICB operator +(GSDel_SetTouchIKInfo_ICB GSEvent, Del_SetTouchIKInfo Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(Type, IKOffset, EffectorOffset, Alpha);
	}
}
