...
public class GSDel_BossRushSetPauseTimeTick : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_BossRushSetPauseTimeTick operator +(GSDel_BossRushSetPauseTimeTick GSEvent, Del_BossRushSetPauseTimeTick Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Pause, Time);
	}
}
