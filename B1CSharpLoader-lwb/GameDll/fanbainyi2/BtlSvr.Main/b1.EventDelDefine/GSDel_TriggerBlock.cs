...
public class GSDel_TriggerBlock : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerBlock operator +(GSDel_TriggerBlock GSEvent, Del_TriggerBlock Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Attacker, FromInstanceID, GroupID, NotifyID, MontageTime, HitLevel, HitActionDir);
	}
}
