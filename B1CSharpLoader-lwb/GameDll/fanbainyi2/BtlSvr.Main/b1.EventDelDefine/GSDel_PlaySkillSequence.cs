...
public class GSDel_PlaySkillSequence : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_PlaySkillSequence operator +(GSDel_PlaySkillSequence GSEvent, Del_PlaySkillSequence Del)
	{
	...
	{
		_MultiCastDel?.Invoke(PlaySettings);
	}
}
