...
public class GSDel_MarkAsServant : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_MarkAsServant operator +(GSDel_MarkAsServant GSEvent, Del_MarkAsServant Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ServantInstance);
	}
}
