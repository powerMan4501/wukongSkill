...
public class GSDel_TriggerDeadBlendPhysic : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerDeadBlendPhysic operator +(GSDel_TriggerDeadBlendPhysic GSEvent, Del_TriggerDeadBlendPhysic Del)
	{
	...
	{
		_MultiCastDel?.Invoke(PhysicBlendInfoList, TotalTime, CallDissolveWhenPhysicsFinish, DirectlyTurnIntoRagdoll);
	}
}
