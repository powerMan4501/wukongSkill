...
public class GSDel_InitObjectMoveProperty_ICB : IFreshAbleGSEvent
{
	private Del_InitObjectMoveProperty _InvokeCallBack;

	private Action<Del_InitObjectMoveProperty> _MultiCastDelChgCallBack;
	...
	public GSDel_InitObjectMoveProperty_ICB(Del_InitObjectMoveProperty InvokeCallBack, Action<Del_InitObjectMoveProperty> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_InitObjectMoveProperty_ICB operator +(GSDel_InitObjectMoveProperty_ICB GSEvent, Del_InitObjectMoveProperty Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(ObjActorMoveProperty);
	}
}
