...
public class GSDel_SpawnGhostActor : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SpawnGhostActor operator +(GSDel_SpawnGhostActor GSEvent, Del_SpawnGhostActor Del)
	{
	...
	{
		_MultiCastDel?.Invoke(DataAssetPath, EffectInstReq, MontageToMapTo);
	}
}
