...
public class GSDel_SweepCheckBegin_ICB : IFreshAbleGSEvent
{
	private Del_SweepCheckBegin _InvokeCallBack;

	private Action<Del_SweepCheckBegin> _MultiCastDelChgCallBack;
	...
	public GSDel_SweepCheckBegin_ICB(Del_SweepCheckBegin InvokeCallBack, Action<Del_SweepCheckBegin> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_SweepCheckBegin_ICB operator +(GSDel_SweepCheckBegin_ICB GSEvent, Del_SweepCheckBegin Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(NotifyID, WeaponIndex, SweepCheckShape, EffectIDList, AbnormalStateEffectList, EffectIDListForSceneItem, HitDestructibleActorConfig, HitChrAudioID, HitChrFXWeight, HitCheckConf, CanHitBackBullet, SweepCheckProtectTime, Animation, AtkReboundingAM, LowAtkRebounding, SweepCheckGroupID, FromInstanceID, EffectsWithCondition_Before, EffectsWithCondition_After, NotifyBeginTime);
	}
}
