...
public class GSDel_TriggerBeTaunted : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerBeTaunted operator +(GSDel_TriggerBeTaunted GSEvent, Del_TriggerBeTaunted Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Taunter, IsReMove);
	}
}
