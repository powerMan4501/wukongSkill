...
public class GSDel_UnitDead : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_UnitDead operator +(GSDel_UnitDead GSEvent, Del_UnitDead Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Attacker, DeadReason, DmgID, StiffLevel, BeAttackedAM, EffectInstReq, bIsDotDmg, AbnormalStateType);
	}
}
