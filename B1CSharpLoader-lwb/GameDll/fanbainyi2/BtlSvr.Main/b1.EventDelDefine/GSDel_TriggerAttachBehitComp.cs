...
public class GSDel_TriggerAttachBehitComp : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerAttachBehitComp operator +(GSDel_TriggerAttachBehitComp GSEvent, Del_TriggerAttachBehitComp Del)
	{
	...
	{
		_MultiCastDel?.Invoke(NotifyID, Duration, Strength, HitTransform, HitDiretionRealDir, AttachBoneName);
	}
}
