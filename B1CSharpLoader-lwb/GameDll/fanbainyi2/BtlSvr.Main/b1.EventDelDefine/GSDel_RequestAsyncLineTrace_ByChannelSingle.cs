...
public class GSDel_RequestAsyncLineTrace_ByChannelSingle : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_RequestAsyncLineTrace_ByChannelSingle operator +(GSDel_RequestAsyncLineTrace_ByChannelSingle GSEvent, Del_RequestAsyncLineTrace_ByChannelSingle Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ReqID, Start, End, CollisionChannel, Ingnores, bTraceComplex, _OnLineTraceFinishCallBack, bDebug);
	}
}
