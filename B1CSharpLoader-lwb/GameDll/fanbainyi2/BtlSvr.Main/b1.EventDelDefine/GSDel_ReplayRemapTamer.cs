...
public class GSDel_ReplayRemapTamer : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ReplayRemapTamer operator +(GSDel_ReplayRemapTamer GSEvent, Del_ReplayRemapTamer Del)
	{
	...
	{
		_MultiCastDel?.Invoke(TamerGuid, NetGuid);
	}
}
