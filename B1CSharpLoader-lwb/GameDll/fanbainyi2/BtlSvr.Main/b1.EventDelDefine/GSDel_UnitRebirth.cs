...
public class GSDel_UnitRebirth : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_UnitRebirth operator +(GSDel_UnitRebirth GSEvent, Del_UnitRebirth Del)
	{
	...
	{
		_MultiCastDel?.Invoke(RebirthType);
	}
}
