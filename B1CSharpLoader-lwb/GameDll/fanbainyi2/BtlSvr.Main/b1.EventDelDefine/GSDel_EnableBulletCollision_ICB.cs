...
public class GSDel_EnableBulletCollision_ICB : IFreshAbleGSEvent
{
	private Del_EnableBulletCollision _InvokeCallBack;

	private Action<Del_EnableBulletCollision> _MultiCastDelChgCallBack;
	...
	public GSDel_EnableBulletCollision_ICB(Del_EnableBulletCollision InvokeCallBack, Action<Del_EnableBulletCollision> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_EnableBulletCollision_ICB operator +(GSDel_EnableBulletCollision_ICB GSEvent, Del_EnableBulletCollision Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(Enable, ChanelIDList);
	}
}
