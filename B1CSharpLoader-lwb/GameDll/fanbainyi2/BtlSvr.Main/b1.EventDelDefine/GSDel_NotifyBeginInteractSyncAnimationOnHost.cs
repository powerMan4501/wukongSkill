...
public class GSDel_NotifyBeginInteractSyncAnimationOnHost : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_NotifyBeginInteractSyncAnimationOnHost operator +(GSDel_NotifyBeginInteractSyncAnimationOnHost GSEvent, Del_NotifyBeginInteractSyncAnimationOnHost Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Guest, AttachSocketOnHost, AttachSocketOnDummyMesh, DummyMeshAnimation);
	}
}
