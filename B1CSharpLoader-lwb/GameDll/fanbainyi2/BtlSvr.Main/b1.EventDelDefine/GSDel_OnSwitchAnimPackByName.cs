...
public class GSDel_OnSwitchAnimPackByName : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_OnSwitchAnimPackByName operator +(GSDel_OnSwitchAnimPackByName GSEvent, Del_OnSwitchAnimPackByName Del)
	{
	...
	public bool Invoke(string AnimPackName)
	{
		...
		return _MultiCastDel(AnimPackName);
	}
}
