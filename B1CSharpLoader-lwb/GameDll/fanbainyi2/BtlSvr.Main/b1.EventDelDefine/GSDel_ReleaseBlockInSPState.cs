...
public class GSDel_ReleaseBlockInSPState : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ReleaseBlockInSPState operator +(GSDel_ReleaseBlockInSPState GSEvent, Del_ReleaseBlockInSPState Del)
	{
