...
public class GSDel_TransBackSpawnNewOne_ICB : IFreshAbleGSEvent
{
	private Del_TransBackSpawnNewOne _InvokeCallBack;

	private Action<Del_TransBackSpawnNewOne> _MultiCastDelChgCallBack;
	...
	public GSDel_TransBackSpawnNewOne_ICB(Del_TransBackSpawnNewOne InvokeCallBack, Action<Del_TransBackSpawnNewOne> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_TransBackSpawnNewOne_ICB operator +(GSDel_TransBackSpawnNewOne_ICB GSEvent, Del_TransBackSpawnNewOne Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(ToReplaceUnitResID, ToReplaceUnitBornSkillID, EnableBlendViewTarget, TransEndType);
	}
}
