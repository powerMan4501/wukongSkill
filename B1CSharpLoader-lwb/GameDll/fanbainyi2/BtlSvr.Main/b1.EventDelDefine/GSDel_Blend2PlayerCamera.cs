...
public class GSDel_Blend2PlayerCamera : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Blend2PlayerCamera operator +(GSDel_Blend2PlayerCamera GSEvent, Del_Blend2PlayerCamera Del)
	{
	...
	{
		_MultiCastDel?.Invoke(InCameraBlendOutTime, InCameraBlendOutFunction, InCameraBlendOutFuncExp);
	}
}
