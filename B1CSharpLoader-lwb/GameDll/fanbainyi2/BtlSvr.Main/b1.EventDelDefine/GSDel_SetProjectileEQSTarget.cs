...
public class GSDel_SetProjectileEQSTarget : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetProjectileEQSTarget operator +(GSDel_SetProjectileEQSTarget GSEvent, Del_SetProjectileEQSTarget Del)
	{
