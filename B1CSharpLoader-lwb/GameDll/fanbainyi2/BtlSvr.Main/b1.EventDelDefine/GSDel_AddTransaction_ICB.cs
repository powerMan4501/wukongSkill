...
public class GSDel_AddTransaction_ICB : IFreshAbleGSEvent
{
	private Del_AddTransaction _InvokeCallBack;

	private Action<Del_AddTransaction> _MultiCastDelChgCallBack;
	...
	public GSDel_AddTransaction_ICB(Del_AddTransaction InvokeCallBack, Action<Del_AddTransaction> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_AddTransaction_ICB operator +(GSDel_AddTransaction_ICB GSEvent, Del_AddTransaction Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(Transaction);
	}
}
