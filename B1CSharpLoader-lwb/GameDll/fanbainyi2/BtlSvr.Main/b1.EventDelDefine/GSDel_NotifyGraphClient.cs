...
public class GSDel_NotifyGraphClient : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_NotifyGraphClient operator +(GSDel_NotifyGraphClient GSEvent, Del_NotifyGraphClient Del)
	{
	...
	{
		_MultiCastDel?.Invoke(FinalGuid, NotifyTag);
	}
}
