...
public class GSDel_PoleDrinkStateBegin : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_PoleDrinkStateBegin operator +(GSDel_PoleDrinkStateBegin GSEvent, Del_PoleDrinkStateBegin Del)
	{
	...
	{
		_MultiCastDel?.Invoke(SuccessAM, FailedAM, UseItemAMMapping);
	}
}
