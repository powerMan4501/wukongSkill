...
public class GSDel_CollectReplicateData : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_CollectReplicateData operator +(GSDel_CollectReplicateData GSEvent, Del_CollectReplicateData Del)
	{
	...
	{
		bytes = null;
		_MultiCastDel?.Invoke(ConnectionPtr, OldVersion, out bytes);
	}
}
