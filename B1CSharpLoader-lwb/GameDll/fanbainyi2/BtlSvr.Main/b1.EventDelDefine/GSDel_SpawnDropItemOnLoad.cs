...
public class GSDel_SpawnDropItemOnLoad : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SpawnDropItemOnLoad operator +(GSDel_SpawnDropItemOnLoad GSEvent, Del_SpawnDropItemOnLoad Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ItemID, Transform, ref DropItem);
	}
}
