...
public class GSDel_UpdateDummyMeshInSyncAnimation_ICB : IFreshAbleGSEvent
{
	private Del_UpdateDummyMeshInSyncAnimation _InvokeCallBack;

	private Action<Del_UpdateDummyMeshInSyncAnimation> _MultiCastDelChgCallBack;
	...
	public GSDel_UpdateDummyMeshInSyncAnimation_ICB(Del_UpdateDummyMeshInSyncAnimation InvokeCallBack, Action<Del_UpdateDummyMeshInSyncAnimation> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_UpdateDummyMeshInSyncAnimation_ICB operator +(GSDel_UpdateDummyMeshInSyncAnimation_ICB GSEvent, Del_UpdateDummyMeshInSyncAnimation Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(in AttachSocketOnHost, in AttachSocketOnDummyMesh, DummyMeshAnimation);
	}
}
