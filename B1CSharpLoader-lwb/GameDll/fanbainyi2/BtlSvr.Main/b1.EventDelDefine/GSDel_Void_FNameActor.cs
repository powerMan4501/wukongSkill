...
public class GSDel_Void_FNameActor : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Void_FNameActor operator +(GSDel_Void_FNameActor GSEvent, Del_Void_FNameActor Del)
	{
