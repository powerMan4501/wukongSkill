...
public class GSDel_SetIgnoredMappingTypeMap : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetIgnoredMappingTypeMap operator +(GSDel_SetIgnoredMappingTypeMap GSEvent, Del_SetIgnoredMappingTypeMap Del)
	{
	...
	{
		_MultiCastDel?.Invoke(in IgnorESkillMappingConditionTypeMap);
	}
}
