...
public class GSDel_SetNewConfigDataAsset : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetNewConfigDataAsset operator +(GSDel_SetNewConfigDataAsset GSEvent, Del_SetNewConfigDataAsset Del)
	{
	...
	{
		_MultiCastDel?.Invoke(AreaActor, GroupAIMgrConfigDA, HotZoneConfigDA);
	}
}
