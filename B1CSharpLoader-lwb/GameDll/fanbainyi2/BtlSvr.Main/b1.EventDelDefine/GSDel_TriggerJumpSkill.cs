...
public class GSDel_TriggerJumpSkill : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerJumpSkill operator +(GSDel_TriggerJumpSkill GSEvent, Del_TriggerJumpSkill Del)
	{
	...
	{
		_MultiCastDel?.Invoke(StartJumpDir, CurrentInput);
	}
}
