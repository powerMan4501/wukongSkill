...
public class GSDel_AIPerceptionConfig : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_AIPerceptionConfig operator +(GSDel_AIPerceptionConfig GSEvent, Del_AIPerceptionConfig Del)
	{
