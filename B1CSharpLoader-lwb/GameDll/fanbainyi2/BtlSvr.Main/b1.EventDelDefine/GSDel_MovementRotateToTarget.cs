...
public class GSDel_MovementRotateToTarget : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_MovementRotateToTarget operator +(GSDel_MovementRotateToTarget GSEvent, Del_MovementRotateToTarget Del)
	{
	...
	{
		_MultiCastDel?.Invoke(TargetActor, TurnSpeed);
	}
}
