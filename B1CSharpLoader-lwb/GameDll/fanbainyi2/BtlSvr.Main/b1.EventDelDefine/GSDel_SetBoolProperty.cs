...
public class GSDel_SetBoolProperty : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetBoolProperty operator +(GSDel_SetBoolProperty GSEvent, Del_SetBoolProperty Del)
	{
