...
public class GSDel_ObjectActorBeginMove : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ObjectActorBeginMove operator +(GSDel_ObjectActorBeginMove GSEvent, Del_ObjectActorBeginMove Del)
	{
	...
	{
		_MultiCastDel?.Invoke(BulletOrMagicFieldMoveModeType);
	}
}
