...
public class GSDel_ChangeAttrByEquip_ICB : IFreshAbleGSEvent
{
	private Del_ChangeAttrByEquip _InvokeCallBack;

	private Action<Del_ChangeAttrByEquip> _MultiCastDelChgCallBack;
	...
	public GSDel_ChangeAttrByEquip_ICB(Del_ChangeAttrByEquip InvokeCallBack, Action<Del_ChangeAttrByEquip> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_ChangeAttrByEquip_ICB operator +(GSDel_ChangeAttrByEquip_ICB GSEvent, Del_ChangeAttrByEquip Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(AttrId, Value);
	}
}
