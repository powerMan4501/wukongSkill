...
public class GSDel_TriggerGuideNodeFinishEvent_WithIntParam_ICB : IFreshAbleGSEvent
{
	private Del_TriggerGuideNodeFinishEvent_WithIntParam _InvokeCallBack;

	private Action<Del_TriggerGuideNodeFinishEvent_WithIntParam> _MultiCastDelChgCallBack;
	...
	public GSDel_TriggerGuideNodeFinishEvent_WithIntParam_ICB(Del_TriggerGuideNodeFinishEvent_WithIntParam InvokeCallBack, Action<Del_TriggerGuideNodeFinishEvent_WithIntParam> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_TriggerGuideNodeFinishEvent_WithIntParam_ICB operator +(GSDel_TriggerGuideNodeFinishEvent_WithIntParam_ICB GSEvent, Del_TriggerGuideNodeFinishEvent_WithIntParam Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(FinishType, IntParam);
	}
}
