...
public class GSDel_PerformCutDeath_ICB : IFreshAbleGSEvent
{
	private Del_PerformCutDeath _InvokeCallBack;

	private Action<Del_PerformCutDeath> _MultiCastDelChgCallBack;
	...
	public GSDel_PerformCutDeath_ICB(Del_PerformCutDeath InvokeCallBack, Action<Del_PerformCutDeath> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_PerformCutDeath_ICB operator +(GSDel_PerformCutDeath_ICB GSEvent, Del_PerformCutDeath Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(OriginalChar, DelayClearArmorTime, DelayDestroyActorTime, StiffLevelCauseDead, KillerLocation, UseBoomForce);
	}
}
