...
public class GSDel_ChallengeSuccessDropItem : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ChallengeSuccessDropItem operator +(GSDel_ChallengeSuccessDropItem GSEvent, Del_ChallengeSuccessDropItem Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Player, DropId);
	}
}
