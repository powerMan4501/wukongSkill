...
public class GSDel_UpdateInteractGroup_ICB : IFreshAbleGSEvent
{
	private Del_UpdateInteractGroup _InvokeCallBack;

	private Action<Del_UpdateInteractGroup> _MultiCastDelChgCallBack;
	...
	public GSDel_UpdateInteractGroup_ICB(Del_UpdateInteractGroup InvokeCallBack, Action<Del_UpdateInteractGroup> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_UpdateInteractGroup_ICB operator +(GSDel_UpdateInteractGroup_ICB GSEvent, Del_UpdateInteractGroup Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(GroupID, InteractUnitState);
	}
}
