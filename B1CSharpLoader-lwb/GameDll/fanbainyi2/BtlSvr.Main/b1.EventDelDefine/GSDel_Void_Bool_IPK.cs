...
public class GSDel_Void_Bool_IPK : IFreshAbleGSEvent
{
	public GSDel_Void_Bool_IPK_Del Predict = new GSDel_Void_Bool_IPK_Del();

	public GSDel_Void_Bool_IPK_Del Confirm = new GSDel_Void_Bool_IPK_Del();

	public GSDel_Void_Bool_IPK_Del Cue = new GSDel_Void_Bool_IPK_Del();

	public GSDel_Void_Bool_IPK_Del RollBack = new GSDel_Void_Bool_IPK_Del();
	...
	public GSDel_Void_Bool_IPK(Del_Void_Bool InvokeCallBack)
	{
		_InvokeCallBack = InvokeCallBack;
	}

	public void PredictInvoke(bool P1, GSPredictionKey PredictionKey = null)
	{
	...
	public void ConfirmInvoke(bool P1, GSPredictionKey PredictionKey = null)
	{
		Confirm?.Invoke(P1, PredictionKey);
	}

	public void CueInvoke(bool P1, GSPredictionKey PredictionKey = null)
	{
	...
	public void RollBackInvoke(bool P1, GSPredictionKey PredictionKey = null)
	{
