...
public class GSDel_AttackWarnningCheckBegin : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_AttackWarnningCheckBegin operator +(GSDel_AttackWarnningCheckBegin GSEvent, Del_AttackWarnningCheckBegin Del)
	{
	...
	{
		_MultiCastDel?.Invoke(FromInstanceID, AttackWarningGroupID, NotifyID, WeaponIndex, AttackWarnningCheckShape, FixedLocalOffset, ResultFilterType, HitLevel, HitActionDir, Duration, Animation, NotifyBeginTime);
	}
}
