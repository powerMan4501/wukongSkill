...
public class GSDel_CallPointsRegister : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_CallPointsRegister operator +(GSDel_CallPointsRegister GSEvent, Del_CallPointsRegister Del)
	{
	...
	{
		_MultiCastDel?.Invoke(RequestID, GenType, ExtParam);
	}
}
