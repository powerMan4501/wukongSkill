...
public class GSDel_Void_BoolBoolFloat_ICB : IFreshAbleGSEvent
{
	private Del_Void_BoolBoolFloat _InvokeCallBack;

	private Action<Del_Void_BoolBoolFloat> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_BoolBoolFloat_ICB(Del_Void_BoolBoolFloat InvokeCallBack, Action<Del_Void_BoolBoolFloat> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_BoolBoolFloat_ICB operator +(GSDel_Void_BoolBoolFloat_ICB GSEvent, Del_Void_BoolBoolFloat Del)
	{
