...
public class GSDel_InputTryQTE : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_InputTryQTE operator +(GSDel_InputTryQTE GSEvent, Del_InputTryQTE Del)
	{
	...
	{
		_MultiCastDel?.Invoke(AxisForward, AxisSideways);
	}
}
