...
public class GSDel_EQSObjRun_ICB : IFreshAbleGSEvent
{
	private Del_EQSObjRun _InvokeCallBack;

	private Action<Del_EQSObjRun> _MultiCastDelChgCallBack;
	...
	public GSDel_EQSObjRun_ICB(Del_EQSObjRun InvokeCallBack, Action<Del_EQSObjRun> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_EQSObjRun_ICB operator +(GSDel_EQSObjRun_ICB GSEvent, Del_EQSObjRun Del)
	{
	...
	public int Invoke(UEnvQuery EnvQueryObj, AActor Querier, EBGURunEQSObjReason Reason, FGSEQSExParam _ExParam, Action<List<FVector>, List<float>, FGSEQSExParam, int> CallBack)
	{
		...
		return _InvokeCallBack(EnvQueryObj, Querier, Reason, _ExParam, CallBack);
	}
}
