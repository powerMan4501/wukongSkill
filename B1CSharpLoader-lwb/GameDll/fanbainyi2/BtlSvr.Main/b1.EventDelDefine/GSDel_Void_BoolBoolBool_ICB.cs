...
public class GSDel_Void_BoolBoolBool_ICB : IFreshAbleGSEvent
{
	private Del_Void_BoolBoolBool _InvokeCallBack;

	private Action<Del_Void_BoolBoolBool> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_BoolBoolBool_ICB(Del_Void_BoolBoolBool InvokeCallBack, Action<Del_Void_BoolBoolBool> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_BoolBoolBool_ICB operator +(GSDel_Void_BoolBoolBool_ICB GSEvent, Del_Void_BoolBoolBool Del)
	{
