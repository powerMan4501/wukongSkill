...
public class GSDel_Void_OutIntInt_ICB : IFreshAbleGSEvent
{
	private Del_Void_OutIntInt _InvokeCallBack;

	private Action<Del_Void_OutIntInt> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_OutIntInt_ICB(Del_Void_OutIntInt InvokeCallBack, Action<Del_Void_OutIntInt> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_OutIntInt_ICB operator +(GSDel_Void_OutIntInt_ICB GSEvent, Del_Void_OutIntInt Del)
	{
	...
	public void Invoke(out int P1, out int P2)
	{
		P1 = 0;
		P2 = 0;
		_InvokeCallBack?.Invoke(out P1, out P2);
	}
}
