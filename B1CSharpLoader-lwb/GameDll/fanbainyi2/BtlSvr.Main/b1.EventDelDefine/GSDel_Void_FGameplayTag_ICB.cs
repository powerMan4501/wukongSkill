...
public class GSDel_Void_FGameplayTag_ICB : IFreshAbleGSEvent
{
	private Del_Void_FGameplayTag _InvokeCallBack;

	private Action<Del_Void_FGameplayTag> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_FGameplayTag_ICB(Del_Void_FGameplayTag InvokeCallBack, Action<Del_Void_FGameplayTag> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_FGameplayTag_ICB operator +(GSDel_Void_FGameplayTag_ICB GSEvent, Del_Void_FGameplayTag Del)
	{
