...
public class GSDel_Void_BoolString : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Void_BoolString operator +(GSDel_Void_BoolString GSEvent, Del_Void_BoolString Del)
	{
