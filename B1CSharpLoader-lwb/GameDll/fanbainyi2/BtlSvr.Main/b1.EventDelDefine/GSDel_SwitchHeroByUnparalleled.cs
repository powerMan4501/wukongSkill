...
public class GSDel_SwitchHeroByUnparalleled : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SwitchHeroByUnparalleled operator +(GSDel_SwitchHeroByUnparalleled GSEvent, Del_SwitchHeroByUnparalleled Del)
	{
	...
	{
		_MultiCastDel?.Invoke(EnityId, CastSkill);
	}
}
