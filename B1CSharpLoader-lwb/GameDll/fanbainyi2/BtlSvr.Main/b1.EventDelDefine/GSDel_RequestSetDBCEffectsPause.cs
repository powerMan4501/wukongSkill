...
public class GSDel_RequestSetDBCEffectsPause : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_RequestSetDBCEffectsPause operator +(GSDel_RequestSetDBCEffectsPause GSEvent, Del_RequestSetDBCEffectsPause Del)
	{
	...
	{
		_MultiCastDel?.Invoke(IdentityID, Pause, PausePriority);
	}
}
