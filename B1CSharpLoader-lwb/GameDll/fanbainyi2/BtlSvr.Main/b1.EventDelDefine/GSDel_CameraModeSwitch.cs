...
public class GSDel_CameraModeSwitch : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_CameraModeSwitch operator +(GSDel_CameraModeSwitch GSEvent, Del_CameraModeSwitch Del)
	{
	...
	{
		_MultiCastDel?.Invoke(CameraMode);
	}
}
