...
public class GSDel_RequestSmartCastSkill : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_RequestSmartCastSkill operator +(GSDel_RequestSmartCastSkill GSEvent, Del_RequestSmartCastSkill Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ID, RuleIDList, Reason, bNeedCheckSkillCanCast, SourceType);
	}
}
