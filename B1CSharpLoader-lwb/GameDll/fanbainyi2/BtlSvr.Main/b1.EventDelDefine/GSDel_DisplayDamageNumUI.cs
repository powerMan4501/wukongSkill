...
public class GSDel_DisplayDamageNumUI : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_DisplayDamageNumUI operator +(GSDel_DisplayDamageNumUI GSEvent, Del_DisplayDamageNumUI Del)
	{
	...
	{
		_MultiCastDel?.Invoke(DamageNumber, DamageType, HitLocation, AnimNeedFast);
	}
}
