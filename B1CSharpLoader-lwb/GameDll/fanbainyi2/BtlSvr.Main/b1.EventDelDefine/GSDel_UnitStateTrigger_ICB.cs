...
public class GSDel_UnitStateTrigger_ICB : IFreshAbleGSEvent
{
	private Del_UnitStateTrigger _InvokeCallBack;

	private Action<Del_UnitStateTrigger> _MultiCastDelChgCallBack;
	...
	public GSDel_UnitStateTrigger_ICB(Del_UnitStateTrigger InvokeCallBack, Action<Del_UnitStateTrigger> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_UnitStateTrigger_ICB operator +(GSDel_UnitStateTrigger_ICB GSEvent, Del_UnitStateTrigger Del)
	{
