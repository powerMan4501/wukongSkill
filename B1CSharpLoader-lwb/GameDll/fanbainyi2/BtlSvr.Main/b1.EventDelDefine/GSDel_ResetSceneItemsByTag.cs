...
public class GSDel_ResetSceneItemsByTag : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ResetSceneItemsByTag operator +(GSDel_ResetSceneItemsByTag GSEvent, Del_ResetSceneItemsByTag Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ActorTags);
	}
}
