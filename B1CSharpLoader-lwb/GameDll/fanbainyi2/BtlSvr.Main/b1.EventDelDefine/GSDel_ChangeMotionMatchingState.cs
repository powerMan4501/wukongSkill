...
public class GSDel_ChangeMotionMatchingState : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ChangeMotionMatchingState operator +(GSDel_ChangeMotionMatchingState GSEvent, Del_ChangeMotionMatchingState Del)
	{
