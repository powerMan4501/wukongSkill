...
public class GSDel_SetPlayerLocomotionLockMoveDirection : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetPlayerLocomotionLockMoveDirection operator +(GSDel_SetPlayerLocomotionLockMoveDirection GSEvent, Del_SetPlayerLocomotionLockMoveDirection Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Direction);
	}
}
