...
public class GSDel_Void_PlayerCameraParam_ICB : IFreshAbleGSEvent
{
	private Del_Void_PlayerCameraParam _InvokeCallBack;

	private Action<Del_Void_PlayerCameraParam> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_PlayerCameraParam_ICB(Del_Void_PlayerCameraParam InvokeCallBack, Action<Del_Void_PlayerCameraParam> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_PlayerCameraParam_ICB operator +(GSDel_Void_PlayerCameraParam_ICB GSEvent, Del_Void_PlayerCameraParam Del)
	{
