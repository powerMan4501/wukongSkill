...
public class GSDel_PocessEventByContentIDList_ByGuid_ICB : IFreshAbleGSEvent
{
	private Del_PocessEventByContentIDList_ByGuid _InvokeCallBack;

	private Action<Del_PocessEventByContentIDList_ByGuid> _MultiCastDelChgCallBack;
	...
	public GSDel_PocessEventByContentIDList_ByGuid_ICB(Del_PocessEventByContentIDList_ByGuid InvokeCallBack, Action<Del_PocessEventByContentIDList_ByGuid> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_PocessEventByContentIDList_ByGuid_ICB operator +(GSDel_PocessEventByContentIDList_ByGuid_ICB GSEvent, Del_PocessEventByContentIDList_ByGuid Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(SourceLog, UnitGuid, ConversationContentIDList, ConversationChain_RootID);
	}
}
