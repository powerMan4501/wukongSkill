...
public class GSDel_UnitCastSkillTry_ICB : IFreshAbleGSEvent
{
	private Del_UnitCastSkillTry _InvokeCallBack;

	private Action<Del_UnitCastSkillTry> _MultiCastDelChgCallBack;
	...
	public GSDel_UnitCastSkillTry_ICB(Del_UnitCastSkillTry InvokeCallBack, Action<Del_UnitCastSkillTry> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_UnitCastSkillTry_ICB operator +(GSDel_UnitCastSkillTry_ICB GSEvent, Del_UnitCastSkillTry Del)
	{
