...
public class GSDel_PlayerTransBegin : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_PlayerTransBegin operator +(GSDel_PlayerTransBegin GSEvent, Del_PlayerTransBegin Del)
	{
