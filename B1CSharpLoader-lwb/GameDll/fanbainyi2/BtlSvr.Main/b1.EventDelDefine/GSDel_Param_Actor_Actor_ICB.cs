...
public class GSDel_Param_Actor_Actor_ICB : IFreshAbleGSEvent
{
	private Del_Param_Actor_Actor _InvokeCallBack;

	private Action<Del_Param_Actor_Actor> _MultiCastDelChgCallBack;
	...
	public GSDel_Param_Actor_Actor_ICB(Del_Param_Actor_Actor InvokeCallBack, Action<Del_Param_Actor_Actor> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Param_Actor_Actor_ICB operator +(GSDel_Param_Actor_Actor_ICB GSEvent, Del_Param_Actor_Actor Del)
	{
