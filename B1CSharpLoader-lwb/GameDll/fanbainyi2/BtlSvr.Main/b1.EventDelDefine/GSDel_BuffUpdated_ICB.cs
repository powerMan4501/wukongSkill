...
public class GSDel_BuffUpdated_ICB : IFreshAbleGSEvent
{
	private Del_BuffUpdated _InvokeCallBack;

	private Action<Del_BuffUpdated> _MultiCastDelChgCallBack;
	...
	public GSDel_BuffUpdated_ICB(Del_BuffUpdated InvokeCallBack, Action<Del_BuffUpdated> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_BuffUpdated_ICB operator +(GSDel_BuffUpdated_ICB GSEvent, Del_BuffUpdated Del)
	{
