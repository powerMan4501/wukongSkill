...
public class GSDel_SetUpperBodyAO : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetUpperBodyAO operator +(GSDel_SetUpperBodyAO GSEvent, Del_SetUpperBodyAO Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Enable, TargetType, InnerTargetPosition);
	}
}
