...
public class GSDel_StartCamOffsetTick : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_StartCamOffsetTick operator +(GSDel_StartCamOffsetTick GSEvent, Del_StartCamOffsetTick Del)
	{
	...
	{
		_MultiCastDel?.Invoke(CameraOffsetSetting, TotalTime);
	}
}
