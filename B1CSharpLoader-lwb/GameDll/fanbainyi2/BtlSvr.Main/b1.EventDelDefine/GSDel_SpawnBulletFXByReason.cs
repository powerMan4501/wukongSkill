...
public class GSDel_SpawnBulletFXByReason : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SpawnBulletFXByReason operator +(GSDel_SpawnBulletFXByReason GSEvent, Del_SpawnBulletFXByReason Del)
	{
	...
	{
		_MultiCastDel?.Invoke(BulletDispReason, EffectInstReq, BeHitActor);
	}
}
