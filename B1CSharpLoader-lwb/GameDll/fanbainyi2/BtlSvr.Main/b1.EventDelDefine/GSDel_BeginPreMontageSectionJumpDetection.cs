...
public class GSDel_BeginPreMontageSectionJumpDetection : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_BeginPreMontageSectionJumpDetection operator +(GSDel_BeginPreMontageSectionJumpDetection GSEvent, Del_BeginPreMontageSectionJumpDetection Del)
	{
	...
	{
		_MultiCastDel?.Invoke(SectionJumpType, IgnoreSimpleState, DetectionConfig, DetectionDuration, OverlayDetectTargetType, bEnableDebugDraw);
	}
}
