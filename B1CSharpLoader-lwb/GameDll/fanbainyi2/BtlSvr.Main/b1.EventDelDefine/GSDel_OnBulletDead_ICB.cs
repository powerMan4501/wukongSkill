...
public class GSDel_OnBulletDead_ICB : IFreshAbleGSEvent
{
	private Del_OnBulletDead _InvokeCallBack;

	private Action<Del_OnBulletDead> _MultiCastDelChgCallBack;
	...
	public GSDel_OnBulletDead_ICB(Del_OnBulletDead InvokeCallBack, Action<Del_OnBulletDead> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_OnBulletDead_ICB operator +(GSDel_OnBulletDead_ICB GSEvent, Del_OnBulletDead Del)
	{
