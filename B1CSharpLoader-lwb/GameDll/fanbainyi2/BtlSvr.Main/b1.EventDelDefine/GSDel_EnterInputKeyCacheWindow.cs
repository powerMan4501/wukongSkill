...
public class GSDel_EnterInputKeyCacheWindow : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_EnterInputKeyCacheWindow operator +(GSDel_EnterInputKeyCacheWindow GSEvent, Del_EnterInputKeyCacheWindow Del)
	{
	...
	{
		_MultiCastDel?.Invoke(KeyCacheType, MontageID, NotifyID, GroupID, Duration);
	}
}
