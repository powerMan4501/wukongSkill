...
public class GSDel_DoFreshMultiTarget_ICB : IFreshAbleGSEvent
{
	private Del_DoFreshMultiTarget _InvokeCallBack;

	private Action<Del_DoFreshMultiTarget> _MultiCastDelChgCallBack;
	...
	public GSDel_DoFreshMultiTarget_ICB(Del_DoFreshMultiTarget InvokeCallBack, Action<Del_DoFreshMultiTarget> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_DoFreshMultiTarget_ICB operator +(GSDel_DoFreshMultiTarget_ICB GSEvent, Del_DoFreshMultiTarget Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(SearchRaius, TargetTeamFilter, TargetTypeFilter, MultiTargetConditionType, Param1, Param2);
	}
}
