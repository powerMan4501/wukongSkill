...
public class GSDel_AttackFeedbackPerform_ICB : IFreshAbleGSEvent
{
	private Del_AttackFeedbackPerform _InvokeCallBack;

	private Action<Del_AttackFeedbackPerform> _MultiCastDelChgCallBack;
	...
	public GSDel_AttackFeedbackPerform_ICB(Del_AttackFeedbackPerform InvokeCallBack, Action<Del_AttackFeedbackPerform> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_AttackFeedbackPerform_ICB operator +(GSDel_AttackFeedbackPerform_ICB GSEvent, Del_AttackFeedbackPerform Del)
	{
