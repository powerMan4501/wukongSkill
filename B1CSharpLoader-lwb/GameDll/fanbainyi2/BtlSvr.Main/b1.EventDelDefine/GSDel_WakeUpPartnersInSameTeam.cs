...
public class GSDel_WakeUpPartnersInSameTeam : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_WakeUpPartnersInSameTeam operator +(GSDel_WakeUpPartnersInSameTeam GSEvent, Del_WakeUpPartnersInSameTeam Del)
	{
	...
	{
		_MultiCastDel?.Invoke(TeamIDList, CatchedTarget);
	}
}
