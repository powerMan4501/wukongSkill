...
public class GSDel_StopAiConversation_ByGUID : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_StopAiConversation_ByGUID operator +(GSDel_StopAiConversation_ByGUID GSEvent, Del_StopAiConversation_ByGUID Del)
	{
	...
	{
		_MultiCastDel?.Invoke(UnitGuid, InterruptType, InterruptReason);
	}
}
