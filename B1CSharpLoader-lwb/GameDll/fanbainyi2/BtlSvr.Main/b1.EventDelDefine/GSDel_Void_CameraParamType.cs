...
public class GSDel_Void_CameraParamType : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Void_CameraParamType operator +(GSDel_Void_CameraParamType GSEvent, Del_Void_CameraParamType Del)
	{
	...
	{
		_MultiCastDel?.Invoke(CameraParamType);
	}
}
