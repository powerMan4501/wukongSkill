...
public class GSDel_ProjectileGetSlotNameToBack : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ProjectileGetSlotNameToBack operator +(GSDel_ProjectileGetSlotNameToBack GSEvent, Del_ProjectileGetSlotNameToBack Del)
	{
	...
	public FName Invoke(string PreSlotName)
	{
		...
		return _MultiCastDel(PreSlotName);
	}
}
