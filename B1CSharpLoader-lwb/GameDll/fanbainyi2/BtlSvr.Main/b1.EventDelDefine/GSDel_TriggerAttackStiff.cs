...
public class GSDel_TriggerAttackStiff : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerAttackStiff operator +(GSDel_TriggerAttackStiff GSEvent, Del_TriggerAttackStiff Del)
	{
	...
	{
		_MultiCastDel?.Invoke(AttackerMaster, StiffLevel, HitWeight);
	}
}
