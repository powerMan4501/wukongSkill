...
public class GSDel_InitiateEQSObjRun : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_InitiateEQSObjRun operator +(GSDel_InitiateEQSObjRun GSEvent, Del_InitiateEQSObjRun Del)
	{
	...
	{
		_MultiCastDel?.Invoke(EnvQueryObj, Reason, _ExParam);
	}
}
