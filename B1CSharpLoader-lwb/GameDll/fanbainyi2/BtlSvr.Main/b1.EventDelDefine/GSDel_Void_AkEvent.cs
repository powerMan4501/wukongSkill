...
public class GSDel_Void_AkEvent : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Void_AkEvent operator +(GSDel_Void_AkEvent GSEvent, Del_Void_AkEvent Del)
	{
