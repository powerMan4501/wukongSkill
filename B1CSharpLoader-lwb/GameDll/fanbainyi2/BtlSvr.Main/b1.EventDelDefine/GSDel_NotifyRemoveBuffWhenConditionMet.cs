...
public class GSDel_NotifyRemoveBuffWhenConditionMet : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_NotifyRemoveBuffWhenConditionMet operator +(GSDel_NotifyRemoveBuffWhenConditionMet GSEvent, Del_NotifyRemoveBuffWhenConditionMet Del)
	{
	...
	{
		_MultiCastDel?.Invoke(bAttackedOrAttackHit);
	}
}
