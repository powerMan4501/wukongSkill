...
public class GSDel_EQSFinishBroadcast : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_EQSFinishBroadcast operator +(GSDel_EQSFinishBroadcast GSEvent, Del_EQSFinishBroadcast Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Result, Scores, ExParam, QueryID);
	}
}
