...
public class GSDel_Void_IntCastSkill_ICB : IFreshAbleGSEvent
{
	private Del_Void_IntCastSkill _InvokeCallBack;

	private Action<Del_Void_IntCastSkill> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_IntCastSkill_ICB(Del_Void_IntCastSkill InvokeCallBack, Action<Del_Void_IntCastSkill> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_IntCastSkill_ICB operator +(GSDel_Void_IntCastSkill_ICB GSEvent, Del_Void_IntCastSkill Del)
	{
