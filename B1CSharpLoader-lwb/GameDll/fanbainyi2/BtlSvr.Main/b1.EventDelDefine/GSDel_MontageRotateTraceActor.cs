...
public class GSDel_MontageRotateTraceActor : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_MontageRotateTraceActor operator +(GSDel_MontageRotateTraceActor GSEvent, Del_MontageRotateTraceActor Del)
	{
	...
	{
		_MultiCastDel?.Invoke(LockTargetInfo, TurnSpeed, RotateDeflectionAngle, MaxRotateAngle, TraceSocket, bIncludeAutoLockPoint, RotateDirection, bStillRotateWhenAboveMaxRotateAngle, DeadzoneAngle, EnableDebug);
	}
}
