...
public class GSDel_StandardObjFinishInteract : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_StandardObjFinishInteract operator +(GSDel_StandardObjFinishInteract GSEvent, Del_StandardObjFinishInteract Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Player, Guid);
	}
}
