...
public class GSDel_Int_FNameFNameVector : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Int_FNameFNameVector operator +(GSDel_Int_FNameFNameVector GSEvent, Del_Int_FNameFNameVector Del)
	{
