...
public class GSDel_UpdateDebugUILog_ICB : IFreshAbleGSEvent
{
	private Del_UpdateDebugUILog _InvokeCallBack;

	private Action<Del_UpdateDebugUILog> _MultiCastDelChgCallBack;
	...
	public GSDel_UpdateDebugUILog_ICB(Del_UpdateDebugUILog InvokeCallBack, Action<Del_UpdateDebugUILog> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_UpdateDebugUILog_ICB operator +(GSDel_UpdateDebugUILog_ICB GSEvent, Del_UpdateDebugUILog Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(Name, Value);
	}
}
