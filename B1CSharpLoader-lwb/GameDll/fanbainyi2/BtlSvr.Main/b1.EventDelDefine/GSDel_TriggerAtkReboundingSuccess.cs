...
public class GSDel_TriggerAtkReboundingSuccess : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerAtkReboundingSuccess operator +(GSDel_TriggerAtkReboundingSuccess GSEvent, Del_TriggerAtkReboundingSuccess Del)
	{
	...
	{
		_MultiCastDel?.Invoke(AtkReboundingActor);
	}
}
