...
public class GSDel_PassiveSkillModifyParam_ICB : IFreshAbleGSEvent
{
	private Del_PassiveSkillModifyParam _InvokeCallBack;

	private Action<Del_PassiveSkillModifyParam> _MultiCastDelChgCallBack;
	...
	public GSDel_PassiveSkillModifyParam_ICB(Del_PassiveSkillModifyParam InvokeCallBack, Action<Del_PassiveSkillModifyParam> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_PassiveSkillModifyParam_ICB operator +(GSDel_PassiveSkillModifyParam_ICB GSEvent, Del_PassiveSkillModifyParam Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(PassiveSkillID, PassiveSkillMappingIndexID, bRecover, Level);
	}
}
