...
public class GSDel_PassiveSkill3IDIntParamChanged : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_PassiveSkill3IDIntParamChanged operator +(GSDel_PassiveSkill3IDIntParamChanged GSEvent, Del_PassiveSkill3IDIntParamChanged Del)
	{
