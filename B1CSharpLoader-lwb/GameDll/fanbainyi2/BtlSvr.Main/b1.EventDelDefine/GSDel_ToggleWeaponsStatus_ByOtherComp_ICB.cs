...
public class GSDel_ToggleWeaponsStatus_ByOtherComp_ICB : IFreshAbleGSEvent
{
	private Del_ToggleWeaponsStatus_ByOtherComp _InvokeCallBack;

	private Action<Del_ToggleWeaponsStatus_ByOtherComp> _MultiCastDelChgCallBack;
	...
	public GSDel_ToggleWeaponsStatus_ByOtherComp_ICB(Del_ToggleWeaponsStatus_ByOtherComp InvokeCallBack, Action<Del_ToggleWeaponsStatus_ByOtherComp> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_ToggleWeaponsStatus_ByOtherComp_ICB operator +(GSDel_ToggleWeaponsStatus_ByOtherComp_ICB GSEvent, Del_ToggleWeaponsStatus_ByOtherComp Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(WeaponIndexes, TriggerActivate, NeedOverride, CompType);
	}
}
