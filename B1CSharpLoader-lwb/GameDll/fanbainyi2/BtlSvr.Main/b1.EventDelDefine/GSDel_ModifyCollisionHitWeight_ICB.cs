...
public class GSDel_ModifyCollisionHitWeight_ICB : IFreshAbleGSEvent
{
	private Del_ModifyCollisionHitWeight _InvokeCallBack;

	private Action<Del_ModifyCollisionHitWeight> _MultiCastDelChgCallBack;
	...
	public GSDel_ModifyCollisionHitWeight_ICB(Del_ModifyCollisionHitWeight InvokeCallBack, Action<Del_ModifyCollisionHitWeight> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_ModifyCollisionHitWeight_ICB operator +(GSDel_ModifyCollisionHitWeight_ICB GSEvent, Del_ModifyCollisionHitWeight Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(NewWeight);
	}
}
