...
public class GSDel_OnSweepHitWorldItemForProceduralFX_ICB : IFreshAbleGSEvent
{
	private Del_OnSweepHitWorldItemForProceduralFX _InvokeCallBack;

	private Action<Del_OnSweepHitWorldItemForProceduralFX> _MultiCastDelChgCallBack;
	...
	public GSDel_OnSweepHitWorldItemForProceduralFX_ICB(Del_OnSweepHitWorldItemForProceduralFX InvokeCallBack, Action<Del_OnSweepHitWorldItemForProceduralFX> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_OnSweepHitWorldItemForProceduralFX_ICB operator +(GSDel_OnSweepHitWorldItemForProceduralFX_ICB GSEvent, Del_OnSweepHitWorldItemForProceduralFX Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(HitActor, Position, Size, OverrideSurfaceType, OverrideSurfacePersistTime, EntityID);
	}
}
