...
public class GSDel_Void_Bool_IPK_Del : IFreshAbleGSEvent
{
	public delegate void Del_Predict(bool P1, GSPredictionKey PredictionKey);
	...
	public static GSDel_Void_Bool_IPK_Del operator +(GSDel_Void_Bool_IPK_Del GSEvent, Del_Predict Del)
	{
	...
	public void Invoke(bool P1, GSPredictionKey PredictionKey = null)
	{
		_MultiCastDel?.Invoke(P1, PredictionKey);
	}
}
