...
public class GSDel_UnitTriggerDead_ICB : IFreshAbleGSEvent
{
	private Del_UnitTriggerDead _InvokeCallBack;

	private Action<Del_UnitTriggerDead> _MultiCastDelChgCallBack;
	...
	public GSDel_UnitTriggerDead_ICB(Del_UnitTriggerDead InvokeCallBack, Action<Del_UnitTriggerDead> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_UnitTriggerDead_ICB operator +(GSDel_UnitTriggerDead_ICB GSEvent, Del_UnitTriggerDead Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(Attacker, DeadReason, DmgID);
	}
}
