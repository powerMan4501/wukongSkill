...
public class GSDel_UnitCastSkillTry_IPK_Del : IFreshAbleGSEvent
{
	public delegate void Del_Predict(FCastSkillInfo CSI, GSPredictionKey PredictionKey);
	...
	public static GSDel_UnitCastSkillTry_IPK_Del operator +(GSDel_UnitCastSkillTry_IPK_Del GSEvent, Del_Predict Del)
	{
	...
	public void Invoke(FCastSkillInfo CSI, GSPredictionKey PredictionKey = null)
	{
		_MultiCastDel?.Invoke(CSI, PredictionKey);
	}
}
