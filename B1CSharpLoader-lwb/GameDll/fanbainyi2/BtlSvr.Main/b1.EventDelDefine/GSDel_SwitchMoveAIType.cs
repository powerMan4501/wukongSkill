...
public class GSDel_SwitchMoveAIType : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SwitchMoveAIType operator +(GSDel_SwitchMoveAIType GSEvent, Del_SwitchMoveAIType Del)
	{
	...
	{
		_MultiCastDel?.Invoke(MoveAIType);
	}
}
