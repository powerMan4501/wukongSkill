...
public class GSDel_SetMatsScalarParam_ICB : IFreshAbleGSEvent
{
	private Del_SetMatsScalarParam _InvokeCallBack;

	private Action<Del_SetMatsScalarParam> _MultiCastDelChgCallBack;
	...
	public GSDel_SetMatsScalarParam_ICB(Del_SetMatsScalarParam InvokeCallBack, Action<Del_SetMatsScalarParam> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_SetMatsScalarParam_ICB operator +(GSDel_SetMatsScalarParam_ICB GSEvent, Del_SetMatsScalarParam Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(ParamName, Value);
	}
}
