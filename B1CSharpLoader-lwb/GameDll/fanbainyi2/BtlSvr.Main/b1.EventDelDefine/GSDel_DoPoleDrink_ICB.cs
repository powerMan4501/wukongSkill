...
public class GSDel_DoPoleDrink_ICB : IFreshAbleGSEvent
{
	private Del_DoPoleDrink _InvokeCallBack;

	private Action<Del_DoPoleDrink> _MultiCastDelChgCallBack;
	...
	public GSDel_DoPoleDrink_ICB(Del_DoPoleDrink InvokeCallBack, Action<Del_DoPoleDrink> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_DoPoleDrink_ICB operator +(GSDel_DoPoleDrink_ICB GSEvent, Del_DoPoleDrink Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(Type, SkillID, PosIndex);
	}
}
