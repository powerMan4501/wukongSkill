...
public class GSDel_OnSwitchBulletMove : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_OnSwitchBulletMove operator +(GSDel_OnSwitchBulletMove GSEvent, Del_OnSwitchBulletMove Del)
	{
	...
	{
		_MultiCastDel?.Invoke(MovableInfo, Caster);
	}
}
