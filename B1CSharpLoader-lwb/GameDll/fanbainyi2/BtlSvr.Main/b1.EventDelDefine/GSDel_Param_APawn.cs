...
public class GSDel_Param_APawn : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Param_APawn operator +(GSDel_Param_APawn GSEvent, Del_Param_APawn Del)
	{
