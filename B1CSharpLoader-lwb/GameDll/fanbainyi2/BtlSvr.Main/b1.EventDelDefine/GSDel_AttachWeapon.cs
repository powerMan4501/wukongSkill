...
public class GSDel_AttachWeapon : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_AttachWeapon operator +(GSDel_AttachWeapon GSEvent, Del_AttachWeapon Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Weapon, Index, SocketName, LocationRule, RotationRule, ScaleRule);
	}
}
