...
public class GSDel_CopySkillSummonBehavior : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_CopySkillSummonBehavior operator +(GSDel_CopySkillSummonBehavior GSEvent, Del_CopySkillSummonBehavior Del)
	{
	...
	{
		_MultiCastDel?.Invoke(CopyAnim, in TeleportTrans);
	}
}
