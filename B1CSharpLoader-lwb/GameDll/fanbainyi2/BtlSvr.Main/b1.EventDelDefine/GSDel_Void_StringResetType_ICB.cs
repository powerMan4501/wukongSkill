...
public class GSDel_Void_StringResetType_ICB : IFreshAbleGSEvent
{
	private Del_Void_StringResetType _InvokeCallBack;

	private Action<Del_Void_StringResetType> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_StringResetType_ICB(Del_Void_StringResetType InvokeCallBack, Action<Del_Void_StringResetType> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_StringResetType_ICB operator +(GSDel_Void_StringResetType_ICB GSEvent, Del_Void_StringResetType Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(UnitGuid, ResetType);
	}
}
