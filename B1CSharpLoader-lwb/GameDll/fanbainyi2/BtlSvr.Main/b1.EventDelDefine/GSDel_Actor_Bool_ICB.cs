...
public class GSDel_Actor_Bool_ICB : IFreshAbleGSEvent
{
	private Del_Actor_Bool _InvokeCallBack;

	private Action<Del_Actor_Bool> _MultiCastDelChgCallBack;
	...
	public GSDel_Actor_Bool_ICB(Del_Actor_Bool InvokeCallBack, Action<Del_Actor_Bool> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Actor_Bool_ICB operator +(GSDel_Actor_Bool_ICB GSEvent, Del_Actor_Bool Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(Target, IsSelfRescue);
	}
}
