...
public class GSDel_SolveBeAttackedStiffLogic : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SolveBeAttackedStiffLogic operator +(GSDel_SolveBeAttackedStiffLogic GSEvent, Del_SolveBeAttackedStiffLogic Del)
	{
