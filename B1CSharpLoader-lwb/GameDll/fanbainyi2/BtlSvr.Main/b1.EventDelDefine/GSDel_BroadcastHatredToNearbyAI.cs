...
public class GSDel_BroadcastHatredToNearbyAI : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_BroadcastHatredToNearbyAI operator +(GSDel_BroadcastHatredToNearbyAI GSEvent, Del_BroadcastHatredToNearbyAI Del)
	{
	...
	{
		_MultiCastDel?.Invoke(AlertTarget, AlertEndBuffID);
	}
}
