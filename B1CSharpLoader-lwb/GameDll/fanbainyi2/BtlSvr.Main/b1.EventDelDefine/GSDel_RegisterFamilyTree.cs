...
public class GSDel_RegisterFamilyTree : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_RegisterFamilyTree operator +(GSDel_RegisterFamilyTree GSEvent, Del_RegisterFamilyTree Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Actor, Register);
	}
}
