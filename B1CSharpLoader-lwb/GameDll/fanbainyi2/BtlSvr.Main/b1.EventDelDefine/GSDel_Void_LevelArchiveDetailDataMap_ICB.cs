...
public class GSDel_Void_LevelArchiveDetailDataMap_ICB : IFreshAbleGSEvent
{
	private Del_Void_LevelArchiveDetailDataMap _InvokeCallBack;

	private Action<Del_Void_LevelArchiveDetailDataMap> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_LevelArchiveDetailDataMap_ICB(Del_Void_LevelArchiveDetailDataMap InvokeCallBack, Action<Del_Void_LevelArchiveDetailDataMap> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_LevelArchiveDetailDataMap_ICB operator +(GSDel_Void_LevelArchiveDetailDataMap_ICB GSEvent, Del_Void_LevelArchiveDetailDataMap Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(DetailData);
	}
}
