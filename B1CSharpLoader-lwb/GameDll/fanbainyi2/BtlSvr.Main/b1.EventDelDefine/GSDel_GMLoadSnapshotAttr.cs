...
public class GSDel_GMLoadSnapshotAttr : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_GMLoadSnapshotAttr operator +(GSDel_GMLoadSnapshotAttr GSEvent, Del_GMLoadSnapshotAttr Del)
	{
	...
	{
		_MultiCastDel?.Invoke(effectAttrList, customAttrList);
	}
}
