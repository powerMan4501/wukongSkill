...
public class GSDel_ResetMatsLayerParam : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ResetMatsLayerParam operator +(GSDel_ResetMatsLayerParam GSEvent, Del_ResetMatsLayerParam Del)
	{
	...
	{
		_MultiCastDel?.Invoke(LayerMappingIdx, LayerMappingName, ParamName);
	}
}
