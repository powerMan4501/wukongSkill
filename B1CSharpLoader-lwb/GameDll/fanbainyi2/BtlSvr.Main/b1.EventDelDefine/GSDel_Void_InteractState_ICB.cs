...
public class GSDel_Void_InteractState_ICB : IFreshAbleGSEvent
{
	private Del_Void_InteractState _InvokeCallBack;

	private Action<Del_Void_InteractState> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_InteractState_ICB(Del_Void_InteractState InvokeCallBack, Action<Del_Void_InteractState> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_InteractState_ICB operator +(GSDel_Void_InteractState_ICB GSEvent, Del_Void_InteractState Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(Guid, State);
	}
}
