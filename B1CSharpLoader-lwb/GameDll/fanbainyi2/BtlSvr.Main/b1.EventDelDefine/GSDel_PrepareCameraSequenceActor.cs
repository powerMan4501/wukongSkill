...
public class GSDel_PrepareCameraSequenceActor : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_PrepareCameraSequenceActor operator +(GSDel_PrepareCameraSequenceActor GSEvent, Del_PrepareCameraSequenceActor Del)
	{
	...
	{
		_MultiCastDel?.Invoke(CameraSequenceData, ref StartTransform, IsSeqAttachToActor);
	}
}
