...
public class GSDel_HandleSlowIK : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_HandleSlowIK operator +(GSDel_HandleSlowIK GSEvent, Del_HandleSlowIK Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Enable, SlowIKType, SlowTime);
	}
}
