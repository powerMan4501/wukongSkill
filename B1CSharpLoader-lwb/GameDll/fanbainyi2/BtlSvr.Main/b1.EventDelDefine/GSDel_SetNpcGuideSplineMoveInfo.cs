...
public class GSDel_SetNpcGuideSplineMoveInfo : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetNpcGuideSplineMoveInfo operator +(GSDel_SetNpcGuideSplineMoveInfo GSEvent, Del_SetNpcGuideSplineMoveInfo Del)
	{
	...
	{
		_MultiCastDel?.Invoke(SplineGuid, NeedSwitchSpeedByDistanceToPlayer, SplineMoveSpeed, MaxDistance_Sprint, MaxDistance_Run, MaxDistance_Jog, DistanceBuffer);
	}
}
