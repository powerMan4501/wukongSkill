...
public class GSDel_SmartCastSkillTry : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SmartCastSkillTry operator +(GSDel_SmartCastSkillTry GSEvent, Del_SmartCastSkillTry Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ID, RuleIDList, Reason, SkillDirection, bNeedCheckSkillCanCast, SourceType);
	}
}
