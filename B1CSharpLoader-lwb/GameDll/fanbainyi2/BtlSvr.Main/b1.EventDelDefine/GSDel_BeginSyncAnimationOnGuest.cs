...
public class GSDel_BeginSyncAnimationOnGuest : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_BeginSyncAnimationOnGuest operator +(GSDel_BeginSyncAnimationOnGuest GSEvent, Del_BeginSyncAnimationOnGuest Del)
	{
	...
	{
		_MultiCastDel?.Invoke(GuestMontage, bFoundHostSyncPointOnDummyMesh, SelfSyncPointOnHost, TargetSyncPointOnHost, SelfSyncPointOnGuest, bEnableDebugDraw, NotifyBeginTime, TotalDuration);
	}
}
