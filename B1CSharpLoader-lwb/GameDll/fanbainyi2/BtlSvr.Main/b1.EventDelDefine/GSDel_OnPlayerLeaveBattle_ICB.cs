...
public class GSDel_OnPlayerLeaveBattle_ICB : IFreshAbleGSEvent
{
	private Del_OnPlayerLeaveBattle _InvokeCallBack;

	private Action<Del_OnPlayerLeaveBattle> _MultiCastDelChgCallBack;
	...
	public GSDel_OnPlayerLeaveBattle_ICB(Del_OnPlayerLeaveBattle InvokeCallBack, Action<Del_OnPlayerLeaveBattle> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_OnPlayerLeaveBattle_ICB operator +(GSDel_OnPlayerLeaveBattle_ICB GSEvent, Del_OnPlayerLeaveBattle Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(RoleId, Player, LeaveFightTime, bIsTransUnit, bBecauseOfTrans);
	}
}
