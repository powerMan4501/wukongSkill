...
public class GSDel_UpdateInteractState_ICB : IFreshAbleGSEvent
{
	private Del_UpdateInteractState _InvokeCallBack;

	private Action<Del_UpdateInteractState> _MultiCastDelChgCallBack;
	...
	public GSDel_UpdateInteractState_ICB(Del_UpdateInteractState InvokeCallBack, Action<Del_UpdateInteractState> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_UpdateInteractState_ICB operator +(GSDel_UpdateInteractState_ICB GSEvent, Del_UpdateInteractState Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(InteractUnitState, UpdatePersistent);
	}
}
