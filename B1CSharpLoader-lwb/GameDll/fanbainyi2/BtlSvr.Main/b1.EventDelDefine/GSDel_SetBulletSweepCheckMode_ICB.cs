...
public class GSDel_SetBulletSweepCheckMode_ICB : IFreshAbleGSEvent
{
	private Del_SetBulletSweepCheckMode _InvokeCallBack;

	private Action<Del_SetBulletSweepCheckMode> _MultiCastDelChgCallBack;
	...
	public GSDel_SetBulletSweepCheckMode_ICB(Del_SetBulletSweepCheckMode InvokeCallBack, Action<Del_SetBulletSweepCheckMode> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_SetBulletSweepCheckMode_ICB operator +(GSDel_SetBulletSweepCheckMode_ICB GSEvent, Del_SetBulletSweepCheckMode Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(CheckMode);
	}
}
