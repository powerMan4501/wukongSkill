...
public class GSDel_OverlapSceneItems : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_OverlapSceneItems operator +(GSDel_OverlapSceneItems GSEvent, Del_OverlapSceneItems Del)
	{
	...
	public List<AActor> Invoke(List<FUStCheckShape> SweepCheckShape)
	{
		...
		return _MultiCastDel(SweepCheckShape);
	}
}
