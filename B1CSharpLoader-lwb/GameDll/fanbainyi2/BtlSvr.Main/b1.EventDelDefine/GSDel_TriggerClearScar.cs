...
public class GSDel_TriggerClearScar : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerClearScar operator +(GSDel_TriggerClearScar GSEvent, Del_TriggerClearScar Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ScarDecalTriggerType);
	}
}
