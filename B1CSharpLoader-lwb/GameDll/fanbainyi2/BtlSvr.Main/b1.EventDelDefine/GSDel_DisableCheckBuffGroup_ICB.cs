...
public class GSDel_DisableCheckBuffGroup_ICB : IFreshAbleGSEvent
{
	private Del_DisableCheckBuffGroup _InvokeCallBack;

	private Action<Del_DisableCheckBuffGroup> _MultiCastDelChgCallBack;
	...
	public GSDel_DisableCheckBuffGroup_ICB(Del_DisableCheckBuffGroup InvokeCallBack, Action<Del_DisableCheckBuffGroup> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_DisableCheckBuffGroup_ICB operator +(GSDel_DisableCheckBuffGroup_ICB GSEvent, Del_DisableCheckBuffGroup Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(BuffGroupID);
	}
}
