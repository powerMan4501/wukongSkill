...
public class GSDel_CastIronBody : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_CastIronBody operator +(GSDel_CastIronBody GSEvent, Del_CastIronBody Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Attacker, SkillEffectID, SkillDamageType);
	}
}
