...
public class GSDel_TriggerImmobilizedBreak_ICB : IFreshAbleGSEvent
{
	private Action<AActor, int, FEffectInstReq, UAnimMontage, bool> _InvokeCallBack;

	private Action<Del_TriggerImmobilizedBreak> _MultiCastDelChgCallBack;
	...
	public GSDel_TriggerImmobilizedBreak_ICB(Action<AActor, int, FEffectInstReq, UAnimMontage, bool> InvokeCallBack, Action<Del_TriggerImmobilizedBreak> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_TriggerImmobilizedBreak_ICB operator +(GSDel_TriggerImmobilizedBreak_ICB GSEvent, Del_TriggerImmobilizedBreak Del)
	{
