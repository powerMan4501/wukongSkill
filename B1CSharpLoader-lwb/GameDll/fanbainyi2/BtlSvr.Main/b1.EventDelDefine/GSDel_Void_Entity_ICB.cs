...
public class GSDel_Void_Entity_ICB : IFreshAbleGSEvent
{
	private Del_Void_Entity _InvokeCallBack;

	private Action<Del_Void_Entity> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_Entity_ICB(Del_Void_Entity InvokeCallBack, Action<Del_Void_Entity> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_Entity_ICB operator +(GSDel_Void_Entity_ICB GSEvent, Del_Void_Entity Del)
	{
