...
public class GSDel_SetAutoCloudMove : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetAutoCloudMove operator +(GSDel_SetAutoCloudMove GSEvent, Del_SetAutoCloudMove Del)
	{
	...
	{
		_MultiCastDel?.Invoke(TargetLocation, AcceptRadius);
	}
}
