...
public class GSDel_ModifyCD : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ModifyCD operator +(GSDel_ModifyCD GSEvent, Del_ModifyCD Del)
	{
	...
	{
		_MultiCastDel?.Invoke(SkillID, bAddOrMul, Value);
	}
}
