...
public class GSDel_BGS_TryStopBattleBGM_ICB : IFreshAbleGSEvent
{
	private Del_BGS_TryStopBattleBGM _InvokeCallBack;

	private Action<Del_BGS_TryStopBattleBGM> _MultiCastDelChgCallBack;
	...
	public GSDel_BGS_TryStopBattleBGM_ICB(Del_BGS_TryStopBattleBGM InvokeCallBack, Action<Del_BGS_TryStopBattleBGM> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_BGS_TryStopBattleBGM_ICB operator +(GSDel_BGS_TryStopBattleBGM_ICB GSEvent, Del_BGS_TryStopBattleBGM Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(RequestorEntity, StopCondition);
	}
}
