...
public class GSDel_Void_ActorStringInt : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Void_ActorStringInt operator +(GSDel_Void_ActorStringInt GSEvent, Del_Void_ActorStringInt Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Actor, P1, P2);
	}
}
