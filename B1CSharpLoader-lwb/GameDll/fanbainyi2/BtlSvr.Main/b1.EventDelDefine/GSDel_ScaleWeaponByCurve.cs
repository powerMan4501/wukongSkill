...
public class GSDel_ScaleWeaponByCurve : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ScaleWeaponByCurve operator +(GSDel_ScaleWeaponByCurve GSEvent, Del_ScaleWeaponByCurve Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ScaleCurve);
	}
}
