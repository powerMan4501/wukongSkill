...
public class GSDel_DetachWeapon : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_DetachWeapon operator +(GSDel_DetachWeapon GSEvent, Del_DetachWeapon Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Index, LocationRule, RotationRule, ScaleRule, WeaponDestroyDelayTime, WeaponEnablePhysic);
	}
}
