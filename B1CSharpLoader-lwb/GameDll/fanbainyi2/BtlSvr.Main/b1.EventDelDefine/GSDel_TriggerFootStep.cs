...
public class GSDel_TriggerFootStep : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerFootStep operator +(GSDel_TriggerFootStep GSEvent, Del_TriggerFootStep Del)
	{
	...
	{
		_MultiCastDel?.Invoke(FootStepType, IsFromNotify);
	}
}
