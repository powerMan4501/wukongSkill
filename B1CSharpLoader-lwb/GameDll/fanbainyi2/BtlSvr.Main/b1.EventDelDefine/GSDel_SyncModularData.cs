...
public class GSDel_SyncModularData : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SyncModularData operator +(GSDel_SyncModularData GSEvent, Del_SyncModularData Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ModularActors, bAutoAttachModularActors, bAutoSnapToGround, bDestroyAfterOwnerDeath, bNeedsCopyPose, BreakDownProjectileMap);
	}
}
