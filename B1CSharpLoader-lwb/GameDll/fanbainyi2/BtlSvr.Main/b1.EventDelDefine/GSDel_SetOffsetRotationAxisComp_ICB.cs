...
public class GSDel_SetOffsetRotationAxisComp_ICB : IFreshAbleGSEvent
{
	private Del_SetOffsetRotationAxisComp _InvokeCallBack;

	private Action<Del_SetOffsetRotationAxisComp> _MultiCastDelChgCallBack;
	...
	public GSDel_SetOffsetRotationAxisComp_ICB(Del_SetOffsetRotationAxisComp InvokeCallBack, Action<Del_SetOffsetRotationAxisComp> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_SetOffsetRotationAxisComp_ICB operator +(GSDel_SetOffsetRotationAxisComp_ICB GSEvent, Del_SetOffsetRotationAxisComp Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(RotationAxisComp);
	}
}
