...
public class GSDel_Void_Chr_ICB : IFreshAbleGSEvent
{
	private Del_Void_Chr _InvokeCallBack;

	private Action<Del_Void_Chr> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_Chr_ICB(Del_Void_Chr InvokeCallBack, Action<Del_Void_Chr> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_Chr_ICB operator +(GSDel_Void_Chr_ICB GSEvent, Del_Void_Chr Del)
	{
