...
public class GSDel_TriggerBeInteract : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerBeInteract operator +(GSDel_TriggerBeInteract GSEvent, Del_TriggerBeInteract Del)
	{
	...
	{
		_MultiCastDel?.Invoke(PlayerActor, IsAiTrigger);
	}
}
