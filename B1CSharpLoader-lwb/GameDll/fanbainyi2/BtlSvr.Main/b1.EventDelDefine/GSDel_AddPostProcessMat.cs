...
public class GSDel_AddPostProcessMat : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_AddPostProcessMat operator +(GSDel_AddPostProcessMat GSEvent, Del_AddPostProcessMat Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Source, NotifyId, Owner, Template);
	}
}
