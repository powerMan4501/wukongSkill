...
public class GSDel_SkillRotateTraceActor : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SkillRotateTraceActor operator +(GSDel_SkillRotateTraceActor GSEvent, Del_SkillRotateTraceActor Del)
	{
