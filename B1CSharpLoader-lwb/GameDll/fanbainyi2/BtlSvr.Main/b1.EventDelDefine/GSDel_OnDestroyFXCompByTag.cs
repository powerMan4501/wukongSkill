...
public class GSDel_OnDestroyFXCompByTag : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_OnDestroyFXCompByTag operator +(GSDel_OnDestroyFXCompByTag GSEvent, Del_OnDestroyFXCompByTag Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Tag, DestroyImmediately);
	}
}
