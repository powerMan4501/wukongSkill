...
public class GSDel_Void_ActorFloat : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Void_ActorFloat operator +(GSDel_Void_ActorFloat GSEvent, Del_Void_ActorFloat Del)
	{
