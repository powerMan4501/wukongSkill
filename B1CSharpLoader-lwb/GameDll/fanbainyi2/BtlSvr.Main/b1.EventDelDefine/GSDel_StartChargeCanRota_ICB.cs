...
public class GSDel_StartChargeCanRota_ICB : IFreshAbleGSEvent
{
	private Del_StartChargeCanRota _InvokeCallBack;

	private Action<Del_StartChargeCanRota> _MultiCastDelChgCallBack;
	...
	public GSDel_StartChargeCanRota_ICB(Del_StartChargeCanRota InvokeCallBack, Action<Del_StartChargeCanRota> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_StartChargeCanRota_ICB operator +(GSDel_StartChargeCanRota_ICB GSEvent, Del_StartChargeCanRota Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(StartChargeCanRota, Speed);
	}
}
