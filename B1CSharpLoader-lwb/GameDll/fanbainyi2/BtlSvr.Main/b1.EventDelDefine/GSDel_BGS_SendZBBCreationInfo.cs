...
public class GSDel_BGS_SendZBBCreationInfo : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_BGS_SendZBBCreationInfo operator +(GSDel_BGS_SendZBBCreationInfo GSEvent, Del_BGS_SendZBBCreationInfo Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Actor, UnitDist, ZBBConfigs);
	}
}
