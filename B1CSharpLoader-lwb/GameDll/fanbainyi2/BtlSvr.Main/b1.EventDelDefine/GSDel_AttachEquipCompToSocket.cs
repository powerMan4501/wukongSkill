...
public class GSDel_AttachEquipCompToSocket : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_AttachEquipCompToSocket operator +(GSDel_AttachEquipCompToSocket GSEvent, Del_AttachEquipCompToSocket Del)
	{
	...
	{
		_MultiCastDel?.Invoke(EquipPosition, SocketName, InstanceID, UniqueID);
	}
}
