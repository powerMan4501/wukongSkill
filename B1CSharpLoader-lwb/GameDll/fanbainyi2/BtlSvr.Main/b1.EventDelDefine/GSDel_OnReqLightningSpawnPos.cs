...
public class GSDel_OnReqLightningSpawnPos : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_OnReqLightningSpawnPos operator +(GSDel_OnReqLightningSpawnPos GSEvent, Del_OnReqLightningSpawnPos Del)
	{
	...
	{
		_MultiCastDel?.Invoke(TargetPoints, AttachMeshComp, SocketList);
	}
}
