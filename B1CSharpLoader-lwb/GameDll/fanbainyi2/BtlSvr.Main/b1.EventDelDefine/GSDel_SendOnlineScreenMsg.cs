...
public class GSDel_SendOnlineScreenMsg : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SendOnlineScreenMsg operator +(GSDel_SendOnlineScreenMsg GSEvent, Del_SendOnlineScreenMsg Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ScreenMsgType, Msg, TipsDuration);
	}
}
