...
public class GSDel_TransBack_PreUnitTrans : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TransBack_PreUnitTrans operator +(GSDel_TransBack_PreUnitTrans GSEvent, Del_TransBack_PreUnitTrans Del)
	{
