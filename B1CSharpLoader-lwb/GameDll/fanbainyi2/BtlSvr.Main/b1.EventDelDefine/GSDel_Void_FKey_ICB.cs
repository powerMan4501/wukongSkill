...
public class GSDel_Void_FKey_ICB : IFreshAbleGSEvent
{
	private Del_Void_FKey _InvokeCallBack;

	private Action<Del_Void_FKey> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_FKey_ICB(Del_Void_FKey InvokeCallBack, Action<Del_Void_FKey> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_FKey_ICB operator +(GSDel_Void_FKey_ICB GSEvent, Del_Void_FKey Del)
	{
