...
public class GSDel_ResetMatsParam_ICB : IFreshAbleGSEvent
{
	private Del_ResetMatsParam _InvokeCallBack;

	private Action<Del_ResetMatsParam> _MultiCastDelChgCallBack;
	...
	public GSDel_ResetMatsParam_ICB(Del_ResetMatsParam InvokeCallBack, Action<Del_ResetMatsParam> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_ResetMatsParam_ICB operator +(GSDel_ResetMatsParam_ICB GSEvent, Del_ResetMatsParam Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(ParamName);
	}
}
