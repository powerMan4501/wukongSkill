...
public class GSDel_NotifyAssociationUnitActive : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_NotifyAssociationUnitActive operator +(GSDel_NotifyAssociationUnitActive GSEvent, Del_NotifyAssociationUnitActive Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ConfigID, TargetGUID, OnFightSkillID);
	}
}
