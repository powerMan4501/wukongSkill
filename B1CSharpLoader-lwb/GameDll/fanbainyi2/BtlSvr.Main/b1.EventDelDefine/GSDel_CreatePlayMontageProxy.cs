...
public class GSDel_CreatePlayMontageProxy : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_CreatePlayMontageProxy operator +(GSDel_CreatePlayMontageProxy GSEvent, Del_CreatePlayMontageProxy Del)
	{
	...
	public bool Invoke(EMontageBindReason Reason, USkeletalMeshComponent InSkeletalMeshComponent, UAnimMontage MontageToPaly, float PlayRate, float StartingPosition, FName StartingSection)
	{
		...
		return _MultiCastDel(Reason, InSkeletalMeshComponent, MontageToPaly, PlayRate, StartingPosition, StartingSection);
	}
}
