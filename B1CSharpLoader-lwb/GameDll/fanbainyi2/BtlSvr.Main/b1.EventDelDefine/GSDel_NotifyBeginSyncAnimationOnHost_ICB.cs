...
public class GSDel_NotifyBeginSyncAnimationOnHost_ICB : IFreshAbleGSEvent
{
	private Del_NotifyBeginSyncAnimationOnHost _InvokeCallBack;

	private Action<Del_NotifyBeginSyncAnimationOnHost> _MultiCastDelChgCallBack;
	...
	public GSDel_NotifyBeginSyncAnimationOnHost_ICB(Del_NotifyBeginSyncAnimationOnHost InvokeCallBack, Action<Del_NotifyBeginSyncAnimationOnHost> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_NotifyBeginSyncAnimationOnHost_ICB operator +(GSDel_NotifyBeginSyncAnimationOnHost_ICB GSEvent, Del_NotifyBeginSyncAnimationOnHost Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(PreAnimationSyncStateHostBuffList, GuestMontage, bFoundHostSyncPointOnDummyMesh, SelfSyncPointOnHost, TargetSyncPointOnHost, SelfSyncPointOnGuest, bForceSyncDummyMeshAnimation, bEnableDebugDraw, NotifyBeginTime, TotalDuration, AnimationSyncMontageInstanceID);
	}
}
