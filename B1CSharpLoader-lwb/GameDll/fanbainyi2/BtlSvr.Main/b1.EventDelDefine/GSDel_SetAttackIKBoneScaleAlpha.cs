...
public class GSDel_SetAttackIKBoneScaleAlpha : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetAttackIKBoneScaleAlpha operator +(GSDel_SetAttackIKBoneScaleAlpha GSEvent, Del_SetAttackIKBoneScaleAlpha Del)
	{
