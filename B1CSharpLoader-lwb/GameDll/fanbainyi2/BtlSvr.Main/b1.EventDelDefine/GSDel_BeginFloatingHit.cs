...
public class GSDel_BeginFloatingHit : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_BeginFloatingHit operator +(GSDel_BeginFloatingHit GSEvent, Del_BeginFloatingHit Del)
	{
	...
	{
		_MultiCastDel?.Invoke(FloatingHeight, RiseTime, DeclineSpd);
	}
}
