...
public class GSDel_TryAttachSceneItem : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TryAttachSceneItem operator +(GSDel_TryAttachSceneItem GSEvent, Del_TryAttachSceneItem Del)
	{
	...
	{
		_MultiCastDel?.Invoke(SocketName);
	}
}
