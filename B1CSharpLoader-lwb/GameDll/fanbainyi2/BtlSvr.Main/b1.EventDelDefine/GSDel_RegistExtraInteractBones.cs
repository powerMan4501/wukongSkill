...
public class GSDel_RegistExtraInteractBones : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_RegistExtraInteractBones operator +(GSDel_RegistExtraInteractBones GSEvent, Del_RegistExtraInteractBones Del)
	{
	...
	{
		_MultiCastDel?.Invoke(NotifyID, InteractBones);
	}
}
