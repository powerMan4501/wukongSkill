...
public class GSDel_BeginModularSimulation_ICB : IFreshAbleGSEvent
{
	private Del_BeginModularSimulation _InvokeCallBack;

	private Action<Del_BeginModularSimulation> _MultiCastDelChgCallBack;
	...
	public GSDel_BeginModularSimulation_ICB(Del_BeginModularSimulation InvokeCallBack, Action<Del_BeginModularSimulation> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_BeginModularSimulation_ICB operator +(GSDel_BeginModularSimulation_ICB GSEvent, Del_BeginModularSimulation Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(TigerWoodsDataAssetPath);
	}
}
