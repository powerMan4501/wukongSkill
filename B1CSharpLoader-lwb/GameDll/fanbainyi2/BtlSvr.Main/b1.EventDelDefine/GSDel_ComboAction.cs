...
public class GSDel_ComboAction : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ComboAction operator +(GSDel_ComboAction GSEvent, Del_ComboAction Del)
	{
	...
	{
		_MultiCastDel?.Invoke(MaxTime, Target);
	}
}
