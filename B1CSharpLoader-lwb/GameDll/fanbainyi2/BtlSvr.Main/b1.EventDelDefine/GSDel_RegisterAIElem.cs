...
public class GSDel_RegisterAIElem : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_RegisterAIElem operator +(GSDel_RegisterAIElem GSEvent, Del_RegisterAIElem Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ElemID, ElemType, Score);
	}
}
