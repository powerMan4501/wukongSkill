...
public class GSDel_SetMatchingPosInterpInfo : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetMatchingPosInterpInfo operator +(GSDel_SetMatchingPosInterpInfo GSEvent, Del_SetMatchingPosInterpInfo Del)
	{
	...
	{
		_MultiCastDel?.Invoke(MoveTargetTransform, InterpolationTime, EnableZAxisMove);
	}
}
