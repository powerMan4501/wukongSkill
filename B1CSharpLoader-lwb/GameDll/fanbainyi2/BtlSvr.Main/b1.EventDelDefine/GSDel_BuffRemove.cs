...
public class GSDel_BuffRemove : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_BuffRemove operator +(GSDel_BuffRemove GSEvent, Del_BuffRemove Del)
	{
	...
	{
		_MultiCastDel?.Invoke(BuffID, RemoveTriggerType, Layer, WithTriggerRemmoveEffect);
	}
}
