...
public class GSDel_OnWeaponDestroyed : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_OnWeaponDestroyed operator +(GSDel_OnWeaponDestroyed GSEvent, Del_OnWeaponDestroyed Del)
	{
