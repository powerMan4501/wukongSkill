...
public class GSDel_FakeDeadForSkillDamage_ICB : IFreshAbleGSEvent
{
	private Del_FakeDeadForSkillDamage _InvokeCallBack;

	private Action<Del_FakeDeadForSkillDamage> _MultiCastDelChgCallBack;
	...
	public GSDel_FakeDeadForSkillDamage_ICB(Del_FakeDeadForSkillDamage InvokeCallBack, Action<Del_FakeDeadForSkillDamage> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_FakeDeadForSkillDamage_ICB operator +(GSDel_FakeDeadForSkillDamage_ICB GSEvent, Del_FakeDeadForSkillDamage Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(Attacker, StiffLevel, BeAttackedAM, in EffectInstReq, bIsDotDmg, AbnormalType);
	}
}
