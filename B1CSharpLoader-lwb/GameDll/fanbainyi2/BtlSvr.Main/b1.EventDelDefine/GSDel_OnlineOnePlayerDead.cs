...
public class GSDel_OnlineOnePlayerDead : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_OnlineOnePlayerDead operator +(GSDel_OnlineOnePlayerDead GSEvent, Del_OnlineOnePlayerDead Del)
	{
