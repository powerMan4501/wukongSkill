...
public class GSDel_Void_FName_ICB : IFreshAbleGSEvent
{
	private Del_Void_FName _InvokeCallBack;

	private Action<Del_Void_FName> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_FName_ICB(Del_Void_FName InvokeCallBack, Action<Del_Void_FName> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_FName_ICB operator +(GSDel_Void_FName_ICB GSEvent, Del_Void_FName Del)
	{
