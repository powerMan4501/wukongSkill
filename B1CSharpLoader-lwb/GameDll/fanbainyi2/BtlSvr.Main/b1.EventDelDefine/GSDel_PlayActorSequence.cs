...
public class GSDel_PlayActorSequence : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_PlayActorSequence operator +(GSDel_PlayActorSequence GSEvent, Del_PlayActorSequence Del)
	{
	...
	{
		_MultiCastDel?.Invoke(MasterActor, LevelSeq, Socket, AttachToSocket, bAttachToCapsuleRoot, bDontRotateWithMaster);
	}
}
