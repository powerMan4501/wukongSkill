...
public class GSDel_Bool_GameplayTag_ICB : IFreshAbleGSEvent
{
	private Del_Bool_GameplayTag _InvokeCallBack;

	private Action<Del_Bool_GameplayTag> _MultiCastDelChgCallBack;
	...
	public GSDel_Bool_GameplayTag_ICB(Del_Bool_GameplayTag InvokeCallBack, Action<Del_Bool_GameplayTag> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Bool_GameplayTag_ICB operator +(GSDel_Bool_GameplayTag_ICB GSEvent, Del_Bool_GameplayTag Del)
	{
