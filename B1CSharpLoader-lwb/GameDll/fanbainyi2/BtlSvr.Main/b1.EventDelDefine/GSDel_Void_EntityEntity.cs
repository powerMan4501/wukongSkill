...
public class GSDel_Void_EntityEntity : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Void_EntityEntity operator +(GSDel_Void_EntityEntity GSEvent, Del_Void_EntityEntity Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Entity1, Entity2);
	}
}
