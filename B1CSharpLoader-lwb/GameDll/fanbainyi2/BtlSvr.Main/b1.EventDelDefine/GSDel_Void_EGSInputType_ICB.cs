...
public class GSDel_Void_EGSInputType_ICB : IFreshAbleGSEvent
{
	private Del_Void_EGSInputType _InvokeCallBack;

	private Action<Del_Void_EGSInputType> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_EGSInputType_ICB(Del_Void_EGSInputType InvokeCallBack, Action<Del_Void_EGSInputType> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_EGSInputType_ICB operator +(GSDel_Void_EGSInputType_ICB GSEvent, Del_Void_EGSInputType Del)
	{
