...
public class GSDel_Void_SummonInstance : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Void_SummonInstance operator +(GSDel_Void_SummonInstance GSEvent, Del_Void_SummonInstance Del)
	{
	...
	{
		_MultiCastDel?.Invoke(InSummonInstance);
	}
}
