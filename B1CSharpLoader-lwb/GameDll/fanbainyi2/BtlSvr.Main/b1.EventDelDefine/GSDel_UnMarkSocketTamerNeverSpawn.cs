...
public class GSDel_UnMarkSocketTamerNeverSpawn : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_UnMarkSocketTamerNeverSpawn operator +(GSDel_UnMarkSocketTamerNeverSpawn GSEvent, Del_UnMarkSocketTamerNeverSpawn Del)
	{
	...
	{
		_MultiCastDel?.Invoke(RootActor, MatchInfo);
	}
}
