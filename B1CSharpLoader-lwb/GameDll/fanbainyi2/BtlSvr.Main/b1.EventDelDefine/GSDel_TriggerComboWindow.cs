...
public class GSDel_TriggerComboWindow : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerComboWindow operator +(GSDel_TriggerComboWindow GSEvent, Del_TriggerComboWindow Del)
	{
	...
	{
		_MultiCastDel?.Invoke(MontageInstanceID, NotifyUniqueID, GroupID, BlackListComboSkillID, WhiteListComboSkillID, TotalDuration);
	}
}
