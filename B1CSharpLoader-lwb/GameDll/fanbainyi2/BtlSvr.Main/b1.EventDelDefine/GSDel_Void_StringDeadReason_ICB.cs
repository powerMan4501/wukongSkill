...
public class GSDel_Void_StringDeadReason_ICB : IFreshAbleGSEvent
{
	private Del_Void_StringDeadReason _InvokeCallBack;

	private Action<Del_Void_StringDeadReason> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_StringDeadReason_ICB(Del_Void_StringDeadReason InvokeCallBack, Action<Del_Void_StringDeadReason> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_StringDeadReason_ICB operator +(GSDel_Void_StringDeadReason_ICB GSEvent, Del_Void_StringDeadReason Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(UnitGuid, DeadReason);
	}
}
