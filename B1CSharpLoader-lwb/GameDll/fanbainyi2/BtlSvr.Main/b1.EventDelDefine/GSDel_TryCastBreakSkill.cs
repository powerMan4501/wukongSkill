...
public class GSDel_TryCastBreakSkill : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TryCastBreakSkill operator +(GSDel_TryCastBreakSkill GSEvent, Del_TryCastBreakSkill Del)
	{
