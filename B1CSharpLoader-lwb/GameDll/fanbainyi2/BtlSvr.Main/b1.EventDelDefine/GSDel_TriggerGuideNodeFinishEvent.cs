...
public class GSDel_TriggerGuideNodeFinishEvent : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerGuideNodeFinishEvent operator +(GSDel_TriggerGuideNodeFinishEvent GSEvent, Del_TriggerGuideNodeFinishEvent Del)
	{
	...
	{
		_MultiCastDel?.Invoke(FinishType);
	}
}
