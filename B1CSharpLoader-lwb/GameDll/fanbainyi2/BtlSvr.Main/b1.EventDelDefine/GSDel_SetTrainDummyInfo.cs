...
public class GSDel_SetTrainDummyInfo : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetTrainDummyInfo operator +(GSDel_SetTrainDummyInfo GSEvent, Del_SetTrainDummyInfo Del)
	{
	...
	{
		_MultiCastDel?.Invoke(TrainDummyClassPath, PlayerRoleDataConfigID, TrainDummyConfigPath, DPSCalTime);
	}
}
