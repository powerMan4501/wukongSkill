...
public class GSDel_EQSRunAction : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_EQSRunAction operator +(GSDel_EQSRunAction GSEvent, Del_EQSRunAction Del)
	{
	...
	{
		_MultiCastDel?.Invoke(EnvQuery, MaxTime);
	}
}
