...
public class GSDel_TriggerFreezeFrame : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerFreezeFrame operator +(GSDel_TriggerFreezeFrame GSEvent, Del_TriggerFreezeFrame Del)
	{
	...
	{
		_MultiCastDel?.Invoke(TotalFreezeTime, FreezeGap, EnableCache, bPlayedMontage);
	}
}
