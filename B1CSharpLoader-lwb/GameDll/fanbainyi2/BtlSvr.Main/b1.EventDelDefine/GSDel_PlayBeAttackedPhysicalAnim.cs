...
public class GSDel_PlayBeAttackedPhysicalAnim : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_PlayBeAttackedPhysicalAnim operator +(GSDel_PlayBeAttackedPhysicalAnim GSEvent, Del_PlayBeAttackedPhysicalAnim Del)
	{
	...
	{
		_MultiCastDel?.Invoke(HitWeight, HitDirection, HitLocation);
	}
}
