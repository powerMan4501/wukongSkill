...
public class GSDel_RegisterTamerAuthInfo : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_RegisterTamerAuthInfo operator +(GSDel_RegisterTamerAuthInfo GSEvent, Del_RegisterTamerAuthInfo Del)
	{
	...
	{
		_MultiCastDel?.Invoke(TamerGuid, PlayerController);
	}
}
