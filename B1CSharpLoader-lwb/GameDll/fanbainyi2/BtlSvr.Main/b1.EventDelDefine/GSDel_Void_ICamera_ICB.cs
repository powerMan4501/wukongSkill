...
public class GSDel_Void_ICamera_ICB : IFreshAbleGSEvent
{
	private Del_Void_ICamera _InvokeCallBack;

	private Action<Del_Void_ICamera> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_ICamera_ICB(Del_Void_ICamera InvokeCallBack, Action<Del_Void_ICamera> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_ICamera_ICB operator +(GSDel_Void_ICamera_ICB GSEvent, Del_Void_ICamera Del)
	{
