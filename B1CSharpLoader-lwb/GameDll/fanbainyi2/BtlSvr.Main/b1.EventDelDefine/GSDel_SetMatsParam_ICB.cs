...
public class GSDel_SetMatsParam_ICB : IFreshAbleGSEvent
{
	private Del_SetMatsParam _InvokeCallBack;

	private Action<Del_SetMatsParam> _MultiCastDelChgCallBack;
	...
	public GSDel_SetMatsParam_ICB(Del_SetMatsParam InvokeCallBack, Action<Del_SetMatsParam> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_SetMatsParam_ICB operator +(GSDel_SetMatsParam_ICB GSEvent, Del_SetMatsParam Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(ParamName, in NewMPI, ForceUpdateDefaultValue);
	}
}
