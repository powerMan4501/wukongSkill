...
public class GSDel_RegisterBattleCallback : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_RegisterBattleCallback operator +(GSDel_RegisterBattleCallback GSEvent, Del_RegisterBattleCallback Del)
	{
