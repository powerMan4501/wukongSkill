...
public class GSDel_Camera_EnableGuiBeiCamera : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Camera_EnableGuiBeiCamera operator +(GSDel_Camera_EnableGuiBeiCamera GSEvent, Del_Camera_EnableGuiBeiCamera Del)
	{
	...
	{
		_MultiCastDel?.Invoke(InverseAnimRotator);
	}
}
