...
public class GSDel_SetDeadInfoID : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetDeadInfoID operator +(GSDel_SetDeadInfoID GSEvent, Del_SetDeadInfoID Del)
	{
