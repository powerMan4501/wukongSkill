...
public class GSDel_SetUnitCameraID : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetUnitCameraID operator +(GSDel_SetUnitCameraID GSEvent, Del_SetUnitCameraID Del)
	{
