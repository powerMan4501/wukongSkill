...
public class GSDel_PlayOrStopAnimation : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_PlayOrStopAnimation operator +(GSDel_PlayOrStopAnimation GSEvent, Del_PlayOrStopAnimation Del)
	{
	...
	{
		_MultiCastDel?.Invoke(IsPlay, IsLoop, NewAnimToPlay);
	}
}
