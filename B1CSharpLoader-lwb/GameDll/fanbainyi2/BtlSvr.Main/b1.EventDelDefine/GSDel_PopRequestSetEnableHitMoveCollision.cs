...
public class GSDel_PopRequestSetEnableHitMoveCollision : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_PopRequestSetEnableHitMoveCollision operator +(GSDel_PopRequestSetEnableHitMoveCollision GSEvent, Del_PopRequestSetEnableHitMoveCollision Del)
	{
	...
	{
		_MultiCastDel?.Invoke(RequestID);
	}
}
