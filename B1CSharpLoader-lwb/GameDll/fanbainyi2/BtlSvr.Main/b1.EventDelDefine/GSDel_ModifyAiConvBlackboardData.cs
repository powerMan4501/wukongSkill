...
public class GSDel_ModifyAiConvBlackboardData : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ModifyAiConvBlackboardData operator +(GSDel_ModifyAiConvBlackboardData GSEvent, Del_ModifyAiConvBlackboardData Del)
	{
	...
	{
		_MultiCastDel?.Invoke(KeyName, OperateType, ModifyContent);
	}
}
