...
public class GSDel_ModifySkillScore : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ModifySkillScore operator +(GSDel_ModifySkillScore GSEvent, Del_ModifySkillScore Del)
	{
	...
	{
		_MultiCastDel?.Invoke(SuccessInfoList, FailedInfoList);
	}
}
