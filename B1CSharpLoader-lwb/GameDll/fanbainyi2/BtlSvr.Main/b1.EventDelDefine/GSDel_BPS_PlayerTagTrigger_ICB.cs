...
public class GSDel_BPS_PlayerTagTrigger_ICB : IFreshAbleGSEvent
{
	private Del_BPS_PlayerTagTrigger _InvokeCallBack;

	private Action<Del_BPS_PlayerTagTrigger> _MultiCastDelChgCallBack;
	...
	public GSDel_BPS_PlayerTagTrigger_ICB(Del_BPS_PlayerTagTrigger InvokeCallBack, Action<Del_BPS_PlayerTagTrigger> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_BPS_PlayerTagTrigger_ICB operator +(GSDel_BPS_PlayerTagTrigger_ICB GSEvent, Del_BPS_PlayerTagTrigger Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(TagTrigger, Time, NeedForceUpdate);
	}
}
