...
public class GSDel_TriggerSkillEffectBySkill_WithoutRPC : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerSkillEffectBySkill_WithoutRPC operator +(GSDel_TriggerSkillEffectBySkill_WithoutRPC GSEvent, Del_TriggerSkillEffectBySkill_WithoutRPC Del)
	{
	...
	{
		_MultiCastDel?.Invoke(EffectID, Caster, Target, in EffectInstReq);
	}
}
