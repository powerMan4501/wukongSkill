...
public class GSDel_Void_FloatFloatFloat_ICB : IFreshAbleGSEvent
{
	private Del_Void_FloatFloatFloat _InvokeCallBack;

	private Action<Del_Void_FloatFloatFloat> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_FloatFloatFloat_ICB(Del_Void_FloatFloatFloat InvokeCallBack, Action<Del_Void_FloatFloatFloat> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_FloatFloatFloat_ICB operator +(GSDel_Void_FloatFloatFloat_ICB GSEvent, Del_Void_FloatFloatFloat Del)
	{
