...
public class GSDel_AddUnitToWave : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_AddUnitToWave operator +(GSDel_AddUnitToWave GSEvent, Del_AddUnitToWave Del)
	{
