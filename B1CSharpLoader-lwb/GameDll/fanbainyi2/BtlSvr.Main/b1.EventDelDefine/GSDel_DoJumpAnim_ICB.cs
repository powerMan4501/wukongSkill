...
public class GSDel_DoJumpAnim_ICB : IFreshAbleGSEvent
{
	private Del_DoJumpAnim _InvokeCallBack;

	private Action<Del_DoJumpAnim> _MultiCastDelChgCallBack;
	...
	public GSDel_DoJumpAnim_ICB(Del_DoJumpAnim InvokeCallBack, Action<Del_DoJumpAnim> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_DoJumpAnim_ICB operator +(GSDel_DoJumpAnim_ICB GSEvent, Del_DoJumpAnim Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(bIsJumping, StartJumpDir, StartJumpSpdState, JumpType);
	}
}
