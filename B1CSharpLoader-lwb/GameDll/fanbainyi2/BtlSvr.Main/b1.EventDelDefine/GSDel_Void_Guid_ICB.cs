...
public class GSDel_Void_Guid_ICB : IFreshAbleGSEvent
{
	private Del_Void_Guid _InvokeCallBack;

	private Action<Del_Void_Guid> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_Guid_ICB(Del_Void_Guid InvokeCallBack, Action<Del_Void_Guid> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_Guid_ICB operator +(GSDel_Void_Guid_ICB GSEvent, Del_Void_Guid Del)
	{
