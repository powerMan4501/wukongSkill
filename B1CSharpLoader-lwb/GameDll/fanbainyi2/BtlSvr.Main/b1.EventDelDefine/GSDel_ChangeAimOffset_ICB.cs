...
public class GSDel_ChangeAimOffset_ICB : IFreshAbleGSEvent
{
	private Del_ChangeAimOffset _InvokeCallBack;

	private Action<Del_ChangeAimOffset> _MultiCastDelChgCallBack;
	...
	public GSDel_ChangeAimOffset_ICB(Del_ChangeAimOffset InvokeCallBack, Action<Del_ChangeAimOffset> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_ChangeAimOffset_ICB operator +(GSDel_ChangeAimOffset_ICB GSEvent, Del_ChangeAimOffset Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(bIsDefaultAO, AimOffset);
	}
}
