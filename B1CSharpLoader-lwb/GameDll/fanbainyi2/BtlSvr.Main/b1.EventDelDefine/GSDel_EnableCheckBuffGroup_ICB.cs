...
public class GSDel_EnableCheckBuffGroup_ICB : IFreshAbleGSEvent
{
	private Del_EnableCheckBuffGroup _InvokeCallBack;

	private Action<Del_EnableCheckBuffGroup> _MultiCastDelChgCallBack;
	...
	public GSDel_EnableCheckBuffGroup_ICB(Del_EnableCheckBuffGroup InvokeCallBack, Action<Del_EnableCheckBuffGroup> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_EnableCheckBuffGroup_ICB operator +(GSDel_EnableCheckBuffGroup_ICB GSEvent, Del_EnableCheckBuffGroup Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(BuffGroupID, TotalLayerCount, RequiredActiveBuffCount, AddBuffID);
	}
}
