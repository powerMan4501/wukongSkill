...
public class GSDel_DisableTargetAttackIK : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_DisableTargetAttackIK operator +(GSDel_DisableTargetAttackIK GSEvent, Del_DisableTargetAttackIK Del)
	{
