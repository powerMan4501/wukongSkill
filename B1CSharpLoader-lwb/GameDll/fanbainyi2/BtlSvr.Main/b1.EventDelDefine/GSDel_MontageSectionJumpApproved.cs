...
public class GSDel_MontageSectionJumpApproved : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_MontageSectionJumpApproved operator +(GSDel_MontageSectionJumpApproved GSEvent, Del_MontageSectionJumpApproved Del)
	{
	...
	{
		_MultiCastDel?.Invoke(SectionJumpType, TimeBeforeNextSection);
	}
}
