...
public class GSDel_Void_LevelArchiveBaseDataMap : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Void_LevelArchiveBaseDataMap operator +(GSDel_Void_LevelArchiveBaseDataMap GSEvent, Del_Void_LevelArchiveBaseDataMap Del)
	{
