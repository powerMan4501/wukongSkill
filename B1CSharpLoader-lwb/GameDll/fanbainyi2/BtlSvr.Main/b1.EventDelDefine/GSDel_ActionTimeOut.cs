...
public class GSDel_ActionTimeOut : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ActionTimeOut operator +(GSDel_ActionTimeOut GSEvent, Del_ActionTimeOut Del)
	{
	...
	{
		_MultiCastDel?.Invoke(TargetLocation);
	}
}
