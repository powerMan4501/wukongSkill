...
public class GSDel_AddPointsToQuene_ICB : IFreshAbleGSEvent
{
	private Del_AddPointsToQuene _InvokeCallBack;

	private Action<Del_AddPointsToQuene> _MultiCastDelChgCallBack;
	...
	public GSDel_AddPointsToQuene_ICB(Del_AddPointsToQuene InvokeCallBack, Action<Del_AddPointsToQuene> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_AddPointsToQuene_ICB operator +(GSDel_AddPointsToQuene_ICB GSEvent, Del_AddPointsToQuene Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(RequestID, Points, bClearTheReqQuene);
	}
}
