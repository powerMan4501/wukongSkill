...
public class GSDel_BGS_BeginAnimationSyncPreCheck_ICB : IFreshAbleGSEvent
{
	private Del_BGS_BeginAnimationSyncPreCheck _InvokeCallBack;

	private Action<Del_BGS_BeginAnimationSyncPreCheck> _MultiCastDelChgCallBack;
	...
	public GSDel_BGS_BeginAnimationSyncPreCheck_ICB(Del_BGS_BeginAnimationSyncPreCheck InvokeCallBack, Action<Del_BGS_BeginAnimationSyncPreCheck> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_BGS_BeginAnimationSyncPreCheck_ICB operator +(GSDel_BGS_BeginAnimationSyncPreCheck_ICB GSEvent, Del_BGS_BeginAnimationSyncPreCheck Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(Host, bForceSuccess, DetectionConfig, JumpToSectionName, bEnableDebugDraw, AnimationSyncMontage);
	}
}
