...
public class GSDel_String_Actor_ICB : IFreshAbleGSEvent
{
	private Del_String_Actor _InvokeCallBack;

	private Action<Del_String_Actor> _MultiCastDelChgCallBack;
	...
	public GSDel_String_Actor_ICB(Del_String_Actor InvokeCallBack, Action<Del_String_Actor> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_String_Actor_ICB operator +(GSDel_String_Actor_ICB GSEvent, Del_String_Actor Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(s1, Actor);
	}
}
