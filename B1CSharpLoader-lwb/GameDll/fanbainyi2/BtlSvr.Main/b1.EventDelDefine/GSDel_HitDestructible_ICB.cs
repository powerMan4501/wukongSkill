...
public class GSDel_HitDestructible_ICB : IFreshAbleGSEvent
{
	private Del_HitDestructible _InvokeCallBack;

	private Action<Del_HitDestructible> _MultiCastDelChgCallBack;
	...
	public GSDel_HitDestructible_ICB(Del_HitDestructible InvokeCallBack, Action<Del_HitDestructible> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_HitDestructible_ICB operator +(GSDel_HitDestructible_ICB GSEvent, Del_HitDestructible Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(Attacker, HitStrengthLevel, HitDirectionType, EffectInstReq, ImpulseStrength);
	}
}
