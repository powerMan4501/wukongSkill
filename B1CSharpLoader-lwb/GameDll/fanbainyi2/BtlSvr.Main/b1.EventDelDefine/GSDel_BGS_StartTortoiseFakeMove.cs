...
public class GSDel_BGS_StartTortoiseFakeMove : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_BGS_StartTortoiseFakeMove operator +(GSDel_BGS_StartTortoiseFakeMove GSEvent, Del_BGS_StartTortoiseFakeMove Del)
	{
	...
	{
		_MultiCastDel?.Invoke(InverseAnim, IsLoop);
	}
}
