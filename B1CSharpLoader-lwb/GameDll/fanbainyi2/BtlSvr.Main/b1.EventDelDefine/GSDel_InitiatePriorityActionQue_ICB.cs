...
public class GSDel_InitiatePriorityActionQue_ICB : IFreshAbleGSEvent
{
	private Del_InitiatePriorityActionQue _InvokeCallBack;

	private Action<Del_InitiatePriorityActionQue> _MultiCastDelChgCallBack;
	...
	public GSDel_InitiatePriorityActionQue_ICB(Del_InitiatePriorityActionQue InvokeCallBack, Action<Del_InitiatePriorityActionQue> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_InitiatePriorityActionQue_ICB operator +(GSDel_InitiatePriorityActionQue_ICB GSEvent, Del_InitiatePriorityActionQue Del)
	{
