...
public class GSDel_SetSuperArmorLevelMapping : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetSuperArmorLevelMapping operator +(GSDel_SetSuperArmorLevelMapping GSEvent, Del_SetSuperArmorLevelMapping Del)
	{
	...
	{
		_MultiCastDel?.Invoke(BuffID, OriginalLevelName, TargetLevelName, ValueIntervalMin, ValueIntervalMax, ValueBias);
	}
}
