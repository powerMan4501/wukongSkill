...
public class GSDel_RequestSpawnFXByDispConfigWithEmitterInfo : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_RequestSpawnFXByDispConfigWithEmitterInfo operator +(GSDel_RequestSpawnFXByDispConfigWithEmitterInfo GSEvent, Del_RequestSpawnFXByDispConfigWithEmitterInfo Del)
	{
	...
	{
		RequestID = 0;
		_MultiCastDel?.Invoke(DispConfigDAPath, out RequestID, EmitterDispOwnerComp, EmitterPosWSOnSpawn);
	}
}
