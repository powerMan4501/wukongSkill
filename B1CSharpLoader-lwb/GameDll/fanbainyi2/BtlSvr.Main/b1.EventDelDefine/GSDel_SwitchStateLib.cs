...
public class GSDel_SwitchStateLib : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SwitchStateLib operator +(GSDel_SwitchStateLib GSEvent, Del_SwitchStateLib Del)
	{
	...
	{
		_MultiCastDel?.Invoke(DataAssetPath, TypesToApply, SwitchType);
	}
}
