...
public class GSDel_SetFloatProperty : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetFloatProperty operator +(GSDel_SetFloatProperty GSEvent, Del_SetFloatProperty Del)
	{
