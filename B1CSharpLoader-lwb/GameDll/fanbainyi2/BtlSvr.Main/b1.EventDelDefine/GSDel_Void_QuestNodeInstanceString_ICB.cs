...
public class GSDel_Void_QuestNodeInstanceString_ICB : IFreshAbleGSEvent
{
	private Del_Void_QuestNodeInstanceString _InvokeCallBack;

	private Action<Del_Void_QuestNodeInstanceString> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_QuestNodeInstanceString_ICB(Del_Void_QuestNodeInstanceString InvokeCallBack, Action<Del_Void_QuestNodeInstanceString> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_QuestNodeInstanceString_ICB operator +(GSDel_Void_QuestNodeInstanceString_ICB GSEvent, Del_Void_QuestNodeInstanceString Del)
	{
