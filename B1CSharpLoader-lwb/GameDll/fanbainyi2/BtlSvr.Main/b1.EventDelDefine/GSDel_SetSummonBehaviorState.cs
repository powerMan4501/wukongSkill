...
public class GSDel_SetSummonBehaviorState : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetSummonBehaviorState operator +(GSDel_SetSummonBehaviorState GSEvent, Del_SetSummonBehaviorState Del)
	{
	...
	{
		_MultiCastDel?.Invoke(State, NeedForceSet);
	}
}
