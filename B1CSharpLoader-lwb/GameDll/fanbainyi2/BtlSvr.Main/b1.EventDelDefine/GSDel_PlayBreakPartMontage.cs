...
public class GSDel_PlayBreakPartMontage : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_PlayBreakPartMontage operator +(GSDel_PlayBreakPartMontage GSEvent, Del_PlayBreakPartMontage Del)
	{
	...
	{
		_MultiCastDel?.Invoke(PartID, BreakerGUID, AttackerArea);
	}
}
