...
public class GSDel_SetSkillPreviewConfig : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetSkillPreviewConfig operator +(GSDel_SetSkillPreviewConfig GSEvent, Del_SetSkillPreviewConfig Del)
	{
	...
	{
		_MultiCastDel?.Invoke(SkillPreviewConfig);
	}
}
