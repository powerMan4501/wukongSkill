...
public class GSDel_TriggerRollSkill : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerRollSkill operator +(GSDel_TriggerRollSkill GSEvent, Del_TriggerRollSkill Del)
	{
