...
public class GSDel_Void_DreamTeleport_ICB : IFreshAbleGSEvent
{
	private Del_Void_DreamTeleport _InvokeCallBack;

	private Action<Del_Void_DreamTeleport> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_DreamTeleport_ICB(Del_Void_DreamTeleport InvokeCallBack, Action<Del_Void_DreamTeleport> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_DreamTeleport_ICB operator +(GSDel_Void_DreamTeleport_ICB GSEvent, Del_Void_DreamTeleport Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(DreamTeleportInfo);
	}
}
