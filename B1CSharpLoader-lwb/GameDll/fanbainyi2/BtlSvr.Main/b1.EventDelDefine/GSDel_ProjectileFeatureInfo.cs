...
public class GSDel_ProjectileFeatureInfo : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ProjectileFeatureInfo operator +(GSDel_ProjectileFeatureInfo GSEvent, Del_ProjectileFeatureInfo Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ChargeLife, HitNumMax, HitNum);
	}
}
