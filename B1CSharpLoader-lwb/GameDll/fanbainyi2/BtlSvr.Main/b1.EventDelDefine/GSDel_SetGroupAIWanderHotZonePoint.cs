...
public class GSDel_SetGroupAIWanderHotZonePoint : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetGroupAIWanderHotZonePoint operator +(GSDel_SetGroupAIWanderHotZonePoint GSEvent, Del_SetGroupAIWanderHotZonePoint Del)
	{
