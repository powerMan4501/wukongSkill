...
public class GSDel_TriggerScarFX : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerScarFX operator +(GSDel_TriggerScarFX GSEvent, Del_TriggerScarFX Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ScarInfoDescID, HitBoneName, HitLocation, HitPointNormalDir, HitTangent);
	}
}
