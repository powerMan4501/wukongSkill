...
public class GSDel_OnEndTireMarkByID_ICB : IFreshAbleGSEvent
{
	private Del_OnEndTireMarkByID _InvokeCallBack;

	private Action<Del_OnEndTireMarkByID> _MultiCastDelChgCallBack;
	...
	public GSDel_OnEndTireMarkByID_ICB(Del_OnEndTireMarkByID InvokeCallBack, Action<Del_OnEndTireMarkByID> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_OnEndTireMarkByID_ICB operator +(GSDel_OnEndTireMarkByID_ICB GSEvent, Del_OnEndTireMarkByID Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(NotifyInstID);
	}
}
