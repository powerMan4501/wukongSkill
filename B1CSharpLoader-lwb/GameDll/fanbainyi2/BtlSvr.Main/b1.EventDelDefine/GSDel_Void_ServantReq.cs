...
public class GSDel_Void_ServantReq : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Void_ServantReq operator +(GSDel_Void_ServantReq GSEvent, Del_Void_ServantReq Del)
	{
	...
	{
		_MultiCastDel?.Invoke(InServantReq);
	}
}
