...
public class GSDel_ChangeBar_ICB : IFreshAbleGSEvent
{
	private Del_ChangeBar _InvokeCallBack;

	private Action<Del_ChangeBar> _MultiCastDelChgCallBack;
	...
	public GSDel_ChangeBar_ICB(Del_ChangeBar InvokeCallBack, Action<Del_ChangeBar> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_ChangeBar_ICB operator +(GSDel_ChangeBar_ICB GSEvent, Del_ChangeBar Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(ShowType);
	}
}
