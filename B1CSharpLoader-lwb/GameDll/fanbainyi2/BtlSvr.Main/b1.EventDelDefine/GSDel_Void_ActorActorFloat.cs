...
public class GSDel_Void_ActorActorFloat : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Void_ActorActorFloat operator +(GSDel_Void_ActorActorFloat GSEvent, Del_Void_ActorActorFloat Del)
	{
