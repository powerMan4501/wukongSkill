...
public class GSDel_OnPlayerPostLogin : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_OnPlayerPostLogin operator +(GSDel_OnPlayerPostLogin GSEvent, Del_OnPlayerPostLogin Del)
	{
