...
public class GSDel_PlayMappedSoundFX : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_PlayMappedSoundFX operator +(GSDel_PlayMappedSoundFX GSEvent, Del_PlayMappedSoundFX Del)
	{
	...
	{
		_MultiCastDel?.Invoke(EquipPosition, ActionTypeID, bIsFollow, SocketName);
	}
}
