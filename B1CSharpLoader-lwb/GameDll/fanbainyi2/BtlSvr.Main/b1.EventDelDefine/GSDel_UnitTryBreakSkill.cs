...
public class GSDel_UnitTryBreakSkill : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_UnitTryBreakSkill operator +(GSDel_UnitTryBreakSkill GSEvent, Del_UnitTryBreakSkill Del)
	{
