...
public class GSDel_Void_IntGameplayTag_ICB : IFreshAbleGSEvent
{
	private Del_Void_IntGameplayTag _InvokeCallBack;

	private Action<Del_Void_IntGameplayTag> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_IntGameplayTag_ICB(Del_Void_IntGameplayTag InvokeCallBack, Action<Del_Void_IntGameplayTag> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_IntGameplayTag_ICB operator +(GSDel_Void_IntGameplayTag_ICB GSEvent, Del_Void_IntGameplayTag Del)
	{
