...
public class GSDel_RequestAsyncLineTrace_ByObjectTypeSingle_Batch_ICB : IFreshAbleGSEvent
{
	private Del_RequestAsyncLineTrace_ByObjectTypeSingle_Batch _InvokeCallBack;

	private Action<Del_RequestAsyncLineTrace_ByObjectTypeSingle_Batch> _MultiCastDelChgCallBack;
	...
	public GSDel_RequestAsyncLineTrace_ByObjectTypeSingle_Batch_ICB(Del_RequestAsyncLineTrace_ByObjectTypeSingle_Batch InvokeCallBack, Action<Del_RequestAsyncLineTrace_ByObjectTypeSingle_Batch> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_RequestAsyncLineTrace_ByObjectTypeSingle_Batch_ICB operator +(GSDel_RequestAsyncLineTrace_ByObjectTypeSingle_Batch_ICB GSEvent, Del_RequestAsyncLineTrace_ByObjectTypeSingle_Batch Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(in ReqRef, ObjectTypes, Ingnores, bTraceComplex, _OnLineTraceFinishCallBack, bDebug);
	}
}
