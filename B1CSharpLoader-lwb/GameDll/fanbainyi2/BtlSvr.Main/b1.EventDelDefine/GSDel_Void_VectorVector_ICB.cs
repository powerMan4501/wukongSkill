...
public class GSDel_Void_VectorVector_ICB : IFreshAbleGSEvent
{
	private Del_Void_VectorVector _InvokeCallBack;

	private Action<Del_Void_VectorVector> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_VectorVector_ICB(Del_Void_VectorVector InvokeCallBack, Action<Del_Void_VectorVector> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_VectorVector_ICB operator +(GSDel_Void_VectorVector_ICB GSEvent, Del_Void_VectorVector Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(Vec1, Vec2);
	}
}
