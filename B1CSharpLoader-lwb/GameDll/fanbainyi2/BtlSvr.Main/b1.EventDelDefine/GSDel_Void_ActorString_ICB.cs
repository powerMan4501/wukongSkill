...
public class GSDel_Void_ActorString_ICB : IFreshAbleGSEvent
{
	private Del_Void_ActorString _InvokeCallBack;

	private Action<Del_Void_ActorString> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_ActorString_ICB(Del_Void_ActorString InvokeCallBack, Action<Del_Void_ActorString> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_ActorString_ICB operator +(GSDel_Void_ActorString_ICB GSEvent, Del_Void_ActorString Del)
	{
