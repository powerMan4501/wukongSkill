...
public class GSDel_NotifyEndSyncAnimation : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_NotifyEndSyncAnimation operator +(GSDel_NotifyEndSyncAnimation GSEvent, Del_NotifyEndSyncAnimation Del)
	{
	...
	{
		_MultiCastDel?.Invoke(PreAnimationSyncStateBuffList, AnimationSyncStateBuffList);
	}
}
