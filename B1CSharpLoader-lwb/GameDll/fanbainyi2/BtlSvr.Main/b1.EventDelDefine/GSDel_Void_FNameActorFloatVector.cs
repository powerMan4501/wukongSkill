...
public class GSDel_Void_FNameActorFloatVector : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Void_FNameActorFloatVector operator +(GSDel_Void_FNameActorFloatVector GSEvent, Del_Void_FNameActorFloatVector Del)
	{
