...
public class GSDel_ActionNodeFinish : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ActionNodeFinish operator +(GSDel_ActionNodeFinish GSEvent, Del_ActionNodeFinish Del)
	{
