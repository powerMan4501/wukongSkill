...
public class GSDel_AISetSpeedRate : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_AISetSpeedRate operator +(GSDel_AISetSpeedRate GSEvent, Del_AISetSpeedRate Del)
	{
	...
	{
		_MultiCastDel?.Invoke(SpeedRate, SpeedCtrlID);
	}
}
