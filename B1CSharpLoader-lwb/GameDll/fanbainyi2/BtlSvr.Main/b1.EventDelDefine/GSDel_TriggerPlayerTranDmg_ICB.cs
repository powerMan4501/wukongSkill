...
public class GSDel_TriggerPlayerTranDmg_ICB : IFreshAbleGSEvent
{
	private Del_TriggerPlayerTranDmg _InvokeCallBack;

	private Action<Del_TriggerPlayerTranDmg> _MultiCastDelChgCallBack;
	...
	public GSDel_TriggerPlayerTranDmg_ICB(Del_TriggerPlayerTranDmg InvokeCallBack, Action<Del_TriggerPlayerTranDmg> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_TriggerPlayerTranDmg_ICB operator +(GSDel_TriggerPlayerTranDmg_ICB GSEvent, Del_TriggerPlayerTranDmg Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(ResId, Dmg);
	}
}
