...
public class GSDel_InitUnitItemData : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_InitUnitItemData operator +(GSDel_InitUnitItemData GSEvent, Del_InitUnitItemData Del)
	{
	...
	{
		_MultiCastDel?.Invoke(HuluId, WineId, WineParterList);
	}
}
