...
public class GSDel_ReCoverFaBaoSkillCDDict : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_ReCoverFaBaoSkillCDDict operator +(GSDel_ReCoverFaBaoSkillCDDict GSEvent, Del_ReCoverFaBaoSkillCDDict Del)
	{
