...
public class GSDel_Void_IntListIntList : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Void_IntListIntList operator +(GSDel_Void_IntListIntList GSEvent, Del_Void_IntListIntList Del)
	{
