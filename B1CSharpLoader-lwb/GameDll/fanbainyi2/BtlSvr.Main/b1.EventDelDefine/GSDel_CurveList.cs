...
public class GSDel_CurveList : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_CurveList operator +(GSDel_CurveList GSEvent, Del_CurveList Del)
	{
	...
	{
		_MultiCastDel?.Invoke(ArmLengthCurve, RotatorCurve, SocketOffsetCurve);
	}
}
