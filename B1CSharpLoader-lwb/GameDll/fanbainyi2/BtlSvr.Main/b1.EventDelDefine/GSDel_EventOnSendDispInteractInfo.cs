...
public class GSDel_EventOnSendDispInteractInfo : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_EventOnSendDispInteractInfo operator +(GSDel_EventOnSendDispInteractInfo GSEvent, Del_EventOnSendDispInteractInfo Del)
	{
	...
	{
		_MultiCastDel?.Invoke(Enable, InfoList);
	}
}
