...
public class GSDel_OnRotateWithCam_ICB : IFreshAbleGSEvent
{
	private Del_OnRotateWithCam _InvokeCallBack;

	private Action<Del_OnRotateWithCam> _MultiCastDelChgCallBack;
	...
	public GSDel_OnRotateWithCam_ICB(Del_OnRotateWithCam InvokeCallBack, Action<Del_OnRotateWithCam> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_OnRotateWithCam_ICB operator +(GSDel_OnRotateWithCam_ICB GSEvent, Del_OnRotateWithCam Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(CamDirInXYPlane, TurnSpeed);
	}
}
