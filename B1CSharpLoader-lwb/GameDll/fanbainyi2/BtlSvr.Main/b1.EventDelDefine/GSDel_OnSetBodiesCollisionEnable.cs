...
public class GSDel_OnSetBodiesCollisionEnable : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_OnSetBodiesCollisionEnable operator +(GSDel_OnSetBodiesCollisionEnable GSEvent, Del_OnSetBodiesCollisionEnable Del)
	{
	...
	{
		_MultiCastDel?.Invoke(BoneNames, Enable);
	}
}
