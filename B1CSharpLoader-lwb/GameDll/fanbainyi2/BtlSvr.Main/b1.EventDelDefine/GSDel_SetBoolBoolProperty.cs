...
public class GSDel_SetBoolBoolProperty : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetBoolBoolProperty operator +(GSDel_SetBoolBoolProperty GSEvent, Del_SetBoolBoolProperty Del)
	{
	...
	{
		_MultiCastDel?.Invoke(PropType, Value1, Value2, HandleID, NotifyUniqueID, bSetDefaultProperty);
	}
}
