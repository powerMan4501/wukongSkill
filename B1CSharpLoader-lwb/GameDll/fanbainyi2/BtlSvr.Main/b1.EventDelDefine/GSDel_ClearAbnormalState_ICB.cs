...
public class GSDel_ClearAbnormalState_ICB : IFreshAbleGSEvent
{
	private Del_ClearAbnormalState _InvokeCallBack;

	private Action<Del_ClearAbnormalState> _MultiCastDelChgCallBack;
	...
	public GSDel_ClearAbnormalState_ICB(Del_ClearAbnormalState InvokeCallBack, Action<Del_ClearAbnormalState> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_ClearAbnormalState_ICB operator +(GSDel_ClearAbnormalState_ICB GSEvent, Del_ClearAbnormalState Del)
	{
