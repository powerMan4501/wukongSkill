...
public class GSDel_Void_TeleportInfoBool_ICB : IFreshAbleGSEvent
{
	private Del_Void_TeleportInfoBool _InvokeCallBack;

	private Action<Del_Void_TeleportInfoBool> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_TeleportInfoBool_ICB(Del_Void_TeleportInfoBool InvokeCallBack, Action<Del_Void_TeleportInfoBool> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_TeleportInfoBool_ICB operator +(GSDel_Void_TeleportInfoBool_ICB GSEvent, Del_Void_TeleportInfoBool Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(TeleportInfo, bNeedSave);
	}
}
