...
public class GSDel_Void_BoolBool_ICB : IFreshAbleGSEvent
{
	private Del_Void_BoolBool _InvokeCallBack;

	private Action<Del_Void_BoolBool> _MultiCastDelChgCallBack;
	...
	public GSDel_Void_BoolBool_ICB(Del_Void_BoolBool InvokeCallBack, Action<Del_Void_BoolBool> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_Void_BoolBool_ICB operator +(GSDel_Void_BoolBool_ICB GSEvent, Del_Void_BoolBool Del)
	{
