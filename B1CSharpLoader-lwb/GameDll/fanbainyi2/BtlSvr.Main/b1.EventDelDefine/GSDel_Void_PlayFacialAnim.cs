...
public class GSDel_Void_PlayFacialAnim : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Void_PlayFacialAnim operator +(GSDel_Void_PlayFacialAnim GSEvent, Del_Void_PlayFacialAnim Del)
	{
	...
	{
		_MultiCastDel?.Invoke(AnimSequence, TimeOffset, AutoBlendOutTime);
	}
}
