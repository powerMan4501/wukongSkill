...
public class GSDel_OnShowDialogueBuddle : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_OnShowDialogueBuddle operator +(GSDel_OnShowDialogueBuddle GSEvent, Del_OnShowDialogueBuddle Del)
	{
