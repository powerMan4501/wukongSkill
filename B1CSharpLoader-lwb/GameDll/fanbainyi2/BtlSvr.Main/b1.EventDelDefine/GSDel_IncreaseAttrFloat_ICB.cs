...
public class GSDel_IncreaseAttrFloat_ICB : IFreshAbleGSEvent
{
	private Del_IncreaseAttrFloat _InvokeCallBack;

	private Action<Del_IncreaseAttrFloat> _MultiCastDelChgCallBack;
	...
	public GSDel_IncreaseAttrFloat_ICB(Del_IncreaseAttrFloat InvokeCallBack, Action<Del_IncreaseAttrFloat> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_IncreaseAttrFloat_ICB operator +(GSDel_IncreaseAttrFloat_ICB GSEvent, Del_IncreaseAttrFloat Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(AttrID, IncreaseValue);
	}
}
