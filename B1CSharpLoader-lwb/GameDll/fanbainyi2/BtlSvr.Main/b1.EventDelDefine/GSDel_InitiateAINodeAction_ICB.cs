...
public class GSDel_InitiateAINodeAction_ICB : IFreshAbleGSEvent
{
	private Del_InitiateAINodeAction _InvokeCallBack;

	private Action<Del_InitiateAINodeAction> _MultiCastDelChgCallBack;
	...
	public GSDel_InitiateAINodeAction_ICB(Del_InitiateAINodeAction InvokeCallBack, Action<Del_InitiateAINodeAction> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_InitiateAINodeAction_ICB operator +(GSDel_InitiateAINodeAction_ICB GSEvent, Del_InitiateAINodeAction Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(ActionType, AINodeActionInfo);
	}
}
