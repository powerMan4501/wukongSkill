...
public class GSDel_TriggerItemSkillAction_ShortCut : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_TriggerItemSkillAction_ShortCut operator +(GSDel_TriggerItemSkillAction_ShortCut GSEvent, Del_TriggerItemSkillAction_ShortCut Del)
	{
	...
	{
		_MultiCastDel?.Invoke(InputActionID, TriggerEvent, InputActionType);
	}
}
