...
public class GSDel_Bool_DetectCondition : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_Bool_DetectCondition operator +(GSDel_Bool_DetectCondition GSEvent, Del_Bool_DetectCondition Del)
	{
	...
	public bool Invoke(CalliopeCustom_DetectCondition DetectCondition)
	{
		...
		return _MultiCastDel(DetectCondition);
	}
}
