...
public class GSDel_SetParkourMoveAnimState_ICB : IFreshAbleGSEvent
{
	private Del_SetParkourMoveAnimState _InvokeCallBack;

	private Action<Del_SetParkourMoveAnimState> _MultiCastDelChgCallBack;
	...
	public GSDel_SetParkourMoveAnimState_ICB(Del_SetParkourMoveAnimState InvokeCallBack, Action<Del_SetParkourMoveAnimState> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_SetParkourMoveAnimState_ICB operator +(GSDel_SetParkourMoveAnimState_ICB GSEvent, Del_SetParkourMoveAnimState Del)
	{
