...
public class GSDel_SetNewTurnSkillID : IFreshAbleGSEvent
{
	public int EventId;
	...
	public static GSDel_SetNewTurnSkillID operator +(GSDel_SetNewTurnSkillID GSEvent, Del_SetNewTurnSkillID Del)
	{
