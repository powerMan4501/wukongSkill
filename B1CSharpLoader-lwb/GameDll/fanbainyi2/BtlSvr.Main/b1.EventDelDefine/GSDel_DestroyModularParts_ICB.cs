...
public class GSDel_DestroyModularParts_ICB : IFreshAbleGSEvent
{
	private Del_DestroyModularParts _InvokeCallBack;

	private Action<Del_DestroyModularParts> _MultiCastDelChgCallBack;
	...
	public GSDel_DestroyModularParts_ICB(Del_DestroyModularParts InvokeCallBack, Action<Del_DestroyModularParts> MultiCastDelChgCallBack)
	{
	...
	public static GSDel_DestroyModularParts_ICB operator +(GSDel_DestroyModularParts_ICB GSEvent, Del_DestroyModularParts Del)
	{
	...
	{
		_InvokeCallBack?.Invoke(BoneName, ComponentTag);
	}
}
