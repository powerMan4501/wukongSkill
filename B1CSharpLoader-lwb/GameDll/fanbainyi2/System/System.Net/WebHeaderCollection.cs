...
public class WebHeaderCollection : NameValueCollection, ISerializable
{
	...
	internal string Location
	{
		get
		{
			string input = ((m_CommonHeaders != null) ? m_CommonHeaders[8] : Get(s_CommonHeaderNames[8]));
			return HeaderEncoding.DecodeUtf8FromString(input);
		}
	}
	...
	public string this[HttpResponseHeader header]
	{
		...
		set
		{
			...
			{
				throw new ArgumentOutOfRangeException("value", value, SR.GetString("net_headers_toolong", ushort.MaxValue));
			}
	...
	public override int Count
	{
		...
		get
		{
			return ((m_InnerCollection != null) ? m_InnerCollection.Count : 0) + m_NumCommonHeaders;
		}
	}
	...
	protected void AddWithoutValidate(string headerName, string headerValue)
	{
		...
		{
			throw new ArgumentOutOfRangeException("headerValue", headerValue, SR.GetString("net_headers_toolong", ushort.MaxValue));
		}
		NormalizeCommonHeaders();
	...
	internal void ThrowOnRestrictedHeader(string headerName)
	{
		if (m_Type == WebHeaderCollectionType.HttpWebRequest)
		{
			...
			{
				throw new ArgumentException(SR.GetString("net_headerrestrict", headerName), "name");
			}
		}
	...
	public void Add(string header)
	{
		...
		{
			throw new ArgumentOutOfRangeException("value", name2, SR.GetString("net_headers_toolong", ushort.MaxValue));
		}
		NormalizeCommonHeaders();
		InvalidateCachedArrays();
