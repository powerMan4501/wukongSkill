...
public class WebClient : Component
{
	...
	public void DownloadFile(Uri address, string fileName)
	{
		if (Logging.On)
		{
			Logging.Enter(Logging.Web, this, "DownloadFile", address?.ToString() + ", " + fileName);
		}
		if (address == null)
		{
			throw new ArgumentNullException("address");
	...
	public Stream OpenWrite(Uri address, string method)
	{
		if (Logging.On)
		{
			Logging.Enter(Logging.Web, this, "OpenWrite", address?.ToString() + ", " + method);
		}
		if (address == null)
		{
			throw new ArgumentNullException("address");
	...
	public byte[] UploadData(Uri address, string method, byte[] data)
	{
		if (Logging.On)
		{
			Logging.Enter(Logging.Web, this, "UploadData", address?.ToString() + ", " + method);
		}
		if (address == null)
		{
			throw new ArgumentNullException("address");
	...
	public byte[] UploadFile(Uri address, string method, string fileName)
	{
		if (Logging.On)
		{
			Logging.Enter(Logging.Web, this, "UploadFile", address?.ToString() + ", " + method);
		}
		if (address == null)
		{
			throw new ArgumentNullException("address");
	...
	public byte[] UploadValues(Uri address, string method, NameValueCollection data)
	{
		if (Logging.On)
		{
			Logging.Enter(Logging.Web, this, "UploadValues", address?.ToString() + ", " + method);
		}
		if (address == null)
		{
			throw new ArgumentNullException("address");
		...
		try
		{
			...
			if (Logging.On)
			{
				Logging.Exit(Logging.Web, this, "UploadValues", address?.ToString() + ", " + method);
			}
			return result;
		}
		catch (Exception ex)
	...
	public string UploadString(Uri address, string method, string data)
	{
		if (Logging.On)
		{
			Logging.Enter(Logging.Web, this, "UploadString", address?.ToString() + ", " + method);
		}
		if (address == null)
		{
			throw new ArgumentNullException("address");
	...
	public void OpenWriteAsync(Uri address, string method, object userToken)
	{
		if (Logging.On)
		{
			Logging.Enter(Logging.Web, this, "OpenWriteAsync", address?.ToString() + ", " + method);
		}
		if (address == null)
		{
			throw new ArgumentNullException("address");
	...
	public void UploadDataAsync(Uri address, string method, byte[] data, object userToken)
	{
		if (Logging.On)
		{
			Logging.Enter(Logging.Web, this, "UploadDataAsync", address?.ToString() + ", " + method);
		}
		if (address == null)
		{
			throw new ArgumentNullException("address");
	...
	public void UploadFileAsync(Uri address, string method, string fileName, object userToken)
	{
		if (Logging.On)
		{
			Logging.Enter(Logging.Web, this, "UploadFileAsync", address?.ToString() + ", " + method);
		}
		if (address == null)
		{
			throw new ArgumentNullException("address");
	...
	public void UploadValuesAsync(Uri address, string method, NameValueCollection data, object userToken)
	{
		if (Logging.On)
		{
			Logging.Enter(Logging.Web, this, "UploadValuesAsync", address?.ToString() + ", " + method);
		}
		if (address == null)
		{
			throw new ArgumentNullException("address");
