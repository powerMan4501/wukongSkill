...
public abstract class UriParser
{
	...
	internal static bool DontEnableStrictRFC3986ReservedCharacterSets => System.LocalAppContextSwitches.DontEnableStrictRFC3986ReservedCharacterSets;

	internal static bool DontKeepUnicodeBidiFormattingCharacters => System.LocalAppContextSwitches.DontKeepUnicodeBidiFormattingCharacters;
	...
	private static void FetchSyntax(UriParser syntax, string lwrCaseSchemeName, int defaultPort)
	{
		...
		lock (m_Table)
		{
			...
			if (value != null)
			{
				throw new InvalidOperationException(SR.GetString("net_uri_AlreadyRegistered", value.SchemeName));
			}
