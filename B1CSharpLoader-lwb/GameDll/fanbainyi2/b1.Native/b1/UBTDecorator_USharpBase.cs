...
[BlueprintType]
[Blueprintable]
[UMetaPath("/Script/b1.BTDecorator_USharpBase", "b1", UnrealModuleType.Game)]
public class UBTDecorator_USharpBase : UBTDecorator
{
	...
	[UMetaPath("/Script/b1.BTDecorator_USharpBase:CustomDescription")]
	protected string CustomDescription
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1.BTDecorator_USharpBase:CustomDescription");
	...
	[UMetaPath("/Script/b1.BTDecorator_USharpBase:SetNodeNameInCS")]
	protected unsafe void SetNodeNameInCS(string NewNodeName)
	{
		CheckDestroyed();
		if (!SetNodeNameInCS_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/b1.BTDecorator_USharpBase:SetNodeNameInCS");
			return;
		}
	...
	[UMetaPath("/Script/b1.BTDecorator_USharpBase:RefreshNodeInfoInEditor")]
	public unsafe void RefreshNodeInfoInEditor()
	{
		CheckDestroyed();
		if (!RefreshNodeInfoInEditor_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/b1.BTDecorator_USharpBase:RefreshNodeInfoInEditor");
			return;
		}
	...
	[UMetaPath("/Script/b1.BTDecorator_USharpBase:OnPropertyChanged")]
	protected unsafe void OnPropertyChanged(string MemberName, string PropertyName)
	{
		CheckDestroyed();
		if (!OnPropertyChanged_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/b1.BTDecorator_USharpBase:OnPropertyChanged");
			return;
		}
	...
	[UMetaPath("/Script/b1.BTDecorator_USharpBase:ForceRefreshDetailView")]
	protected unsafe void ForceRefreshDetailView()
	{
		CheckDestroyed();
		if (!ForceRefreshDetailView_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/b1.BTDecorator_USharpBase:ForceRefreshDetailView");
			return;
		}
	...
	static UBTDecorator_USharpBase()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UBTDecorator_USharpBase)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UBTDecorator_USharpBase));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1.BTDecorator_USharpBase");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1.BTDecorator_USharpBase:SetNodeNameInCS", SetNodeNameInCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1.BTDecorator_USharpBase:RefreshNodeInfoInEditor", RefreshNodeInfoInEditor_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1.BTDecorator_USharpBase:OnPropertyChanged", OnPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1.BTDecorator_USharpBase:ForceRefreshDetailView", ForceRefreshDetailView_IsValid);
	}
}
