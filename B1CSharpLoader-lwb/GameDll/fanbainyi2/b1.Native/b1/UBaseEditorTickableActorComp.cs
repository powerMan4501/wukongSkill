...
[BlueprintType]
[UMetaPath("/Script/b1.BaseEditorTickableActorComp", "b1", UnrealModuleType.Game)]
public class UBaseEditorTickableActorComp : UBaseActorCompTickable
{
	...
	[UMetaPath("/Script/b1.BaseEditorTickableActorComp:OnPropertyChanged")]
	protected unsafe void OnPropertyChanged(string MemberName, string PropertyName)
	{
		CheckDestroyed();
		if (!OnPropertyChanged_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/b1.BaseEditorTickableActorComp:OnPropertyChanged");
			return;
		}
	...
	[UMetaPath("/Script/b1.BaseEditorTickableActorComp:ForceRefreshDetailView")]
	protected unsafe void ForceRefreshDetailView()
	{
		CheckDestroyed();
		if (!ForceRefreshDetailView_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/b1.BaseEditorTickableActorComp:ForceRefreshDetailView");
			return;
		}
	...
	static UBaseEditorTickableActorComp()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UBaseEditorTickableActorComp)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UBaseEditorTickableActorComp));
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1.BaseEditorTickableActorComp");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1.BaseEditorTickableActorComp:OnPropertyChanged", OnPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1.BaseEditorTickableActorComp:ForceRefreshDetailView", ForceRefreshDetailView_IsValid);
	}
}
