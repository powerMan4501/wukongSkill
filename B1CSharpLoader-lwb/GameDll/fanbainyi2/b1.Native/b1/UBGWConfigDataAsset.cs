...
[BlueprintType]
[Blueprintable]
[UMetaPath("/Script/b1.BGWConfigDataAsset", "b1", UnrealModuleType.Game)]
public class UBGWConfigDataAsset : UBGWDataAsset
{
	...
	[UMetaPath("/Script/b1.BGWConfigDataAsset:OnPropertyChanged")]
	protected unsafe void OnPropertyChanged(string MemberName, string PropertyName)
	{
		CheckDestroyed();
		if (!OnPropertyChanged_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/b1.BGWConfigDataAsset:OnPropertyChanged");
			return;
		}
	...
	[UMetaPath("/Script/b1.BGWConfigDataAsset:ForceRefreshDetailView")]
	protected unsafe void ForceRefreshDetailView()
	{
		CheckDestroyed();
		if (!ForceRefreshDetailView_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/b1.BGWConfigDataAsset:ForceRefreshDetailView");
			return;
		}
	...
	static UBGWConfigDataAsset()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UBGWConfigDataAsset)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UBGWConfigDataAsset));
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1.BGWConfigDataAsset");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1.BGWConfigDataAsset:OnPropertyChanged", OnPropertyChanged_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1.BGWConfigDataAsset:ForceRefreshDetailView", ForceRefreshDetailView_IsValid);
	}
}
