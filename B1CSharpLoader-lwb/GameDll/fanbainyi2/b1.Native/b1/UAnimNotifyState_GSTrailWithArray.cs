...
[BlueprintType]
[Blueprintable]
[UMetaPath("/Script/b1.AnimNotifyState_GSTrailWithArray", "b1", UnrealModuleType.Game)]
public class UAnimNotifyState_GSTrailWithArray : UAnimNotifyState
{
	...
	private TArrayReadOnlyMarshaler<FSocketName> SocketNameList_MarshalerCached;
	...
	[UMetaPath("/Script/b1.AnimNotifyState_GSTrailWithArray:PSTemplate")]
	public UParticleSystem PSTemplate
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1.AnimNotifyState_GSTrailWithArray:PSTemplate");
				return null;
			}
	...
	[UMetaPath("/Script/b1.AnimNotifyState_GSTrailWithArray:SocketNameList")]
	public TArrayReadOnly<FSocketName> SocketNameList
	{
		get
		{
			CheckDestroyed();
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1.AnimNotifyState_GSTrailWithArray:SocketNameList");
				return null;
			}
			if (SocketNameList_MarshalerCached == null)
			{
				SocketNameList_MarshalerCached = new TArrayReadOnlyMarshaler<FSocketName>(1, SocketNameList_PropertyAddress, CachedMarshalingDelegates<FSocketName, FSocketName>.FromNative, CachedMarshalingDelegates<FSocketName, FSocketName>.ToNative);
			}
			return SocketNameList_MarshalerCached.FromNative(IntPtr.Add(base.Address, SocketNameList_Offset));
		}
	}

	[UProperty(Flags = (PropFlags)6755469234274837uL)]
	[UMetaPath("/Script/b1.AnimNotifyState_GSTrailWithArray:WidthScaleMode")]
	public ETrailWidthMode WidthScaleMode
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1.AnimNotifyState_GSTrailWithArray:WidthScaleMode");
	...
	[UProperty(Flags = (PropFlags)6755469234274837uL)]
	[UMetaPath("/Script/b1.AnimNotifyState_GSTrailWithArray:WidthScaleCurve")]
	public FName WidthScaleCurve
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1.AnimNotifyState_GSTrailWithArray:WidthScaleCurve");
	...
	[UMetaPath("/Script/b1.AnimNotifyState_GSTrailWithArray:bRecycleSpawnedSystems")]
	public bool RecycleSpawnedSystems
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/b1.AnimNotifyState_GSTrailWithArray:bRecycleSpawnedSystems");
				return false;
			}
	...
	[UMetaPath("/Script/b1.AnimNotifyState_GSTrailWithArray:OverridePSTemplate")]
	public unsafe UParticleSystem OverridePSTemplate(USkeletalMeshComponent MeshComp, UAnimSequenceBase Animation)
	{
		...
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/b1.AnimNotifyState_GSTrailWithArray:OverridePSTemplate");
			return null;
		}
	...
	static UAnimNotifyState_GSTrailWithArray()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UAnimNotifyState_GSTrailWithArray)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UAnimNotifyState_GSTrailWithArray));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/b1.AnimNotifyState_GSTrailWithArray");
		...
		NativeReflectionCached.GetPropertyRef(ref SocketNameList_PropertyAddress, intPtr, "SocketNameList");
		SocketNameList_Offset = NativeReflectionCached.GetPropertyOffset(intPtr, "SocketNameList");
		SocketNameList_IsValid = NativeReflectionCached.ValidatePropertyClass(intPtr, "SocketNameList", Classes.FArrayProperty);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1.AnimNotifyState_GSTrailWithArray:OverridePSTemplate", OverridePSTemplate_IsValid);
	}
}
