...
[BlueprintType]
[UMetaPath("/Script/b1.BGWTickableWorldSubSystem", "b1", UnrealModuleType.Game)]
public class UBGWTickableWorldSubSystem : UTickableWorldSubsystem
{
	...
	private IntPtr OnTickCS_InstanceFunctionAddress;
	...
	private static FFieldAddress OnTickCS_DeltaTime_PropertyAddress;
	...
	[UMetaPath("/Script/b1.BGWTickableWorldSubSystem:PostInitializeCS")]
	public unsafe void PostInitializeCS()
	{
		CheckDestroyed();
		if (!PostInitializeCS_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/b1.BGWTickableWorldSubSystem:PostInitializeCS");
			return;
		}
	...
	[UFunction(Flags = 134350848u)]
	[UMetaPath("/Script/b1.BGWTickableWorldSubSystem:OnWorldComponentsUpdatedCS")]
	public unsafe void OnWorldComponentsUpdatedCS(UWorld World)
	{
		CheckDestroyed();
		if (!OnWorldComponentsUpdatedCS_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/b1.BGWTickableWorldSubSystem:OnWorldComponentsUpdatedCS");
			return;
		}
	...
	[UFunction(Flags = 134350848u)]
	[UMetaPath("/Script/b1.BGWTickableWorldSubSystem:OnWorldBeginPlayCS")]
	public unsafe void OnWorldBeginPlayCS(UWorld InWorld)
	{
		CheckDestroyed();
		if (!OnWorldBeginPlayCS_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/b1.BGWTickableWorldSubSystem:OnWorldBeginPlayCS");
			return;
		}
	...
	[UFunction(Flags = 134350848u)]
	[UMetaPath("/Script/b1.BGWTickableWorldSubSystem:OnTickCS")]
	public unsafe void OnTickCS(float DeltaTime)
	{
		CheckDestroyed();
		if (!OnTickCS_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/b1.BGWTickableWorldSubSystem:OnTickCS");
			return;
		}
		if (OnTickCS_InstanceFunctionAddress == IntPtr.Zero)
		{
			OnTickCS_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "OnTickCS");
		}
		byte* ptr = stackalloc byte[(int)(uint)(OnTickCS_ParamsSize + 16)];
		int num = (int)((16L - (long)ptr) & 0xF);
		byte* ptr2 = ptr + num;
		Unsafe.InitBlockUnaligned(ptr2, 0, (uint)OnTickCS_ParamsSize);
		IntPtr intPtr = new IntPtr(ptr2);
		BlittableTypeMarshaler<float>.ToNative(IntPtr.Add(intPtr, OnTickCS_DeltaTime_Offset), 0, OnTickCS_DeltaTime_PropertyAddress.Address, DeltaTime);
		NativeReflection.InvokeFunctionOptimized(base.Address, OnTickCS_InstanceFunctionAddress, intPtr, OnTickCS_ParamsSize);
	}

	protected unsafe virtual void OnTickCS_Implementation(float DeltaTime)
	{
		CheckDestroyed();
		if (!OnTickCS_IsValid)
		{
		...
		IntPtr intPtr = new IntPtr(ptr2);
		BlittableTypeMarshaler<float>.ToNative(IntPtr.Add(intPtr, OnTickCS_DeltaTime_Offset), 0, OnTickCS_DeltaTime_PropertyAddress.Address, DeltaTime);
		NativeReflection.InvokeFunctionOptimized(base.Address, OnTickCS_FunctionAddress, intPtr, OnTickCS_ParamsSize);
	}

	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/b1.BGWTickableWorldSubSystem:GetWorldRefCS")]
	public unsafe UWorld GetWorldRefCS()
	{
		CheckDestroyed();
		if (!GetWorldRefCS_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/b1.BGWTickableWorldSubSystem:GetWorldRefCS");
			return null;
		}
	...
	[UMetaPath("/Script/b1.BGWTickableWorldSubSystem:DoesSupportWorldTypeCS")]
	public unsafe bool DoesSupportWorldTypeCS(int WorldType)
	{
		CheckDestroyed();
		if (!DoesSupportWorldTypeCS_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/b1.BGWTickableWorldSubSystem:DoesSupportWorldTypeCS");
			return false;
		}
	...
	static UBGWTickableWorldSubSystem()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UBGWTickableWorldSubSystem)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UBGWTickableWorldSubSystem));
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/b1.BGWTickableWorldSubSystem");
		...
		NativeReflection.LogFunctionIsValid("/Script/b1.BGWTickableWorldSubSystem:PostInitializeCS", PostInitializeCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1.BGWTickableWorldSubSystem:OnWorldComponentsUpdatedCS", OnWorldComponentsUpdatedCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1.BGWTickableWorldSubSystem:OnWorldBeginPlayCS", OnWorldBeginPlayCS_IsValid);
		...
		NativeReflectionCached.GetPropertyRef(ref OnTickCS_DeltaTime_PropertyAddress, OnTickCS_FunctionAddress, "DeltaTime");
		OnTickCS_DeltaTime_Offset = NativeReflectionCached.GetPropertyOffset(OnTickCS_FunctionAddress, "DeltaTime");
		OnTickCS_DeltaTime_IsValid = NativeReflectionCached.ValidatePropertyClass(OnTickCS_FunctionAddress, "DeltaTime", Classes.FFloatProperty);
		OnTickCS_IsValid = OnTickCS_FunctionAddress != IntPtr.Zero && OnTickCS_DeltaTime_IsValid;
		NativeReflection.LogFunctionIsValid("/Script/b1.BGWTickableWorldSubSystem:OnTickCS", OnTickCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1.BGWTickableWorldSubSystem:GetWorldRefCS", GetWorldRefCS_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/b1.BGWTickableWorldSubSystem:DoesSupportWorldTypeCS", DoesSupportWorldTypeCS_IsValid);
	}
}
