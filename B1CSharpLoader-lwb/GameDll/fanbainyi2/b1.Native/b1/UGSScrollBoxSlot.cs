...
[BlueprintType]
[UMetaPath("/Script/UnrealExtent.GSScrollBoxSlot", "UnrealExtent", UnrealModuleType.Game)]
public class UGSScrollBoxSlot : UPanelSlot
{
	...
	[UMetaPath("/Script/UnrealExtent.GSScrollBoxSlot:Padding")]
	public FMargin Padding
	{
		get
		{
			...
			if (!Padding_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UnrealExtent.GSScrollBoxSlot:Padding");
	...
	[UMetaPath("/Script/UnrealExtent.GSScrollBoxSlot:HorizontalAlignment")]
	public EHorizontalAlignment HorizontalAlignment
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UnrealExtent.GSScrollBoxSlot:HorizontalAlignment");
	...
	[UProperty(Flags = (PropFlags)6755469234274837uL)]
	[UMetaPath("/Script/UnrealExtent.GSScrollBoxSlot:VerticalAlignment")]
	public EVerticalAlignment VerticalAlignment
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UnrealExtent.GSScrollBoxSlot:VerticalAlignment");
	...
	[UMetaPath("/Script/UnrealExtent.GSScrollBoxSlot:SetVerticalAlignment")]
	public unsafe void SetVerticalAlignment(EVerticalAlignment InVerticalAlignment)
	{
		CheckDestroyed();
		if (!SetVerticalAlignment_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UnrealExtent.GSScrollBoxSlot:SetVerticalAlignment");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/UnrealExtent.GSScrollBoxSlot:SetPadding")]
	public unsafe void SetPadding(FMargin InPadding)
	{
		CheckDestroyed();
		if (!SetPadding_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UnrealExtent.GSScrollBoxSlot:SetPadding");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/UnrealExtent.GSScrollBoxSlot:SetHorizontalAlignment")]
	public unsafe void SetHorizontalAlignment(EHorizontalAlignment InHorizontalAlignment)
	{
		CheckDestroyed();
		if (!SetHorizontalAlignment_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UnrealExtent.GSScrollBoxSlot:SetHorizontalAlignment");
			return;
		}
	...
	static UGSScrollBoxSlot()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UGSScrollBoxSlot)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UGSScrollBoxSlot));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/UnrealExtent.GSScrollBoxSlot");
		...
		NativeReflection.LogFunctionIsValid("/Script/UnrealExtent.GSScrollBoxSlot:SetVerticalAlignment", SetVerticalAlignment_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/UnrealExtent.GSScrollBoxSlot:SetPadding", SetPadding_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/UnrealExtent.GSScrollBoxSlot:SetHorizontalAlignment", SetHorizontalAlignment_IsValid);
	}
}
