...
[BlueprintType]
[Blueprintable]
[UMetaPath("/Script/JavascriptUMG.JavascriptGameViewport", "JavascriptUMG", UnrealModuleType.GamePlugin)]
public class UJavascriptGameViewport : UContentWidget
{
	...
	[UMetaPath("/Script/JavascriptUMG.JavascriptGameViewport:Spawn")]
	public unsafe AActor Spawn(TSubclassOf<AActor> ActorClass)
	{
		CheckDestroyed();
		if (!Spawn_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/JavascriptUMG.JavascriptGameViewport:Spawn");
			return null;
		}
	...
	[UMetaPath("/Script/JavascriptUMG.JavascriptGameViewport:SetViewRotation")]
	public unsafe void SetViewRotation(FRotator Rotation)
	{
		CheckDestroyed();
		if (!SetViewRotation_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/JavascriptUMG.JavascriptGameViewport:SetViewRotation");
			return;
		}
	...
	[UFunction(Flags = 75629569u)]
	[UMetaPath("/Script/JavascriptUMG.JavascriptGameViewport:SetViewLocation")]
	public unsafe void SetViewLocation(FVector Location)
	{
		CheckDestroyed();
		if (!SetViewLocation_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/JavascriptUMG.JavascriptGameViewport:SetViewLocation");
			return;
		}
	...
	[UMetaPath("/Script/JavascriptUMG.JavascriptGameViewport:GetViewRotation")]
	public unsafe FRotator GetViewRotation()
	{
		CheckDestroyed();
		if (!GetViewRotation_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/JavascriptUMG.JavascriptGameViewport:GetViewRotation");
	...
	[UMetaPath("/Script/JavascriptUMG.JavascriptGameViewport:GetViewportWorld")]
	public unsafe UWorld GetViewportWorld()
	{
		CheckDestroyed();
		if (!GetViewportWorld_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/JavascriptUMG.JavascriptGameViewport:GetViewportWorld");
			return null;
		}
	...
	[UFunction(Flags = 1417806849u)]
	[UMetaPath("/Script/JavascriptUMG.JavascriptGameViewport:GetViewLocation")]
	public unsafe FVector GetViewLocation()
	{
		CheckDestroyed();
		if (!GetViewLocation_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/JavascriptUMG.JavascriptGameViewport:GetViewLocation");
	...
	static UJavascriptGameViewport()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UJavascriptGameViewport)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UJavascriptGameViewport));
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/JavascriptUMG.JavascriptGameViewport");
		...
		NativeReflection.LogFunctionIsValid("/Script/JavascriptUMG.JavascriptGameViewport:Spawn", Spawn_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/JavascriptUMG.JavascriptGameViewport:SetViewRotation", SetViewRotation_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/JavascriptUMG.JavascriptGameViewport:SetViewLocation", SetViewLocation_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/JavascriptUMG.JavascriptGameViewport:GetViewRotation", GetViewRotation_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/JavascriptUMG.JavascriptGameViewport:GetViewportWorld", GetViewportWorld_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/JavascriptUMG.JavascriptGameViewport:GetViewLocation", GetViewLocation_IsValid);
	}
}
