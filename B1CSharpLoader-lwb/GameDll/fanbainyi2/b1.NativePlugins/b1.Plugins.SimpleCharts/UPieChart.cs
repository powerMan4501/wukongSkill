...
[BlueprintType]
[Blueprintable]
[UMetaPath("/Script/SimpleCharts.PieChart", "SimpleCharts", UnrealModuleType.GamePlugin)]
public class UPieChart : UChartBase
{
	...
	[UMetaPath("/Script/SimpleCharts.PieChart:Series")]
	public FPieSeries Series
	{
		get
		{
			CheckDestroyed();
			if (!Series_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/SimpleCharts.PieChart:Series");
				return default(FPieSeries);
			}
			return FPieSeries.FromNative(IntPtr.Add(base.Address, Series_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				FPieSeries.ToNative(IntPtr.Add(base.Address, Series_Offset), value);
			}
		}
	}

	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/SimpleCharts.PieChart:SetSeries")]
	public unsafe void SetSeries(FPieSeries SeriesData)
	{
		CheckDestroyed();
		if (!SetSeries_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.PieChart:SetSeries");
			return;
		}
		...
		FPieSeries.ToNative(IntPtr.Add(intPtr, SetSeries_SeriesData_Offset), 0, SetSeries_SeriesData_PropertyAddress.Address, SeriesData);
	...
	[UMetaPath("/Script/SimpleCharts.PieChart:SetLegend")]
	public unsafe void SetLegend(bool show, EPosition position, EOrient orient, FLinearColor color, int fontSize)
	{
		...
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.PieChart:SetLegend");
			return;
		}
	...
	static UPieChart()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UPieChart)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UPieChart));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/SimpleCharts.PieChart");
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.PieChart:SetSeries", SetSeries_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.PieChart:SetLegend", SetLegend_IsValid);
	}
}
