...
[BlueprintType]
[Blueprintable]
[UMetaPath("/Script/SimpleCharts.BarChart", "SimpleCharts", UnrealModuleType.GamePlugin)]
public class UBarChart : UChartBase
{
	...
	private TArrayReadWriteMarshaler<FBarSeries> Series_MarshalerCached;
	...
	[UMetaPath("/Script/SimpleCharts.BarChart:Series")]
	public TArrayReadWrite<FBarSeries> Series
	{
		get
		{
			CheckDestroyed();
			if (!Series_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/SimpleCharts.BarChart:Series");
				return null;
			}
			if (Series_MarshalerCached == null)
			{
				Series_MarshalerCached = new TArrayReadWriteMarshaler<FBarSeries>(1, Series_PropertyAddress, CachedMarshalingDelegates<FBarSeries, FBarSeries>.FromNative, CachedMarshalingDelegates<FBarSeries, FBarSeries>.ToNative);
			}
	...
	[UMetaPath("/Script/SimpleCharts.BarChart:SetSeries")]
	public unsafe void SetSeries(List<FBarSeries> SeriesData)
	{
		CheckDestroyed();
		if (!SetSeries_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.BarChart:SetSeries");
			return;
		}
		...
		new TArrayCopyMarshaler<FBarSeries>(1, SetSeries_SeriesData_PropertyAddress, CachedMarshalingDelegates<FBarSeries, FBarSeries>.FromNative, CachedMarshalingDelegates<FBarSeries, FBarSeries>.ToNative).ToNative(IntPtr.Add(intPtr, SetSeries_SeriesData_Offset), SeriesData);
	...
	[UMetaPath("/Script/SimpleCharts.BarChart:SetLegend")]
	public unsafe void SetLegend(bool show, EPosition position, EOrient orient, FLinearColor color, int fontSize)
	{
		...
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.BarChart:SetLegend");
			return;
		}
	...
	static UBarChart()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UBarChart)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UBarChart));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/SimpleCharts.BarChart");
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.BarChart:SetSeries", SetSeries_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.BarChart:SetLegend", SetLegend_IsValid);
	}
}
