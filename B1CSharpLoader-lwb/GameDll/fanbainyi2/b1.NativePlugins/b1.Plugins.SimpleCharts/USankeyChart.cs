...
[BlueprintType]
[Blueprintable]
[UMetaPath("/Script/SimpleCharts.SankeyChart", "SimpleCharts", UnrealModuleType.GamePlugin)]
public class USankeyChart : UChartBase
{
	...
	[UMetaPath("/Script/SimpleCharts.SankeyChart:Series")]
	public FSankeySeries Series
	{
		get
		{
			CheckDestroyed();
			if (!Series_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/SimpleCharts.SankeyChart:Series");
				return default(FSankeySeries);
			}
			return FSankeySeries.FromNative(IntPtr.Add(base.Address, Series_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				FSankeySeries.ToNative(IntPtr.Add(base.Address, Series_Offset), value);
			}
		}
	}

	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/SimpleCharts.SankeyChart:SetSeries")]
	public unsafe void SetSeries(FSankeySeries SeriesData)
	{
		CheckDestroyed();
		if (!SetSeries_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.SankeyChart:SetSeries");
			return;
		}
		...
		FSankeySeries.ToNative(IntPtr.Add(intPtr, SetSeries_SeriesData_Offset), 0, SetSeries_SeriesData_PropertyAddress.Address, SeriesData);
	...
	[UMetaPath("/Script/SimpleCharts.SankeyChart:SetLegend")]
	public unsafe void SetLegend(bool show, EPosition position, EOrient orient, FLinearColor color, int fontSize)
	{
		...
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.SankeyChart:SetLegend");
			return;
		}
	...
	static USankeyChart()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(USankeyChart)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(USankeyChart));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/SimpleCharts.SankeyChart");
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.SankeyChart:SetSeries", SetSeries_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.SankeyChart:SetLegend", SetLegend_IsValid);
	}
}
