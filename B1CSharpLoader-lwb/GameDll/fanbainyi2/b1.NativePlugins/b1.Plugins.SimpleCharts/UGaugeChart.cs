...
[BlueprintType]
[Blueprintable]
[UMetaPath("/Script/SimpleCharts.GaugeChart", "SimpleCharts", UnrealModuleType.GamePlugin)]
public class UGaugeChart : UChartBase
{
	...
	[UMetaPath("/Script/SimpleCharts.GaugeChart:Series")]
	public FGaugeSeries Series
	{
		get
		{
			CheckDestroyed();
			if (!Series_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/SimpleCharts.GaugeChart:Series");
				return default(FGaugeSeries);
			}
			return FGaugeSeries.FromNative(IntPtr.Add(base.Address, Series_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				FGaugeSeries.ToNative(IntPtr.Add(base.Address, Series_Offset), value);
			}
		}
	}

	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/SimpleCharts.GaugeChart:SetSeries")]
	public unsafe void SetSeries(FGaugeSeries SeriesData)
	{
		CheckDestroyed();
		if (!SetSeries_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.GaugeChart:SetSeries");
			return;
		}
		...
		FGaugeSeries.ToNative(IntPtr.Add(intPtr, SetSeries_SeriesData_Offset), 0, SetSeries_SeriesData_PropertyAddress.Address, SeriesData);
	...
	[UMetaPath("/Script/SimpleCharts.GaugeChart:SetLegend")]
	public unsafe void SetLegend(bool show, EPosition position, EOrient orient, FLinearColor color, int fontSize)
	{
		...
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.GaugeChart:SetLegend");
			return;
		}
	...
	static UGaugeChart()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UGaugeChart)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UGaugeChart));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/SimpleCharts.GaugeChart");
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.GaugeChart:SetSeries", SetSeries_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.GaugeChart:SetLegend", SetLegend_IsValid);
	}
}
