...
[BlueprintType]
[Blueprintable]
[UMetaPath("/Script/SimpleCharts.ScatterChart", "SimpleCharts", UnrealModuleType.GamePlugin)]
public class UScatterChart : UChartBase
{
	...
	private TArrayReadWriteMarshaler<FScatterSeries> Series_MarshalerCached;
	...
	[UMetaPath("/Script/SimpleCharts.ScatterChart:Series")]
	public TArrayReadWrite<FScatterSeries> Series
	{
		get
		{
			CheckDestroyed();
			if (!Series_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/SimpleCharts.ScatterChart:Series");
				return null;
			}
			if (Series_MarshalerCached == null)
			{
				Series_MarshalerCached = new TArrayReadWriteMarshaler<FScatterSeries>(1, Series_PropertyAddress, CachedMarshalingDelegates<FScatterSeries, FScatterSeries>.FromNative, CachedMarshalingDelegates<FScatterSeries, FScatterSeries>.ToNative);
			}
	...
	[UMetaPath("/Script/SimpleCharts.ScatterChart:SetSeries")]
	public unsafe void SetSeries(List<FScatterSeries> SeriesData)
	{
		CheckDestroyed();
		if (!SetSeries_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.ScatterChart:SetSeries");
			return;
		}
		...
		new TArrayCopyMarshaler<FScatterSeries>(1, SetSeries_SeriesData_PropertyAddress, CachedMarshalingDelegates<FScatterSeries, FScatterSeries>.FromNative, CachedMarshalingDelegates<FScatterSeries, FScatterSeries>.ToNative).ToNative(IntPtr.Add(intPtr, SetSeries_SeriesData_Offset), SeriesData);
	...
	[UMetaPath("/Script/SimpleCharts.ScatterChart:SetLegend")]
	public unsafe void SetLegend(bool show, EPosition position, EOrient orient, FLinearColor color, int fontSize)
	{
		...
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.ScatterChart:SetLegend");
			return;
		}
	...
	static UScatterChart()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UScatterChart)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UScatterChart));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/SimpleCharts.ScatterChart");
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.ScatterChart:SetSeries", SetSeries_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.ScatterChart:SetLegend", SetLegend_IsValid);
	}
}
