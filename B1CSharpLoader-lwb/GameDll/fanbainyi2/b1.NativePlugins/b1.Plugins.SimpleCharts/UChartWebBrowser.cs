...
[BlueprintType]
[Blueprintable]
[UMetaPath("/Script/SimpleCharts.ChartWebBrowser", "SimpleCharts", UnrealModuleType.GamePlugin)]
public class UChartWebBrowser : UWidget
{
	[UDelegate]
	[UMetaPath("/Script/SimpleCharts.ChartWebBrowser:OnUrlChanged__DelegateSignature")]
	public class FOnUrlChanged : FMulticastDelegate<FOnUrlChanged.Signature>
	{
		...
		{
			OnUrlChanged__DelegateSignature_FunctionAddress = NativeReflection.GetFunction("/Script/SimpleCharts.ChartWebBrowser:OnUrlChanged__DelegateSignature");
			...
			NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.ChartWebBrowser:OnUrlChanged__DelegateSignature", OnUrlChanged__DelegateSignature_IsValid);
		}
		...
		private unsafe void Invoker(FText Text)
		{
			...
			{
				NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.ChartWebBrowser:OnUrlChanged__DelegateSignature");
			}
			else if (IsBound)
			{
	...
	[UDelegate]
	[UMetaPath("/Script/SimpleCharts.ChartWebBrowser:OnBeforePopup__DelegateSignature")]
	public class FOnBeforePopup : FMulticastDelegate<FOnBeforePopup.Signature>
	{
		...
		private static void LoadNativeType()
		{
			OnBeforePopup__DelegateSignature_FunctionAddress = NativeReflection.GetFunction("/Script/SimpleCharts.ChartWebBrowser:OnBeforePopup__DelegateSignature");
			...
			NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.ChartWebBrowser:OnBeforePopup__DelegateSignature", OnBeforePopup__DelegateSignature_IsValid);
		}
		...
		private unsafe void Invoker(string URL, string Frame)
		{
			...
			{
				NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.ChartWebBrowser:OnBeforePopup__DelegateSignature");
			}
			else if (IsBound)
			{
	...
	[UMetaPath("/Script/SimpleCharts.ChartWebBrowser:OnUrlChanged")]
	public FOnUrlChanged OnUrlChanged
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/SimpleCharts.ChartWebBrowser:OnUrlChanged");
	...
	[UProperty(Flags = (PropFlags)4503599896330752uL)]
	[UMetaPath("/Script/SimpleCharts.ChartWebBrowser:OnBeforePopup")]
	public FOnBeforePopup OnBeforePopup
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/SimpleCharts.ChartWebBrowser:OnBeforePopup");
	...
	[UMetaPath("/Script/SimpleCharts.ChartWebBrowser:LoadURL")]
	public unsafe void LoadURL(string NewURL)
	{
		CheckDestroyed();
		if (!LoadURL_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.ChartWebBrowser:LoadURL");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/SimpleCharts.ChartWebBrowser:LoadString")]
	public unsafe void LoadString(string Contents, string DummyURL)
	{
		CheckDestroyed();
		if (!LoadString_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.ChartWebBrowser:LoadString");
			return;
		}
	...
	[UMetaPath("/Script/SimpleCharts.ChartWebBrowser:GetUrl")]
	public unsafe string GetUrl()
	{
		CheckDestroyed();
		if (!GetUrl_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.ChartWebBrowser:GetUrl");
	...
	[UFunction(Flags = 1409418241u)]
	[UMetaPath("/Script/SimpleCharts.ChartWebBrowser:GetTitleText")]
	public unsafe string GetTitleText()
	{
		CheckDestroyed();
		if (!GetTitleText_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.ChartWebBrowser:GetTitleText");
			return FStringMarshaler.DefaultString;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/SimpleCharts.ChartWebBrowser:ExecuteJavascript")]
	public unsafe void ExecuteJavascript(string ScriptText)
	{
		CheckDestroyed();
		if (!ExecuteJavascript_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.ChartWebBrowser:ExecuteJavascript");
			return;
		}
	...
	static UChartWebBrowser()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UChartWebBrowser)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UChartWebBrowser));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/SimpleCharts.ChartWebBrowser");
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.ChartWebBrowser:LoadURL", LoadURL_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.ChartWebBrowser:LoadString", LoadString_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.ChartWebBrowser:GetUrl", GetUrl_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.ChartWebBrowser:GetTitleText", GetTitleText_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.ChartWebBrowser:ExecuteJavascript", ExecuteJavascript_IsValid);
	}
}
