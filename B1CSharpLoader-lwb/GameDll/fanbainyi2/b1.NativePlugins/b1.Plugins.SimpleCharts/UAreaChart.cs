...
[BlueprintType]
[Blueprintable]
[UMetaPath("/Script/SimpleCharts.AreaChart", "SimpleCharts", UnrealModuleType.GamePlugin)]
public class UAreaChart : UChartBase
{
	...
	private TArrayReadWriteMarshaler<FAreaSeries> Series_MarshalerCached;
	...
	[UMetaPath("/Script/SimpleCharts.AreaChart:Series")]
	public TArrayReadWrite<FAreaSeries> Series
	{
		get
		{
			CheckDestroyed();
			if (!Series_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/SimpleCharts.AreaChart:Series");
				return null;
			}
			if (Series_MarshalerCached == null)
			{
				Series_MarshalerCached = new TArrayReadWriteMarshaler<FAreaSeries>(1, Series_PropertyAddress, CachedMarshalingDelegates<FAreaSeries, FAreaSeries>.FromNative, CachedMarshalingDelegates<FAreaSeries, FAreaSeries>.ToNative);
			}
	...
	[UMetaPath("/Script/SimpleCharts.AreaChart:SetSeries")]
	public unsafe void SetSeries(List<FAreaSeries> SeriesData)
	{
		CheckDestroyed();
		if (!SetSeries_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.AreaChart:SetSeries");
			return;
		}
		...
		new TArrayCopyMarshaler<FAreaSeries>(1, SetSeries_SeriesData_PropertyAddress, CachedMarshalingDelegates<FAreaSeries, FAreaSeries>.FromNative, CachedMarshalingDelegates<FAreaSeries, FAreaSeries>.ToNative).ToNative(IntPtr.Add(intPtr, SetSeries_SeriesData_Offset), SeriesData);
	...
	[UMetaPath("/Script/SimpleCharts.AreaChart:SetLegend")]
	public unsafe void SetLegend(bool show, EPosition position, EOrient orient, FLinearColor color, int fontSize)
	{
		...
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.AreaChart:SetLegend");
			return;
		}
	...
	static UAreaChart()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UAreaChart)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UAreaChart));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/SimpleCharts.AreaChart");
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.AreaChart:SetSeries", SetSeries_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.AreaChart:SetLegend", SetLegend_IsValid);
	}
}
