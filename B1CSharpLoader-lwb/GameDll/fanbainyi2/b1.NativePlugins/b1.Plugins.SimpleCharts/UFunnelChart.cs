...
[BlueprintType]
[Blueprintable]
[UMetaPath("/Script/SimpleCharts.FunnelChart", "SimpleCharts", UnrealModuleType.GamePlugin)]
public class UFunnelChart : UChartBase
{
	...
	[UMetaPath("/Script/SimpleCharts.FunnelChart:Series")]
	public FfunnelSeries Series
	{
		get
		{
			CheckDestroyed();
			if (!Series_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/SimpleCharts.FunnelChart:Series");
				return default(FfunnelSeries);
			}
			return FfunnelSeries.FromNative(IntPtr.Add(base.Address, Series_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				FfunnelSeries.ToNative(IntPtr.Add(base.Address, Series_Offset), value);
			}
		}
	}

	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/SimpleCharts.FunnelChart:SetSeries")]
	public unsafe void SetSeries(FfunnelSeries SeriesData)
	{
		CheckDestroyed();
		if (!SetSeries_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.FunnelChart:SetSeries");
			return;
		}
		...
		FfunnelSeries.ToNative(IntPtr.Add(intPtr, SetSeries_SeriesData_Offset), 0, SetSeries_SeriesData_PropertyAddress.Address, SeriesData);
	...
	[UMetaPath("/Script/SimpleCharts.FunnelChart:SetLegend")]
	public unsafe void SetLegend(bool show, EPosition position, EOrient orient, FLinearColor color, int fontSize)
	{
		...
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SimpleCharts.FunnelChart:SetLegend");
			return;
		}
	...
	static UFunnelChart()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UFunnelChart)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UFunnelChart));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/SimpleCharts.FunnelChart");
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.FunnelChart:SetSeries", SetSeries_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SimpleCharts.FunnelChart:SetLegend", SetLegend_IsValid);
	}
}
