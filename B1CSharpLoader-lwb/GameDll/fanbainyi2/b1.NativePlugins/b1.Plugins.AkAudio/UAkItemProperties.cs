...
[BlueprintType]
[Blueprintable]
[UMetaPath("/Script/AkAudio.AkItemProperties", "AkAudio", UnrealModuleType.GamePlugin)]
public class UAkItemProperties : UWidget
{
	private static bool OnSelectionChanged_IsValid;

	private static int OnSelectionChanged_Offset;

	private FOnItemPropertySelectionChanged OnSelectionChanged_DelegateCached;

	private static bool OnPropertyDragged_IsValid;

	private static int OnPropertyDragged_Offset;

	private FOnItemPropertyDragDetected OnPropertyDragged_DelegateCached;
	...
	[UMetaPath("/Script/AkAudio.AkItemProperties:OnSelectionChanged")]
	public FOnItemPropertySelectionChanged OnSelectionChanged
	{
		get
		{
			CheckDestroyed();
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/AkAudio.AkItemProperties:OnSelectionChanged");
				return new FOnItemPropertySelectionChanged();
			}
			if (OnSelectionChanged_DelegateCached == null)
			{
				OnSelectionChanged_DelegateCached = new FOnItemPropertySelectionChanged();
	...
	[UProperty(Flags = (PropFlags)4503599896330752uL)]
	[UMetaPath("/Script/AkAudio.AkItemProperties:OnPropertyDragged")]
	public FOnItemPropertyDragDetected OnPropertyDragged
	{
		get
		{
			CheckDestroyed();
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/AkAudio.AkItemProperties:OnPropertyDragged");
				return new FOnItemPropertyDragDetected();
			}
			if (OnPropertyDragged_DelegateCached == null)
			{
				OnPropertyDragged_DelegateCached = new FOnItemPropertyDragDetected();
	...
	[UMetaPath("/Script/AkAudio.AkItemProperties:SetSearchText")]
	public unsafe void SetSearchText(string newText)
	{
		CheckDestroyed();
		if (!SetSearchText_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/AkAudio.AkItemProperties:SetSearchText");
			return;
		}
	...
	[UMetaPath("/Script/AkAudio.AkItemProperties:GetSelectedProperty")]
	public unsafe string GetSelectedProperty()
	{
		CheckDestroyed();
		if (!GetSelectedProperty_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/AkAudio.AkItemProperties:GetSelectedProperty");
	...
	[UFunction(Flags = 1409418249u)]
	[UMetaPath("/Script/AkAudio.AkItemProperties:GetSearchText")]
	public unsafe string GetSearchText()
	{
		CheckDestroyed();
		if (!GetSearchText_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/AkAudio.AkItemProperties:GetSearchText");
			return FStringMarshaler.DefaultString;
		}
	...
	static UAkItemProperties()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UAkItemProperties)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UAkItemProperties));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/AkAudio.AkItemProperties");
		...
		NativeReflection.LogFunctionIsValid("/Script/AkAudio.AkItemProperties:SetSearchText", SetSearchText_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/AkAudio.AkItemProperties:GetSelectedProperty", GetSelectedProperty_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/AkAudio.AkItemProperties:GetSearchText", GetSearchText_IsValid);
	}
}
