...
internal sealed class ReadObjectInfo
{
	...
	internal MemberInfo GetMemberInfo(string name)
	{
		...
		if (isSi)
		{
			throw new SerializationException(Environment.GetResourceString("Serialization_MemberInfo", objectType?.ToString() + " " + name));
		}
		if (cache.memberInfos == null)
		{
			throw new SerializationException(Environment.GetResourceString("Serialization_NoMemberInfo", objectType?.ToString() + " " + name));
		}
	...
	internal Type GetType(string name)
	{
		...
		if ((object)type == null)
		{
			throw new SerializationException(Environment.GetResourceString("Serialization_ISerializableTypes", objectType?.ToString() + " " + name));
		}
		return type;
	}
