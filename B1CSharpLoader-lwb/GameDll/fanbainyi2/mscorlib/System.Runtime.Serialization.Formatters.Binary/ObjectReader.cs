...
internal sealed class ObjectReader
{
	...
	{
		throw new SerializationException(Environment.GetResourceString("Serialization_ParseError", onStack.PRname + " " + ((object)onStack.PRparseTypeEnum)?.ToString() + " " + processing.PRname + " " + (object)processing.PRparseTypeEnum));
	}
