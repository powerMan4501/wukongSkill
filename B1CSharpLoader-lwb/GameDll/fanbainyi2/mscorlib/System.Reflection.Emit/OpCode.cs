...
public struct OpCode
{
	...
	{
		m_stringname = null;
		m_pop = (StackBehaviour)((flags >> 12) & 0x1F);
		m_push = (StackBehaviour)((flags >> 17) & 0x1F);
		m_operand = (OperandType)(flags & 0x1F);
		m_type = (OpCodeType)((flags >> 9) & 7);
		m_size = (flags >> 22) & 3;
		m_s1 = (byte)((int)value >> 8);
		m_s2 = (byte)value;
		m_ctrl = (FlowControl)((flags >> 5) & 0xF);
		m_endsUncondJmpBlk = (flags & 0x1000000) != 0;
