...
public sealed class ProcessStateCustom_PlayLevelSequence : IMessage<ProcessStateCustom_PlayLevelSequence>, IMessage, IEquatable<ProcessStateCustom_PlayLevelSequence>, IDeepCloneable<ProcessStateCustom_PlayLevelSequence>
{
	private static readonly MessageParser<ProcessStateCustom_PlayLevelSequence> _parser = new MessageParser<ProcessStateCustom_PlayLevelSequence>(() => new ProcessStateCustom_PlayLevelSequence());
	...
	public static MessageParser<ProcessStateCustom_PlayLevelSequence> Parser => _parser;
	...
	public ProcessStateCustom_PlayLevelSequence()
	{
	}

	public ProcessStateCustom_PlayLevelSequence(ProcessStateCustom_PlayLevelSequence other)
		: this()
	{
	...
	public ProcessStateCustom_PlayLevelSequence Clone()
	{
		return new ProcessStateCustom_PlayLevelSequence(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as ProcessStateCustom_PlayLevelSequence);
	}

	public bool Equals(ProcessStateCustom_PlayLevelSequence other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(ProcessStateCustom_PlayLevelSequence other)
	{
		if (other != null)
		{
