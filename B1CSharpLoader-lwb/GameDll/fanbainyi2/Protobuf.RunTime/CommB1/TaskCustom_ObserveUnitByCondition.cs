...
public sealed class TaskCustom_ObserveUnitByCondition : IMessage<TaskCustom_ObserveUnitByCondition>, IMessage, IEquatable<TaskCustom_ObserveUnitByCondition>, IDeepCloneable<TaskCustom_ObserveUnitByCondition>
{
	private static readonly MessageParser<TaskCustom_ObserveUnitByCondition> _parser = new MessageParser<TaskCustom_ObserveUnitByCondition>(() => new TaskCustom_ObserveUnitByCondition());
	...
	public static MessageParser<TaskCustom_ObserveUnitByCondition> Parser => _parser;
	...
	public TaskCustom_ObserveUnitByCondition()
	{
	}

	public TaskCustom_ObserveUnitByCondition(TaskCustom_ObserveUnitByCondition other)
		: this()
	{
	...
	public TaskCustom_ObserveUnitByCondition Clone()
	{
		return new TaskCustom_ObserveUnitByCondition(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as TaskCustom_ObserveUnitByCondition);
	}

	public bool Equals(TaskCustom_ObserveUnitByCondition other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(TaskCustom_ObserveUnitByCondition other)
	{
		if (other != null)
		{
