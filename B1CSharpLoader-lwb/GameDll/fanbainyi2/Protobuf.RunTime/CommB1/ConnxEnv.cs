...
public sealed class ConnxEnv : IMessage<ConnxEnv>, IMessage, IEquatable<ConnxEnv>, IDeepCloneable<ConnxEnv>
{
	private static readonly MessageParser<ConnxEnv> _parser = new MessageParser<ConnxEnv>(() => new ConnxEnv());
	...
	public static MessageParser<ConnxEnv> Parser => _parser;
	...
	public ConnxEnv(ConnxEnv other)
		: this()
	{
	...
	public ConnxEnv Clone()
	{
		return new ConnxEnv(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as ConnxEnv);
	}

	public bool Equals(ConnxEnv other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(ConnxEnv other)
	{
		if (other != null)
		{
