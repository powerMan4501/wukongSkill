...
public sealed class BehaviorCustom_PlayLevelSequence : IMessage<BehaviorCustom_PlayLevelSequence>, IMessage, IEquatable<BehaviorCustom_PlayLevelSequence>, IDeepCloneable<BehaviorCustom_PlayLevelSequence>
{
	private static readonly MessageParser<BehaviorCustom_PlayLevelSequence> _parser = new MessageParser<BehaviorCustom_PlayLevelSequence>(() => new BehaviorCustom_PlayLevelSequence());
	...
	public static MessageParser<BehaviorCustom_PlayLevelSequence> Parser => _parser;
	...
	public BehaviorCustom_PlayLevelSequence()
	{
	}

	public BehaviorCustom_PlayLevelSequence(BehaviorCustom_PlayLevelSequence other)
		: this()
	{
	...
	public BehaviorCustom_PlayLevelSequence Clone()
	{
		return new BehaviorCustom_PlayLevelSequence(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as BehaviorCustom_PlayLevelSequence);
	}

	public bool Equals(BehaviorCustom_PlayLevelSequence other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(BehaviorCustom_PlayLevelSequence other)
	{
		if (other != null)
		{
