...
public sealed class ProcessStateCustom_Timer : IMessage<ProcessStateCustom_Timer>, IMessage, IEquatable<ProcessStateCustom_Timer>, IDeepCloneable<ProcessStateCustom_Timer>
{
	private static readonly MessageParser<ProcessStateCustom_Timer> _parser = new MessageParser<ProcessStateCustom_Timer>(() => new ProcessStateCustom_Timer());
	...
	public static MessageParser<ProcessStateCustom_Timer> Parser => _parser;
	...
	public ProcessStateCustom_Timer()
	{
	}

	public ProcessStateCustom_Timer(ProcessStateCustom_Timer other)
		: this()
	{
	...
	public ProcessStateCustom_Timer Clone()
	{
		return new ProcessStateCustom_Timer(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as ProcessStateCustom_Timer);
	}

	public bool Equals(ProcessStateCustom_Timer other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(ProcessStateCustom_Timer other)
	{
		if (other != null)
		{
