...
public sealed class HuluDesc : IMessage<HuluDesc>, IMessage, IEquatable<HuluDesc>, IDeepCloneable<HuluDesc>
{
	private static readonly MessageParser<HuluDesc> _parser = new MessageParser<HuluDesc>(() => new HuluDesc());
	...
	private static readonly FieldCodec<int> _repeated_buffList_codec = FieldCodec.ForInt32(42u);
	...
	public static MessageParser<HuluDesc> Parser => _parser;
	...
	public HuluDesc(HuluDesc other)
		: this()
	{
		id_ = other.id_;
	...
	public HuluDesc Clone()
	{
		return new HuluDesc(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as HuluDesc);
	}

	public bool Equals(HuluDesc other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(HuluDesc other)
	{
		if (other != null)
		{
			if (other.Id != 0)
