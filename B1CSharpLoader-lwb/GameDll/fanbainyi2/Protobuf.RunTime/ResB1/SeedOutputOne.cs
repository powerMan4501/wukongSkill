...
public sealed class SeedOutputOne : IMessage<SeedOutputOne>, IMessage, IEquatable<SeedOutputOne>, IDeepCloneable<SeedOutputOne>
{
	private static readonly MessageParser<SeedOutputOne> _parser = new MessageParser<SeedOutputOne>(() => new SeedOutputOne());
	...
	public static MessageParser<SeedOutputOne> Parser => _parser;
	...
	public SeedOutputOne()
	{
	}

	public SeedOutputOne(SeedOutputOne other)
		: this()
	{
	...
	public SeedOutputOne Clone()
	{
		return new SeedOutputOne(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as SeedOutputOne);
	}

	public bool Equals(SeedOutputOne other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(SeedOutputOne other)
	{
		if (other != null)
		{
