...
{
	private static readonly MessageParser<ActivationStateSyncWrapper> _parser = new MessageParser<ActivationStateSyncWrapper>(() => new ActivationStateSyncWrapper());
	...
	public static MessageParser<ActivationStateSyncWrapper> Parser => _parser;
	...
	public ActivationStateSyncWrapper()
	{
	}
	...
	{
		return new ActivationStateSyncWrapper(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as ActivationStateSyncWrapper);
	}
	...
	public override int GetHashCode()
	{
		...
		if (Value != ActivationState.NeverActivated)
		{
	...
	public void MergeFrom(ActivationStateSyncWrapper other)
	{
		if (other != null)
		{
			...
			if (other.Value != ActivationState.NeverActivated)
			{
				Value = other.Value;
			}
	...
	public void MergeFrom(CodedInputStream input)
	{
		...
		while ((num = input.ReadTag()) != 0)
		{
			...
			case 16u:
				...
				break;
			case 24u:
				Value = (ActivationState)input.ReadEnum();
				break;
			}
		}
	}
