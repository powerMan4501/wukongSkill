...
public sealed class BossRushRefightRecordSyncWrapper : IMessage<BossRushRefightRecordSyncWrapper>, IMessage, IEquatable<BossRushRefightRecordSyncWrapper>, IDeepCloneable<BossRushRefightRecordSyncWrapper>
{
	private static readonly MessageParser<BossRushRefightRecordSyncWrapper> _parser = new MessageParser<BossRushRefightRecordSyncWrapper>(() => new BossRushRefightRecordSyncWrapper());
	...
	public static MessageParser<BossRushRefightRecordSyncWrapper> Parser => _parser;
	...
	public BossRushRefightRecordSyncWrapper()
	{
	}

	public BossRushRefightRecordSyncWrapper(BossRushRefightRecordSyncWrapper other)
		: this()
	{
	...
	public BossRushRefightRecordSyncWrapper Clone()
	{
		return new BossRushRefightRecordSyncWrapper(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as BossRushRefightRecordSyncWrapper);
	}

	public bool Equals(BossRushRefightRecordSyncWrapper other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(BossRushRefightRecordSyncWrapper other)
	{
		if (other == null)
		{
			return;
