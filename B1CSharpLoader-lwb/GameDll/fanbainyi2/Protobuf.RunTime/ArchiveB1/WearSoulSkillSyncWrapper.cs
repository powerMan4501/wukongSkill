...
public sealed class WearSoulSkillSyncWrapper : IMessage<WearSoulSkillSyncWrapper>, IMessage, IEquatable<WearSoulSkillSyncWrapper>, IDeepCloneable<WearSoulSkillSyncWrapper>
{
	private static readonly MessageParser<WearSoulSkillSyncWrapper> _parser = new MessageParser<WearSoulSkillSyncWrapper>(() => new WearSoulSkillSyncWrapper());
	...
	public static MessageParser<WearSoulSkillSyncWrapper> Parser => _parser;
	...
	public WearSoulSkillSyncWrapper()
	{
	}

	public WearSoulSkillSyncWrapper(WearSoulSkillSyncWrapper other)
		: this()
	{
	...
	public WearSoulSkillSyncWrapper Clone()
	{
		return new WearSoulSkillSyncWrapper(this);
	}

	public override bool Equals(object other)
	{
		return Equals(other as WearSoulSkillSyncWrapper);
	}

	public bool Equals(WearSoulSkillSyncWrapper other)
	{
		if (other == null)
		{
			return false;
	...
	public void MergeFrom(WearSoulSkillSyncWrapper other)
	{
		if (other == null)
		{
			return;
