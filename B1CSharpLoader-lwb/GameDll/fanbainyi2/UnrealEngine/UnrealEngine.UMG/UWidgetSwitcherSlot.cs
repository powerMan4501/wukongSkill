...
[BlueprintType]
[UMetaPath("/Script/UMG.WidgetSwitcherSlot", "UMG", UnrealModuleType.Engine)]
public class UWidgetSwitcherSlot : UPanelSlot
{
	...
	[UMetaPath("/Script/UMG.WidgetSwitcherSlot:Padding")]
	public FMargin Padding
	{
		get
		{
			...
			if (!Padding_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.WidgetSwitcherSlot:Padding");
	...
	[UMetaPath("/Script/UMG.WidgetSwitcherSlot:HorizontalAlignment")]
	public EHorizontalAlignment HorizontalAlignment
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.WidgetSwitcherSlot:HorizontalAlignment");
	...
	[UProperty(Flags = (PropFlags)6755469234274837uL)]
	[UMetaPath("/Script/UMG.WidgetSwitcherSlot:VerticalAlignment")]
	public EVerticalAlignment VerticalAlignment
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.WidgetSwitcherSlot:VerticalAlignment");
	...
	[UMetaPath("/Script/UMG.WidgetSwitcherSlot:SetVerticalAlignment")]
	public unsafe void SetVerticalAlignment(EVerticalAlignment InVerticalAlignment)
	{
		CheckDestroyed();
		if (!SetVerticalAlignment_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.WidgetSwitcherSlot:SetVerticalAlignment");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/UMG.WidgetSwitcherSlot:SetPadding")]
	public unsafe void SetPadding(FMargin InPadding)
	{
		CheckDestroyed();
		if (!SetPadding_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.WidgetSwitcherSlot:SetPadding");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/UMG.WidgetSwitcherSlot:SetHorizontalAlignment")]
	public unsafe void SetHorizontalAlignment(EHorizontalAlignment InHorizontalAlignment)
	{
		CheckDestroyed();
		if (!SetHorizontalAlignment_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.WidgetSwitcherSlot:SetHorizontalAlignment");
			return;
		}
	...
	static UWidgetSwitcherSlot()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UWidgetSwitcherSlot)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UWidgetSwitcherSlot));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/UMG.WidgetSwitcherSlot");
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.WidgetSwitcherSlot:SetVerticalAlignment", SetVerticalAlignment_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.WidgetSwitcherSlot:SetPadding", SetPadding_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.WidgetSwitcherSlot:SetHorizontalAlignment", SetHorizontalAlignment_IsValid);
	}
}
