...
[BlueprintType]
[UMetaPath("/Script/UMG.WindowTitleBarAreaSlot", "UMG", UnrealModuleType.Engine)]
public class UWindowTitleBarAreaSlot : UPanelSlot
{
	...
	[UProperty(Flags = (PropFlags)9016065140982293uL)]
	[UMetaPath("/Script/UMG.WindowTitleBarAreaSlot:Padding")]
	protected FMargin Padding
	{
		get
		{
			CheckDestroyed();
			if (!Padding_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.WindowTitleBarAreaSlot:Padding");
	...
	[UMetaPath("/Script/UMG.WindowTitleBarAreaSlot:HorizontalAlignment")]
	protected EHorizontalAlignment HorizontalAlignment
	{
		get
		{
			CheckDestroyed();
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.WindowTitleBarAreaSlot:HorizontalAlignment");
	...
	[UMetaPath("/Script/UMG.WindowTitleBarAreaSlot:SetVerticalAlignment")]
	public unsafe void SetVerticalAlignment(EVerticalAlignment InVerticalAlignment)
	{
		CheckDestroyed();
		if (!SetVerticalAlignment_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.WindowTitleBarAreaSlot:SetVerticalAlignment");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/UMG.WindowTitleBarAreaSlot:SetPadding")]
	public unsafe void SetPadding(FMargin InPadding)
	{
		CheckDestroyed();
		if (!SetPadding_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.WindowTitleBarAreaSlot:SetPadding");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/UMG.WindowTitleBarAreaSlot:SetHorizontalAlignment")]
	public unsafe void SetHorizontalAlignment(EHorizontalAlignment InHorizontalAlignment)
	{
		CheckDestroyed();
		if (!SetHorizontalAlignment_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.WindowTitleBarAreaSlot:SetHorizontalAlignment");
			return;
		}
	...
	static UWindowTitleBarAreaSlot()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UWindowTitleBarAreaSlot)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UWindowTitleBarAreaSlot));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/UMG.WindowTitleBarAreaSlot");
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.WindowTitleBarAreaSlot:SetVerticalAlignment", SetVerticalAlignment_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.WindowTitleBarAreaSlot:SetPadding", SetPadding_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.WindowTitleBarAreaSlot:SetHorizontalAlignment", SetHorizontalAlignment_IsValid);
	}
}
