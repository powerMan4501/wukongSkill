...
[BlueprintType]
[UMetaPath("/Script/UMG.ScaleBoxSlot", "UMG", UnrealModuleType.Engine)]
public class UScaleBoxSlot : UPanelSlot
{
	...
	[UMetaPath("/Script/UMG.ScaleBoxSlot:Padding")]
	public FMargin Padding
	{
		get
		{
			...
			if (!Padding_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.ScaleBoxSlot:Padding");
	...
	[UMetaPath("/Script/UMG.ScaleBoxSlot:HorizontalAlignment")]
	public EHorizontalAlignment HorizontalAlignment
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.ScaleBoxSlot:HorizontalAlignment");
	...
	[UProperty(Flags = (PropFlags)6755469234274837uL)]
	[UMetaPath("/Script/UMG.ScaleBoxSlot:VerticalAlignment")]
	public EVerticalAlignment VerticalAlignment
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.ScaleBoxSlot:VerticalAlignment");
	...
	[UMetaPath("/Script/UMG.ScaleBoxSlot:SetVerticalAlignment")]
	public unsafe void SetVerticalAlignment(EVerticalAlignment InVerticalAlignment)
	{
		CheckDestroyed();
		if (!SetVerticalAlignment_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.ScaleBoxSlot:SetVerticalAlignment");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/UMG.ScaleBoxSlot:SetPadding")]
	public unsafe void SetPadding(FMargin InPadding)
	{
		CheckDestroyed();
		if (!SetPadding_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.ScaleBoxSlot:SetPadding");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/UMG.ScaleBoxSlot:SetHorizontalAlignment")]
	public unsafe void SetHorizontalAlignment(EHorizontalAlignment InHorizontalAlignment)
	{
		CheckDestroyed();
		if (!SetHorizontalAlignment_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.ScaleBoxSlot:SetHorizontalAlignment");
			return;
		}
	...
	static UScaleBoxSlot()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UScaleBoxSlot)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UScaleBoxSlot));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/UMG.ScaleBoxSlot");
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.ScaleBoxSlot:SetVerticalAlignment", SetVerticalAlignment_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.ScaleBoxSlot:SetPadding", SetPadding_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.ScaleBoxSlot:SetHorizontalAlignment", SetHorizontalAlignment_IsValid);
	}
}
