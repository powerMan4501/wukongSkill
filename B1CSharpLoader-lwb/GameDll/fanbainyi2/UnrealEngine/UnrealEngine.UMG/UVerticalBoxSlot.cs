...
[BlueprintType]
[UMetaPath("/Script/UMG.VerticalBoxSlot", "UMG", UnrealModuleType.Engine)]
public class UVerticalBoxSlot : UPanelSlot
{
	...
	[UMetaPath("/Script/UMG.VerticalBoxSlot:Size")]
	public FSlateChildSize Size
	{
		get
		{
			...
			if (!Size_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.VerticalBoxSlot:Size");
	...
	[UMetaPath("/Script/UMG.VerticalBoxSlot:Padding")]
	public FMargin Padding
	{
		get
		{
			...
			if (!Padding_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.VerticalBoxSlot:Padding");
	...
	[UMetaPath("/Script/UMG.VerticalBoxSlot:HorizontalAlignment")]
	public EHorizontalAlignment HorizontalAlignment
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.VerticalBoxSlot:HorizontalAlignment");
	...
	[UProperty(Flags = (PropFlags)6755469234274837uL)]
	[UMetaPath("/Script/UMG.VerticalBoxSlot:VerticalAlignment")]
	public EVerticalAlignment VerticalAlignment
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.VerticalBoxSlot:VerticalAlignment");
	...
	[UMetaPath("/Script/UMG.VerticalBoxSlot:SetVerticalAlignment")]
	public unsafe void SetVerticalAlignment(EVerticalAlignment InVerticalAlignment)
	{
		CheckDestroyed();
		if (!SetVerticalAlignment_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.VerticalBoxSlot:SetVerticalAlignment");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/UMG.VerticalBoxSlot:SetSize")]
	public unsafe void SetSize(FSlateChildSize InSize)
	{
		CheckDestroyed();
		if (!SetSize_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.VerticalBoxSlot:SetSize");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/UMG.VerticalBoxSlot:SetPadding")]
	public unsafe void SetPadding(FMargin InPadding)
	{
		CheckDestroyed();
		if (!SetPadding_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.VerticalBoxSlot:SetPadding");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/UMG.VerticalBoxSlot:SetHorizontalAlignment")]
	public unsafe void SetHorizontalAlignment(EHorizontalAlignment InHorizontalAlignment)
	{
		CheckDestroyed();
		if (!SetHorizontalAlignment_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.VerticalBoxSlot:SetHorizontalAlignment");
			return;
		}
	...
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UVerticalBoxSlot)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UVerticalBoxSlot));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/UMG.VerticalBoxSlot");
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.VerticalBoxSlot:SetVerticalAlignment", SetVerticalAlignment_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.VerticalBoxSlot:SetSize", SetSize_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.VerticalBoxSlot:SetPadding", SetPadding_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.VerticalBoxSlot:SetHorizontalAlignment", SetHorizontalAlignment_IsValid);
	}
}
