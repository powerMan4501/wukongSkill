...
[BlueprintType]
[Blueprintable]
[UMetaPath("/Script/UMG.RetainerBox", "UMG", UnrealModuleType.Engine)]
public class URetainerBox : UContentWidget
{
	...
	[UMetaPath("/Script/UMG.RetainerBox:RenderOnInvalidation")]
	public bool RenderOnInvalidation
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.RetainerBox:RenderOnInvalidation");
				return false;
			}
	...
	[UProperty(Flags = (PropFlags)6755469234274837uL)]
	[UMetaPath("/Script/UMG.RetainerBox:RenderOnPhase")]
	public bool RenderOnPhase
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.RetainerBox:RenderOnPhase");
				return false;
			}
	...
	[UProperty(Flags = (PropFlags)6755469234274837uL)]
	[UMetaPath("/Script/UMG.RetainerBox:Phase")]
	public int Phase
	{
		get
		{
			...
			if (!Phase_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.RetainerBox:Phase");
				return 0;
			}
	...
	[UProperty(Flags = (PropFlags)6755469234274837uL)]
	[UMetaPath("/Script/UMG.RetainerBox:PhaseCount")]
	public int PhaseCount
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.RetainerBox:PhaseCount");
				return 0;
			}
	...
	[UProperty(Flags = (PropFlags)6755469234274837uL)]
	[UMetaPath("/Script/UMG.RetainerBox:IsGSPixToPix")]
	public bool IsGSPixToPix
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.RetainerBox:IsGSPixToPix");
				return false;
			}
	...
	[UMetaPath("/Script/UMG.RetainerBox:EffectMaterial")]
	protected UMaterialInterface EffectMaterial
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.RetainerBox:EffectMaterial");
				return null;
			}
	...
	[UMetaPath("/Script/UMG.RetainerBox:TextureParameter")]
	protected FName TextureParameter
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.RetainerBox:TextureParameter");
	...
	[UMetaPath("/Script/UMG.RetainerBox:SetTextureParameter")]
	public unsafe void SetTextureParameter(FName TextureParameter)
	{
		CheckDestroyed();
		if (!SetTextureParameter_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.RetainerBox:SetTextureParameter");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/UMG.RetainerBox:SetRetainRendering")]
	public unsafe void SetRetainRendering(bool bInRetainRendering)
	{
		CheckDestroyed();
		if (!SetRetainRendering_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.RetainerBox:SetRetainRendering");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/UMG.RetainerBox:SetRenderingPhase")]
	public unsafe void SetRenderingPhase(int RenderPhase, int TotalPhases)
	{
		CheckDestroyed();
		if (!SetRenderingPhase_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.RetainerBox:SetRenderingPhase");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/UMG.RetainerBox:SetEffectMaterial")]
	public unsafe void SetEffectMaterial(UMaterialInterface EffectMaterial)
	{
		CheckDestroyed();
		if (!SetEffectMaterial_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.RetainerBox:SetEffectMaterial");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/UMG.RetainerBox:RequestRender")]
	public unsafe void RequestRender()
	{
		CheckDestroyed();
		if (!RequestRender_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.RetainerBox:RequestRender");
			return;
		}
	...
	[UMetaPath("/Script/UMG.RetainerBox:GetEffectMaterial")]
	public unsafe UMaterialInstanceDynamic GetEffectMaterial()
	{
		CheckDestroyed();
		if (!GetEffectMaterial_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.RetainerBox:GetEffectMaterial");
			return null;
		}
	...
	static URetainerBox()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(URetainerBox)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(URetainerBox));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/UMG.RetainerBox");
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.RetainerBox:SetTextureParameter", SetTextureParameter_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.RetainerBox:SetRetainRendering", SetRetainRendering_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.RetainerBox:SetRenderingPhase", SetRenderingPhase_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.RetainerBox:SetEffectMaterial", SetEffectMaterial_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.RetainerBox:RequestRender", RequestRender_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.RetainerBox:GetEffectMaterial", GetEffectMaterial_IsValid);
	}
}
