...
[UDelegate]
[UMetaPath("/Script/UMG.OnFloatValueChangedEvent__DelegateSignature")]
public class FOnFloatValueChangedEvent : FMulticastDelegate<FOnFloatValueChangedEvent.Signature>
{
	...
	{
		OnFloatValueChangedEvent__DelegateSignature_FunctionAddress = NativeReflection.GetFunction("/Script/UMG.OnFloatValueChangedEvent__DelegateSignature");
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.OnFloatValueChangedEvent__DelegateSignature", OnFloatValueChangedEvent__DelegateSignature_IsValid);
	}
	...
	private unsafe void Invoker(float Value)
	{
		...
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.OnFloatValueChangedEvent__DelegateSignature");
		}
		else if (IsBound)
		{
