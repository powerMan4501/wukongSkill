...
[BlueprintType]
[UMetaPath("/Script/UMG.SizeBoxSlot", "UMG", UnrealModuleType.Engine)]
public class USizeBoxSlot : UPanelSlot
{
	...
	[UMetaPath("/Script/UMG.SizeBoxSlot:Padding")]
	public FMargin Padding
	{
		get
		{
			...
			if (!Padding_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.SizeBoxSlot:Padding");
	...
	[UMetaPath("/Script/UMG.SizeBoxSlot:HorizontalAlignment")]
	public EHorizontalAlignment HorizontalAlignment
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.SizeBoxSlot:HorizontalAlignment");
	...
	[UProperty(Flags = (PropFlags)6755469234274837uL)]
	[UMetaPath("/Script/UMG.SizeBoxSlot:VerticalAlignment")]
	public EVerticalAlignment VerticalAlignment
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/UMG.SizeBoxSlot:VerticalAlignment");
	...
	[UMetaPath("/Script/UMG.SizeBoxSlot:SetVerticalAlignment")]
	public unsafe void SetVerticalAlignment(EVerticalAlignment InVerticalAlignment)
	{
		CheckDestroyed();
		if (!SetVerticalAlignment_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.SizeBoxSlot:SetVerticalAlignment");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/UMG.SizeBoxSlot:SetPadding")]
	public unsafe void SetPadding(FMargin InPadding)
	{
		CheckDestroyed();
		if (!SetPadding_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.SizeBoxSlot:SetPadding");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/UMG.SizeBoxSlot:SetHorizontalAlignment")]
	public unsafe void SetHorizontalAlignment(EHorizontalAlignment InHorizontalAlignment)
	{
		CheckDestroyed();
		if (!SetHorizontalAlignment_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/UMG.SizeBoxSlot:SetHorizontalAlignment");
			return;
		}
	...
	static USizeBoxSlot()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(USizeBoxSlot)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(USizeBoxSlot));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/UMG.SizeBoxSlot");
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.SizeBoxSlot:SetVerticalAlignment", SetVerticalAlignment_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.SizeBoxSlot:SetPadding", SetPadding_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/UMG.SizeBoxSlot:SetHorizontalAlignment", SetHorizontalAlignment_IsValid);
	}
}
