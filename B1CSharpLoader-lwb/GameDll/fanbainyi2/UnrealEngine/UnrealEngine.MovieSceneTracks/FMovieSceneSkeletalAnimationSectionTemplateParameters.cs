...
[UStruct(Flags = 4097)]
[BlueprintType]
[UMetaPath("/Script/MovieSceneTracks.MovieSceneSkeletalAnimationSectionTemplateParameters", "MovieSceneTracks", UnrealModuleType.Engine)]
public struct FMovieSceneSkeletalAnimationSectionTemplateParameters
{
	...
	private static bool FMovieSceneSkeletalAnimationSectionTemplateParameters_IsValid;

	private static int FMovieSceneSkeletalAnimationSectionTemplateParameters_StructSize;

	public FMovieSceneSkeletalAnimationSectionTemplateParameters Copy()
	{
		return this;
	}

	public static FMovieSceneSkeletalAnimationSectionTemplateParameters FromNative(IntPtr nativeBuffer)
	{
		return new FMovieSceneSkeletalAnimationSectionTemplateParameters(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FMovieSceneSkeletalAnimationSectionTemplateParameters value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FMovieSceneSkeletalAnimationSectionTemplateParameters FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FMovieSceneSkeletalAnimationSectionTemplateParameters(nativeBuffer + arrayIndex * FMovieSceneSkeletalAnimationSectionTemplateParameters_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FMovieSceneSkeletalAnimationSectionTemplateParameters value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FMovieSceneSkeletalAnimationSectionTemplateParameters_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FMovieSceneSkeletalAnimationSectionTemplateParameters_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/MovieSceneTracks.MovieSceneSkeletalAnimationSectionTemplateParameters");
			return;
		}
	...
	public FMovieSceneSkeletalAnimationSectionTemplateParameters(IntPtr nativeStruct)
	{
		if (!FMovieSceneSkeletalAnimationSectionTemplateParameters_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/MovieSceneTracks.MovieSceneSkeletalAnimationSectionTemplateParameters");
	...
	static FMovieSceneSkeletalAnimationSectionTemplateParameters()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FMovieSceneSkeletalAnimationSectionTemplateParameters)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FMovieSceneSkeletalAnimationSectionTemplateParameters));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/MovieSceneTracks.MovieSceneSkeletalAnimationSectionTemplateParameters");
		FMovieSceneSkeletalAnimationSectionTemplateParameters_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FMovieSceneSkeletalAnimationSectionTemplateParameters_IsValid = intPtr != IntPtr.Zero && Animation_IsValid && FirstLoopStartFrameOffset_IsValid && StartFrameOffset_IsValid && EndFrameOffset_IsValid && PlayRate_IsValid && Reverse_IsValid && SlotName_IsValid && MirrorDataTable_IsValid && SkipAnimNotifiers_IsValid;
		NativeReflection.LogStructIsValid("/Script/MovieSceneTracks.MovieSceneSkeletalAnimationSectionTemplateParameters", FMovieSceneSkeletalAnimationSectionTemplateParameters_IsValid);
	}
}
