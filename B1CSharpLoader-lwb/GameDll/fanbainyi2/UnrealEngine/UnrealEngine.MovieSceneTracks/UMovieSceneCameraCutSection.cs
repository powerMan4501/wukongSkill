...
[BlueprintType]
[UMetaPath("/Script/MovieSceneTracks.MovieSceneCameraCutSection", "MovieSceneTracks", UnrealModuleType.Engine)]
public class UMovieSceneCameraCutSection : UMovieSceneSection, IMovieSceneEntityProvider, IInterface
{
	...
	[UMetaPath("/Script/MovieSceneTracks.MovieSceneCameraCutSection:SetCameraBindingID")]
	public unsafe void SetCameraBindingID(FMovieSceneObjectBindingID InCameraBindingID)
	{
		CheckDestroyed();
		if (!SetCameraBindingID_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/MovieSceneTracks.MovieSceneCameraCutSection:SetCameraBindingID");
			return;
		}
	...
	[UMetaPath("/Script/MovieSceneTracks.MovieSceneCameraCutSection:GetCameraBindingID")]
	public unsafe FMovieSceneObjectBindingID GetCameraBindingID()
	{
		CheckDestroyed();
		if (!GetCameraBindingID_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/MovieSceneTracks.MovieSceneCameraCutSection:GetCameraBindingID");
	...
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UMovieSceneCameraCutSection)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UMovieSceneCameraCutSection));
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/MovieSceneTracks.MovieSceneCameraCutSection");
		...
		NativeReflection.LogFunctionIsValid("/Script/MovieSceneTracks.MovieSceneCameraCutSection:SetCameraBindingID", SetCameraBindingID_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/MovieSceneTracks.MovieSceneCameraCutSection:GetCameraBindingID", GetCameraBindingID_IsValid);
	}
}
