...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/AnimationWarpingRuntime.AnimNode_OrientationWarping", "AnimationWarpingRuntime", UnrealModuleType.EnginePlugin)]
public struct FAnimNode_OrientationWarping
{
	...
	private static bool OrientationAngle_IsValid;

	private static int OrientationAngle_Offset;

	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/AnimationWarpingRuntime.AnimNode_OrientationWarping:OrientationAngle")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/AnimationWarpingRuntime.AnimNode_OrientationWarping:LocomotionAngle")]
	public float LocomotionAngle;

	private static bool LocomotionAngleDeltaThreshold_IsValid;

	private static int LocomotionAngleDeltaThreshold_Offset;

	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/AnimationWarpingRuntime.AnimNode_OrientationWarping:LocomotionAngleDeltaThreshold")]
	public float LocomotionAngleDeltaThreshold;

	private static bool FAnimNode_OrientationWarping_IsValid;

	private static int FAnimNode_OrientationWarping_StructSize;

	public FAnimNode_OrientationWarping Copy()
	{
		return this;
	}

	public static FAnimNode_OrientationWarping FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_OrientationWarping(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_OrientationWarping value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_OrientationWarping FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_OrientationWarping(nativeBuffer + arrayIndex * FAnimNode_OrientationWarping_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_OrientationWarping value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_OrientationWarping_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_OrientationWarping_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimationWarpingRuntime.AnimNode_OrientationWarping");
			return;
		}
		BlittableTypeMarshaler<float>.ToNative(IntPtr.Add(nativeStruct, OrientationAngle_Offset), OrientationAngle);
		BlittableTypeMarshaler<float>.ToNative(IntPtr.Add(nativeStruct, LocomotionAngle_Offset), LocomotionAngle);
		BlittableTypeMarshaler<float>.ToNative(IntPtr.Add(nativeStruct, LocomotionAngleDeltaThreshold_Offset), LocomotionAngleDeltaThreshold);
	...
	public FAnimNode_OrientationWarping(IntPtr nativeStruct)
	{
		if (!FAnimNode_OrientationWarping_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimationWarpingRuntime.AnimNode_OrientationWarping");
			OrientationAngle = 0f;
			LocomotionAngle = 0f;
			LocomotionAngleDeltaThreshold = 0f;
		...
		{
			OrientationAngle = BlittableTypeMarshaler<float>.FromNative(IntPtr.Add(nativeStruct, OrientationAngle_Offset));
			LocomotionAngle = BlittableTypeMarshaler<float>.FromNative(IntPtr.Add(nativeStruct, LocomotionAngle_Offset));
			LocomotionAngleDeltaThreshold = BlittableTypeMarshaler<float>.FromNative(IntPtr.Add(nativeStruct, LocomotionAngleDeltaThreshold_Offset));
	...
	static FAnimNode_OrientationWarping()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_OrientationWarping)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_OrientationWarping));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimationWarpingRuntime.AnimNode_OrientationWarping");
		FAnimNode_OrientationWarping_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		OrientationAngle_Offset = NativeReflectionCached.GetPropertyOffset(intPtr, "OrientationAngle");
		OrientationAngle_IsValid = NativeReflectionCached.ValidatePropertyClass(intPtr, "OrientationAngle", Classes.FFloatProperty);
		...
		LocomotionAngleDeltaThreshold_Offset = NativeReflectionCached.GetPropertyOffset(intPtr, "LocomotionAngleDeltaThreshold");
		LocomotionAngleDeltaThreshold_IsValid = NativeReflectionCached.ValidatePropertyClass(intPtr, "LocomotionAngleDeltaThreshold", Classes.FFloatProperty);
		FAnimNode_OrientationWarping_IsValid = intPtr != IntPtr.Zero && OrientationAngle_IsValid && LocomotionAngle_IsValid && LocomotionAngleDeltaThreshold_IsValid && ComponentPose_IsValid && LODThreshold_IsValid && AlphaInputType_IsValid && AlphaBoolEnabled_IsValid && Alpha_IsValid && AlphaScaleBias_IsValid && AlphaBoolBlend_IsValid && AlphaCurveName_IsValid && AlphaScaleBiasClamp_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimationWarpingRuntime.AnimNode_OrientationWarping", FAnimNode_OrientationWarping_IsValid);
	}
}
