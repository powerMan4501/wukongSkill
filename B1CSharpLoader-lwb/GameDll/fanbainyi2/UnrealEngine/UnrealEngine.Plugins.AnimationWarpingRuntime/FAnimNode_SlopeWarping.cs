...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/AnimationWarpingRuntime.AnimNode_SlopeWarping", "AnimationWarpingRuntime", UnrealModuleType.EnginePlugin)]
public struct FAnimNode_SlopeWarping
{
	...
	private static bool FAnimNode_SlopeWarping_IsValid;

	private static int FAnimNode_SlopeWarping_StructSize;

	public FAnimNode_SlopeWarping Copy()
	{
		return this;
	}

	public static FAnimNode_SlopeWarping FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_SlopeWarping(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_SlopeWarping value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_SlopeWarping FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_SlopeWarping(nativeBuffer + arrayIndex * FAnimNode_SlopeWarping_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_SlopeWarping value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_SlopeWarping_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_SlopeWarping_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimationWarpingRuntime.AnimNode_SlopeWarping");
			return;
		}
	...
	public FAnimNode_SlopeWarping(IntPtr nativeStruct)
	{
		if (!FAnimNode_SlopeWarping_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimationWarpingRuntime.AnimNode_SlopeWarping");
	...
	static FAnimNode_SlopeWarping()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_SlopeWarping)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_SlopeWarping));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimationWarpingRuntime.AnimNode_SlopeWarping");
		FAnimNode_SlopeWarping_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FAnimNode_SlopeWarping_IsValid = intPtr != IntPtr.Zero && ComponentPose_IsValid && LODThreshold_IsValid && AlphaInputType_IsValid && AlphaBoolEnabled_IsValid && Alpha_IsValid && AlphaScaleBias_IsValid && AlphaBoolBlend_IsValid && AlphaCurveName_IsValid && AlphaScaleBiasClamp_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimationWarpingRuntime.AnimNode_SlopeWarping", FAnimNode_SlopeWarping_IsValid);
	}
}
