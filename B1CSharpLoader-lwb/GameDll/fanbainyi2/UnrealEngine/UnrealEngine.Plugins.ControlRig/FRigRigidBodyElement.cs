...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/ControlRig.RigRigidBodyElement", "ControlRig", UnrealModuleType.EnginePlugin)]
public struct FRigRigidBodyElement
{
	...
	[UProperty(Flags = (PropFlags)4503668346847253uL)]
	[UMetaPath("/Script/ControlRig.RigRigidBodyElement:Settings")]
	public FRigRigidBodySettings Settings;

	private static bool FRigRigidBodyElement_IsValid;

	private static int FRigRigidBodyElement_StructSize;

	public FRigRigidBodyElement Copy()
	{
		return this;
	}

	public static FRigRigidBodyElement FromNative(IntPtr nativeBuffer)
	{
		return new FRigRigidBodyElement(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FRigRigidBodyElement value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FRigRigidBodyElement FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FRigRigidBodyElement(nativeBuffer + arrayIndex * FRigRigidBodyElement_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FRigRigidBodyElement value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FRigRigidBodyElement_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FRigRigidBodyElement_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/ControlRig.RigRigidBodyElement");
			return;
		}
		FRigRigidBodySettings.ToNative(IntPtr.Add(nativeStruct, Settings_Offset), Settings);
	...
	public FRigRigidBodyElement(IntPtr nativeStruct)
	{
		if (!FRigRigidBodyElement_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/ControlRig.RigRigidBodyElement");
			Settings = default(FRigRigidBodySettings);
		...
		{
			Settings = FRigRigidBodySettings.FromNative(IntPtr.Add(nativeStruct, Settings_Offset));
	...
	static FRigRigidBodyElement()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FRigRigidBodyElement)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FRigRigidBodyElement));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/ControlRig.RigRigidBodyElement");
		FRigRigidBodyElement_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FRigRigidBodyElement_IsValid = intPtr != IntPtr.Zero && Settings_IsValid && Pose_IsValid && Key_IsValid && Index_IsValid && SubIndex_IsValid && Selected_IsValid;
		NativeReflection.LogStructIsValid("/Script/ControlRig.RigRigidBodyElement", FRigRigidBodyElement_IsValid);
	}
}
