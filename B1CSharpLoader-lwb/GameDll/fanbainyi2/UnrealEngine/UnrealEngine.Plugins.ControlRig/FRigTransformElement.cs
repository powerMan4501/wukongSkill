...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/ControlRig.RigTransformElement", "ControlRig", UnrealModuleType.EnginePlugin)]
public struct FRigTransformElement
{
	...
	private static bool FRigTransformElement_IsValid;

	private static int FRigTransformElement_StructSize;

	public FRigTransformElement Copy()
	{
		return this;
	}

	public static FRigTransformElement FromNative(IntPtr nativeBuffer)
	{
		return new FRigTransformElement(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FRigTransformElement value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FRigTransformElement FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FRigTransformElement(nativeBuffer + arrayIndex * FRigTransformElement_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FRigTransformElement value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FRigTransformElement_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FRigTransformElement_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/ControlRig.RigTransformElement");
			return;
		}
	...
	public FRigTransformElement(IntPtr nativeStruct)
	{
		if (!FRigTransformElement_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/ControlRig.RigTransformElement");
	...
	static FRigTransformElement()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FRigTransformElement)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FRigTransformElement));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/ControlRig.RigTransformElement");
		FRigTransformElement_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FRigTransformElement_IsValid = intPtr != IntPtr.Zero && Pose_IsValid && Key_IsValid && Index_IsValid && SubIndex_IsValid && Selected_IsValid;
		NativeReflection.LogStructIsValid("/Script/ControlRig.RigTransformElement", FRigTransformElement_IsValid);
	}
}
