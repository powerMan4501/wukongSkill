...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/ControlRig.RigMultiParentElement", "ControlRig", UnrealModuleType.EnginePlugin)]
public struct FRigMultiParentElement
{
	...
	private static bool FRigMultiParentElement_IsValid;

	private static int FRigMultiParentElement_StructSize;

	public FRigMultiParentElement Copy()
	{
		return this;
	}

	public static FRigMultiParentElement FromNative(IntPtr nativeBuffer)
	{
		return new FRigMultiParentElement(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FRigMultiParentElement value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FRigMultiParentElement FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FRigMultiParentElement(nativeBuffer + arrayIndex * FRigMultiParentElement_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FRigMultiParentElement value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FRigMultiParentElement_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FRigMultiParentElement_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/ControlRig.RigMultiParentElement");
			return;
		}
	...
	public FRigMultiParentElement(IntPtr nativeStruct)
	{
		if (!FRigMultiParentElement_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/ControlRig.RigMultiParentElement");
	...
	static FRigMultiParentElement()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FRigMultiParentElement)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FRigMultiParentElement));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/ControlRig.RigMultiParentElement");
		FRigMultiParentElement_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FRigMultiParentElement_IsValid = intPtr != IntPtr.Zero && Parent_IsValid && Pose_IsValid && Key_IsValid && Index_IsValid && SubIndex_IsValid && Selected_IsValid;
		NativeReflection.LogStructIsValid("/Script/ControlRig.RigMultiParentElement", FRigMultiParentElement_IsValid);
	}
}
