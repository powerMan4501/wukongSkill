...
[BlueprintType]
[UMetaPath("/Script/MovieRenderPipelineEditor.MoviePipelineQueueSubsystem", "MovieRenderPipelineEditor", UnrealModuleType.EnginePlugin)]
public class UMoviePipelineQueueSubsystem : UEditorSubsystem
{
	...
	[UMetaPath("/Script/MovieRenderPipelineEditor.MoviePipelineQueueSubsystem:RenderQueueWithExecutorInstance")]
	public unsafe void RenderQueueWithExecutorInstance(UMoviePipelineExecutorBase InExecutor)
	{
		...
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/MovieRenderPipelineEditor.MoviePipelineQueueSubsystem:RenderQueueWithExecutorInstance");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/MovieRenderPipelineEditor.MoviePipelineQueueSubsystem:RenderQueueWithExecutor")]
	public unsafe UMoviePipelineExecutorBase RenderQueueWithExecutor(TSubclassOf<UMoviePipelineExecutorBase> InExecutorType)
	{
		...
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/MovieRenderPipelineEditor.MoviePipelineQueueSubsystem:RenderQueueWithExecutor");
			return null;
		}
	...
	[UMetaPath("/Script/MovieRenderPipelineEditor.MoviePipelineQueueSubsystem:IsRendering")]
	public unsafe bool IsRendering()
	{
		CheckDestroyed();
		if (!IsRendering_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/MovieRenderPipelineEditor.MoviePipelineQueueSubsystem:IsRendering");
			return false;
		}
	...
	[UFunction(Flags = 1409418241u)]
	[UMetaPath("/Script/MovieRenderPipelineEditor.MoviePipelineQueueSubsystem:GetQueue")]
	public unsafe UMoviePipelineQueue GetQueue()
	{
		CheckDestroyed();
		if (!GetQueue_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/MovieRenderPipelineEditor.MoviePipelineQueueSubsystem:GetQueue");
			return null;
		}
	...
	[UFunction(Flags = 1409418241u)]
	[UMetaPath("/Script/MovieRenderPipelineEditor.MoviePipelineQueueSubsystem:GetActiveExecutor")]
	public unsafe UMoviePipelineExecutorBase GetActiveExecutor()
	{
		CheckDestroyed();
		if (!GetActiveExecutor_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/MovieRenderPipelineEditor.MoviePipelineQueueSubsystem:GetActiveExecutor");
			return null;
		}
	...
	static UMoviePipelineQueueSubsystem()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UMoviePipelineQueueSubsystem)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UMoviePipelineQueueSubsystem));
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/MovieRenderPipelineEditor.MoviePipelineQueueSubsystem");
		...
		NativeReflection.LogFunctionIsValid("/Script/MovieRenderPipelineEditor.MoviePipelineQueueSubsystem:RenderQueueWithExecutorInstance", RenderQueueWithExecutorInstance_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/MovieRenderPipelineEditor.MoviePipelineQueueSubsystem:RenderQueueWithExecutor", RenderQueueWithExecutor_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/MovieRenderPipelineEditor.MoviePipelineQueueSubsystem:IsRendering", IsRendering_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/MovieRenderPipelineEditor.MoviePipelineQueueSubsystem:GetQueue", GetQueue_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/MovieRenderPipelineEditor.MoviePipelineQueueSubsystem:GetActiveExecutor", GetActiveExecutor_IsValid);
	}
}
