...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/AnimGraphRuntime.AnimNode_SkeletalControlBase", "AnimGraphRuntime", UnrealModuleType.Engine)]
public struct FAnimNode_SkeletalControlBase
{
	...
	private static bool FAnimNode_SkeletalControlBase_IsValid;

	private static int FAnimNode_SkeletalControlBase_StructSize;

	public FAnimNode_SkeletalControlBase Copy()
	{
		return this;
	}

	public static FAnimNode_SkeletalControlBase FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_SkeletalControlBase(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_SkeletalControlBase value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_SkeletalControlBase FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_SkeletalControlBase(nativeBuffer + arrayIndex * FAnimNode_SkeletalControlBase_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_SkeletalControlBase value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_SkeletalControlBase_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_SkeletalControlBase_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_SkeletalControlBase");
			return;
		}
	...
	public FAnimNode_SkeletalControlBase(IntPtr nativeStruct)
	{
		if (!FAnimNode_SkeletalControlBase_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_SkeletalControlBase");
	...
	static FAnimNode_SkeletalControlBase()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_SkeletalControlBase)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_SkeletalControlBase));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimGraphRuntime.AnimNode_SkeletalControlBase");
		FAnimNode_SkeletalControlBase_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FAnimNode_SkeletalControlBase_IsValid = intPtr != IntPtr.Zero && ComponentPose_IsValid && LODThreshold_IsValid && AlphaInputType_IsValid && AlphaBoolEnabled_IsValid && Alpha_IsValid && AlphaScaleBias_IsValid && AlphaBoolBlend_IsValid && AlphaCurveName_IsValid && AlphaScaleBiasClamp_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimGraphRuntime.AnimNode_SkeletalControlBase", FAnimNode_SkeletalControlBase_IsValid);
	}
}
