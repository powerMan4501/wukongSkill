...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/AnimGraphRuntime.AnimNode_LookAt", "AnimGraphRuntime", UnrealModuleType.Engine)]
public struct FAnimNode_LookAt
{
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/AnimGraphRuntime.AnimNode_LookAt:LookAtLocation")]
	public FVector LookAtLocation;

	private static bool InterpolationType_IsValid;

	private static FFieldAddress InterpolationType_PropertyAddress;

	private static int InterpolationType_Offset;

	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/AnimGraphRuntime.AnimNode_LookAt:InterpolationType")]
	public EInterpolationBlend InterpolationType;

	private static bool LookAtClamp_IsValid;

	private static int LookAtClamp_Offset;

	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/AnimGraphRuntime.AnimNode_LookAt:LookAtClamp")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/AnimGraphRuntime.AnimNode_LookAt:InterpolationTime")]
	public float InterpolationTime;

	private static bool InterpolationTriggerThreashold_IsValid;

	private static int InterpolationTriggerThreashold_Offset;

	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/AnimGraphRuntime.AnimNode_LookAt:InterpolationTriggerThreashold")]
	public float InterpolationTriggerThreashold;

	private static bool FAnimNode_LookAt_IsValid;

	private static int FAnimNode_LookAt_StructSize;

	public FAnimNode_LookAt Copy()
	{
		return this;
	}

	public static FAnimNode_LookAt FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_LookAt(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_LookAt value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_LookAt FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_LookAt(nativeBuffer + arrayIndex * FAnimNode_LookAt_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_LookAt value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_LookAt_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_LookAt_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_LookAt");
			return;
		}
		BlittableTypeMarshaler<FVector>.ToNative(IntPtr.Add(nativeStruct, LookAtLocation_Offset), LookAtLocation);
		EnumMarshaler<EInterpolationBlend>.ToNative(IntPtr.Add(nativeStruct, InterpolationType_Offset), 0, InterpolationType_PropertyAddress.Address, InterpolationType);
		BlittableTypeMarshaler<float>.ToNative(IntPtr.Add(nativeStruct, LookAtClamp_Offset), LookAtClamp);
		BlittableTypeMarshaler<float>.ToNative(IntPtr.Add(nativeStruct, InterpolationTime_Offset), InterpolationTime);
		BlittableTypeMarshaler<float>.ToNative(IntPtr.Add(nativeStruct, InterpolationTriggerThreashold_Offset), InterpolationTriggerThreashold);
	...
	public FAnimNode_LookAt(IntPtr nativeStruct)
	{
		if (!FAnimNode_LookAt_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_LookAt");
			...
			InterpolationTriggerThreashold = 0f;
		...
		else
		{
			...
			InterpolationType = EnumMarshaler<EInterpolationBlend>.FromNative(IntPtr.Add(nativeStruct, InterpolationType_Offset), 0, InterpolationType_PropertyAddress.Address);
			LookAtClamp = BlittableTypeMarshaler<float>.FromNative(IntPtr.Add(nativeStruct, LookAtClamp_Offset));
			InterpolationTime = BlittableTypeMarshaler<float>.FromNative(IntPtr.Add(nativeStruct, InterpolationTime_Offset));
			InterpolationTriggerThreashold = BlittableTypeMarshaler<float>.FromNative(IntPtr.Add(nativeStruct, InterpolationTriggerThreashold_Offset));
	...
	static FAnimNode_LookAt()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_LookAt)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_LookAt));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimGraphRuntime.AnimNode_LookAt");
		FAnimNode_LookAt_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		NativeReflectionCached.GetPropertyRef(ref InterpolationType_PropertyAddress, intPtr, "InterpolationType");
		InterpolationType_Offset = NativeReflectionCached.GetPropertyOffset(intPtr, "InterpolationType");
		InterpolationType_IsValid = NativeReflectionCached.ValidatePropertyClass(intPtr, "InterpolationType", Classes.FByteProperty);
		LookAtClamp_Offset = NativeReflectionCached.GetPropertyOffset(intPtr, "LookAtClamp");
		LookAtClamp_IsValid = NativeReflectionCached.ValidatePropertyClass(intPtr, "LookAtClamp", Classes.FFloatProperty);
		...
		InterpolationTriggerThreashold_Offset = NativeReflectionCached.GetPropertyOffset(intPtr, "InterpolationTriggerThreashold");
		InterpolationTriggerThreashold_IsValid = NativeReflectionCached.ValidatePropertyClass(intPtr, "InterpolationTriggerThreashold", Classes.FFloatProperty);
		FAnimNode_LookAt_IsValid = intPtr != IntPtr.Zero && LookAtLocation_IsValid && InterpolationType_IsValid && LookAtClamp_IsValid && InterpolationTime_IsValid && InterpolationTriggerThreashold_IsValid && ComponentPose_IsValid && LODThreshold_IsValid && AlphaInputType_IsValid && AlphaBoolEnabled_IsValid && Alpha_IsValid && AlphaScaleBias_IsValid && AlphaBoolBlend_IsValid && AlphaCurveName_IsValid && AlphaScaleBiasClamp_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimGraphRuntime.AnimNode_LookAt", FAnimNode_LookAt_IsValid);
	}
}
