...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/AnimGraphRuntime.AnimNode_ModifyBone", "AnimGraphRuntime", UnrealModuleType.Engine)]
public struct FAnimNode_ModifyBone
{
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/AnimGraphRuntime.AnimNode_ModifyBone:Translation")]
	...
	[UMetaPath("/Script/AnimGraphRuntime.AnimNode_ModifyBone:Rotation")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/AnimGraphRuntime.AnimNode_ModifyBone:Scale")]
	public FVector Scale;

	private static bool FAnimNode_ModifyBone_IsValid;

	private static int FAnimNode_ModifyBone_StructSize;

	public FAnimNode_ModifyBone Copy()
	{
		return this;
	}

	public static FAnimNode_ModifyBone FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_ModifyBone(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_ModifyBone value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_ModifyBone FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_ModifyBone(nativeBuffer + arrayIndex * FAnimNode_ModifyBone_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_ModifyBone value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_ModifyBone_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_ModifyBone_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_ModifyBone");
			return;
		}
	...
	public FAnimNode_ModifyBone(IntPtr nativeStruct)
	{
		if (!FAnimNode_ModifyBone_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_ModifyBone");
			Translation = default(FVector);
	...
	static FAnimNode_ModifyBone()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_ModifyBone)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_ModifyBone));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimGraphRuntime.AnimNode_ModifyBone");
		FAnimNode_ModifyBone_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FAnimNode_ModifyBone_IsValid = intPtr != IntPtr.Zero && Translation_IsValid && Rotation_IsValid && Scale_IsValid && ComponentPose_IsValid && LODThreshold_IsValid && AlphaInputType_IsValid && AlphaBoolEnabled_IsValid && Alpha_IsValid && AlphaScaleBias_IsValid && AlphaBoolBlend_IsValid && AlphaCurveName_IsValid && AlphaScaleBiasClamp_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimGraphRuntime.AnimNode_ModifyBone", FAnimNode_ModifyBone_IsValid);
	}
}
