...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/AnimGraphRuntime.AnimNode_HandIKRetargeting", "AnimGraphRuntime", UnrealModuleType.Engine)]
public struct FAnimNode_HandIKRetargeting
{
	...
	private static bool HandFKWeight_IsValid;

	private static int HandFKWeight_Offset;

	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/AnimGraphRuntime.AnimNode_HandIKRetargeting:HandFKWeight")]
	public float HandFKWeight;

	private static bool FAnimNode_HandIKRetargeting_IsValid;

	private static int FAnimNode_HandIKRetargeting_StructSize;

	public FAnimNode_HandIKRetargeting Copy()
	{
		return this;
	}

	public static FAnimNode_HandIKRetargeting FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_HandIKRetargeting(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_HandIKRetargeting value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_HandIKRetargeting FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_HandIKRetargeting(nativeBuffer + arrayIndex * FAnimNode_HandIKRetargeting_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_HandIKRetargeting value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_HandIKRetargeting_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_HandIKRetargeting_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_HandIKRetargeting");
			return;
		}
		BlittableTypeMarshaler<float>.ToNative(IntPtr.Add(nativeStruct, HandFKWeight_Offset), HandFKWeight);
	...
	public FAnimNode_HandIKRetargeting(IntPtr nativeStruct)
	{
		if (!FAnimNode_HandIKRetargeting_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_HandIKRetargeting");
		...
		{
			HandFKWeight = BlittableTypeMarshaler<float>.FromNative(IntPtr.Add(nativeStruct, HandFKWeight_Offset));
	...
	static FAnimNode_HandIKRetargeting()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_HandIKRetargeting)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_HandIKRetargeting));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimGraphRuntime.AnimNode_HandIKRetargeting");
		FAnimNode_HandIKRetargeting_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		HandFKWeight_Offset = NativeReflectionCached.GetPropertyOffset(intPtr, "HandFKWeight");
		HandFKWeight_IsValid = NativeReflectionCached.ValidatePropertyClass(intPtr, "HandFKWeight", Classes.FFloatProperty);
		FAnimNode_HandIKRetargeting_IsValid = intPtr != IntPtr.Zero && HandFKWeight_IsValid && ComponentPose_IsValid && LODThreshold_IsValid && AlphaInputType_IsValid && AlphaBoolEnabled_IsValid && Alpha_IsValid && AlphaScaleBias_IsValid && AlphaBoolBlend_IsValid && AlphaCurveName_IsValid && AlphaScaleBiasClamp_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimGraphRuntime.AnimNode_HandIKRetargeting", FAnimNode_HandIKRetargeting_IsValid);
	}
}
