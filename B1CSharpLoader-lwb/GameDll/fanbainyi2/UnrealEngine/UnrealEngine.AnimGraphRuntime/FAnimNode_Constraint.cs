...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/AnimGraphRuntime.AnimNode_Constraint", "AnimGraphRuntime", UnrealModuleType.Engine)]
public struct FAnimNode_Constraint
{
	...
	private static bool FAnimNode_Constraint_IsValid;

	private static int FAnimNode_Constraint_StructSize;

	public FAnimNode_Constraint Copy()
	{
		return this;
	}

	public static FAnimNode_Constraint FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_Constraint(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_Constraint value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_Constraint FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_Constraint(nativeBuffer + arrayIndex * FAnimNode_Constraint_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_Constraint value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_Constraint_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_Constraint_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_Constraint");
			return;
		}
	...
	public FAnimNode_Constraint(IntPtr nativeStruct)
	{
		if (!FAnimNode_Constraint_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_Constraint");
	...
	static FAnimNode_Constraint()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_Constraint)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_Constraint));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimGraphRuntime.AnimNode_Constraint");
		FAnimNode_Constraint_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FAnimNode_Constraint_IsValid = intPtr != IntPtr.Zero && ComponentPose_IsValid && LODThreshold_IsValid && AlphaInputType_IsValid && AlphaBoolEnabled_IsValid && Alpha_IsValid && AlphaScaleBias_IsValid && AlphaBoolBlend_IsValid && AlphaCurveName_IsValid && AlphaScaleBiasClamp_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimGraphRuntime.AnimNode_Constraint", FAnimNode_Constraint_IsValid);
	}
}
