...
[BlueprintType]
[UMetaPath("/Script/AnimGraphRuntime.AnimNode_RigidBody", "AnimGraphRuntime", UnrealModuleType.Engine)]
public struct FAnimNode_RigidBody
{
	...
	private static bool FAnimNode_RigidBody_IsValid;

	private static int FAnimNode_RigidBody_StructSize;

	public FAnimNode_RigidBody Copy()
	{
		return this;
	}

	public static FAnimNode_RigidBody FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_RigidBody(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_RigidBody value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_RigidBody FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_RigidBody(nativeBuffer + arrayIndex * FAnimNode_RigidBody_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_RigidBody value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_RigidBody_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_RigidBody_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_RigidBody");
			return;
		}
	...
	public FAnimNode_RigidBody(IntPtr nativeStruct)
	{
		if (!FAnimNode_RigidBody_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_RigidBody");
	...
	static FAnimNode_RigidBody()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_RigidBody)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_RigidBody));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimGraphRuntime.AnimNode_RigidBody");
		FAnimNode_RigidBody_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FAnimNode_RigidBody_IsValid = intPtr != IntPtr.Zero && ComponentPose_IsValid && LODThreshold_IsValid && AlphaInputType_IsValid && AlphaBoolEnabled_IsValid && Alpha_IsValid && AlphaScaleBias_IsValid && AlphaBoolBlend_IsValid && AlphaCurveName_IsValid && AlphaScaleBiasClamp_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimGraphRuntime.AnimNode_RigidBody", FAnimNode_RigidBody_IsValid);
	}
}
