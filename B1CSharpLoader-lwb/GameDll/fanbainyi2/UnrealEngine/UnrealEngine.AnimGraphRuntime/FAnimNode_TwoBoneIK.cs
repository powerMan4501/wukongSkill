...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/AnimGraphRuntime.AnimNode_TwoBoneIK", "AnimGraphRuntime", UnrealModuleType.Engine)]
public struct FAnimNode_TwoBoneIK
{
	...
	private static bool EffectorLocation_IsValid;

	private static int EffectorLocation_Offset;

	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/AnimGraphRuntime.AnimNode_TwoBoneIK:EffectorLocation")]
	public FVector EffectorLocation;

	private static bool JointTargetLocation_IsValid;

	private static int JointTargetLocation_Offset;

	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/AnimGraphRuntime.AnimNode_TwoBoneIK:JointTargetLocation")]
	public FVector JointTargetLocation;

	private static bool FAnimNode_TwoBoneIK_IsValid;

	private static int FAnimNode_TwoBoneIK_StructSize;

	public FAnimNode_TwoBoneIK Copy()
	{
		return this;
	}

	public static FAnimNode_TwoBoneIK FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_TwoBoneIK(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_TwoBoneIK value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_TwoBoneIK FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_TwoBoneIK(nativeBuffer + arrayIndex * FAnimNode_TwoBoneIK_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_TwoBoneIK value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_TwoBoneIK_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_TwoBoneIK_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_TwoBoneIK");
			return;
		}
		BlittableTypeMarshaler<FVector>.ToNative(IntPtr.Add(nativeStruct, EffectorLocation_Offset), EffectorLocation);
		BlittableTypeMarshaler<FVector>.ToNative(IntPtr.Add(nativeStruct, JointTargetLocation_Offset), JointTargetLocation);
	...
	public FAnimNode_TwoBoneIK(IntPtr nativeStruct)
	{
		if (!FAnimNode_TwoBoneIK_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_TwoBoneIK");
			EffectorLocation = default(FVector);
			JointTargetLocation = default(FVector);
		...
		{
			EffectorLocation = BlittableTypeMarshaler<FVector>.FromNative(IntPtr.Add(nativeStruct, EffectorLocation_Offset));
			JointTargetLocation = BlittableTypeMarshaler<FVector>.FromNative(IntPtr.Add(nativeStruct, JointTargetLocation_Offset));
	...
	static FAnimNode_TwoBoneIK()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_TwoBoneIK)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_TwoBoneIK));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimGraphRuntime.AnimNode_TwoBoneIK");
		FAnimNode_TwoBoneIK_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		EffectorLocation_Offset = NativeReflectionCached.GetPropertyOffset(intPtr, "EffectorLocation");
		EffectorLocation_IsValid = NativeReflectionCached.ValidatePropertyClass(intPtr, "EffectorLocation", Classes.FStructProperty);
		JointTargetLocation_Offset = NativeReflectionCached.GetPropertyOffset(intPtr, "JointTargetLocation");
		JointTargetLocation_IsValid = NativeReflectionCached.ValidatePropertyClass(intPtr, "JointTargetLocation", Classes.FStructProperty);
		FAnimNode_TwoBoneIK_IsValid = intPtr != IntPtr.Zero && EffectorLocation_IsValid && JointTargetLocation_IsValid && ComponentPose_IsValid && LODThreshold_IsValid && AlphaInputType_IsValid && AlphaBoolEnabled_IsValid && Alpha_IsValid && AlphaScaleBias_IsValid && AlphaBoolBlend_IsValid && AlphaCurveName_IsValid && AlphaScaleBiasClamp_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimGraphRuntime.AnimNode_TwoBoneIK", FAnimNode_TwoBoneIK_IsValid);
	}
}
