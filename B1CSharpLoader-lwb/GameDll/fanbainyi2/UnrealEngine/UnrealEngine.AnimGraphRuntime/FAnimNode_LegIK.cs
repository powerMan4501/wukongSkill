...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/AnimGraphRuntime.AnimNode_LegIK", "AnimGraphRuntime", UnrealModuleType.Engine)]
public struct FAnimNode_LegIK
{
	...
	private static bool FAnimNode_LegIK_IsValid;

	private static int FAnimNode_LegIK_StructSize;

	public FAnimNode_LegIK Copy()
	{
		return this;
	}

	public static FAnimNode_LegIK FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_LegIK(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_LegIK value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_LegIK FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_LegIK(nativeBuffer + arrayIndex * FAnimNode_LegIK_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_LegIK value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_LegIK_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_LegIK_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_LegIK");
			return;
		}
	...
	public FAnimNode_LegIK(IntPtr nativeStruct)
	{
		if (!FAnimNode_LegIK_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_LegIK");
	...
	static FAnimNode_LegIK()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_LegIK)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_LegIK));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimGraphRuntime.AnimNode_LegIK");
		FAnimNode_LegIK_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FAnimNode_LegIK_IsValid = intPtr != IntPtr.Zero && ComponentPose_IsValid && LODThreshold_IsValid && AlphaInputType_IsValid && AlphaBoolEnabled_IsValid && Alpha_IsValid && AlphaScaleBias_IsValid && AlphaBoolBlend_IsValid && AlphaCurveName_IsValid && AlphaScaleBiasClamp_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimGraphRuntime.AnimNode_LegIK", FAnimNode_LegIK_IsValid);
	}
}
