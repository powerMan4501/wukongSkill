...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/AnimGraphRuntime.AnimNode_BlendSpaceGraph", "AnimGraphRuntime", UnrealModuleType.Engine)]
public struct FAnimNode_BlendSpaceGraph
{
	...
	private static bool FAnimNode_BlendSpaceGraph_IsValid;

	private static int FAnimNode_BlendSpaceGraph_StructSize;

	public FAnimNode_BlendSpaceGraph Copy()
	{
		return this;
	}

	public static FAnimNode_BlendSpaceGraph FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_BlendSpaceGraph(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_BlendSpaceGraph value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_BlendSpaceGraph FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_BlendSpaceGraph(nativeBuffer + arrayIndex * FAnimNode_BlendSpaceGraph_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_BlendSpaceGraph value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_BlendSpaceGraph_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_BlendSpaceGraph_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_BlendSpaceGraph");
			return;
		}
	...
	public FAnimNode_BlendSpaceGraph(IntPtr nativeStruct)
	{
		if (!FAnimNode_BlendSpaceGraph_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_BlendSpaceGraph");
	...
	static FAnimNode_BlendSpaceGraph()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_BlendSpaceGraph)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_BlendSpaceGraph));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimGraphRuntime.AnimNode_BlendSpaceGraph");
		FAnimNode_BlendSpaceGraph_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FAnimNode_BlendSpaceGraph_IsValid = intPtr != IntPtr.Zero && X_IsValid && Y_IsValid && GroupName_IsValid && GroupRole_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimGraphRuntime.AnimNode_BlendSpaceGraph", FAnimNode_BlendSpaceGraph_IsValid);
	}
}
