...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/AnimGraphRuntime.AnimNode_BlendSpaceGraphBase", "AnimGraphRuntime", UnrealModuleType.Engine)]
public struct FAnimNode_BlendSpaceGraphBase
{
	...
	private static bool FAnimNode_BlendSpaceGraphBase_IsValid;

	private static int FAnimNode_BlendSpaceGraphBase_StructSize;

	public FAnimNode_BlendSpaceGraphBase Copy()
	{
		return this;
	}

	public static FAnimNode_BlendSpaceGraphBase FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_BlendSpaceGraphBase(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_BlendSpaceGraphBase value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_BlendSpaceGraphBase FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_BlendSpaceGraphBase(nativeBuffer + arrayIndex * FAnimNode_BlendSpaceGraphBase_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_BlendSpaceGraphBase value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_BlendSpaceGraphBase_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_BlendSpaceGraphBase_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_BlendSpaceGraphBase");
			return;
		}
	...
	public FAnimNode_BlendSpaceGraphBase(IntPtr nativeStruct)
	{
		if (!FAnimNode_BlendSpaceGraphBase_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_BlendSpaceGraphBase");
	...
	static FAnimNode_BlendSpaceGraphBase()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_BlendSpaceGraphBase)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_BlendSpaceGraphBase));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimGraphRuntime.AnimNode_BlendSpaceGraphBase");
		FAnimNode_BlendSpaceGraphBase_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FAnimNode_BlendSpaceGraphBase_IsValid = intPtr != IntPtr.Zero && X_IsValid && Y_IsValid && GroupName_IsValid && GroupRole_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimGraphRuntime.AnimNode_BlendSpaceGraphBase", FAnimNode_BlendSpaceGraphBase_IsValid);
	}
}
