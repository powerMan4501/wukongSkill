...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/AnimGraphRuntime.AnimNode_TwistCorrectiveNode", "AnimGraphRuntime", UnrealModuleType.Engine)]
public struct FAnimNode_TwistCorrectiveNode
{
	...
	private static bool FAnimNode_TwistCorrectiveNode_IsValid;

	private static int FAnimNode_TwistCorrectiveNode_StructSize;

	public FAnimNode_TwistCorrectiveNode Copy()
	{
		return this;
	}

	public static FAnimNode_TwistCorrectiveNode FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_TwistCorrectiveNode(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_TwistCorrectiveNode value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_TwistCorrectiveNode FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_TwistCorrectiveNode(nativeBuffer + arrayIndex * FAnimNode_TwistCorrectiveNode_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_TwistCorrectiveNode value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_TwistCorrectiveNode_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_TwistCorrectiveNode_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_TwistCorrectiveNode");
			return;
		}
	...
	public FAnimNode_TwistCorrectiveNode(IntPtr nativeStruct)
	{
		if (!FAnimNode_TwistCorrectiveNode_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_TwistCorrectiveNode");
	...
	static FAnimNode_TwistCorrectiveNode()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_TwistCorrectiveNode)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_TwistCorrectiveNode));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimGraphRuntime.AnimNode_TwistCorrectiveNode");
		FAnimNode_TwistCorrectiveNode_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FAnimNode_TwistCorrectiveNode_IsValid = intPtr != IntPtr.Zero && ComponentPose_IsValid && LODThreshold_IsValid && AlphaInputType_IsValid && AlphaBoolEnabled_IsValid && Alpha_IsValid && AlphaScaleBias_IsValid && AlphaBoolBlend_IsValid && AlphaCurveName_IsValid && AlphaScaleBiasClamp_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimGraphRuntime.AnimNode_TwistCorrectiveNode", FAnimNode_TwistCorrectiveNode_IsValid);
	}
}
