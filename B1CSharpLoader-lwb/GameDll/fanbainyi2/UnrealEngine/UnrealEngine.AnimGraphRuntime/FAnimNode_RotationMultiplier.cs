...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/AnimGraphRuntime.AnimNode_RotationMultiplier", "AnimGraphRuntime", UnrealModuleType.Engine)]
public struct FAnimNode_RotationMultiplier
{
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/AnimGraphRuntime.AnimNode_RotationMultiplier:Multiplier")]
	public float Multiplier;

	private static bool FAnimNode_RotationMultiplier_IsValid;

	private static int FAnimNode_RotationMultiplier_StructSize;

	public FAnimNode_RotationMultiplier Copy()
	{
		return this;
	}

	public static FAnimNode_RotationMultiplier FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_RotationMultiplier(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_RotationMultiplier value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_RotationMultiplier FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_RotationMultiplier(nativeBuffer + arrayIndex * FAnimNode_RotationMultiplier_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_RotationMultiplier value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_RotationMultiplier_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_RotationMultiplier_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_RotationMultiplier");
			return;
		}
	...
	public FAnimNode_RotationMultiplier(IntPtr nativeStruct)
	{
		if (!FAnimNode_RotationMultiplier_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_RotationMultiplier");
	...
	static FAnimNode_RotationMultiplier()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_RotationMultiplier)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_RotationMultiplier));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimGraphRuntime.AnimNode_RotationMultiplier");
		FAnimNode_RotationMultiplier_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FAnimNode_RotationMultiplier_IsValid = intPtr != IntPtr.Zero && Multiplier_IsValid && ComponentPose_IsValid && LODThreshold_IsValid && AlphaInputType_IsValid && AlphaBoolEnabled_IsValid && Alpha_IsValid && AlphaScaleBias_IsValid && AlphaBoolBlend_IsValid && AlphaCurveName_IsValid && AlphaScaleBiasClamp_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimGraphRuntime.AnimNode_RotationMultiplier", FAnimNode_RotationMultiplier_IsValid);
	}
}
