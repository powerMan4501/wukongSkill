...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/AnimGraphRuntime.AnimNode_Fabrik", "AnimGraphRuntime", UnrealModuleType.Engine)]
public struct FAnimNode_Fabrik
{
	...
	private static bool EffectorTransform_IsValid;

	private static int EffectorTransform_Offset;

	[UProperty(Flags = (PropFlags)4503669420589061uL)]
	[UMetaPath("/Script/AnimGraphRuntime.AnimNode_Fabrik:EffectorTransform")]
	public FTransform EffectorTransform;

	private static bool FAnimNode_Fabrik_IsValid;

	private static int FAnimNode_Fabrik_StructSize;

	public FAnimNode_Fabrik Copy()
	{
		return this;
	}

	public static FAnimNode_Fabrik FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_Fabrik(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_Fabrik value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_Fabrik FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_Fabrik(nativeBuffer + arrayIndex * FAnimNode_Fabrik_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_Fabrik value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_Fabrik_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_Fabrik_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_Fabrik");
			return;
		}
		BlittableTypeMarshaler<FTransform>.ToNative(IntPtr.Add(nativeStruct, EffectorTransform_Offset), EffectorTransform);
	...
	public FAnimNode_Fabrik(IntPtr nativeStruct)
	{
		if (!FAnimNode_Fabrik_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_Fabrik");
			EffectorTransform = default(FTransform);
		...
		{
			EffectorTransform = BlittableTypeMarshaler<FTransform>.FromNative(IntPtr.Add(nativeStruct, EffectorTransform_Offset));
	...
	static FAnimNode_Fabrik()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_Fabrik)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_Fabrik));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimGraphRuntime.AnimNode_Fabrik");
		FAnimNode_Fabrik_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		EffectorTransform_Offset = NativeReflectionCached.GetPropertyOffset(intPtr, "EffectorTransform");
		EffectorTransform_IsValid = NativeReflectionCached.ValidatePropertyClass(intPtr, "EffectorTransform", Classes.FStructProperty);
		FAnimNode_Fabrik_IsValid = intPtr != IntPtr.Zero && EffectorTransform_IsValid && ComponentPose_IsValid && LODThreshold_IsValid && AlphaInputType_IsValid && AlphaBoolEnabled_IsValid && Alpha_IsValid && AlphaScaleBias_IsValid && AlphaBoolBlend_IsValid && AlphaCurveName_IsValid && AlphaScaleBiasClamp_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimGraphRuntime.AnimNode_Fabrik", FAnimNode_Fabrik_IsValid);
	}
}
