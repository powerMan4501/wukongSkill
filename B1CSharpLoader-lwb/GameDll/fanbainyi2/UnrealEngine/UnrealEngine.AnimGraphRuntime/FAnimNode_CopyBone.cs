...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/AnimGraphRuntime.AnimNode_CopyBone", "AnimGraphRuntime", UnrealModuleType.Engine)]
public struct FAnimNode_CopyBone
{
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/AnimGraphRuntime.AnimNode_CopyBone:bCopyTranslation")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/AnimGraphRuntime.AnimNode_CopyBone:bCopyRotation")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/AnimGraphRuntime.AnimNode_CopyBone:bCopyScale")]
	public bool CopyScale;

	private static bool FAnimNode_CopyBone_IsValid;

	private static int FAnimNode_CopyBone_StructSize;

	public FAnimNode_CopyBone Copy()
	{
		return this;
	}

	public static FAnimNode_CopyBone FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_CopyBone(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_CopyBone value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_CopyBone FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_CopyBone(nativeBuffer + arrayIndex * FAnimNode_CopyBone_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_CopyBone value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_CopyBone_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_CopyBone_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_CopyBone");
			return;
		}
	...
	public FAnimNode_CopyBone(IntPtr nativeStruct)
	{
		if (!FAnimNode_CopyBone_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_CopyBone");
	...
	static FAnimNode_CopyBone()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_CopyBone)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_CopyBone));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimGraphRuntime.AnimNode_CopyBone");
		FAnimNode_CopyBone_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FAnimNode_CopyBone_IsValid = intPtr != IntPtr.Zero && CopyTranslation_IsValid && CopyRotation_IsValid && CopyScale_IsValid && ComponentPose_IsValid && LODThreshold_IsValid && AlphaInputType_IsValid && AlphaBoolEnabled_IsValid && Alpha_IsValid && AlphaScaleBias_IsValid && AlphaBoolBlend_IsValid && AlphaCurveName_IsValid && AlphaScaleBiasClamp_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimGraphRuntime.AnimNode_CopyBone", FAnimNode_CopyBone_IsValid);
	}
}
