...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/AnimGraphRuntime.AnimNode_ObserveBone", "AnimGraphRuntime", UnrealModuleType.Engine)]
public struct FAnimNode_ObserveBone
{
	...
	private static bool FAnimNode_ObserveBone_IsValid;

	private static int FAnimNode_ObserveBone_StructSize;

	public FAnimNode_ObserveBone Copy()
	{
		return this;
	}

	public static FAnimNode_ObserveBone FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_ObserveBone(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_ObserveBone value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_ObserveBone FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_ObserveBone(nativeBuffer + arrayIndex * FAnimNode_ObserveBone_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_ObserveBone value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_ObserveBone_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_ObserveBone_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_ObserveBone");
			return;
		}
	...
	public FAnimNode_ObserveBone(IntPtr nativeStruct)
	{
		if (!FAnimNode_ObserveBone_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_ObserveBone");
	...
	static FAnimNode_ObserveBone()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_ObserveBone)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_ObserveBone));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimGraphRuntime.AnimNode_ObserveBone");
		FAnimNode_ObserveBone_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FAnimNode_ObserveBone_IsValid = intPtr != IntPtr.Zero && ComponentPose_IsValid && LODThreshold_IsValid && AlphaInputType_IsValid && AlphaBoolEnabled_IsValid && Alpha_IsValid && AlphaScaleBias_IsValid && AlphaBoolBlend_IsValid && AlphaCurveName_IsValid && AlphaScaleBiasClamp_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimGraphRuntime.AnimNode_ObserveBone", FAnimNode_ObserveBone_IsValid);
	}
}
