...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/AnimGraphRuntime.AnimNode_CCDIK", "AnimGraphRuntime", UnrealModuleType.Engine)]
public struct FAnimNode_CCDIK
{
	...
	private static bool FAnimNode_CCDIK_IsValid;

	private static int FAnimNode_CCDIK_StructSize;

	public FAnimNode_CCDIK Copy()
	{
		return this;
	}

	public static FAnimNode_CCDIK FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_CCDIK(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_CCDIK value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_CCDIK FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_CCDIK(nativeBuffer + arrayIndex * FAnimNode_CCDIK_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_CCDIK value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_CCDIK_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_CCDIK_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_CCDIK");
			return;
		}
	...
	public FAnimNode_CCDIK(IntPtr nativeStruct)
	{
		if (!FAnimNode_CCDIK_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_CCDIK");
	...
	static FAnimNode_CCDIK()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_CCDIK)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_CCDIK));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimGraphRuntime.AnimNode_CCDIK");
		FAnimNode_CCDIK_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FAnimNode_CCDIK_IsValid = intPtr != IntPtr.Zero && ComponentPose_IsValid && LODThreshold_IsValid && AlphaInputType_IsValid && AlphaBoolEnabled_IsValid && Alpha_IsValid && AlphaScaleBias_IsValid && AlphaBoolBlend_IsValid && AlphaCurveName_IsValid && AlphaScaleBiasClamp_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimGraphRuntime.AnimNode_CCDIK", FAnimNode_CCDIK_IsValid);
	}
}
