...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/AnimGraphRuntime.AnimNode_ResetRoot", "AnimGraphRuntime", UnrealModuleType.Engine)]
public struct FAnimNode_ResetRoot
{
	...
	private static bool FAnimNode_ResetRoot_IsValid;

	private static int FAnimNode_ResetRoot_StructSize;

	public FAnimNode_ResetRoot Copy()
	{
		return this;
	}

	public static FAnimNode_ResetRoot FromNative(IntPtr nativeBuffer)
	{
		return new FAnimNode_ResetRoot(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FAnimNode_ResetRoot value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FAnimNode_ResetRoot FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FAnimNode_ResetRoot(nativeBuffer + arrayIndex * FAnimNode_ResetRoot_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FAnimNode_ResetRoot value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FAnimNode_ResetRoot_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FAnimNode_ResetRoot_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_ResetRoot");
			return;
		}
	...
	public FAnimNode_ResetRoot(IntPtr nativeStruct)
	{
		if (!FAnimNode_ResetRoot_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/AnimGraphRuntime.AnimNode_ResetRoot");
	...
	static FAnimNode_ResetRoot()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FAnimNode_ResetRoot)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FAnimNode_ResetRoot));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/AnimGraphRuntime.AnimNode_ResetRoot");
		FAnimNode_ResetRoot_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FAnimNode_ResetRoot_IsValid = intPtr != IntPtr.Zero && ComponentPose_IsValid && LODThreshold_IsValid && AlphaInputType_IsValid && AlphaBoolEnabled_IsValid && Alpha_IsValid && AlphaScaleBias_IsValid && AlphaBoolBlend_IsValid && AlphaCurveName_IsValid && AlphaScaleBiasClamp_IsValid;
		NativeReflection.LogStructIsValid("/Script/AnimGraphRuntime.AnimNode_ResetRoot", FAnimNode_ResetRoot_IsValid);
	}
}
