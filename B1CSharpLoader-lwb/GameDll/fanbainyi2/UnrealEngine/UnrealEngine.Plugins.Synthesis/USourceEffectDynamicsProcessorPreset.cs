...
[BlueprintType]
[UMetaPath("/Script/Synthesis.SourceEffectDynamicsProcessorPreset", "Synthesis", UnrealModuleType.EnginePlugin)]
public class USourceEffectDynamicsProcessorPreset : USoundEffectSourcePreset
{
	...
	[UMetaPath("/Script/Synthesis.SourceEffectDynamicsProcessorPreset:Settings")]
	public FSourceEffectDynamicsProcessorSettings Settings
	{
		get
		{
			...
			if (!Settings_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/Synthesis.SourceEffectDynamicsProcessorPreset:Settings");
				return default(FSourceEffectDynamicsProcessorSettings);
			}
			return FSourceEffectDynamicsProcessorSettings.FromNative(IntPtr.Add(base.Address, Settings_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				FSourceEffectDynamicsProcessorSettings.ToNative(IntPtr.Add(base.Address, Settings_Offset), value);
			}
		}
	}

	[UFunction(Flags = 71435265u)]
	[UMetaPath("/Script/Synthesis.SourceEffectDynamicsProcessorPreset:SetSettings")]
	public unsafe void SetSettings(FSourceEffectDynamicsProcessorSettings InSettings)
	{
		CheckDestroyed();
		if (!SetSettings_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/Synthesis.SourceEffectDynamicsProcessorPreset:SetSettings");
			return;
		}
		...
		FSourceEffectDynamicsProcessorSettings.ToNative(IntPtr.Add(intPtr, SetSettings_InSettings_Offset), 0, SetSettings_InSettings_PropertyAddress.Address, InSettings);
		NativeReflection.InvokeFunctionOptimized(base.Address, SetSettings_FunctionAddress, intPtr, SetSettings_ParamsSize);
	}

	static USourceEffectDynamicsProcessorPreset()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(USourceEffectDynamicsProcessorPreset)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(USourceEffectDynamicsProcessorPreset));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/Synthesis.SourceEffectDynamicsProcessorPreset");
		...
		NativeReflection.LogFunctionIsValid("/Script/Synthesis.SourceEffectDynamicsProcessorPreset:SetSettings", SetSettings_IsValid);
	}
}
