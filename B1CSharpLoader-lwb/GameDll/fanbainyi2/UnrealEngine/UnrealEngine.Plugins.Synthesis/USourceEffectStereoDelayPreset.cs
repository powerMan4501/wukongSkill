...
[BlueprintType]
[UMetaPath("/Script/Synthesis.SourceEffectStereoDelayPreset", "Synthesis", UnrealModuleType.EnginePlugin)]
public class USourceEffectStereoDelayPreset : USoundEffectSourcePreset
{
	...
	[UMetaPath("/Script/Synthesis.SourceEffectStereoDelayPreset:Settings")]
	public FSourceEffectStereoDelaySettings Settings
	{
		get
		{
			...
			if (!Settings_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/Synthesis.SourceEffectStereoDelayPreset:Settings");
				return default(FSourceEffectStereoDelaySettings);
			}
			return FSourceEffectStereoDelaySettings.FromNative(IntPtr.Add(base.Address, Settings_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				FSourceEffectStereoDelaySettings.ToNative(IntPtr.Add(base.Address, Settings_Offset), value);
			}
		}
	}

	[UFunction(Flags = 71435265u)]
	[UMetaPath("/Script/Synthesis.SourceEffectStereoDelayPreset:SetSettings")]
	public unsafe void SetSettings(FSourceEffectStereoDelaySettings InSettings)
	{
		CheckDestroyed();
		if (!SetSettings_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/Synthesis.SourceEffectStereoDelayPreset:SetSettings");
			return;
		}
		...
		FSourceEffectStereoDelaySettings.ToNative(IntPtr.Add(intPtr, SetSettings_InSettings_Offset), 0, SetSettings_InSettings_PropertyAddress.Address, InSettings);
		NativeReflection.InvokeFunctionOptimized(base.Address, SetSettings_FunctionAddress, intPtr, SetSettings_ParamsSize);
	}

	static USourceEffectStereoDelayPreset()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(USourceEffectStereoDelayPreset)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(USourceEffectStereoDelayPreset));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/Synthesis.SourceEffectStereoDelayPreset");
		...
		NativeReflection.LogFunctionIsValid("/Script/Synthesis.SourceEffectStereoDelayPreset:SetSettings", SetSettings_IsValid);
	}
}
