...
[BlueprintType]
[UMetaPath("/Script/Synthesis.SourceEffectWaveShaperPreset", "Synthesis", UnrealModuleType.EnginePlugin)]
public class USourceEffectWaveShaperPreset : USoundEffectSourcePreset
{
	...
	[UMetaPath("/Script/Synthesis.SourceEffectWaveShaperPreset:Settings")]
	public FSourceEffectWaveShaperSettings Settings
	{
		get
		{
			...
			if (!Settings_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/Synthesis.SourceEffectWaveShaperPreset:Settings");
				return default(FSourceEffectWaveShaperSettings);
			}
			return FSourceEffectWaveShaperSettings.FromNative(IntPtr.Add(base.Address, Settings_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				FSourceEffectWaveShaperSettings.ToNative(IntPtr.Add(base.Address, Settings_Offset), value);
			}
		}
	}

	[UFunction(Flags = 71435265u)]
	[UMetaPath("/Script/Synthesis.SourceEffectWaveShaperPreset:SetSettings")]
	public unsafe void SetSettings(FSourceEffectWaveShaperSettings InSettings)
	{
		CheckDestroyed();
		if (!SetSettings_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/Synthesis.SourceEffectWaveShaperPreset:SetSettings");
			return;
		}
		...
		FSourceEffectWaveShaperSettings.ToNative(IntPtr.Add(intPtr, SetSettings_InSettings_Offset), 0, SetSettings_InSettings_PropertyAddress.Address, InSettings);
		NativeReflection.InvokeFunctionOptimized(base.Address, SetSettings_FunctionAddress, intPtr, SetSettings_ParamsSize);
	}

	static USourceEffectWaveShaperPreset()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(USourceEffectWaveShaperPreset)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(USourceEffectWaveShaperPreset));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/Synthesis.SourceEffectWaveShaperPreset");
		...
		NativeReflection.LogFunctionIsValid("/Script/Synthesis.SourceEffectWaveShaperPreset:SetSettings", SetSettings_IsValid);
	}
}
