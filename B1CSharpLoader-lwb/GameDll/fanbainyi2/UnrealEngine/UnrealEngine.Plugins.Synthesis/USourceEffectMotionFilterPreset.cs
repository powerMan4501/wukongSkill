...
[BlueprintType]
[UMetaPath("/Script/Synthesis.SourceEffectMotionFilterPreset", "Synthesis", UnrealModuleType.EnginePlugin)]
public class USourceEffectMotionFilterPreset : USoundEffectSourcePreset
{
	...
	[UMetaPath("/Script/Synthesis.SourceEffectMotionFilterPreset:Settings")]
	public FSourceEffectMotionFilterSettings Settings
	{
		get
		{
			...
			if (!Settings_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/Synthesis.SourceEffectMotionFilterPreset:Settings");
				return default(FSourceEffectMotionFilterSettings);
			}
			return FSourceEffectMotionFilterSettings.FromNative(IntPtr.Add(base.Address, Settings_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				FSourceEffectMotionFilterSettings.ToNative(IntPtr.Add(base.Address, Settings_Offset), value);
			}
		}
	}

	[UFunction(Flags = 71435265u)]
	[UMetaPath("/Script/Synthesis.SourceEffectMotionFilterPreset:SetSettings")]
	public unsafe void SetSettings(FSourceEffectMotionFilterSettings InSettings)
	{
		CheckDestroyed();
		if (!SetSettings_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/Synthesis.SourceEffectMotionFilterPreset:SetSettings");
			return;
		}
		...
		FSourceEffectMotionFilterSettings.ToNative(IntPtr.Add(intPtr, SetSettings_InSettings_Offset), 0, SetSettings_InSettings_PropertyAddress.Address, InSettings);
	...
	static USourceEffectMotionFilterPreset()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(USourceEffectMotionFilterPreset)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(USourceEffectMotionFilterPreset));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/Synthesis.SourceEffectMotionFilterPreset");
		...
		NativeReflection.LogFunctionIsValid("/Script/Synthesis.SourceEffectMotionFilterPreset:SetSettings", SetSettings_IsValid);
	}
}
