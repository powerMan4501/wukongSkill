...
[BlueprintType]
[UMetaPath("/Script/Synthesis.SourceEffectFoldbackDistortionPreset", "Synthesis", UnrealModuleType.EnginePlugin)]
public class USourceEffectFoldbackDistortionPreset : USoundEffectSourcePreset
{
	...
	[UMetaPath("/Script/Synthesis.SourceEffectFoldbackDistortionPreset:Settings")]
	public FSourceEffectFoldbackDistortionSettings Settings
	{
		get
		{
			...
			if (!Settings_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/Synthesis.SourceEffectFoldbackDistortionPreset:Settings");
				return default(FSourceEffectFoldbackDistortionSettings);
			}
			return FSourceEffectFoldbackDistortionSettings.FromNative(IntPtr.Add(base.Address, Settings_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				FSourceEffectFoldbackDistortionSettings.ToNative(IntPtr.Add(base.Address, Settings_Offset), value);
			}
		}
	}

	[UFunction(Flags = 71435265u)]
	[UMetaPath("/Script/Synthesis.SourceEffectFoldbackDistortionPreset:SetSettings")]
	public unsafe void SetSettings(FSourceEffectFoldbackDistortionSettings InSettings)
	{
		CheckDestroyed();
		if (!SetSettings_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/Synthesis.SourceEffectFoldbackDistortionPreset:SetSettings");
			return;
		}
		...
		FSourceEffectFoldbackDistortionSettings.ToNative(IntPtr.Add(intPtr, SetSettings_InSettings_Offset), 0, SetSettings_InSettings_PropertyAddress.Address, InSettings);
		NativeReflection.InvokeFunctionOptimized(base.Address, SetSettings_FunctionAddress, intPtr, SetSettings_ParamsSize);
	}

	static USourceEffectFoldbackDistortionPreset()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(USourceEffectFoldbackDistortionPreset)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(USourceEffectFoldbackDistortionPreset));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/Synthesis.SourceEffectFoldbackDistortionPreset");
		...
		NativeReflection.LogFunctionIsValid("/Script/Synthesis.SourceEffectFoldbackDistortionPreset:SetSettings", SetSettings_IsValid);
	}
}
