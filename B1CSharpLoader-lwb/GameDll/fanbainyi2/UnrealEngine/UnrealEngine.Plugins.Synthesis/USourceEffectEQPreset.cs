...
[BlueprintType]
[UMetaPath("/Script/Synthesis.SourceEffectEQPreset", "Synthesis", UnrealModuleType.EnginePlugin)]
public class USourceEffectEQPreset : USoundEffectSourcePreset
{
	...
	[UMetaPath("/Script/Synthesis.SourceEffectEQPreset:Settings")]
	public FSourceEffectEQSettings Settings
	{
		get
		{
			...
			if (!Settings_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/Synthesis.SourceEffectEQPreset:Settings");
				return default(FSourceEffectEQSettings);
			}
			return FSourceEffectEQSettings.FromNative(IntPtr.Add(base.Address, Settings_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				FSourceEffectEQSettings.ToNative(IntPtr.Add(base.Address, Settings_Offset), value);
			}
		}
	}

	[UFunction(Flags = 71435265u)]
	[UMetaPath("/Script/Synthesis.SourceEffectEQPreset:SetSettings")]
	public unsafe void SetSettings(FSourceEffectEQSettings InSettings)
	{
		CheckDestroyed();
		if (!SetSettings_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/Synthesis.SourceEffectEQPreset:SetSettings");
			return;
		}
		...
		FSourceEffectEQSettings.ToNative(IntPtr.Add(intPtr, SetSettings_InSettings_Offset), 0, SetSettings_InSettings_PropertyAddress.Address, InSettings);
	...
	static USourceEffectEQPreset()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(USourceEffectEQPreset)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(USourceEffectEQPreset));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/Synthesis.SourceEffectEQPreset");
		...
		NativeReflection.LogFunctionIsValid("/Script/Synthesis.SourceEffectEQPreset:SetSettings", SetSettings_IsValid);
	}
}
