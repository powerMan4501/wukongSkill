...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/Synthesis.SourceEffectStereoDelaySettings", "Synthesis", UnrealModuleType.EnginePlugin)]
public struct FSourceEffectStereoDelaySettings
{
	...
	[UMetaPath("/Script/Synthesis.SourceEffectStereoDelaySettings:DelayMode")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/Synthesis.SourceEffectStereoDelaySettings:DelayTimeMsec")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/Synthesis.SourceEffectStereoDelaySettings:Feedback")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/Synthesis.SourceEffectStereoDelaySettings:DelayRatio")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/Synthesis.SourceEffectStereoDelaySettings:WetLevel")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/Synthesis.SourceEffectStereoDelaySettings:DryLevel")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/Synthesis.SourceEffectStereoDelaySettings:bFilterEnabled")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/Synthesis.SourceEffectStereoDelaySettings:FilterType")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/Synthesis.SourceEffectStereoDelaySettings:FilterFrequency")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/Synthesis.SourceEffectStereoDelaySettings:FilterQ")]
	public float FilterQ;

	private static bool FSourceEffectStereoDelaySettings_IsValid;

	private static int FSourceEffectStereoDelaySettings_StructSize;

	public FSourceEffectStereoDelaySettings Copy()
	{
		return this;
	}

	public static FSourceEffectStereoDelaySettings FromNative(IntPtr nativeBuffer)
	{
		return new FSourceEffectStereoDelaySettings(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FSourceEffectStereoDelaySettings value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FSourceEffectStereoDelaySettings FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FSourceEffectStereoDelaySettings(nativeBuffer + arrayIndex * FSourceEffectStereoDelaySettings_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FSourceEffectStereoDelaySettings value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FSourceEffectStereoDelaySettings_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FSourceEffectStereoDelaySettings_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/Synthesis.SourceEffectStereoDelaySettings");
			return;
		}
	...
	public FSourceEffectStereoDelaySettings(IntPtr nativeStruct)
	{
		if (!FSourceEffectStereoDelaySettings_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/Synthesis.SourceEffectStereoDelaySettings");
	...
	static FSourceEffectStereoDelaySettings()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FSourceEffectStereoDelaySettings)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FSourceEffectStereoDelaySettings));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/Synthesis.SourceEffectStereoDelaySettings");
		FSourceEffectStereoDelaySettings_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FSourceEffectStereoDelaySettings_IsValid = intPtr != IntPtr.Zero && DelayMode_IsValid && DelayTimeMsec_IsValid && Feedback_IsValid && DelayRatio_IsValid && WetLevel_IsValid && DryLevel_IsValid && FilterEnabled_IsValid && FilterType_IsValid && FilterFrequency_IsValid && FilterQ_IsValid;
		NativeReflection.LogStructIsValid("/Script/Synthesis.SourceEffectStereoDelaySettings", FSourceEffectStereoDelaySettings_IsValid);
	}
}
