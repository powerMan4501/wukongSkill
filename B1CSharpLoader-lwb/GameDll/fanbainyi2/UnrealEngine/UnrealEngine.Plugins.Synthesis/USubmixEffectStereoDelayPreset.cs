...
[BlueprintType]
[UMetaPath("/Script/Synthesis.SubmixEffectStereoDelayPreset", "Synthesis", UnrealModuleType.EnginePlugin)]
public class USubmixEffectStereoDelayPreset : USoundEffectSubmixPreset
{
	...
	[UMetaPath("/Script/Synthesis.SubmixEffectStereoDelayPreset:Settings")]
	public FSubmixEffectStereoDelaySettings Settings
	{
		get
		{
			...
			if (!Settings_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/Synthesis.SubmixEffectStereoDelayPreset:Settings");
				return default(FSubmixEffectStereoDelaySettings);
			}
			return FSubmixEffectStereoDelaySettings.FromNative(IntPtr.Add(base.Address, Settings_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				FSubmixEffectStereoDelaySettings.ToNative(IntPtr.Add(base.Address, Settings_Offset), value);
			}
		}
	}

	[UFunction(Flags = 71435265u)]
	[UMetaPath("/Script/Synthesis.SubmixEffectStereoDelayPreset:SetSettings")]
	public unsafe void SetSettings(FSubmixEffectStereoDelaySettings InSettings)
	{
		CheckDestroyed();
		if (!SetSettings_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/Synthesis.SubmixEffectStereoDelayPreset:SetSettings");
			return;
		}
		...
		FSubmixEffectStereoDelaySettings.ToNative(IntPtr.Add(intPtr, SetSettings_InSettings_Offset), 0, SetSettings_InSettings_PropertyAddress.Address, InSettings);
		NativeReflection.InvokeFunctionOptimized(base.Address, SetSettings_FunctionAddress, intPtr, SetSettings_ParamsSize);
	}

	static USubmixEffectStereoDelayPreset()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(USubmixEffectStereoDelayPreset)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(USubmixEffectStereoDelayPreset));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/Synthesis.SubmixEffectStereoDelayPreset");
		...
		NativeReflection.LogFunctionIsValid("/Script/Synthesis.SubmixEffectStereoDelayPreset:SetSettings", SetSettings_IsValid);
	}
}
