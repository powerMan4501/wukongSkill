...
[BlueprintType]
[UMetaPath("/Script/AudioMixer.SubmixEffectSubmixEQPreset", "AudioMixer", UnrealModuleType.Engine)]
public class USubmixEffectSubmixEQPreset : USoundEffectSubmixPreset
{
	...
	[UMetaPath("/Script/AudioMixer.SubmixEffectSubmixEQPreset:Settings")]
	public FSubmixEffectSubmixEQSettings Settings
	{
		get
		{
			CheckDestroyed();
			if (!Settings_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/AudioMixer.SubmixEffectSubmixEQPreset:Settings");
				return default(FSubmixEffectSubmixEQSettings);
			}
			return FSubmixEffectSubmixEQSettings.FromNative(IntPtr.Add(base.Address, Settings_Offset));
		}
		set
		{
			CheckDestroyed();
			...
			{
				FSubmixEffectSubmixEQSettings.ToNative(IntPtr.Add(base.Address, Settings_Offset), value);
			}
		}
	}

	[UFunction(Flags = 71435265u)]
	[UMetaPath("/Script/AudioMixer.SubmixEffectSubmixEQPreset:SetSettings")]
	public unsafe void SetSettings(FSubmixEffectSubmixEQSettings InSettings)
	{
		CheckDestroyed();
		if (!SetSettings_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/AudioMixer.SubmixEffectSubmixEQPreset:SetSettings");
			return;
		}
		...
		FSubmixEffectSubmixEQSettings.ToNative(IntPtr.Add(intPtr, SetSettings_InSettings_Offset), 0, SetSettings_InSettings_PropertyAddress.Address, InSettings);
	...
	static USubmixEffectSubmixEQPreset()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(USubmixEffectSubmixEQPreset)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(USubmixEffectSubmixEQPreset));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/AudioMixer.SubmixEffectSubmixEQPreset");
		...
		NativeReflection.LogFunctionIsValid("/Script/AudioMixer.SubmixEffectSubmixEQPreset:SetSettings", SetSettings_IsValid);
	}
}
