...
namespace UnrealEngine.Plugins.WebBrowserWidget;

[UClass(Flags = (ClassFlags)821035168uL, Config = "Engine")]
[BlueprintType]
[Blueprintable]
[UMetaPath("/Script/WebBrowserWidget.WebBrowser", "WebBrowserWidget", UnrealModuleType.EnginePlugin)]
public class UWebBrowser : UWidget
{
	[UDelegate]
	[UMetaPath("/Script/WebBrowserWidget.WebBrowser:OnUrlChanged__DelegateSignature")]
	public class FOnUrlChanged : FMulticastDelegate<FOnUrlChanged.Signature>
	{
		...
		{
			OnUrlChanged__DelegateSignature_FunctionAddress = NativeReflection.GetFunction("/Script/WebBrowserWidget.WebBrowser:OnUrlChanged__DelegateSignature");
			...
			NativeReflection.LogFunctionIsValid("/Script/WebBrowserWidget.WebBrowser:OnUrlChanged__DelegateSignature", OnUrlChanged__DelegateSignature_IsValid);
		}
		...
		private unsafe void Invoker(FText Text)
		{
			...
			{
				NativeReflection.LogInvalidFunctionAccessed("/Script/WebBrowserWidget.WebBrowser:OnUrlChanged__DelegateSignature");
			}
			else if (IsBound)
			{
	...
	[UDelegate]
	[UMetaPath("/Script/WebBrowserWidget.WebBrowser:OnBeforePopup__DelegateSignature")]
	public class FOnBeforePopup : FMulticastDelegate<FOnBeforePopup.Signature>
	{
		...
		private static void LoadNativeType()
		{
			OnBeforePopup__DelegateSignature_FunctionAddress = NativeReflection.GetFunction("/Script/WebBrowserWidget.WebBrowser:OnBeforePopup__DelegateSignature");
			...
			NativeReflection.LogFunctionIsValid("/Script/WebBrowserWidget.WebBrowser:OnBeforePopup__DelegateSignature", OnBeforePopup__DelegateSignature_IsValid);
		}
		...
		private unsafe void Invoker(string URL, string Frame)
		{
			...
			{
				NativeReflection.LogInvalidFunctionAccessed("/Script/WebBrowserWidget.WebBrowser:OnBeforePopup__DelegateSignature");
			}
			else if (IsBound)
			{
	...
	[UMetaPath("/Script/WebBrowserWidget.WebBrowser:OnUrlChanged")]
	public FOnUrlChanged OnUrlChanged
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/WebBrowserWidget.WebBrowser:OnUrlChanged");
	...
	[UProperty(Flags = (PropFlags)4503599896330752uL)]
	[UMetaPath("/Script/WebBrowserWidget.WebBrowser:OnBeforePopup")]
	public FOnBeforePopup OnBeforePopup
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/WebBrowserWidget.WebBrowser:OnBeforePopup");
	...
	[UMetaPath("/Script/WebBrowserWidget.WebBrowser:LoadURL")]
	public unsafe void LoadURL(string NewURL)
	{
		CheckDestroyed();
		if (!LoadURL_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/WebBrowserWidget.WebBrowser:LoadURL");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/WebBrowserWidget.WebBrowser:LoadString")]
	public unsafe void LoadString(string Contents, string DummyURL)
	{
		CheckDestroyed();
		if (!LoadString_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/WebBrowserWidget.WebBrowser:LoadString");
			return;
		}
	...
	[UMetaPath("/Script/WebBrowserWidget.WebBrowser:GetUrl")]
	public unsafe string GetUrl()
	{
		CheckDestroyed();
		if (!GetUrl_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/WebBrowserWidget.WebBrowser:GetUrl");
	...
	[UFunction(Flags = 1409418241u)]
	[UMetaPath("/Script/WebBrowserWidget.WebBrowser:GetTitleText")]
	public unsafe string GetTitleText()
	{
		CheckDestroyed();
		if (!GetTitleText_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/WebBrowserWidget.WebBrowser:GetTitleText");
			return FStringMarshaler.DefaultString;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/WebBrowserWidget.WebBrowser:ExecuteJavascript")]
	public unsafe void ExecuteJavascript(string ScriptText)
	{
		CheckDestroyed();
		if (!ExecuteJavascript_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/WebBrowserWidget.WebBrowser:ExecuteJavascript");
			return;
		}
	...
	static UWebBrowser()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UWebBrowser)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UWebBrowser));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/WebBrowserWidget.WebBrowser");
		...
		NativeReflection.LogFunctionIsValid("/Script/WebBrowserWidget.WebBrowser:LoadURL", LoadURL_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/WebBrowserWidget.WebBrowser:LoadString", LoadString_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/WebBrowserWidget.WebBrowser:GetUrl", GetUrl_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/WebBrowserWidget.WebBrowser:GetTitleText", GetTitleText_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/WebBrowserWidget.WebBrowser:ExecuteJavascript", ExecuteJavascript_IsValid);
	}
}
