...
[BlueprintType]
[UMetaPath("/Script/NavigationSystem.NavModifierVolume", "NavigationSystem", UnrealModuleType.Engine)]
public class ANavModifierVolume : AVolume, INavRelevantInterface, IInterface
{
	...
	[UMetaPath("/Script/NavigationSystem.NavModifierVolume:AreaClass")]
	protected TSubclassOf<UNavArea> AreaClass
	{
		get
		{
			CheckDestroyed();
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/NavigationSystem.NavModifierVolume:AreaClass");
	...
	[UMetaPath("/Script/NavigationSystem.NavModifierVolume:SetAreaClass")]
	public unsafe void SetAreaClass(TSubclassOf<UNavArea> NewAreaClass)
	{
		CheckDestroyed();
		if (!SetAreaClass_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/NavigationSystem.NavModifierVolume:SetAreaClass");
			return;
		}
	...
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(ANavModifierVolume)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(ANavModifierVolume));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetClass("/Script/NavigationSystem.NavModifierVolume");
		...
		NativeReflection.LogFunctionIsValid("/Script/NavigationSystem.NavModifierVolume:SetAreaClass", SetAreaClass_IsValid);
	}
}
