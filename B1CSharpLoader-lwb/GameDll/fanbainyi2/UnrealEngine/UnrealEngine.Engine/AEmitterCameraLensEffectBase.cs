...
[BlueprintType]
[Blueprintable]
[UMetaPath("/Script/Engine.EmitterCameraLensEffectBase", "Engine", UnrealModuleType.Engine)]
public class AEmitterCameraLensEffectBase : AEmitter, ICameraLensEffectInterface, IInterface
{
	...
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(AEmitterCameraLensEffectBase)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(AEmitterCameraLensEffectBase));
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/Engine.EmitterCameraLensEffectBase");
