...
[UStruct(Flags = 4609)]
[BlueprintType]
[UMetaPath("/Script/Engine.InputScaleBiasClamp", "Engine", UnrealModuleType.Engine)]
public struct FInputScaleBiasClamp
{
	...
	[UMetaPath("/Script/Engine.InputScaleBiasClamp:bMapRange")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/Engine.InputScaleBiasClamp:bClampResult")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/Engine.InputScaleBiasClamp:bInterpResult")]
	...
	[UMetaPath("/Script/Engine.InputScaleBiasClamp:InRange")]
	...
	[UProperty(Flags = (PropFlags)4503668346847237uL)]
	[UMetaPath("/Script/Engine.InputScaleBiasClamp:OutRange")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/Engine.InputScaleBiasClamp:Scale")]
	public float Scale;
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/Engine.InputScaleBiasClamp:Bias")]
	public float Bias;
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/Engine.InputScaleBiasClamp:ClampMin")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/Engine.InputScaleBiasClamp:ClampMax")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/Engine.InputScaleBiasClamp:InterpSpeedIncreasing")]
	...
	[UProperty(Flags = (PropFlags)6755469234274821uL)]
	[UMetaPath("/Script/Engine.InputScaleBiasClamp:InterpSpeedDecreasing")]
	public float InterpSpeedDecreasing;

	private static bool FInputScaleBiasClamp_IsValid;

	private static int FInputScaleBiasClamp_StructSize;

	public FInputScaleBiasClamp Copy()
	{
		return this;
	}

	public static FInputScaleBiasClamp FromNative(IntPtr nativeBuffer)
	{
		return new FInputScaleBiasClamp(nativeBuffer);
	}

	public static void ToNative(IntPtr nativeBuffer, FInputScaleBiasClamp value)
	{
		value.ToNative(nativeBuffer);
	}

	public static FInputScaleBiasClamp FromNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop)
	{
		return new FInputScaleBiasClamp(nativeBuffer + arrayIndex * FInputScaleBiasClamp_StructSize);
	}

	public static void ToNative(IntPtr nativeBuffer, int arrayIndex, IntPtr prop, FInputScaleBiasClamp value)
	{
		value.ToNative(nativeBuffer + arrayIndex * FInputScaleBiasClamp_StructSize);
	}

	public void ToNative(IntPtr nativeStruct)
	{
		if (!FInputScaleBiasClamp_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/Engine.InputScaleBiasClamp");
			return;
		}
	...
	public FInputScaleBiasClamp(IntPtr nativeStruct)
	{
		if (!FInputScaleBiasClamp_IsValid)
		{
			NativeReflection.LogInvalidStructAccessed("/Script/Engine.InputScaleBiasClamp");
	...
	static FInputScaleBiasClamp()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(FInputScaleBiasClamp)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(FInputScaleBiasClamp));
	}

	private static void LoadNativeType()
	{
		IntPtr intPtr = NativeReflection.GetStruct("/Script/Engine.InputScaleBiasClamp");
		FInputScaleBiasClamp_StructSize = NativeReflection.GetStructSize(intPtr);
		...
		FInputScaleBiasClamp_IsValid = intPtr != IntPtr.Zero && MapRange_IsValid && ClampResult_IsValid && InterpResult_IsValid && InRange_IsValid && OutRange_IsValid && Scale_IsValid && Bias_IsValid && ClampMin_IsValid && ClampMax_IsValid && InterpSpeedIncreasing_IsValid && InterpSpeedDecreasing_IsValid;
		NativeReflection.LogStructIsValid("/Script/Engine.InputScaleBiasClamp", FInputScaleBiasClamp_IsValid);
	}
}
