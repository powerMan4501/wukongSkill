...
[BlueprintType]
[UMetaPath("/Script/Engine.MaterialExpressionConstant4Vector", "Engine", UnrealModuleType.Engine)]
public class UMaterialExpressionConstant4Vector : UMaterialExpression
{
	...
	[UMetaPath("/Script/Engine.MaterialExpressionConstant4Vector:Constant")]
	public FLinearColor Constant
	{
		get
		{
			...
			if (!Constant_IsValid)
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/Engine.MaterialExpressionConstant4Vector:Constant");
	...
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UMaterialExpressionConstant4Vector)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UMaterialExpressionConstant4Vector));
	}

	private static void LoadNativeType()
	{
		IntPtr unrealStruct = NativeReflection.GetClass("/Script/Engine.MaterialExpressionConstant4Vector");
