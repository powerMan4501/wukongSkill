...
public sealed class IAnimationDataControllerImpl : IInterfaceImpl, IAnimationDataController, IInterface
{
	...
	public unsafe void UpdateCurveNamesFromSkeleton(USkeleton Skeleton, ERawCurveTrackTypes SupportedCurveType, bool bShouldTransact = true)
	{
		...
		if (UpdateCurveNamesFromSkeleton_InstanceFunctionAddress == IntPtr.Zero)
		{
			UpdateCurveNamesFromSkeleton_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "UpdateCurveNamesFromSkeleton");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, UpdateCurveNamesFromSkeleton_InstanceFunctionAddress, intPtr, UpdateCurveNamesFromSkeleton_ParamsSize);
	}
	...
	public unsafe bool SetTransformCurveKeys(FAnimationCurveIdentifier CurveId, List<FTransform> TransformValues, List<float> TimeKeys, bool bShouldTransact = true)
	{
		...
		if (SetTransformCurveKeys_InstanceFunctionAddress == IntPtr.Zero)
		{
			SetTransformCurveKeys_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "SetTransformCurveKeys");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, SetTransformCurveKeys_InstanceFunctionAddress, intPtr, SetTransformCurveKeys_ParamsSize);
	...
	public unsafe bool SetTransformCurveKey(FAnimationCurveIdentifier CurveId, float Time, FTransform Value, bool bShouldTransact = true)
	{
		...
		if (SetTransformCurveKey_InstanceFunctionAddress == IntPtr.Zero)
		{
			SetTransformCurveKey_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "SetTransformCurveKey");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, SetTransformCurveKey_InstanceFunctionAddress, intPtr, SetTransformCurveKey_ParamsSize);
	...
	public unsafe void SetPlayLength(float Length, bool bShouldTransact = true)
	{
		...
		if (SetPlayLength_InstanceFunctionAddress == IntPtr.Zero)
		{
			SetPlayLength_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "SetPlayLength");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, SetPlayLength_InstanceFunctionAddress, intPtr, SetPlayLength_ParamsSize);
	}
	...
	public unsafe void SetModel(UAnimDataModel InModel)
	{
		...
		if (SetModel_InstanceFunctionAddress == IntPtr.Zero)
		{
			SetModel_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "SetModel");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, SetModel_InstanceFunctionAddress, intPtr, SetModel_ParamsSize);
	}
	...
	public unsafe void SetFrameRate(FFrameRate FrameRate, bool bShouldTransact = true)
	{
		...
		if (SetFrameRate_InstanceFunctionAddress == IntPtr.Zero)
		{
			SetFrameRate_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "SetFrameRate");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, SetFrameRate_InstanceFunctionAddress, intPtr, SetFrameRate_ParamsSize);
	}
	...
	public unsafe bool SetCurveKeys(FAnimationCurveIdentifier CurveId, List<FRichCurveKey> CurveKeys, bool bShouldTransact = true)
	{
		...
		if (SetCurveKeys_InstanceFunctionAddress == IntPtr.Zero)
		{
			SetCurveKeys_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "SetCurveKeys");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, SetCurveKeys_InstanceFunctionAddress, intPtr, SetCurveKeys_ParamsSize);
	...
	public unsafe bool SetCurveKey(FAnimationCurveIdentifier CurveId, FRichCurveKey Key, bool bShouldTransact = true)
	{
		...
		if (SetCurveKey_InstanceFunctionAddress == IntPtr.Zero)
		{
			SetCurveKey_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "SetCurveKey");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, SetCurveKey_InstanceFunctionAddress, intPtr, SetCurveKey_ParamsSize);
	...
	public unsafe bool SetCurveFlags(FAnimationCurveIdentifier CurveId, int Flags, bool bShouldTransact = true)
	{
		...
		if (SetCurveFlags_InstanceFunctionAddress == IntPtr.Zero)
		{
			SetCurveFlags_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "SetCurveFlags");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, SetCurveFlags_InstanceFunctionAddress, intPtr, SetCurveFlags_ParamsSize);
	...
	public unsafe bool SetCurveFlag(FAnimationCurveIdentifier CurveId, EAnimAssetCurveFlags Flag, bool bState = true, bool bShouldTransact = true)
	{
		...
		if (SetCurveFlag_InstanceFunctionAddress == IntPtr.Zero)
		{
			SetCurveFlag_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "SetCurveFlag");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, SetCurveFlag_InstanceFunctionAddress, intPtr, SetCurveFlag_ParamsSize);
	...
	public unsafe bool SetCurveColor(FAnimationCurveIdentifier CurveId, FLinearColor Color, bool bShouldTransact = true)
	{
		...
		if (SetCurveColor_InstanceFunctionAddress == IntPtr.Zero)
		{
			SetCurveColor_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "SetCurveColor");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, SetCurveColor_InstanceFunctionAddress, intPtr, SetCurveColor_ParamsSize);
	...
	public unsafe bool SetBoneTrackKeys(FName BoneName, List<FVector> PositionalKeys, List<FQuat> RotationalKeys, List<FVector> ScalingKeys, bool bShouldTransact = true)
	{
		...
		if (SetBoneTrackKeys_InstanceFunctionAddress == IntPtr.Zero)
		{
			SetBoneTrackKeys_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "SetBoneTrackKeys");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, SetBoneTrackKeys_InstanceFunctionAddress, intPtr, SetBoneTrackKeys_ParamsSize);
	...
	public unsafe bool ScaleCurve(FAnimationCurveIdentifier CurveId, float Origin, float Factor, bool bShouldTransact = true)
	{
		...
		if (ScaleCurve_InstanceFunctionAddress == IntPtr.Zero)
		{
			ScaleCurve_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "ScaleCurve");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, ScaleCurve_InstanceFunctionAddress, intPtr, ScaleCurve_ParamsSize);
	...
	public unsafe void ResizePlayLength(float NewLength, float T0, float T1, bool bShouldTransact = true)
	{
		...
		if (ResizePlayLength_InstanceFunctionAddress == IntPtr.Zero)
		{
			ResizePlayLength_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "ResizePlayLength");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, ResizePlayLength_InstanceFunctionAddress, intPtr, ResizePlayLength_ParamsSize);
	}
	...
	public unsafe void Resize(float Length, float T0, float T1, bool bShouldTransact = true)
	{
		...
		if (Resize_InstanceFunctionAddress == IntPtr.Zero)
		{
			Resize_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "Resize");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, Resize_InstanceFunctionAddress, intPtr, Resize_ParamsSize);
	}
	...
	public unsafe bool RenameCurve(FAnimationCurveIdentifier CurveToRenameId, FAnimationCurveIdentifier NewCurveId, bool bShouldTransact = true)
	{
		...
		if (RenameCurve_InstanceFunctionAddress == IntPtr.Zero)
		{
			RenameCurve_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "RenameCurve");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, RenameCurve_InstanceFunctionAddress, intPtr, RenameCurve_ParamsSize);
	...
	public unsafe bool RemoveTransformCurveKey(FAnimationCurveIdentifier CurveId, float Time, bool bShouldTransact = true)
	{
		...
		if (RemoveTransformCurveKey_InstanceFunctionAddress == IntPtr.Zero)
		{
			RemoveTransformCurveKey_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "RemoveTransformCurveKey");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, RemoveTransformCurveKey_InstanceFunctionAddress, intPtr, RemoveTransformCurveKey_ParamsSize);
	...
	public unsafe bool RemoveCurveKey(FAnimationCurveIdentifier CurveId, float Time, bool bShouldTransact = true)
	{
		...
		if (RemoveCurveKey_InstanceFunctionAddress == IntPtr.Zero)
		{
			RemoveCurveKey_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "RemoveCurveKey");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, RemoveCurveKey_InstanceFunctionAddress, intPtr, RemoveCurveKey_ParamsSize);
	...
	public unsafe bool RemoveCurve(FAnimationCurveIdentifier CurveId, bool bShouldTransact = true)
	{
		...
		if (RemoveCurve_InstanceFunctionAddress == IntPtr.Zero)
		{
			RemoveCurve_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "RemoveCurve");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, RemoveCurve_InstanceFunctionAddress, intPtr, RemoveCurve_ParamsSize);
	...
	public unsafe bool RemoveBoneTrack(FName BoneName, bool bShouldTransact = true)
	{
		...
		if (RemoveBoneTrack_InstanceFunctionAddress == IntPtr.Zero)
		{
			RemoveBoneTrack_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "RemoveBoneTrack");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, RemoveBoneTrack_InstanceFunctionAddress, intPtr, RemoveBoneTrack_ParamsSize);
	...
	public unsafe bool RemoveAttributeKey(FAnimationAttributeIdentifier AttributeIdentifier, float Time, bool bShouldTransact = true)
	{
		...
		if (RemoveAttributeKey_InstanceFunctionAddress == IntPtr.Zero)
		{
			RemoveAttributeKey_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "RemoveAttributeKey");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, RemoveAttributeKey_InstanceFunctionAddress, intPtr, RemoveAttributeKey_ParamsSize);
	...
	public unsafe bool RemoveAttribute(FAnimationAttributeIdentifier AttributeIdentifier, bool bShouldTransact = true)
	{
		...
		if (RemoveAttribute_InstanceFunctionAddress == IntPtr.Zero)
		{
			RemoveAttribute_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "RemoveAttribute");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, RemoveAttribute_InstanceFunctionAddress, intPtr, RemoveAttribute_ParamsSize);
	...
	public unsafe void RemoveAllCurvesOfType(ERawCurveTrackTypes SupportedCurveType, bool bShouldTransact = true)
	{
		...
		if (RemoveAllCurvesOfType_InstanceFunctionAddress == IntPtr.Zero)
		{
			RemoveAllCurvesOfType_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "RemoveAllCurvesOfType");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, RemoveAllCurvesOfType_InstanceFunctionAddress, intPtr, RemoveAllCurvesOfType_ParamsSize);
	}
	...
	public unsafe void RemoveAllBoneTracks(bool bShouldTransact = true)
	{
		...
		if (RemoveAllBoneTracks_InstanceFunctionAddress == IntPtr.Zero)
		{
			RemoveAllBoneTracks_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "RemoveAllBoneTracks");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, RemoveAllBoneTracks_InstanceFunctionAddress, intPtr, RemoveAllBoneTracks_ParamsSize);
	}
	...
	public unsafe int RemoveAllAttributesForBone(FName BoneName, bool bShouldTransact = true)
	{
		...
		if (RemoveAllAttributesForBone_InstanceFunctionAddress == IntPtr.Zero)
		{
			RemoveAllAttributesForBone_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "RemoveAllAttributesForBone");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, RemoveAllAttributesForBone_InstanceFunctionAddress, intPtr, RemoveAllAttributesForBone_ParamsSize);
	...
	public unsafe int RemoveAllAttributes(bool bShouldTransact = true)
	{
		...
		if (RemoveAllAttributes_InstanceFunctionAddress == IntPtr.Zero)
		{
			RemoveAllAttributes_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "RemoveAllAttributes");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, RemoveAllAttributes_InstanceFunctionAddress, intPtr, RemoveAllAttributes_ParamsSize);
	...
	public unsafe void OpenBracket(FText InTitle, bool bShouldTransact = true)
	{
		...
		if (OpenBracket_InstanceFunctionAddress == IntPtr.Zero)
		{
			OpenBracket_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "OpenBracket");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, OpenBracket_InstanceFunctionAddress, intPtr, OpenBracket_ParamsSize);
	...
	public unsafe int InsertBoneTrack(FName BoneName, int DesiredIndex, bool bShouldTransact = true)
	{
		...
		if (InsertBoneTrack_InstanceFunctionAddress == IntPtr.Zero)
		{
			InsertBoneTrack_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "InsertBoneTrack");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, InsertBoneTrack_InstanceFunctionAddress, intPtr, InsertBoneTrack_ParamsSize);
	...
	public unsafe UAnimDataModel GetModel()
	{
		...
		if (GetModel_InstanceFunctionAddress == IntPtr.Zero)
		{
			GetModel_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "GetModel");
		}
		...
		IntPtr intPtr = new IntPtr(ptr2);
		NativeReflection.InvokeFunctionOptimized(base.Address, GetModel_InstanceFunctionAddress, intPtr, GetModel_ParamsSize);
	...
	public unsafe void FindOrAddCurveNamesOnSkeleton(USkeleton Skeleton, ERawCurveTrackTypes SupportedCurveType, bool bShouldTransact = true)
	{
		...
		if (FindOrAddCurveNamesOnSkeleton_InstanceFunctionAddress == IntPtr.Zero)
		{
			FindOrAddCurveNamesOnSkeleton_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "FindOrAddCurveNamesOnSkeleton");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, FindOrAddCurveNamesOnSkeleton_InstanceFunctionAddress, intPtr, FindOrAddCurveNamesOnSkeleton_ParamsSize);
	}
	...
	public unsafe bool DuplicateCurve(FAnimationCurveIdentifier CopyCurveId, FAnimationCurveIdentifier NewCurveId, bool bShouldTransact = true)
	{
		...
		if (DuplicateCurve_InstanceFunctionAddress == IntPtr.Zero)
		{
			DuplicateCurve_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "DuplicateCurve");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, DuplicateCurve_InstanceFunctionAddress, intPtr, DuplicateCurve_ParamsSize);
	...
	public unsafe bool DuplicateAttribute(FAnimationAttributeIdentifier AttributeIdentifier, FAnimationAttributeIdentifier NewAttributeIdentifier, bool bShouldTransact = true)
	{
		...
		if (DuplicateAttribute_InstanceFunctionAddress == IntPtr.Zero)
		{
			DuplicateAttribute_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "DuplicateAttribute");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, DuplicateAttribute_InstanceFunctionAddress, intPtr, DuplicateAttribute_ParamsSize);
	...
	public unsafe void CloseBracket(bool bShouldTransact = true)
	{
		...
		if (CloseBracket_InstanceFunctionAddress == IntPtr.Zero)
		{
			CloseBracket_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "CloseBracket");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, CloseBracket_InstanceFunctionAddress, intPtr, CloseBracket_ParamsSize);
	}
	...
	public unsafe bool AddCurve(FAnimationCurveIdentifier CurveId, int CurveFlags = 4, bool bShouldTransact = true)
	{
		...
		if (AddCurve_InstanceFunctionAddress == IntPtr.Zero)
		{
			AddCurve_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "AddCurve");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, AddCurve_InstanceFunctionAddress, intPtr, AddCurve_ParamsSize);
	...
	public unsafe int AddBoneTrack(FName BoneName, bool bShouldTransact = true)
	{
		...
		if (AddBoneTrack_InstanceFunctionAddress == IntPtr.Zero)
		{
			AddBoneTrack_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "AddBoneTrack");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, AddBoneTrack_InstanceFunctionAddress, intPtr, AddBoneTrack_ParamsSize);
	...
	public unsafe bool AddAttribute(FAnimationAttributeIdentifier AttributeIdentifier, bool bShouldTransact = true)
	{
		...
		if (AddAttribute_InstanceFunctionAddress == IntPtr.Zero)
		{
			AddAttribute_InstanceFunctionAddress = NativeReflection.GetFunctionFromInstance(base.Address, "AddAttribute");
		}
		...
		NativeReflection.InvokeFunctionOptimized(base.Address, AddAttribute_InstanceFunctionAddress, intPtr, AddAttribute_ParamsSize);
	...
	{
		UpdateCurveNamesFromSkeleton_InstanceFunctionAddress = IntPtr.Zero;
		SetTransformCurveKeys_InstanceFunctionAddress = IntPtr.Zero;
		SetTransformCurveKey_InstanceFunctionAddress = IntPtr.Zero;
		SetPlayLength_InstanceFunctionAddress = IntPtr.Zero;
		SetModel_InstanceFunctionAddress = IntPtr.Zero;
		SetFrameRate_InstanceFunctionAddress = IntPtr.Zero;
		SetCurveKeys_InstanceFunctionAddress = IntPtr.Zero;
		SetCurveKey_InstanceFunctionAddress = IntPtr.Zero;
		SetCurveFlags_InstanceFunctionAddress = IntPtr.Zero;
		SetCurveFlag_InstanceFunctionAddress = IntPtr.Zero;
		SetCurveColor_InstanceFunctionAddress = IntPtr.Zero;
		SetBoneTrackKeys_InstanceFunctionAddress = IntPtr.Zero;
		ScaleCurve_InstanceFunctionAddress = IntPtr.Zero;
		ResizePlayLength_InstanceFunctionAddress = IntPtr.Zero;
		Resize_InstanceFunctionAddress = IntPtr.Zero;
		RenameCurve_InstanceFunctionAddress = IntPtr.Zero;
		RemoveTransformCurveKey_InstanceFunctionAddress = IntPtr.Zero;
		RemoveCurveKey_InstanceFunctionAddress = IntPtr.Zero;
		RemoveCurve_InstanceFunctionAddress = IntPtr.Zero;
		RemoveBoneTrack_InstanceFunctionAddress = IntPtr.Zero;
		RemoveAttributeKey_InstanceFunctionAddress = IntPtr.Zero;
		RemoveAttribute_InstanceFunctionAddress = IntPtr.Zero;
		RemoveAllCurvesOfType_InstanceFunctionAddress = IntPtr.Zero;
		RemoveAllBoneTracks_InstanceFunctionAddress = IntPtr.Zero;
		RemoveAllAttributesForBone_InstanceFunctionAddress = IntPtr.Zero;
		RemoveAllAttributes_InstanceFunctionAddress = IntPtr.Zero;
		OpenBracket_InstanceFunctionAddress = IntPtr.Zero;
		InsertBoneTrack_InstanceFunctionAddress = IntPtr.Zero;
		GetModel_InstanceFunctionAddress = IntPtr.Zero;
		FindOrAddCurveNamesOnSkeleton_InstanceFunctionAddress = IntPtr.Zero;
		DuplicateCurve_InstanceFunctionAddress = IntPtr.Zero;
		DuplicateAttribute_InstanceFunctionAddress = IntPtr.Zero;
		CloseBracket_InstanceFunctionAddress = IntPtr.Zero;
		AddCurve_InstanceFunctionAddress = IntPtr.Zero;
		AddBoneTrack_InstanceFunctionAddress = IntPtr.Zero;
		AddAttribute_InstanceFunctionAddress = IntPtr.Zero;
	}

	static IAnimationDataControllerImpl()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(IAnimationDataControllerImpl)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(IAnimationDataControllerImpl));
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/Engine.AnimationDataController");
