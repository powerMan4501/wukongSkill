...
[BlueprintType]
[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel", "SequencerScripting", UnrealModuleType.EnginePlugin)]
public class UMovieSceneScriptingDoubleChannel : UMovieSceneScriptingChannel
{
	...
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:SetPreInfinityExtrapolation")]
	public unsafe void SetPreInfinityExtrapolation(ERichCurveExtrapolation InExtrapolation)
	{
		...
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:SetPreInfinityExtrapolation");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:SetPostInfinityExtrapolation")]
	public unsafe void SetPostInfinityExtrapolation(ERichCurveExtrapolation InExtrapolation)
	{
		...
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:SetPostInfinityExtrapolation");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:SetDefault")]
	public unsafe void SetDefault(double InDefaultValue)
	{
		CheckDestroyed();
		if (!SetDefault_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:SetDefault");
			return;
		}
		...
		IntPtr intPtr = new IntPtr(ptr2);
		BlittableTypeMarshaler<double>.ToNative(IntPtr.Add(intPtr, SetDefault_InDefaultValue_Offset), 0, SetDefault_InDefaultValue_PropertyAddress.Address, InDefaultValue);
		NativeReflection.InvokeFunctionOptimized(base.Address, SetDefault_FunctionAddress, intPtr, SetDefault_ParamsSize);
	}

	[UFunction(Flags = 67240960u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:RemoveKey")]
	public unsafe void RemoveKey(UMovieSceneScriptingKey Key)
	{
		CheckDestroyed();
		if (!RemoveKey_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:RemoveKey");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:RemoveDefault")]
	public unsafe void RemoveDefault()
	{
		CheckDestroyed();
		if (!RemoveDefault_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:RemoveDefault");
			return;
		}
	...
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:HasDefault")]
	public unsafe bool HasDefault()
	{
		CheckDestroyed();
		if (!HasDefault_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:HasDefault");
			return false;
		}
	...
	[UFunction(Flags = 1409418241u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:GetPreInfinityExtrapolation")]
	public unsafe ERichCurveExtrapolation GetPreInfinityExtrapolation()
	{
		CheckDestroyed();
		if (!GetPreInfinityExtrapolation_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:GetPreInfinityExtrapolation");
	...
	[UFunction(Flags = 1409418241u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:GetPostInfinityExtrapolation")]
	public unsafe ERichCurveExtrapolation GetPostInfinityExtrapolation()
	{
		CheckDestroyed();
		if (!GetPostInfinityExtrapolation_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:GetPostInfinityExtrapolation");
			return ERichCurveExtrapolation.RCCE_Cycle;
		}
	...
	[UFunction(Flags = 1409418241u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:GetNumKeys")]
	public unsafe int GetNumKeys()
	{
		CheckDestroyed();
		if (!GetNumKeys_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:GetNumKeys");
			return 0;
		}
	...
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:GetKeys")]
	public unsafe List<UMovieSceneScriptingKey> GetKeys()
	{
		CheckDestroyed();
		if (!GetKeys_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:GetKeys");
			return null;
		}
	...
	[UFunction(Flags = 1409418241u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:GetDefault")]
	public unsafe double GetDefault()
	{
		CheckDestroyed();
		if (!GetDefault_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:GetDefault");
			return 0.0;
		}
		...
		return BlittableTypeMarshaler<double>.FromNative(IntPtr.Add(intPtr, GetDefault_ReturnValue_Offset), 0, GetDefault_ReturnValue_PropertyAddress.Address);
	}

	[UFunction(Flags = 1409418241u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:EvaluateKeys")]
	public unsafe List<double> EvaluateKeys(FSequencerScriptingRange Range, FFrameRate FrameRate)
	{
		CheckDestroyed();
		if (!EvaluateKeys_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:EvaluateKeys");
			return null;
		}
		...
		List<double> result = new TArrayCopyMarshaler<double>(1, EvaluateKeys_ReturnValue_PropertyAddress, CachedMarshalingDelegates<double, BlittableTypeMarshaler<double>>.FromNative, CachedMarshalingDelegates<double, BlittableTypeMarshaler<double>>.ToNative).FromNative(IntPtr.Add(intPtr, EvaluateKeys_ReturnValue_Offset));
		NativeReflection.DestroyValue_InContainer(EvaluateKeys_ReturnValue_PropertyAddress.Address, intPtr);
		return result;
	}

	[UFunction(Flags = 1409418241u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:ComputeEffectiveRange")]
	public unsafe FSequencerScriptingRange ComputeEffectiveRange()
	{
		CheckDestroyed();
		if (!ComputeEffectiveRange_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:ComputeEffectiveRange");
	...
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:AddKey")]
	public unsafe UMovieSceneScriptingDoubleKey AddKey(FFrameNumber InTime, double NewValue, float SubFrame = 0f, ESequenceTimeUnit TimeUnit = ESequenceTimeUnit.DisplayRate, EMovieSceneKeyInterpolation InInterpolation = EMovieSceneKeyInterpolation.Auto)
	{
		CheckDestroyed();
		if (!AddKey_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:AddKey");
			return null;
		}
		...
		BlittableTypeMarshaler<double>.ToNative(IntPtr.Add(intPtr, AddKey_NewValue_Offset), 0, AddKey_NewValue_PropertyAddress.Address, NewValue);
		...
		return UObjectMarshaler<UMovieSceneScriptingDoubleKey>.FromNative(IntPtr.Add(intPtr, AddKey_ReturnValue_Offset), 0, AddKey_ReturnValue_PropertyAddress.Address);
	}

	static UMovieSceneScriptingDoubleChannel()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UMovieSceneScriptingDoubleChannel)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UMovieSceneScriptingDoubleChannel));
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel");
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:SetPreInfinityExtrapolation", SetPreInfinityExtrapolation_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:SetPostInfinityExtrapolation", SetPostInfinityExtrapolation_IsValid);
		...
		SetDefault_InDefaultValue_IsValid = NativeReflectionCached.ValidatePropertyClass(SetDefault_FunctionAddress, "InDefaultValue", Classes.FDoubleProperty);
		SetDefault_IsValid = SetDefault_FunctionAddress != IntPtr.Zero && SetDefault_InDefaultValue_IsValid;
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:SetDefault", SetDefault_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:RemoveKey", RemoveKey_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:RemoveDefault", RemoveDefault_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:HasDefault", HasDefault_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:GetPreInfinityExtrapolation", GetPreInfinityExtrapolation_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:GetPostInfinityExtrapolation", GetPostInfinityExtrapolation_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:GetNumKeys", GetNumKeys_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:GetKeys", GetKeys_IsValid);
		...
		GetDefault_ReturnValue_IsValid = NativeReflectionCached.ValidatePropertyClass(GetDefault_FunctionAddress, "ReturnValue", Classes.FDoubleProperty);
		GetDefault_IsValid = GetDefault_FunctionAddress != IntPtr.Zero && GetDefault_ReturnValue_IsValid;
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:GetDefault", GetDefault_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:EvaluateKeys", EvaluateKeys_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:ComputeEffectiveRange", ComputeEffectiveRange_IsValid);
		...
		AddKey_NewValue_IsValid = NativeReflectionCached.ValidatePropertyClass(AddKey_FunctionAddress, "NewValue", Classes.FDoubleProperty);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingDoubleChannel:AddKey", AddKey_IsValid);
	}
}
