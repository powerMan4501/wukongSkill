...
[BlueprintType]
[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingBoolKey", "SequencerScripting", UnrealModuleType.EnginePlugin)]
public class UMovieSceneScriptingBoolKey : UMovieSceneScriptingKey
{
	...
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingBoolKey:SetValue")]
	public unsafe void SetValue(bool InNewValue)
	{
		CheckDestroyed();
		if (!SetValue_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingBoolKey:SetValue");
			return;
		}
		...
		BoolMarshaler.ToNative(IntPtr.Add(intPtr, SetValue_InNewValue_Offset), 0, SetValue_InNewValue_PropertyAddress.Address, InNewValue);
		NativeReflection.InvokeFunctionOptimized(base.Address, SetValue_FunctionAddress, intPtr, SetValue_ParamsSize);
	}

	[UFunction(Flags = 79823873u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingBoolKey:SetTime")]
	public unsafe void SetTime(FFrameNumber NewFrameNumber, float SubFrame = 0f, ESequenceTimeUnit TimeUnit = ESequenceTimeUnit.DisplayRate)
	{
		...
		if (!SetTime_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingBoolKey:SetTime");
			return;
		}
	...
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingBoolKey:GetValue")]
	public unsafe bool GetValue()
	{
		CheckDestroyed();
		if (!GetValue_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingBoolKey:GetValue");
			return false;
		}
		...
		return BoolMarshaler.FromNative(IntPtr.Add(intPtr, GetValue_ReturnValue_Offset), 0, GetValue_ReturnValue_PropertyAddress.Address);
	}

	[UFunction(Flags = 1409418240u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingBoolKey:GetTime")]
	public unsafe FFrameTime GetTime(ESequenceTimeUnit TimeUnit = ESequenceTimeUnit.DisplayRate)
	{
		CheckDestroyed();
		if (!GetTime_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingBoolKey:GetTime");
	...
	static UMovieSceneScriptingBoolKey()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UMovieSceneScriptingBoolKey)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UMovieSceneScriptingBoolKey));
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/SequencerScripting.MovieSceneScriptingBoolKey");
		...
		SetValue_InNewValue_IsValid = NativeReflectionCached.ValidatePropertyClass(SetValue_FunctionAddress, "InNewValue", Classes.FBoolProperty);
		SetValue_IsValid = SetValue_FunctionAddress != IntPtr.Zero && SetValue_InNewValue_IsValid;
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingBoolKey:SetValue", SetValue_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingBoolKey:SetTime", SetTime_IsValid);
		...
		GetValue_ReturnValue_IsValid = NativeReflectionCached.ValidatePropertyClass(GetValue_FunctionAddress, "ReturnValue", Classes.FBoolProperty);
		GetValue_IsValid = GetValue_FunctionAddress != IntPtr.Zero && GetValue_ReturnValue_IsValid;
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingBoolKey:GetValue", GetValue_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingBoolKey:GetTime", GetTime_IsValid);
	}
}
