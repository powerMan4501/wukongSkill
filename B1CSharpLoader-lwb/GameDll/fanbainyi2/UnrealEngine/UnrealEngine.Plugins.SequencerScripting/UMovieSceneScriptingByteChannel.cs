...
[BlueprintType]
[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingByteChannel", "SequencerScripting", UnrealModuleType.EnginePlugin)]
public class UMovieSceneScriptingByteChannel : UMovieSceneScriptingChannel
{
	...
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingByteChannel:SetDefault")]
	public unsafe void SetDefault(byte InDefaultValue)
	{
		CheckDestroyed();
		if (!SetDefault_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingByteChannel:SetDefault");
			return;
		}
		...
		BlittableTypeMarshaler<byte>.ToNative(IntPtr.Add(intPtr, SetDefault_InDefaultValue_Offset), 0, SetDefault_InDefaultValue_PropertyAddress.Address, InDefaultValue);
		NativeReflection.InvokeFunctionOptimized(base.Address, SetDefault_FunctionAddress, intPtr, SetDefault_ParamsSize);
	}

	[UFunction(Flags = 67240960u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingByteChannel:RemoveKey")]
	public unsafe void RemoveKey(UMovieSceneScriptingKey Key)
	{
		CheckDestroyed();
		if (!RemoveKey_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingByteChannel:RemoveKey");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingByteChannel:RemoveDefault")]
	public unsafe void RemoveDefault()
	{
		CheckDestroyed();
		if (!RemoveDefault_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingByteChannel:RemoveDefault");
			return;
		}
	...
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingByteChannel:HasDefault")]
	public unsafe bool HasDefault()
	{
		CheckDestroyed();
		if (!HasDefault_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingByteChannel:HasDefault");
			return false;
		}
	...
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingByteChannel:GetKeys")]
	public unsafe List<UMovieSceneScriptingKey> GetKeys()
	{
		CheckDestroyed();
		if (!GetKeys_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingByteChannel:GetKeys");
			return null;
		}
	...
	[UFunction(Flags = 1409418241u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingByteChannel:GetDefault")]
	public unsafe byte GetDefault()
	{
		CheckDestroyed();
		if (!GetDefault_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingByteChannel:GetDefault");
			return 0;
		}
		...
		return BlittableTypeMarshaler<byte>.FromNative(IntPtr.Add(intPtr, GetDefault_ReturnValue_Offset), 0, GetDefault_ReturnValue_PropertyAddress.Address);
	}

	[UFunction(Flags = 79823873u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingByteChannel:AddKey")]
	public unsafe UMovieSceneScriptingByteKey AddKey(FFrameNumber InTime, byte NewValue, float SubFrame = 0f, ESequenceTimeUnit TimeUnit = ESequenceTimeUnit.DisplayRate, EMovieSceneKeyInterpolation InInterpolation = EMovieSceneKeyInterpolation.Auto)
	{
		CheckDestroyed();
		if (!AddKey_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingByteChannel:AddKey");
			return null;
		}
		...
		BlittableTypeMarshaler<byte>.ToNative(IntPtr.Add(intPtr, AddKey_NewValue_Offset), 0, AddKey_NewValue_PropertyAddress.Address, NewValue);
		...
		return UObjectMarshaler<UMovieSceneScriptingByteKey>.FromNative(IntPtr.Add(intPtr, AddKey_ReturnValue_Offset), 0, AddKey_ReturnValue_PropertyAddress.Address);
	}

	static UMovieSceneScriptingByteChannel()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UMovieSceneScriptingByteChannel)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UMovieSceneScriptingByteChannel));
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/SequencerScripting.MovieSceneScriptingByteChannel");
		...
		SetDefault_InDefaultValue_IsValid = NativeReflectionCached.ValidatePropertyClass(SetDefault_FunctionAddress, "InDefaultValue", Classes.FByteProperty);
		SetDefault_IsValid = SetDefault_FunctionAddress != IntPtr.Zero && SetDefault_InDefaultValue_IsValid;
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingByteChannel:SetDefault", SetDefault_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingByteChannel:RemoveKey", RemoveKey_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingByteChannel:RemoveDefault", RemoveDefault_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingByteChannel:HasDefault", HasDefault_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingByteChannel:GetKeys", GetKeys_IsValid);
		...
		GetDefault_ReturnValue_IsValid = NativeReflectionCached.ValidatePropertyClass(GetDefault_FunctionAddress, "ReturnValue", Classes.FByteProperty);
		GetDefault_IsValid = GetDefault_FunctionAddress != IntPtr.Zero && GetDefault_ReturnValue_IsValid;
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingByteChannel:GetDefault", GetDefault_IsValid);
		...
		AddKey_NewValue_IsValid = NativeReflectionCached.ValidatePropertyClass(AddKey_FunctionAddress, "NewValue", Classes.FByteProperty);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingByteChannel:AddKey", AddKey_IsValid);
	}
}
