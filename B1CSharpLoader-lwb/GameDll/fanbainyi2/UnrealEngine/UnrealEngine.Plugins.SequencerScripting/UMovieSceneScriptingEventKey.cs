...
[BlueprintType]
[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingEventKey", "SequencerScripting", UnrealModuleType.EnginePlugin)]
public class UMovieSceneScriptingEventKey : UMovieSceneScriptingKey
{
	...
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingEventKey:SetValue")]
	public unsafe void SetValue(FMovieSceneEvent InNewValue)
	{
		CheckDestroyed();
		if (!SetValue_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingEventKey:SetValue");
			return;
		}
		...
		FMovieSceneEvent.ToNative(IntPtr.Add(intPtr, SetValue_InNewValue_Offset), 0, SetValue_InNewValue_PropertyAddress.Address, InNewValue);
	...
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingEventKey:SetTime")]
	public unsafe void SetTime(FFrameNumber NewFrameNumber, float SubFrame = 0f, ESequenceTimeUnit TimeUnit = ESequenceTimeUnit.DisplayRate)
	{
		...
		if (!SetTime_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingEventKey:SetTime");
			return;
		}
	...
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingEventKey:GetValue")]
	public unsafe FMovieSceneEvent GetValue()
	{
		CheckDestroyed();
		if (!GetValue_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingEventKey:GetValue");
		...
		FMovieSceneEvent result = FMovieSceneEvent.FromNative(IntPtr.Add(intPtr, GetValue_ReturnValue_Offset), 0, GetValue_ReturnValue_PropertyAddress.Address);
		NativeReflection.DestroyValue_InContainer(GetValue_ReturnValue_PropertyAddress.Address, intPtr);
		return result;
	}

	[UFunction(Flags = 1409418240u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingEventKey:GetTime")]
	public unsafe FFrameTime GetTime(ESequenceTimeUnit TimeUnit = ESequenceTimeUnit.DisplayRate)
	{
		CheckDestroyed();
		if (!GetTime_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingEventKey:GetTime");
	...
	static UMovieSceneScriptingEventKey()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UMovieSceneScriptingEventKey)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UMovieSceneScriptingEventKey));
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/SequencerScripting.MovieSceneScriptingEventKey");
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingEventKey:SetValue", SetValue_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingEventKey:SetTime", SetTime_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingEventKey:GetValue", GetValue_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingEventKey:GetTime", GetTime_IsValid);
	}
}
