...
[BlueprintType]
[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel", "SequencerScripting", UnrealModuleType.EnginePlugin)]
public class UMovieSceneScriptingIntegerChannel : UMovieSceneScriptingChannel
{
	...
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:SetDefault")]
	public unsafe void SetDefault(int InDefaultValue)
	{
		CheckDestroyed();
		if (!SetDefault_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:SetDefault");
			return;
		}
		...
		BlittableTypeMarshaler<int>.ToNative(IntPtr.Add(intPtr, SetDefault_InDefaultValue_Offset), 0, SetDefault_InDefaultValue_PropertyAddress.Address, InDefaultValue);
		NativeReflection.InvokeFunctionOptimized(base.Address, SetDefault_FunctionAddress, intPtr, SetDefault_ParamsSize);
	}

	[UFunction(Flags = 67240960u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:RemoveKey")]
	public unsafe void RemoveKey(UMovieSceneScriptingKey Key)
	{
		CheckDestroyed();
		if (!RemoveKey_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:RemoveKey");
			return;
		}
	...
	[UFunction(Flags = 67240961u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:RemoveDefault")]
	public unsafe void RemoveDefault()
	{
		CheckDestroyed();
		if (!RemoveDefault_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:RemoveDefault");
			return;
		}
	...
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:HasDefault")]
	public unsafe bool HasDefault()
	{
		CheckDestroyed();
		if (!HasDefault_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:HasDefault");
			return false;
		}
	...
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:GetKeys")]
	public unsafe List<UMovieSceneScriptingKey> GetKeys()
	{
		CheckDestroyed();
		if (!GetKeys_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:GetKeys");
			return null;
		}
	...
	[UFunction(Flags = 1409418241u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:GetDefault")]
	public unsafe int GetDefault()
	{
		CheckDestroyed();
		if (!GetDefault_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:GetDefault");
			return 0;
		}
		...
		return BlittableTypeMarshaler<int>.FromNative(IntPtr.Add(intPtr, GetDefault_ReturnValue_Offset), 0, GetDefault_ReturnValue_PropertyAddress.Address);
	}

	[UFunction(Flags = 79823873u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:AddKey")]
	public unsafe UMovieSceneScriptingIntegerKey AddKey(FFrameNumber InTime, int NewValue, float SubFrame = 0f, ESequenceTimeUnit TimeUnit = ESequenceTimeUnit.DisplayRate)
	{
		CheckDestroyed();
		if (!AddKey_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:AddKey");
			return null;
		}
		...
		BlittableTypeMarshaler<int>.ToNative(IntPtr.Add(intPtr, AddKey_NewValue_Offset), 0, AddKey_NewValue_PropertyAddress.Address, NewValue);
		...
		return UObjectMarshaler<UMovieSceneScriptingIntegerKey>.FromNative(IntPtr.Add(intPtr, AddKey_ReturnValue_Offset), 0, AddKey_ReturnValue_PropertyAddress.Address);
	}

	static UMovieSceneScriptingIntegerChannel()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UMovieSceneScriptingIntegerChannel)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UMovieSceneScriptingIntegerChannel));
	}

	private static void LoadNativeType()
	{
		IntPtr unrealClass = NativeReflection.GetClass("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel");
		...
		SetDefault_InDefaultValue_IsValid = NativeReflectionCached.ValidatePropertyClass(SetDefault_FunctionAddress, "InDefaultValue", Classes.FIntProperty);
		SetDefault_IsValid = SetDefault_FunctionAddress != IntPtr.Zero && SetDefault_InDefaultValue_IsValid;
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:SetDefault", SetDefault_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:RemoveKey", RemoveKey_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:RemoveDefault", RemoveDefault_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:HasDefault", HasDefault_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:GetKeys", GetKeys_IsValid);
		...
		GetDefault_ReturnValue_IsValid = NativeReflectionCached.ValidatePropertyClass(GetDefault_FunctionAddress, "ReturnValue", Classes.FIntProperty);
		GetDefault_IsValid = GetDefault_FunctionAddress != IntPtr.Zero && GetDefault_ReturnValue_IsValid;
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:GetDefault", GetDefault_IsValid);
		...
		AddKey_NewValue_IsValid = NativeReflectionCached.ValidatePropertyClass(AddKey_FunctionAddress, "NewValue", Classes.FIntProperty);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel:AddKey", AddKey_IsValid);
	}
}
