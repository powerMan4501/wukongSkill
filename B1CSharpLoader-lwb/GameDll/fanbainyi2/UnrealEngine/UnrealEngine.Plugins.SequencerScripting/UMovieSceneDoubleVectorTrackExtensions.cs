...
[UMetaPath("/Script/SequencerScripting.MovieSceneDoubleVectorTrackExtensions", "SequencerScripting", UnrealModuleType.EnginePlugin)]
public class UMovieSceneDoubleVectorTrackExtensions : UBlueprintFunctionLibrary
{
	...
	[UMetaPath("/Script/SequencerScripting.MovieSceneDoubleVectorTrackExtensions:SetNumChannelsUsed")]
	public unsafe static void SetNumChannelsUsed(UMovieSceneDoubleVectorTrack Track, int InNumChannelsUsed)
	{
		if (!SetNumChannelsUsed_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneDoubleVectorTrackExtensions:SetNumChannelsUsed");
			return;
		}
		...
		UObjectMarshaler<UMovieSceneDoubleVectorTrack>.ToNative(IntPtr.Add(intPtr, SetNumChannelsUsed_Track_Offset), 0, SetNumChannelsUsed_Track_PropertyAddress.Address, Track);
	...
	[UFunction(Flags = 67249153u)]
	[UMetaPath("/Script/SequencerScripting.MovieSceneDoubleVectorTrackExtensions:GetNumChannelsUsed")]
	public unsafe static int GetNumChannelsUsed(UMovieSceneDoubleVectorTrack Track)
	{
		if (!GetNumChannelsUsed_IsValid)
		{
			NativeReflection.LogInvalidFunctionAccessed("/Script/SequencerScripting.MovieSceneDoubleVectorTrackExtensions:GetNumChannelsUsed");
			return 0;
		}
		...
		IntPtr intPtr = new IntPtr(ptr2);
		UObjectMarshaler<UMovieSceneDoubleVectorTrack>.ToNative(IntPtr.Add(intPtr, GetNumChannelsUsed_Track_Offset), 0, GetNumChannelsUsed_Track_PropertyAddress.Address, Track);
	...
	static UMovieSceneDoubleVectorTrackExtensions()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UMovieSceneDoubleVectorTrackExtensions)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UMovieSceneDoubleVectorTrackExtensions));
	}

	private static void LoadNativeType()
	{
		classAddress = NativeReflection.GetClass("/Script/SequencerScripting.MovieSceneDoubleVectorTrackExtensions");
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneDoubleVectorTrackExtensions:SetNumChannelsUsed", SetNumChannelsUsed_IsValid);
		...
		NativeReflection.LogFunctionIsValid("/Script/SequencerScripting.MovieSceneDoubleVectorTrackExtensions:GetNumChannelsUsed", GetNumChannelsUsed_IsValid);
	}
}
