...
[BlueprintType]
[UMetaPath("/Script/PCG.PCGMetadataMathsSettings", "PCG", UnrealModuleType.EnginePlugin)]
public class UPCGMetadataMathsSettings : UPCGMetadataSettingsBase
{
	...
	[UMetaPath("/Script/PCG.PCGMetadataMathsSettings:Operation")]
	public EPCGMedadataMathsOperation Operation
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/PCG.PCGMetadataMathsSettings:Operation");
				return (EPCGMedadataMathsOperation)0;
			}
			return EnumMarshaler<EPCGMedadataMathsOperation>.FromNative(IntPtr.Add(base.Address, Operation_Offset), 0, Operation_PropertyAddress.Address);
		}
		set
		{
			CheckDestroyed();
			...
			{
				EnumMarshaler<EPCGMedadataMathsOperation>.ToNative(IntPtr.Add(base.Address, Operation_Offset), 0, Operation_PropertyAddress.Address, value);
			}
		}
	}

	[UProperty(Flags = (PropFlags)4503599627370501uL)]
	[UMetaPath("/Script/PCG.PCGMetadataMathsSettings:InputSource1")]
	public FPCGAttributePropertyInputSelector InputSource1
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/PCG.PCGMetadataMathsSettings:InputSource1");
	...
	[UProperty(Flags = (PropFlags)4503599627370501uL)]
	[UMetaPath("/Script/PCG.PCGMetadataMathsSettings:InputSource2")]
	public FPCGAttributePropertyInputSelector InputSource2
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/PCG.PCGMetadataMathsSettings:InputSource2");
				return default(FPCGAttributePropertyInputSelector);
			}
	...
	[UProperty(Flags = (PropFlags)4503599627370501uL)]
	[UMetaPath("/Script/PCG.PCGMetadataMathsSettings:InputSource3")]
	public FPCGAttributePropertyInputSelector InputSource3
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/PCG.PCGMetadataMathsSettings:InputSource3");
				return default(FPCGAttributePropertyInputSelector);
			}
	...
	static UPCGMetadataMathsSettings()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UPCGMetadataMathsSettings)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UPCGMetadataMathsSettings));
	}

	private static void LoadNativeType()
	{
		IntPtr unrealStruct = NativeReflection.GetClass("/Script/PCG.PCGMetadataMathsSettings");
