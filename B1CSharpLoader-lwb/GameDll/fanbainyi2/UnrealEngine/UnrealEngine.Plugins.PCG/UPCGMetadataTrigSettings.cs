...
[BlueprintType]
[UMetaPath("/Script/PCG.PCGMetadataTrigSettings", "PCG", UnrealModuleType.EnginePlugin)]
public class UPCGMetadataTrigSettings : UPCGMetadataSettingsBase
{
	...
	[UMetaPath("/Script/PCG.PCGMetadataTrigSettings:Operation")]
	public EPCGMedadataTrigOperation Operation
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/PCG.PCGMetadataTrigSettings:Operation");
				return EPCGMedadataTrigOperation.Acos;
			}
			return EnumMarshaler<EPCGMedadataTrigOperation>.FromNative(IntPtr.Add(base.Address, Operation_Offset), 0, Operation_PropertyAddress.Address);
		}
		set
		{
			CheckDestroyed();
			...
			{
				EnumMarshaler<EPCGMedadataTrigOperation>.ToNative(IntPtr.Add(base.Address, Operation_Offset), 0, Operation_PropertyAddress.Address, value);
			}
		}
	}

	[UProperty(Flags = (PropFlags)4503599627370501uL)]
	[UMetaPath("/Script/PCG.PCGMetadataTrigSettings:InputSource1")]
	public FPCGAttributePropertyInputSelector InputSource1
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/PCG.PCGMetadataTrigSettings:InputSource1");
	...
	[UProperty(Flags = (PropFlags)4503599627370501uL)]
	[UMetaPath("/Script/PCG.PCGMetadataTrigSettings:InputSource2")]
	public FPCGAttributePropertyInputSelector InputSource2
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/PCG.PCGMetadataTrigSettings:InputSource2");
				return default(FPCGAttributePropertyInputSelector);
			}
	...
	static UPCGMetadataTrigSettings()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UPCGMetadataTrigSettings)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UPCGMetadataTrigSettings));
	}

	private static void LoadNativeType()
	{
		IntPtr unrealStruct = NativeReflection.GetClass("/Script/PCG.PCGMetadataTrigSettings");
