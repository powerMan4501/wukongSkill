...
[BlueprintType]
[UMetaPath("/Script/PCG.PCGMetadataBitwiseSettings", "PCG", UnrealModuleType.EnginePlugin)]
public class UPCGMetadataBitwiseSettings : UPCGMetadataSettingsBase
{
	...
	[UMetaPath("/Script/PCG.PCGMetadataBitwiseSettings:Operation")]
	public EPCGMedadataBitwiseOperation Operation
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/PCG.PCGMetadataBitwiseSettings:Operation");
				return EPCGMedadataBitwiseOperation.And;
			}
			return EnumMarshaler<EPCGMedadataBitwiseOperation>.FromNative(IntPtr.Add(base.Address, Operation_Offset), 0, Operation_PropertyAddress.Address);
		}
		set
		{
			CheckDestroyed();
			...
			{
				EnumMarshaler<EPCGMedadataBitwiseOperation>.ToNative(IntPtr.Add(base.Address, Operation_Offset), 0, Operation_PropertyAddress.Address, value);
			}
		}
	}

	[UProperty(Flags = (PropFlags)4503599627370501uL)]
	[UMetaPath("/Script/PCG.PCGMetadataBitwiseSettings:InputSource1")]
	public FPCGAttributePropertyInputSelector InputSource1
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/PCG.PCGMetadataBitwiseSettings:InputSource1");
	...
	[UProperty(Flags = (PropFlags)4503599627370501uL)]
	[UMetaPath("/Script/PCG.PCGMetadataBitwiseSettings:InputSource2")]
	public FPCGAttributePropertyInputSelector InputSource2
	{
		get
		{
			...
			{
				NativeReflection.LogInvalidPropertyAccessed("/Script/PCG.PCGMetadataBitwiseSettings:InputSource2");
				return default(FPCGAttributePropertyInputSelector);
			}
	...
	static UPCGMetadataBitwiseSettings()
	{
		if (UnrealTypes.CanLazyLoadNativeType(typeof(UPCGMetadataBitwiseSettings)))
		{
			LoadNativeType();
		}
		UnrealTypes.OnCCtorCalled(typeof(UPCGMetadataBitwiseSettings));
	}

	private static void LoadNativeType()
	{
		IntPtr unrealStruct = NativeReflection.GetClass("/Script/PCG.PCGMetadataBitwiseSettings");
