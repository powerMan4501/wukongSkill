...
public sealed class ListDeltaMsgGeoInfoCustomData : IMessage<ListDeltaMsgGeoInfoCustomData>, IMessage, IEquatable<ListDeltaMsgGeoInfoCustomData>, IDeepCloneable<ListDeltaMsgGeoInfoCustomData>
{
	...
	private static readonly FieldCodec<ClassDeltaMsgGeoInfoCustomData> _repeated_value_codec = FieldCodec.ForMessage(18u, ClassDeltaMsgGeoInfoCustomData.Parser);

	private readonly RepeatedField<ClassDeltaMsgGeoInfoCustomData> value_ = new RepeatedField<ClassDeltaMsgGeoInfoCustomData>();
	...
	public RepeatedField<ClassDeltaMsgGeoInfoCustomData> Value => value_;
