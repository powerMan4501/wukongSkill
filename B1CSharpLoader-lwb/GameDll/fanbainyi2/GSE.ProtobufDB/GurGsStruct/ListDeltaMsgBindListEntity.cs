...
public sealed class ListDeltaMsgBindListEntity : IMessage<ListDeltaMsgBindListEntity>, IMessage, IEquatable<ListDeltaMsgBindListEntity>, IDeepCloneable<ListDeltaMsgBindListEntity>
{
	...
	private static readonly FieldCodec<ListDeltaMsgEntity> _repeated_value_codec = FieldCodec.ForMessage(18u, ListDeltaMsgEntity.Parser);

	private readonly RepeatedField<ListDeltaMsgEntity> value_ = new RepeatedField<ListDeltaMsgEntity>();
	...
	public RepeatedField<ListDeltaMsgEntity> Value => value_;
