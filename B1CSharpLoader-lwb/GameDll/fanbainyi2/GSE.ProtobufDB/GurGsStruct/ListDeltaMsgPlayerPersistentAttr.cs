...
public sealed class ListDeltaMsgPlayerPersistentAttr : IMessage<ListDeltaMsgPlayerPersistentAttr>, IMessage, IEquatable<ListDeltaMsgPlayerPersistentAttr>, IDeepCloneable<ListDeltaMsgPlayerPersistentAttr>
{
	...
	private static readonly FieldCodec<ClassDeltaMsgPlayerPersistentAttr> _repeated_value_codec = FieldCodec.ForMessage(18u, ClassDeltaMsgPlayerPersistentAttr.Parser);

	private readonly RepeatedField<ClassDeltaMsgPlayerPersistentAttr> value_ = new RepeatedField<ClassDeltaMsgPlayerPersistentAttr>();
	...
	public RepeatedField<ClassDeltaMsgPlayerPersistentAttr> Value => value_;
