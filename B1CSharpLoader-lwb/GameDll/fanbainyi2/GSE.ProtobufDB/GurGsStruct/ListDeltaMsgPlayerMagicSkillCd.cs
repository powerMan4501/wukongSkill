...
public sealed class ListDeltaMsgPlayerMagicSkillCd : IMessage<ListDeltaMsgPlayerMagicSkillCd>, IMessage, IEquatable<ListDeltaMsgPlayerMagicSkillCd>, IDeepCloneable<ListDeltaMsgPlayerMagicSkillCd>
{
	...
	private static readonly FieldCodec<ClassDeltaMsgPlayerMagicSkillCd> _repeated_value_codec = FieldCodec.ForMessage(18u, ClassDeltaMsgPlayerMagicSkillCd.Parser);

	private readonly RepeatedField<ClassDeltaMsgPlayerMagicSkillCd> value_ = new RepeatedField<ClassDeltaMsgPlayerMagicSkillCd>();
	...
	public RepeatedField<ClassDeltaMsgPlayerMagicSkillCd> Value => value_;
